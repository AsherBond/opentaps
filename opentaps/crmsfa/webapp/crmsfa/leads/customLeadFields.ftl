...
function removePartyAttribute(/*String*/ partyAttributeIndex) {
  ...
  form.action = "removeLeadCustomField";
  form.submit();
}
</script>
<!-- only display the custom fields section when use has create or view permission-->
<#if hasLeadCustCreatePermission || hasLeadCustViewPermission>
<@frameSection title=uiLabelMap.CrmCustomFields>
      <table class="twoColumn">
        <tbody>
          ...
          <#if hasLeadCustViewPermission && partyAttributes?exists>
               <#list partyAttributes as partyAttribute>

              <form method="post" action="<@ofbizUrl>updateLeadCustomField</@ofbizUrl>" name="updateCustomField_${partyAttribute_index}" id="updateCustomField_${partyAttribute_index}">
              <tr>
                <td/>
                ...
                <td>
                <#if hasLeadCustUpdatePermission || userLogin.userLoginId==partyAttribute.createdByUserLoginId?default("")>
                ...
                <#if hasLeadCustDeletePermission || userLogin.userLoginId==partyAttribute.createdByUserLoginId?default("")>
          ...
          <#if hasLeadCustCreatePermission>
          <form method="post" action="<@ofbizUrl>createLeadCustomField</@ofbizUrl>" name="addCustomField">
          <tr>
            <td/>
