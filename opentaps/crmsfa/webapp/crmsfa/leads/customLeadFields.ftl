        ...
        <tbody>
          ...
          <#if hasLeadCustViewPermission && partyAttributes?exists>
              ...
              <tr>
                ...
                <td>
                <#if hasLeadCustUpdatePermission || userLogin.userLoginId==partyAttribute.createdByUserLoginId>
                ...
                <#if hasLeadCustDeletePermission || userLogin.userLoginId==partyAttribute.createdByUserLoginId>
