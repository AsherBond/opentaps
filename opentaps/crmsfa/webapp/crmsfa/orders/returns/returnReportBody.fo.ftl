...
<#macro displayReturnAdjustment returnAdjustment>
    ...
    <#if returnAdjustment.amount?has_content>
      ...
      <fo:block font-size="10pt">
        <fo:table width="7.25in" height="5in">
          ...
          <fo:table-body>
            ...
            <fo:table-row text-align="center" font-weight="bold">
              <fo:table-cell padding="1mm" border-bottom="solid" border-width="0.1pt" display-align="after"><fo:block font-size="10pt">${uiLabelMap.OrderOrderId}</fo:block></fo:table-cell>
              <fo:table-cell padding="1mm" border-bottom="solid" border-width="0.1pt" display-align="after"><fo:block font-size="10pt">${uiLabelMap.ProductProductId}</fo:block></fo:table-cell>
              <fo:table-cell padding="1mm" border-bottom="solid" border-width="0.1pt" display-align="after"><fo:block font-size="10pt">${uiLabelMap.CommonDescription}</fo:block></fo:table-cell>
              <fo:table-cell padding="1mm" border-bottom="solid" border-width="0.1pt" display-align="after"><fo:block font-size="10pt">${uiLabelMap.OrderQty}</fo:block></fo:table-cell>
              <fo:table-cell padding="1mm" border-bottom="solid" border-width="0.1pt" display-align="after"><fo:block font-size="10pt">${uiLabelMap.OrderUnitPrice}</fo:block></fo:table-cell>
              <fo:table-cell padding="1mm" border-bottom="solid" border-width="0.1pt" display-align="after"><fo:block font-size="10pt">${uiLabelMap.OrderAmount}</fo:block></fo:table-cell>
            </fo:table-row>
