...
function removePartyAttribute(/*String*/ partyAttributeIndex) {
  ...
  form.action = "removeContactCustomField";
  form.submit();
}
</script>
<!-- only display the custom fields section when use has create or view permission-->
<#if hasContactCustCreatePermission || hasContactCustViewPermission>
<@frameSection title=uiLabelMap.CrmCustomFields>
      <table class="twoColumn">
        <tbody>
          ...
          <#if hasContactCustViewPermission && partyAttributes?exists>
               <#list partyAttributes as partyAttribute>

              <form method="post" action="<@ofbizUrl>updateContactCustomField</@ofbizUrl>" name="updateCustomField_${partyAttribute_index}" id="updateCustomField_${partyAttribute_index}">
              <tr>
                <td/>
                ...
                <td>
                <#if hasContactCustUpdatePermission || userLogin.userLoginId==partyAttribute.createdByUserLoginId?default("")>
                ...
                <#if hasContactCustDeletePermission || userLogin.userLoginId==partyAttribute.createdByUserLoginId?default("")>
          ...
          <#if hasContactCustCreatePermission>
          <form method="post" action="<@ofbizUrl>createContactCustomField</@ofbizUrl>" name="addCustomField">
          <tr>
            <td/>
