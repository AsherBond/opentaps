  ...
  <div class="screenlet-body">
    <table width="100%" border="0" cellpadding="1" cellspacing="0">
      ...
      <tr>
        ...
        <td width="5">&nbsp;</td>
        <td width="80%">
          <select name="newOrderContactMechId" id="newOrderContactMechId" class="selectBox">
