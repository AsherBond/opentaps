      ...
      <table cellspacing="2" cellpadding="1" border="0">
          ...
          <tr valign="top">
            ...
            <td>
              <table border="0">
                  ...
                  <td colspan="2">
                    <div class="tabletext">
                      <#if cartLine.getProductId()?exists>
                        <#-- product item -->
                        ${cartLine.getProductId()} - <input size="50" class="inputBox" type="text" name="description_${cartLineIndex}" value="${cartLine.getName()?default("")}"/><br/>
                      <#else>
                ...
                <#if cartLine.getQuoteId()?has_content && cartLine.getQuoteItemSeqId()?has_content>
                  <tr>
                    <td colspan="2" align="left">
                ...
                <#if cartLine.getDesiredDeliveryDate()?has_content>
                  <tr>
                    ...
                    <td align="left"><div class="tabletext">${cartLine.getDesiredDeliveryDate()?if_exists}</div></td>
                  </tr>
                </#if>
                <#-- inventory summary -->
                <#if cartLine.getProductId()?exists>
                      ...
                      <tr>
                        <td align="left">
                          <div class="tabletext">${uiLabelMap.OrderShipAfterDate}
                            <@inputDate name="shipAfterDate_${cartLineIndex}" default=cartLine.getShipAfterDate()?default("")/>
                          </div>
                        </td>
                        <td>&nbsp;</td>
                        <td align="left">
                          <div class="tabletext">${uiLabelMap.OrderShipBeforeDate}
                            <@inputDate name="shipBeforeDate_${cartLineIndex}" default=cartLine.getShipBeforeDate()?default("")/>
                          </div>
                        </td>
                      </tr>
                    </table>
            ...
            <td nowrap="nowrap" align="right"><div class="tabletext"><@ofbizCurrency amount=cartLine.getOtherAdjustments() isoCode=currencyUomId/></div></td>
            <td nowrap="nowrap" align="right"><div class="tabletext"><@ofbizCurrency amount=cartLine.getDisplayItemSubTotal() isoCode=currencyUomId/></div></td>
        ...
        <#if shoppingCart.getAdjustments()?has_content>
          ...
          <tr>
            ...
            <td nowrap="nowrap" align="right"><div class="tabletext"><@ofbizCurrency amount=shoppingCart.getSubTotal() isoCode=currencyUomId/></div></td>
            <td>&nbsp;</td>
          </tr>
          <#list shoppingCart.getAdjustments() as cartAdjustment>
            ...
            <tr>
              ...
              <td nowrap="nowrap" align="right"><div class="tabletext"><@ofbizCurrency amount=Static["org.ofbiz.order.order.OrderReadHelper"].calcOrderAdjustment(cartAdjustment, shoppingCart.getSubTotal()) isoCode=currencyUomId/></div></td>
              <td>&nbsp;</td>
            </tr>
          </#list>
        </#if>
