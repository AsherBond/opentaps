...
/** {@inheritDoc}. */
public class PartyDataImportRepository extends DomainRepository implements PartyDataImportRepositoryInterface{
    
    /**
     * Default constructor.
     */
    public PartyDataImportRepository() {
        super();
    }
     ...
     */
    public PartyDataImportRepository(Infrastructure infrastructure, User user) throws RepositoryException {
