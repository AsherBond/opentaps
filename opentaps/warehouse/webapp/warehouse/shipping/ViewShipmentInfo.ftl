  ...
  <#if shipment?exists>
    <table border="0" cellpadding="2" cellspacing="0">
      ...
      <tr>
        ...
        <td width="80%" align="left">
          <span class="tabletext">
            <span class="tableheadtext">${uiLabelMap.CommonReady}:&nbsp;</span>${getLocalizedDate(shipment.estimatedReadyDate)}
            <span class="tableheadtext">${uiLabelMap.ProductEstimatedShipDate}:&nbsp;</span>${getLocalizedDate(shipment.estimatedShipDate)}
            <span class="tableheadtext">${uiLabelMap.ProductArrival}:&nbsp;</span>${getLocalizedDate(shipment.estimatedArrivalDate)}
          </span>
        </td>
      </tr>
      <tr>
        ...
        <td><span class="tabletext">&nbsp;</span></td>
        <td width="80%" align="left"><span class="tabletext">${getLocalizedDate(shipment.latestCancelDate)}</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><span class="tabletext">&nbsp;</span></td>
        <td width="80%" align="left">
          <div class="tabletext">${uiLabelMap.CommonBy} [${shipment.createdByUserLogin?if_exists}] ${uiLabelMap.CommonOn} ${getLocalizedDate(shipment.createdDate)}</div>
        </td>
      </tr>
      <tr>
        ...
        <td><span class="tabletext">&nbsp;</span></td>
        <td width="80%" align="left">
          <div class="tabletext">${uiLabelMap.CommonBy} [${shipment.lastModifiedByUserLogin?if_exists}] ${uiLabelMap.CommonOn} ${getLocalizedDate(shipment.lastModifiedDate)}</div>
        </td>
      </tr>
    </table>  
  </#if>
