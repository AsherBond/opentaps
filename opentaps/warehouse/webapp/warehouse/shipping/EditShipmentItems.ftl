    ...
    <div class="screenlet-body">
        ...
        <#list shipmentItemDatas as shipmentItemData>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                ...
                <td colspan="2">${(product.internalName)?if_exists} <@displayLink href="/catalog/control/EditProduct?productId=${shipmentItem.productId?if_exists}" text="${shipmentItem.productId?if_exists}" target="_blank" /></td>
            ...
            <#list orderShipments as orderShipment>
                <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                    <td>&nbsp;</td>
                    <td><span class="label">${uiLabelMap.ProductOrderItem}</span> <@displayLink href="/crmsfa/control/orderview?orderId=${orderShipment.orderId?if_exists}" text="${orderShipment.orderId?if_exists}" target="_blank" /> ${orderShipment.orderItemSeqId?if_exists}</td>
                    <td>&nbsp;</td>
            ...
            <#list itemIssuances as itemIssuance>
                <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                    <td>&nbsp;</td>
                    <td><span class="label">${uiLabelMap.ProductOrderItem}</span> <@displayLink href="/crmsfa/control/orderview?orderId=${itemIssuance.orderId?if_exists}" text="${itemIssuance.orderId?if_exists}" target="_blank" /> ${itemIssuance.orderItemSeqId?if_exists}</td>
                    <td><span class="label">${uiLabelMap.ProductInventory}</span> <@displayLink href="EditInventoryItem?inventoryItemId=${itemIssuance.inventoryItemId?if_exists}" text="${itemIssuance.inventoryItemId?if_exists}" target="_blank" /></td>
