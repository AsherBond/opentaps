 ...
 * Auto generated base service entity setInvoiceDefaultBillingAddressIfNeeded.
 *
 * Engine: java
 * Location: com.opensourcestrategies.financials.invoice.InvoiceServices
 * Invoke: setInvoiceDefaultBillingAddress
 * Defined in: opentaps/financials/servicedef/services_invoice.xml
 */
public class SetInvoiceDefaultBillingAddressIfNeededService extends ServiceWrapper {

    /** The service name as used by the service engine. */
    public static final String NAME = "setInvoiceDefaultBillingAddressIfNeeded";
    ...
    /**
     * Creates a new <code>SetInvoiceDefaultBillingAddressIfNeededService</code> instance.
     */
    public SetInvoiceDefaultBillingAddressIfNeededService() {
        super();
    }
     ...
     */
    public SetInvoiceDefaultBillingAddressIfNeededService(User user) {
        super(user);
    }
    ...
    */
    ...
    /**
     * Construct a <code>SetInvoiceDefaultBillingAddressIfNeededService</code> from the input values of the given <code>SetInvoiceDefaultBillingAddressIfNeededService</code>.
     * @param input a <code>SetInvoiceDefaultBillingAddressIfNeededService</code>
     */
    public static SetInvoiceDefaultBillingAddressIfNeededService fromInput(SetInvoiceDefaultBillingAddressIfNeededService input) {
        SetInvoiceDefaultBillingAddressIfNeededService service = new SetInvoiceDefaultBillingAddressIfNeededService();
        return fromInput(input.inputMap());
    }

    /**
     * Construct a <code>SetInvoiceDefaultBillingAddressIfNeededService</code> from the output values of the given <code>SetInvoiceDefaultBillingAddressIfNeededService</code>.
     * @param output a <code>SetInvoiceDefaultBillingAddressIfNeededService</code>
     */
    public static SetInvoiceDefaultBillingAddressIfNeededService fromOutput(SetInvoiceDefaultBillingAddressIfNeededService output) {
        SetInvoiceDefaultBillingAddressIfNeededService service = new SetInvoiceDefaultBillingAddressIfNeededService();
    ...
    /**
     * Construct a <code>SetInvoiceDefaultBillingAddressIfNeededService</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SetInvoiceDefaultBillingAddressIfNeededService fromInput(Map<String, Object> mapValue) {
        SetInvoiceDefaultBillingAddressIfNeededService service = new SetInvoiceDefaultBillingAddressIfNeededService();
    ...
    /**
     * Construct a <code>SetInvoiceDefaultBillingAddressIfNeededService</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SetInvoiceDefaultBillingAddressIfNeededService fromOutput(Map<String, Object> mapValue) {
        SetInvoiceDefaultBillingAddressIfNeededService service = new SetInvoiceDefaultBillingAddressIfNeededService();
