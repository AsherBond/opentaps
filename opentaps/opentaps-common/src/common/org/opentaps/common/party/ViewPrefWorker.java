...
public class ViewPrefWorker {
    ...
    /** Gets the value of the preference as a String.  If it is not set yet, return the default value. */
    public static String getViewPreferenceString(GenericValue userLogin, String viewPrefTypeId, String defaultValue) throws GenericEntityException {
        String pref = getViewPreferenceString(userLogin, viewPrefTypeId);
        return (UtilValidate.isEmpty(pref) ? defaultValue : pref);
    }
}
