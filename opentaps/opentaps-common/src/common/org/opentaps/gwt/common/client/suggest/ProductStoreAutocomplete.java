...
/**
 * A ComboBox that autocompletes ProductStores.
 */
public class ProductStoreAutocomplete  extends EntityAutocomplete {
     ...
     */
    public ProductStoreAutocomplete(String fieldLabel, String name, int fieldWidth) {
        super(fieldLabel, name, fieldWidth, ProductStoreLookupConfiguration.URL_SUGGEST_PRODUCTSTORES, ProductStoreLookupConfiguration.OUT_PRODUCT_STORE_ID);
    }
}
