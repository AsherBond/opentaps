...
/**
 * A ComboBox that autocompletes Case Status.
 */
public class CaseStatusAutocomplete extends EntityStaticAutocomplete {
    /**
     * Creates a new <code>CaseStatusAutocomplete</code> instance.
     ...
     */
    public CaseStatusAutocomplete(String fieldLabel, String name, int fieldWidth) {
        super(fieldLabel, name, fieldWidth, CaseStatusLookupConfiguration.URL_SUGGEST_CLASSIFICATIONS , CaseStatusLookupConfiguration.OUT_DESCRIPTION);
    }
}
