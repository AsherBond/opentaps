...
public abstract class PartyLookupConfiguration {
    ...
    public static final String URL_SUGGEST_SALES_REP = "gwtSuggestSalesRep";
    ...
    public static final String IN_RELATED_PARTY_RELATIONSHIP_TYPE_ID = "relatedPartyRelationshipTypeId";
    public static final String IN_RELATED_PARTY_ID = "relatedPartyId";
    ...
    public static final List<String> SIMPLE_LIST_OUT_FIELDS = Arrays.asList(
        INOUT_PARTY_ID,
        INOUT_GROUP_NAME,
        INOUT_FIRST_NAME,
        INOUT_LAST_NAME
