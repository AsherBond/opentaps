...
<table border="0" cellpadding="2" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <td align="right" valign="top">
      <div class="head1">${productContentWrapper.get("PRODUCT_NAME")?if_exists}</div>
        ...
        <#if product.isVirtual?if_exists?upper_case == "Y">
          <#if product.virtualVariantMethodEnum?if_exists == "VV_FEATURETREE" && featureLists?has_content>
            <#list featureLists as featureList>
                <#list featureList as feature>
                    <#if feature_index == 0>
                        <div>${feature.description}: <select id="FT${feature.productFeatureTypeId}" name="FT${feature.productFeatureTypeId}" onChange="javascript:checkRadioButton();" class="inputBox">
            ...
            <div id="addCart1" style="display:none;">
              ...
              <input type="text" size="5" name="quantity" value="1" class="inputBox"/>
            ...
            <div id="addCart2" style="display:block;">
              <span style="white-space: nowrap;"><b>${uiLabelMap.CommonQuantity}:</b></span>&nbsp;
              <input type="text" size="5" value="1" disabled="disabled" class="inputBox"/>
          ...
          <#if !product.virtualVariantMethodEnum?exists || product.virtualVariantMethodEnum == "VV_VARIANTTREE">
           <#if variantTree?exists && (variantTree.size() gt 0)>
            <#list featureSet as currentType>
              <div>
                <select name="FT${currentType}" onchange="javascript:getList(this.name, (this.selectedIndex-1), 1);" class="inputBox">
        ...
        <#elseif product.virtualVariantMethodEnum?if_exists != "VV_FEATURETREE">
          <#if inStock>
            ...
            <div id="add_amount" class="${hiddenStyle}">
              ...
              <input type="text" size="5" name="add_amount" value="" class="inputBox"/>
            </div>
            <#if product.productTypeId?if_exists == "ASSET_USAGE">
                <table width="100%"><tr>
                <td nowrap="nowrap" align="right">Start Date<br/>(yyyy-mm-dd)</td><td><input type="text" size="10" name="reservStart" class="inputBox"/><a href="javascript:call_cal_notime(document.addform.reservStart, '${nowTimestamp.toString().substring(0,10)}');"><img src="<@ofbizContentUrl>/images/cal.gif</@ofbizContentUrl>" width="16" height="16" border="0" alt="Calendar"/></a></td>
                <td nowrap="nowrap" align="right">End Date<br/>(yyyy-mm-dd)</td><td><input type="text" size="10" name="reservEnd" class="inputBox"/><a href="javascript:call_cal_notime(document.addform.reservEnd, '${nowTimestamp.toString().substring(0,10)}');"><img src="<@ofbizContentUrl>/images/cal.gif</@ofbizContentUrl>" width="16" height="16" border="0" alt="Calendar"/></a></td></tr>
                <tr>
                <#--td nowrap="nowrap" align="right">Number<br/>of days</td><td><input type="textt" size="4" name="reservLength" class="inputBox"/></td></tr><tr><td>&nbsp;</td><td align="right" nowrap>&nbsp;</td-->
                <td nowrap="nowrap" align="right">Number of persons</td><td><input type="text" size="4" name="reservPersons" value="2" class="inputBox"/></td>
                <td nowrap="nowrap" align="right">Number of rooms</td><td><input type="text" size="5" name="quantity" value="1" class="inputBox"/></td></tr></table>
            <#else/>
                <input type="text" size="5" name="quantity" class="inputBox" value="1"<#if product.isVirtual?if_exists?upper_case == "Y"> disabled="disabled"</#if>/>
            </#if>
    ...
    <div>
      <#if sessionAttributes.userLogin?has_content && sessionAttributes.userLogin.userLoginId != "anonymous">
        ...
        <form name="addToShoppingList" method="post" action="<@ofbizUrl>addItemToShoppingList<#if requestAttributes._CURRENT_VIEW_?exists>/${requestAttributes._CURRENT_VIEW_}</#if></@ofbizUrl>">
          ...
          <select name="shoppingListId" class="inputBox">>
          ...
          &nbsp;&nbsp;
          <#if product.productTypeId?if_exists == "ASSET_USAGE">
              <table><tr><td>&nbsp;</td><td align="right">${uiLabelMap.CommonStartDate} (yyyy-mm-dd)</td><td><input type="text" size="10" name="reservStartStr" class="inputBox"></td><td>Number of&nbsp;days</td><td><input type="text" size="4" name="reservLength"></td><td>&nbsp;</td><td align="right">Number of&nbsp;persons</td><td><input type="text" size="4" name="reservPersons" value="1" class="inputBox"></td><td align="right">Qty&nbsp;</td><td><input type="text" size="5" name="quantity" value="1" class="inputBox"></td></tr></table>
          <#else>
              <input type="text" size="5" name="quantity" value="1" class="inputBox"/>
