...
<#if product?exists>
    ...
    <div class="productsummary">
        ...
        <@flexArea targetId="${productDetailId}" title="Details" controlClassOpen="flexAreaControlButton_open" controlClassClosed="flexAreaControlButton_closed" style="border:0">
          <table>
            <tr valign="top">
              <td>
