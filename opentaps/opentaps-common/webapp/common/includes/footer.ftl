...
<div id="footer">
  <#-- Need string wrapper so the footer text can contain HTML -->
  <#assign customFooter = StringUtil.wrapString((infrastructure.getConfigurationValue("UI_FOOTER_TEXT"))!"") />
  <#if customFooter?has_content>
    ${customFooter}
  <#else>
