...
<div id="footer">
    <div class="tabletext"><a href="http://www.opentaps.org" class="tabletext">${uiLabelMap.OpentapsProductName}</a> ${uiLabelMap.OpentapsReleaseVersion}.
      opentaps is a trademark of <a href="http://www.opentaps.org">opentaps Group LLC</a></div>
    ...
    <div class="tabletext">(c) <a href="http://www.opentaps.org" class="tabletext">opentaps Group LLC</a></div>
    <div class="tabletext">
