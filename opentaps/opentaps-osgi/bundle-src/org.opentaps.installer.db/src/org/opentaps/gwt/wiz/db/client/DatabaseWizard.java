 ...
 */
package org.opentaps.gwt.wiz.db.client;
 ...
 *
 */
public class DatabaseWizard extends BaseEntry {
    ...
    public void onModuleLoad() {
        ...
        form.setWidth(400);
        form.setHeight(300);
        form.setTitle("Database Settings");
        ...
        prev.addListener(new ButtonListenerAdapter() {
            ...
            public void onClick(Button button, EventObject e) {
                DatabaseWizard.this.requestUri("prev");
            }
        ...
        next.addListener(new ButtonListenerAdapter() {
            ...
            public void onClick(Button button, EventObject e) {
                DatabaseWizard.this.requestUri("next");
            }
    ...
    public void requestUri(String direction) {
        ...
        builder.setRequestData(Format.format("stepId={0}&direction={1}", "database", direction));
