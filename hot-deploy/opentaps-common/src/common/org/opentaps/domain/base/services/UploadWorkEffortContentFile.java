 ...
 */
public class UploadWorkEffortContentFile extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UploadWorkEffortContentFile</code> from the input values of the given <code>UploadWorkEffortContentFile</code>.
     * @param input a <code>UploadWorkEffortContentFile</code>
     */
    public static UploadWorkEffortContentFile fromInput(UploadWorkEffortContentFile input) {
        UploadWorkEffortContentFile service = new UploadWorkEffortContentFile();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UploadWorkEffortContentFile</code> from the output values of the given <code>UploadWorkEffortContentFile</code>.
     * @param output a <code>UploadWorkEffortContentFile</code>
     */
    public static UploadWorkEffortContentFile fromOutput(UploadWorkEffortContentFile output) {
        UploadWorkEffortContentFile service = new UploadWorkEffortContentFile();
    ...
    /**
     * Construct a <code>UploadWorkEffortContentFile</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UploadWorkEffortContentFile fromInput(Map<String, Object> mapValue) {
        UploadWorkEffortContentFile service = new UploadWorkEffortContentFile();
    ...
    /**
     * Construct a <code>UploadWorkEffortContentFile</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UploadWorkEffortContentFile fromOutput(Map<String, Object> mapValue) {
        UploadWorkEffortContentFile service = new UploadWorkEffortContentFile();
