 ...
 */
public class CreateSimpleTextContentForProduct extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForProduct</code> from the input values of the given <code>CreateSimpleTextContentForProduct</code>.
     * @param input a <code>CreateSimpleTextContentForProduct</code>
     */
    public static CreateSimpleTextContentForProduct fromInput(CreateSimpleTextContentForProduct input) {
        CreateSimpleTextContentForProduct service = new CreateSimpleTextContentForProduct();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateSimpleTextContentForProduct</code> from the output values of the given <code>CreateSimpleTextContentForProduct</code>.
     * @param output a <code>CreateSimpleTextContentForProduct</code>
     */
    public static CreateSimpleTextContentForProduct fromOutput(CreateSimpleTextContentForProduct output) {
        CreateSimpleTextContentForProduct service = new CreateSimpleTextContentForProduct();
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForProduct</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateSimpleTextContentForProduct fromInput(Map<String, Object> mapValue) {
        CreateSimpleTextContentForProduct service = new CreateSimpleTextContentForProduct();
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForProduct</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateSimpleTextContentForProduct fromOutput(Map<String, Object> mapValue) {
        CreateSimpleTextContentForProduct service = new CreateSimpleTextContentForProduct();
