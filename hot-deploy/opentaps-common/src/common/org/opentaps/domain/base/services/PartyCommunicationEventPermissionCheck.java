 ...
 */
public class PartyCommunicationEventPermissionCheck extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PartyCommunicationEventPermissionCheck</code> from the input values of the given <code>PartyCommunicationEventPermissionCheck</code>.
     * @param input a <code>PartyCommunicationEventPermissionCheck</code>
     */
    public static PartyCommunicationEventPermissionCheck fromInput(PartyCommunicationEventPermissionCheck input) {
        PartyCommunicationEventPermissionCheck service = new PartyCommunicationEventPermissionCheck();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PartyCommunicationEventPermissionCheck</code> from the output values of the given <code>PartyCommunicationEventPermissionCheck</code>.
     * @param output a <code>PartyCommunicationEventPermissionCheck</code>
     */
    public static PartyCommunicationEventPermissionCheck fromOutput(PartyCommunicationEventPermissionCheck output) {
        PartyCommunicationEventPermissionCheck service = new PartyCommunicationEventPermissionCheck();
    ...
    /**
     * Construct a <code>PartyCommunicationEventPermissionCheck</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PartyCommunicationEventPermissionCheck fromInput(Map<String, Object> mapValue) {
        PartyCommunicationEventPermissionCheck service = new PartyCommunicationEventPermissionCheck();
    ...
    /**
     * Construct a <code>PartyCommunicationEventPermissionCheck</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PartyCommunicationEventPermissionCheck fromOutput(Map<String, Object> mapValue) {
        PartyCommunicationEventPermissionCheck service = new PartyCommunicationEventPermissionCheck();
