 ...
 */
public class UpdatePaymentApplicationDef extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdatePaymentApplicationDef</code> from the input values of the given <code>UpdatePaymentApplicationDef</code>.
     * @param input a <code>UpdatePaymentApplicationDef</code>
     */
    public static UpdatePaymentApplicationDef fromInput(UpdatePaymentApplicationDef input) {
        UpdatePaymentApplicationDef service = new UpdatePaymentApplicationDef();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdatePaymentApplicationDef</code> from the output values of the given <code>UpdatePaymentApplicationDef</code>.
     * @param output a <code>UpdatePaymentApplicationDef</code>
     */
    public static UpdatePaymentApplicationDef fromOutput(UpdatePaymentApplicationDef output) {
        UpdatePaymentApplicationDef service = new UpdatePaymentApplicationDef();
    ...
    /**
     * Construct a <code>UpdatePaymentApplicationDef</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdatePaymentApplicationDef fromInput(Map<String, Object> mapValue) {
        UpdatePaymentApplicationDef service = new UpdatePaymentApplicationDef();
    ...
    /**
     * Construct a <code>UpdatePaymentApplicationDef</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdatePaymentApplicationDef fromOutput(Map<String, Object> mapValue) {
        UpdatePaymentApplicationDef service = new UpdatePaymentApplicationDef();
