 ...
 */
public class CreateDataText extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateDataText</code> from the input values of the given <code>CreateDataText</code>.
     * @param input a <code>CreateDataText</code>
     */
    public static CreateDataText fromInput(CreateDataText input) {
        CreateDataText service = new CreateDataText();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateDataText</code> from the output values of the given <code>CreateDataText</code>.
     * @param output a <code>CreateDataText</code>
     */
    public static CreateDataText fromOutput(CreateDataText output) {
        CreateDataText service = new CreateDataText();
    ...
    /**
     * Construct a <code>CreateDataText</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateDataText fromInput(Map<String, Object> mapValue) {
        CreateDataText service = new CreateDataText();
    ...
    /**
     * Construct a <code>CreateDataText</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateDataText fromOutput(Map<String, Object> mapValue) {
        CreateDataText service = new CreateDataText();
