 ...
 */
public class UpdateReturnHeader extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateReturnHeader</code> from the input values of the given <code>UpdateReturnHeader</code>.
     * @param input a <code>UpdateReturnHeader</code>
     */
    public static UpdateReturnHeader fromInput(UpdateReturnHeader input) {
        UpdateReturnHeader service = new UpdateReturnHeader();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateReturnHeader</code> from the output values of the given <code>UpdateReturnHeader</code>.
     * @param output a <code>UpdateReturnHeader</code>
     */
    public static UpdateReturnHeader fromOutput(UpdateReturnHeader output) {
        UpdateReturnHeader service = new UpdateReturnHeader();
    ...
    /**
     * Construct a <code>UpdateReturnHeader</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateReturnHeader fromInput(Map<String, Object> mapValue) {
        UpdateReturnHeader service = new UpdateReturnHeader();
    ...
    /**
     * Construct a <code>UpdateReturnHeader</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateReturnHeader fromOutput(Map<String, Object> mapValue) {
        UpdateReturnHeader service = new UpdateReturnHeader();
