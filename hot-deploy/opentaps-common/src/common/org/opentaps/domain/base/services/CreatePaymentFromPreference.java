 ...
 */
public class CreatePaymentFromPreference extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePaymentFromPreference</code> from the input values of the given <code>CreatePaymentFromPreference</code>.
     * @param input a <code>CreatePaymentFromPreference</code>
     */
    public static CreatePaymentFromPreference fromInput(CreatePaymentFromPreference input) {
        CreatePaymentFromPreference service = new CreatePaymentFromPreference();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePaymentFromPreference</code> from the output values of the given <code>CreatePaymentFromPreference</code>.
     * @param output a <code>CreatePaymentFromPreference</code>
     */
    public static CreatePaymentFromPreference fromOutput(CreatePaymentFromPreference output) {
        CreatePaymentFromPreference service = new CreatePaymentFromPreference();
    ...
    /**
     * Construct a <code>CreatePaymentFromPreference</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePaymentFromPreference fromInput(Map<String, Object> mapValue) {
        CreatePaymentFromPreference service = new CreatePaymentFromPreference();
    ...
    /**
     * Construct a <code>CreatePaymentFromPreference</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePaymentFromPreference fromOutput(Map<String, Object> mapValue) {
        CreatePaymentFromPreference service = new CreatePaymentFromPreference();
