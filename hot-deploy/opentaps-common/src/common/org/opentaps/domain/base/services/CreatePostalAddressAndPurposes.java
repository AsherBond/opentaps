 ...
 */
public class CreatePostalAddressAndPurposes extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePostalAddressAndPurposes</code> from the input values of the given <code>CreatePostalAddressAndPurposes</code>.
     * @param input a <code>CreatePostalAddressAndPurposes</code>
     */
    public static CreatePostalAddressAndPurposes fromInput(CreatePostalAddressAndPurposes input) {
        CreatePostalAddressAndPurposes service = new CreatePostalAddressAndPurposes();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePostalAddressAndPurposes</code> from the output values of the given <code>CreatePostalAddressAndPurposes</code>.
     * @param output a <code>CreatePostalAddressAndPurposes</code>
     */
    public static CreatePostalAddressAndPurposes fromOutput(CreatePostalAddressAndPurposes output) {
        CreatePostalAddressAndPurposes service = new CreatePostalAddressAndPurposes();
    ...
    /**
     * Construct a <code>CreatePostalAddressAndPurposes</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePostalAddressAndPurposes fromInput(Map<String, Object> mapValue) {
        CreatePostalAddressAndPurposes service = new CreatePostalAddressAndPurposes();
    ...
    /**
     * Construct a <code>CreatePostalAddressAndPurposes</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePostalAddressAndPurposes fromOutput(Map<String, Object> mapValue) {
        CreatePostalAddressAndPurposes service = new CreatePostalAddressAndPurposes();
