 ...
 */
public class CreateCommunicationEvent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateCommunicationEvent</code> from the input values of the given <code>CreateCommunicationEvent</code>.
     * @param input a <code>CreateCommunicationEvent</code>
     */
    public static CreateCommunicationEvent fromInput(CreateCommunicationEvent input) {
        CreateCommunicationEvent service = new CreateCommunicationEvent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateCommunicationEvent</code> from the output values of the given <code>CreateCommunicationEvent</code>.
     * @param output a <code>CreateCommunicationEvent</code>
     */
    public static CreateCommunicationEvent fromOutput(CreateCommunicationEvent output) {
        CreateCommunicationEvent service = new CreateCommunicationEvent();
    ...
    /**
     * Construct a <code>CreateCommunicationEvent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCommunicationEvent fromInput(Map<String, Object> mapValue) {
        CreateCommunicationEvent service = new CreateCommunicationEvent();
    ...
    /**
     * Construct a <code>CreateCommunicationEvent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCommunicationEvent fromOutput(Map<String, Object> mapValue) {
        CreateCommunicationEvent service = new CreateCommunicationEvent();
