 ...
 */
public class CreateCatalogRequestWithSurvey extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateCatalogRequestWithSurvey</code> from the input values of the given <code>CreateCatalogRequestWithSurvey</code>.
     * @param input a <code>CreateCatalogRequestWithSurvey</code>
     */
    public static CreateCatalogRequestWithSurvey fromInput(CreateCatalogRequestWithSurvey input) {
        CreateCatalogRequestWithSurvey service = new CreateCatalogRequestWithSurvey();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateCatalogRequestWithSurvey</code> from the output values of the given <code>CreateCatalogRequestWithSurvey</code>.
     * @param output a <code>CreateCatalogRequestWithSurvey</code>
     */
    public static CreateCatalogRequestWithSurvey fromOutput(CreateCatalogRequestWithSurvey output) {
        CreateCatalogRequestWithSurvey service = new CreateCatalogRequestWithSurvey();
    ...
    /**
     * Construct a <code>CreateCatalogRequestWithSurvey</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCatalogRequestWithSurvey fromInput(Map<String, Object> mapValue) {
        CreateCatalogRequestWithSurvey service = new CreateCatalogRequestWithSurvey();
    ...
    /**
     * Construct a <code>CreateCatalogRequestWithSurvey</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCatalogRequestWithSurvey fromOutput(Map<String, Object> mapValue) {
        CreateCatalogRequestWithSurvey service = new CreateCatalogRequestWithSurvey();
