 ...
 */
public class CheckContentPermission extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CheckContentPermission</code> from the input values of the given <code>CheckContentPermission</code>.
     * @param input a <code>CheckContentPermission</code>
     */
    public static CheckContentPermission fromInput(CheckContentPermission input) {
        CheckContentPermission service = new CheckContentPermission();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CheckContentPermission</code> from the output values of the given <code>CheckContentPermission</code>.
     * @param output a <code>CheckContentPermission</code>
     */
    public static CheckContentPermission fromOutput(CheckContentPermission output) {
        CheckContentPermission service = new CheckContentPermission();
    ...
    /**
     * Construct a <code>CheckContentPermission</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CheckContentPermission fromInput(Map<String, Object> mapValue) {
        CheckContentPermission service = new CheckContentPermission();
    ...
    /**
     * Construct a <code>CheckContentPermission</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CheckContentPermission fromOutput(Map<String, Object> mapValue) {
        CheckContentPermission service = new CheckContentPermission();
