 ...
 */
public class CreateQuoteAdjustment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateQuoteAdjustment</code> from the input values of the given <code>CreateQuoteAdjustment</code>.
     * @param input a <code>CreateQuoteAdjustment</code>
     */
    public static CreateQuoteAdjustment fromInput(CreateQuoteAdjustment input) {
        CreateQuoteAdjustment service = new CreateQuoteAdjustment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateQuoteAdjustment</code> from the output values of the given <code>CreateQuoteAdjustment</code>.
     * @param output a <code>CreateQuoteAdjustment</code>
     */
    public static CreateQuoteAdjustment fromOutput(CreateQuoteAdjustment output) {
        CreateQuoteAdjustment service = new CreateQuoteAdjustment();
    ...
    /**
     * Construct a <code>CreateQuoteAdjustment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateQuoteAdjustment fromInput(Map<String, Object> mapValue) {
        CreateQuoteAdjustment service = new CreateQuoteAdjustment();
    ...
    /**
     * Construct a <code>CreateQuoteAdjustment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateQuoteAdjustment fromOutput(Map<String, Object> mapValue) {
        CreateQuoteAdjustment service = new CreateQuoteAdjustment();
