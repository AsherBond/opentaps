 ...
 */
public class CreateEftAccountAndAddress extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateEftAccountAndAddress</code> from the input values of the given <code>CreateEftAccountAndAddress</code>.
     * @param input a <code>CreateEftAccountAndAddress</code>
     */
    public static CreateEftAccountAndAddress fromInput(CreateEftAccountAndAddress input) {
        CreateEftAccountAndAddress service = new CreateEftAccountAndAddress();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateEftAccountAndAddress</code> from the output values of the given <code>CreateEftAccountAndAddress</code>.
     * @param output a <code>CreateEftAccountAndAddress</code>
     */
    public static CreateEftAccountAndAddress fromOutput(CreateEftAccountAndAddress output) {
        CreateEftAccountAndAddress service = new CreateEftAccountAndAddress();
    ...
    /**
     * Construct a <code>CreateEftAccountAndAddress</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateEftAccountAndAddress fromInput(Map<String, Object> mapValue) {
        CreateEftAccountAndAddress service = new CreateEftAccountAndAddress();
    ...
    /**
     * Construct a <code>CreateEftAccountAndAddress</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateEftAccountAndAddress fromOutput(Map<String, Object> mapValue) {
        CreateEftAccountAndAddress service = new CreateEftAccountAndAddress();
