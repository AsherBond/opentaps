 ...
 */
public class CrmsfaUpdateActivityWithoutAssoc extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaUpdateActivityWithoutAssoc</code> from the input values of the given <code>CrmsfaUpdateActivityWithoutAssoc</code>.
     * @param input a <code>CrmsfaUpdateActivityWithoutAssoc</code>
     */
    public static CrmsfaUpdateActivityWithoutAssoc fromInput(CrmsfaUpdateActivityWithoutAssoc input) {
        CrmsfaUpdateActivityWithoutAssoc service = new CrmsfaUpdateActivityWithoutAssoc();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaUpdateActivityWithoutAssoc</code> from the output values of the given <code>CrmsfaUpdateActivityWithoutAssoc</code>.
     * @param output a <code>CrmsfaUpdateActivityWithoutAssoc</code>
     */
    public static CrmsfaUpdateActivityWithoutAssoc fromOutput(CrmsfaUpdateActivityWithoutAssoc output) {
        CrmsfaUpdateActivityWithoutAssoc service = new CrmsfaUpdateActivityWithoutAssoc();
    ...
    /**
     * Construct a <code>CrmsfaUpdateActivityWithoutAssoc</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaUpdateActivityWithoutAssoc fromInput(Map<String, Object> mapValue) {
        CrmsfaUpdateActivityWithoutAssoc service = new CrmsfaUpdateActivityWithoutAssoc();
    ...
    /**
     * Construct a <code>CrmsfaUpdateActivityWithoutAssoc</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaUpdateActivityWithoutAssoc fromOutput(Map<String, Object> mapValue) {
        CrmsfaUpdateActivityWithoutAssoc service = new CrmsfaUpdateActivityWithoutAssoc();
