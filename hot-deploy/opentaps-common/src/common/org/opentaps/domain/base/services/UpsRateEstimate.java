 ...
 */
public class UpsRateEstimate extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpsRateEstimate</code> from the input values of the given <code>UpsRateEstimate</code>.
     * @param input a <code>UpsRateEstimate</code>
     */
    public static UpsRateEstimate fromInput(UpsRateEstimate input) {
        UpsRateEstimate service = new UpsRateEstimate();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpsRateEstimate</code> from the output values of the given <code>UpsRateEstimate</code>.
     * @param output a <code>UpsRateEstimate</code>
     */
    public static UpsRateEstimate fromOutput(UpsRateEstimate output) {
        UpsRateEstimate service = new UpsRateEstimate();
    ...
    /**
     * Construct a <code>UpsRateEstimate</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpsRateEstimate fromInput(Map<String, Object> mapValue) {
        UpsRateEstimate service = new UpsRateEstimate();
    ...
    /**
     * Construct a <code>UpsRateEstimate</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpsRateEstimate fromOutput(Map<String, Object> mapValue) {
        UpsRateEstimate service = new UpsRateEstimate();
