 ...
 */
public class UpdateTaxAuthorityCategory extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityCategory</code> from the input values of the given <code>UpdateTaxAuthorityCategory</code>.
     * @param input a <code>UpdateTaxAuthorityCategory</code>
     */
    public static UpdateTaxAuthorityCategory fromInput(UpdateTaxAuthorityCategory input) {
        UpdateTaxAuthorityCategory service = new UpdateTaxAuthorityCategory();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateTaxAuthorityCategory</code> from the output values of the given <code>UpdateTaxAuthorityCategory</code>.
     * @param output a <code>UpdateTaxAuthorityCategory</code>
     */
    public static UpdateTaxAuthorityCategory fromOutput(UpdateTaxAuthorityCategory output) {
        UpdateTaxAuthorityCategory service = new UpdateTaxAuthorityCategory();
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityCategory</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateTaxAuthorityCategory fromInput(Map<String, Object> mapValue) {
        UpdateTaxAuthorityCategory service = new UpdateTaxAuthorityCategory();
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityCategory</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateTaxAuthorityCategory fromOutput(Map<String, Object> mapValue) {
        UpdateTaxAuthorityCategory service = new UpdateTaxAuthorityCategory();
