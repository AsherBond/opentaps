 ...
 */
public class CreateMarketingCampaign extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateMarketingCampaign</code> from the input values of the given <code>CreateMarketingCampaign</code>.
     * @param input a <code>CreateMarketingCampaign</code>
     */
    public static CreateMarketingCampaign fromInput(CreateMarketingCampaign input) {
        CreateMarketingCampaign service = new CreateMarketingCampaign();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateMarketingCampaign</code> from the output values of the given <code>CreateMarketingCampaign</code>.
     * @param output a <code>CreateMarketingCampaign</code>
     */
    public static CreateMarketingCampaign fromOutput(CreateMarketingCampaign output) {
        CreateMarketingCampaign service = new CreateMarketingCampaign();
    ...
    /**
     * Construct a <code>CreateMarketingCampaign</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateMarketingCampaign fromInput(Map<String, Object> mapValue) {
        CreateMarketingCampaign service = new CreateMarketingCampaign();
    ...
    /**
     * Construct a <code>CreateMarketingCampaign</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateMarketingCampaign fromOutput(Map<String, Object> mapValue) {
        CreateMarketingCampaign service = new CreateMarketingCampaign();
