 ...
 */
public class UpdateMarketingCampaign extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateMarketingCampaign</code> from the input values of the given <code>UpdateMarketingCampaign</code>.
     * @param input a <code>UpdateMarketingCampaign</code>
     */
    public static UpdateMarketingCampaign fromInput(UpdateMarketingCampaign input) {
        UpdateMarketingCampaign service = new UpdateMarketingCampaign();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateMarketingCampaign</code> from the output values of the given <code>UpdateMarketingCampaign</code>.
     * @param output a <code>UpdateMarketingCampaign</code>
     */
    public static UpdateMarketingCampaign fromOutput(UpdateMarketingCampaign output) {
        UpdateMarketingCampaign service = new UpdateMarketingCampaign();
    ...
    /**
     * Construct a <code>UpdateMarketingCampaign</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateMarketingCampaign fromInput(Map<String, Object> mapValue) {
        UpdateMarketingCampaign service = new UpdateMarketingCampaign();
    ...
    /**
     * Construct a <code>UpdateMarketingCampaign</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateMarketingCampaign fromOutput(Map<String, Object> mapValue) {
        UpdateMarketingCampaign service = new UpdateMarketingCampaign();
