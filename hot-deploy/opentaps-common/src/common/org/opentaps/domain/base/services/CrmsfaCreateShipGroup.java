 ...
 */
public class CrmsfaCreateShipGroup extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateShipGroup</code> from the input values of the given <code>CrmsfaCreateShipGroup</code>.
     * @param input a <code>CrmsfaCreateShipGroup</code>
     */
    public static CrmsfaCreateShipGroup fromInput(CrmsfaCreateShipGroup input) {
        CrmsfaCreateShipGroup service = new CrmsfaCreateShipGroup();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaCreateShipGroup</code> from the output values of the given <code>CrmsfaCreateShipGroup</code>.
     * @param output a <code>CrmsfaCreateShipGroup</code>
     */
    public static CrmsfaCreateShipGroup fromOutput(CrmsfaCreateShipGroup output) {
        CrmsfaCreateShipGroup service = new CrmsfaCreateShipGroup();
    ...
    /**
     * Construct a <code>CrmsfaCreateShipGroup</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateShipGroup fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateShipGroup service = new CrmsfaCreateShipGroup();
    ...
    /**
     * Construct a <code>CrmsfaCreateShipGroup</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateShipGroup fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateShipGroup service = new CrmsfaCreateShipGroup();
