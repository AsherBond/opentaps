 ...
 */
public class GetNextOrderId extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetNextOrderId</code> from the input values of the given <code>GetNextOrderId</code>.
     * @param input a <code>GetNextOrderId</code>
     */
    public static GetNextOrderId fromInput(GetNextOrderId input) {
        GetNextOrderId service = new GetNextOrderId();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetNextOrderId</code> from the output values of the given <code>GetNextOrderId</code>.
     * @param output a <code>GetNextOrderId</code>
     */
    public static GetNextOrderId fromOutput(GetNextOrderId output) {
        GetNextOrderId service = new GetNextOrderId();
    ...
    /**
     * Construct a <code>GetNextOrderId</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetNextOrderId fromInput(Map<String, Object> mapValue) {
        GetNextOrderId service = new GetNextOrderId();
    ...
    /**
     * Construct a <code>GetNextOrderId</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetNextOrderId fromOutput(Map<String, Object> mapValue) {
        GetNextOrderId service = new GetNextOrderId();
