 ...
 */
public class UpdateFixedAsset extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateFixedAsset</code> from the input values of the given <code>UpdateFixedAsset</code>.
     * @param input a <code>UpdateFixedAsset</code>
     */
    public static UpdateFixedAsset fromInput(UpdateFixedAsset input) {
        UpdateFixedAsset service = new UpdateFixedAsset();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateFixedAsset</code> from the output values of the given <code>UpdateFixedAsset</code>.
     * @param output a <code>UpdateFixedAsset</code>
     */
    public static UpdateFixedAsset fromOutput(UpdateFixedAsset output) {
        UpdateFixedAsset service = new UpdateFixedAsset();
    ...
    /**
     * Construct a <code>UpdateFixedAsset</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateFixedAsset fromInput(Map<String, Object> mapValue) {
        UpdateFixedAsset service = new UpdateFixedAsset();
    ...
    /**
     * Construct a <code>UpdateFixedAsset</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateFixedAsset fromOutput(Map<String, Object> mapValue) {
        UpdateFixedAsset service = new UpdateFixedAsset();
