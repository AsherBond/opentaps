 ...
 */
public class UpdateProductStoreShipMeth extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateProductStoreShipMeth</code> from the input values of the given <code>UpdateProductStoreShipMeth</code>.
     * @param input a <code>UpdateProductStoreShipMeth</code>
     */
    public static UpdateProductStoreShipMeth fromInput(UpdateProductStoreShipMeth input) {
        UpdateProductStoreShipMeth service = new UpdateProductStoreShipMeth();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateProductStoreShipMeth</code> from the output values of the given <code>UpdateProductStoreShipMeth</code>.
     * @param output a <code>UpdateProductStoreShipMeth</code>
     */
    public static UpdateProductStoreShipMeth fromOutput(UpdateProductStoreShipMeth output) {
        UpdateProductStoreShipMeth service = new UpdateProductStoreShipMeth();
    ...
    /**
     * Construct a <code>UpdateProductStoreShipMeth</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateProductStoreShipMeth fromInput(Map<String, Object> mapValue) {
        UpdateProductStoreShipMeth service = new UpdateProductStoreShipMeth();
    ...
    /**
     * Construct a <code>UpdateProductStoreShipMeth</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateProductStoreShipMeth fromOutput(Map<String, Object> mapValue) {
        UpdateProductStoreShipMeth service = new UpdateProductStoreShipMeth();
