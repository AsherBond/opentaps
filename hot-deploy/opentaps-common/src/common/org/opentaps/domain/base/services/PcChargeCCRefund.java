 ...
 */
public class PcChargeCCRefund extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PcChargeCCRefund</code> from the input values of the given <code>PcChargeCCRefund</code>.
     * @param input a <code>PcChargeCCRefund</code>
     */
    public static PcChargeCCRefund fromInput(PcChargeCCRefund input) {
        PcChargeCCRefund service = new PcChargeCCRefund();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PcChargeCCRefund</code> from the output values of the given <code>PcChargeCCRefund</code>.
     * @param output a <code>PcChargeCCRefund</code>
     */
    public static PcChargeCCRefund fromOutput(PcChargeCCRefund output) {
        PcChargeCCRefund service = new PcChargeCCRefund();
    ...
    /**
     * Construct a <code>PcChargeCCRefund</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PcChargeCCRefund fromInput(Map<String, Object> mapValue) {
        PcChargeCCRefund service = new PcChargeCCRefund();
    ...
    /**
     * Construct a <code>PcChargeCCRefund</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PcChargeCCRefund fromOutput(Map<String, Object> mapValue) {
        PcChargeCCRefund service = new PcChargeCCRefund();
