 ...
 */
public class OpentapsCreatePartnerSalesAgreement extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsCreatePartnerSalesAgreement</code> from the input values of the given <code>OpentapsCreatePartnerSalesAgreement</code>.
     * @param input a <code>OpentapsCreatePartnerSalesAgreement</code>
     */
    public static OpentapsCreatePartnerSalesAgreement fromInput(OpentapsCreatePartnerSalesAgreement input) {
        OpentapsCreatePartnerSalesAgreement service = new OpentapsCreatePartnerSalesAgreement();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsCreatePartnerSalesAgreement</code> from the output values of the given <code>OpentapsCreatePartnerSalesAgreement</code>.
     * @param output a <code>OpentapsCreatePartnerSalesAgreement</code>
     */
    public static OpentapsCreatePartnerSalesAgreement fromOutput(OpentapsCreatePartnerSalesAgreement output) {
        OpentapsCreatePartnerSalesAgreement service = new OpentapsCreatePartnerSalesAgreement();
    ...
    /**
     * Construct a <code>OpentapsCreatePartnerSalesAgreement</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsCreatePartnerSalesAgreement fromInput(Map<String, Object> mapValue) {
        OpentapsCreatePartnerSalesAgreement service = new OpentapsCreatePartnerSalesAgreement();
    ...
    /**
     * Construct a <code>OpentapsCreatePartnerSalesAgreement</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsCreatePartnerSalesAgreement fromOutput(Map<String, Object> mapValue) {
        OpentapsCreatePartnerSalesAgreement service = new OpentapsCreatePartnerSalesAgreement();
