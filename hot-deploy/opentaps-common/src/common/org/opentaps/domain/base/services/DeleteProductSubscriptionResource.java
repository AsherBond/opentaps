 ...
 */
public class DeleteProductSubscriptionResource extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductSubscriptionResource</code> from the input values of the given <code>DeleteProductSubscriptionResource</code>.
     * @param input a <code>DeleteProductSubscriptionResource</code>
     */
    public static DeleteProductSubscriptionResource fromInput(DeleteProductSubscriptionResource input) {
        DeleteProductSubscriptionResource service = new DeleteProductSubscriptionResource();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteProductSubscriptionResource</code> from the output values of the given <code>DeleteProductSubscriptionResource</code>.
     * @param output a <code>DeleteProductSubscriptionResource</code>
     */
    public static DeleteProductSubscriptionResource fromOutput(DeleteProductSubscriptionResource output) {
        DeleteProductSubscriptionResource service = new DeleteProductSubscriptionResource();
    ...
    /**
     * Construct a <code>DeleteProductSubscriptionResource</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductSubscriptionResource fromInput(Map<String, Object> mapValue) {
        DeleteProductSubscriptionResource service = new DeleteProductSubscriptionResource();
    ...
    /**
     * Construct a <code>DeleteProductSubscriptionResource</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductSubscriptionResource fromOutput(Map<String, Object> mapValue) {
        DeleteProductSubscriptionResource service = new DeleteProductSubscriptionResource();
