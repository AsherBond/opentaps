 ...
 */
public class CheckCategoryPermissionWithViewPurchaseAllow extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CheckCategoryPermissionWithViewPurchaseAllow</code> from the input values of the given <code>CheckCategoryPermissionWithViewPurchaseAllow</code>.
     * @param input a <code>CheckCategoryPermissionWithViewPurchaseAllow</code>
     */
    public static CheckCategoryPermissionWithViewPurchaseAllow fromInput(CheckCategoryPermissionWithViewPurchaseAllow input) {
        CheckCategoryPermissionWithViewPurchaseAllow service = new CheckCategoryPermissionWithViewPurchaseAllow();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CheckCategoryPermissionWithViewPurchaseAllow</code> from the output values of the given <code>CheckCategoryPermissionWithViewPurchaseAllow</code>.
     * @param output a <code>CheckCategoryPermissionWithViewPurchaseAllow</code>
     */
    public static CheckCategoryPermissionWithViewPurchaseAllow fromOutput(CheckCategoryPermissionWithViewPurchaseAllow output) {
        CheckCategoryPermissionWithViewPurchaseAllow service = new CheckCategoryPermissionWithViewPurchaseAllow();
    ...
    /**
     * Construct a <code>CheckCategoryPermissionWithViewPurchaseAllow</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CheckCategoryPermissionWithViewPurchaseAllow fromInput(Map<String, Object> mapValue) {
        CheckCategoryPermissionWithViewPurchaseAllow service = new CheckCategoryPermissionWithViewPurchaseAllow();
    ...
    /**
     * Construct a <code>CheckCategoryPermissionWithViewPurchaseAllow</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CheckCategoryPermissionWithViewPurchaseAllow fromOutput(Map<String, Object> mapValue) {
        CheckCategoryPermissionWithViewPurchaseAllow service = new CheckCategoryPermissionWithViewPurchaseAllow();
