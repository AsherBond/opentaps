 ...
 */
public class CreateQuoteItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateQuoteItem</code> from the input values of the given <code>CreateQuoteItem</code>.
     * @param input a <code>CreateQuoteItem</code>
     */
    public static CreateQuoteItem fromInput(CreateQuoteItem input) {
        CreateQuoteItem service = new CreateQuoteItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateQuoteItem</code> from the output values of the given <code>CreateQuoteItem</code>.
     * @param output a <code>CreateQuoteItem</code>
     */
    public static CreateQuoteItem fromOutput(CreateQuoteItem output) {
        CreateQuoteItem service = new CreateQuoteItem();
    ...
    /**
     * Construct a <code>CreateQuoteItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateQuoteItem fromInput(Map<String, Object> mapValue) {
        CreateQuoteItem service = new CreateQuoteItem();
    ...
    /**
     * Construct a <code>CreateQuoteItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateQuoteItem fromOutput(Map<String, Object> mapValue) {
        CreateQuoteItem service = new CreateQuoteItem();
