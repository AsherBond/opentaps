 ...
 */
public class AddRoleToMarketingCampaign extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AddRoleToMarketingCampaign</code> from the input values of the given <code>AddRoleToMarketingCampaign</code>.
     * @param input a <code>AddRoleToMarketingCampaign</code>
     */
    public static AddRoleToMarketingCampaign fromInput(AddRoleToMarketingCampaign input) {
        AddRoleToMarketingCampaign service = new AddRoleToMarketingCampaign();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AddRoleToMarketingCampaign</code> from the output values of the given <code>AddRoleToMarketingCampaign</code>.
     * @param output a <code>AddRoleToMarketingCampaign</code>
     */
    public static AddRoleToMarketingCampaign fromOutput(AddRoleToMarketingCampaign output) {
        AddRoleToMarketingCampaign service = new AddRoleToMarketingCampaign();
    ...
    /**
     * Construct a <code>AddRoleToMarketingCampaign</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AddRoleToMarketingCampaign fromInput(Map<String, Object> mapValue) {
        AddRoleToMarketingCampaign service = new AddRoleToMarketingCampaign();
    ...
    /**
     * Construct a <code>AddRoleToMarketingCampaign</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AddRoleToMarketingCampaign fromOutput(Map<String, Object> mapValue) {
        AddRoleToMarketingCampaign service = new AddRoleToMarketingCampaign();
