 ...
 */
public class CancelPartyInvitationPermissionCheck extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CancelPartyInvitationPermissionCheck</code> from the input values of the given <code>CancelPartyInvitationPermissionCheck</code>.
     * @param input a <code>CancelPartyInvitationPermissionCheck</code>
     */
    public static CancelPartyInvitationPermissionCheck fromInput(CancelPartyInvitationPermissionCheck input) {
        CancelPartyInvitationPermissionCheck service = new CancelPartyInvitationPermissionCheck();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CancelPartyInvitationPermissionCheck</code> from the output values of the given <code>CancelPartyInvitationPermissionCheck</code>.
     * @param output a <code>CancelPartyInvitationPermissionCheck</code>
     */
    public static CancelPartyInvitationPermissionCheck fromOutput(CancelPartyInvitationPermissionCheck output) {
        CancelPartyInvitationPermissionCheck service = new CancelPartyInvitationPermissionCheck();
    ...
    /**
     * Construct a <code>CancelPartyInvitationPermissionCheck</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CancelPartyInvitationPermissionCheck fromInput(Map<String, Object> mapValue) {
        CancelPartyInvitationPermissionCheck service = new CancelPartyInvitationPermissionCheck();
    ...
    /**
     * Construct a <code>CancelPartyInvitationPermissionCheck</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CancelPartyInvitationPermissionCheck fromOutput(Map<String, Object> mapValue) {
        CancelPartyInvitationPermissionCheck service = new CancelPartyInvitationPermissionCheck();
