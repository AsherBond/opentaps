 ...
 */
public class CreateCommunicationEventRoleWithoutPermission extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateCommunicationEventRoleWithoutPermission</code> from the input values of the given <code>CreateCommunicationEventRoleWithoutPermission</code>.
     * @param input a <code>CreateCommunicationEventRoleWithoutPermission</code>
     */
    public static CreateCommunicationEventRoleWithoutPermission fromInput(CreateCommunicationEventRoleWithoutPermission input) {
        CreateCommunicationEventRoleWithoutPermission service = new CreateCommunicationEventRoleWithoutPermission();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateCommunicationEventRoleWithoutPermission</code> from the output values of the given <code>CreateCommunicationEventRoleWithoutPermission</code>.
     * @param output a <code>CreateCommunicationEventRoleWithoutPermission</code>
     */
    public static CreateCommunicationEventRoleWithoutPermission fromOutput(CreateCommunicationEventRoleWithoutPermission output) {
        CreateCommunicationEventRoleWithoutPermission service = new CreateCommunicationEventRoleWithoutPermission();
    ...
    /**
     * Construct a <code>CreateCommunicationEventRoleWithoutPermission</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCommunicationEventRoleWithoutPermission fromInput(Map<String, Object> mapValue) {
        CreateCommunicationEventRoleWithoutPermission service = new CreateCommunicationEventRoleWithoutPermission();
    ...
    /**
     * Construct a <code>CreateCommunicationEventRoleWithoutPermission</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCommunicationEventRoleWithoutPermission fromOutput(Map<String, Object> mapValue) {
        CreateCommunicationEventRoleWithoutPermission service = new CreateCommunicationEventRoleWithoutPermission();
