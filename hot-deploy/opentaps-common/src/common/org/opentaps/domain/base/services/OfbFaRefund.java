 ...
 */
public class OfbFaRefund extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OfbFaRefund</code> from the input values of the given <code>OfbFaRefund</code>.
     * @param input a <code>OfbFaRefund</code>
     */
    public static OfbFaRefund fromInput(OfbFaRefund input) {
        OfbFaRefund service = new OfbFaRefund();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OfbFaRefund</code> from the output values of the given <code>OfbFaRefund</code>.
     * @param output a <code>OfbFaRefund</code>
     */
    public static OfbFaRefund fromOutput(OfbFaRefund output) {
        OfbFaRefund service = new OfbFaRefund();
    ...
    /**
     * Construct a <code>OfbFaRefund</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OfbFaRefund fromInput(Map<String, Object> mapValue) {
        OfbFaRefund service = new OfbFaRefund();
    ...
    /**
     * Construct a <code>OfbFaRefund</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OfbFaRefund fromOutput(Map<String, Object> mapValue) {
        OfbFaRefund service = new OfbFaRefund();
