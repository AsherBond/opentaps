 ...
 */
public class ReceiveBillingAccountPayment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ReceiveBillingAccountPayment</code> from the input values of the given <code>ReceiveBillingAccountPayment</code>.
     * @param input a <code>ReceiveBillingAccountPayment</code>
     */
    public static ReceiveBillingAccountPayment fromInput(ReceiveBillingAccountPayment input) {
        ReceiveBillingAccountPayment service = new ReceiveBillingAccountPayment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ReceiveBillingAccountPayment</code> from the output values of the given <code>ReceiveBillingAccountPayment</code>.
     * @param output a <code>ReceiveBillingAccountPayment</code>
     */
    public static ReceiveBillingAccountPayment fromOutput(ReceiveBillingAccountPayment output) {
        ReceiveBillingAccountPayment service = new ReceiveBillingAccountPayment();
    ...
    /**
     * Construct a <code>ReceiveBillingAccountPayment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ReceiveBillingAccountPayment fromInput(Map<String, Object> mapValue) {
        ReceiveBillingAccountPayment service = new ReceiveBillingAccountPayment();
    ...
    /**
     * Construct a <code>ReceiveBillingAccountPayment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ReceiveBillingAccountPayment fromOutput(Map<String, Object> mapValue) {
        ReceiveBillingAccountPayment service = new ReceiveBillingAccountPayment();
