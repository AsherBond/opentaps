 ...
 */
public class RemotePullAndReportEntitySyncDataHttp extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemotePullAndReportEntitySyncDataHttp</code> from the input values of the given <code>RemotePullAndReportEntitySyncDataHttp</code>.
     * @param input a <code>RemotePullAndReportEntitySyncDataHttp</code>
     */
    public static RemotePullAndReportEntitySyncDataHttp fromInput(RemotePullAndReportEntitySyncDataHttp input) {
        RemotePullAndReportEntitySyncDataHttp service = new RemotePullAndReportEntitySyncDataHttp();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemotePullAndReportEntitySyncDataHttp</code> from the output values of the given <code>RemotePullAndReportEntitySyncDataHttp</code>.
     * @param output a <code>RemotePullAndReportEntitySyncDataHttp</code>
     */
    public static RemotePullAndReportEntitySyncDataHttp fromOutput(RemotePullAndReportEntitySyncDataHttp output) {
        RemotePullAndReportEntitySyncDataHttp service = new RemotePullAndReportEntitySyncDataHttp();
    ...
    /**
     * Construct a <code>RemotePullAndReportEntitySyncDataHttp</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemotePullAndReportEntitySyncDataHttp fromInput(Map<String, Object> mapValue) {
        RemotePullAndReportEntitySyncDataHttp service = new RemotePullAndReportEntitySyncDataHttp();
    ...
    /**
     * Construct a <code>RemotePullAndReportEntitySyncDataHttp</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemotePullAndReportEntitySyncDataHttp fromOutput(Map<String, Object> mapValue) {
        RemotePullAndReportEntitySyncDataHttp service = new RemotePullAndReportEntitySyncDataHttp();
