 ...
 */
public class CrmsfaCreateContentForOpportunity extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForOpportunity</code> from the input values of the given <code>CrmsfaCreateContentForOpportunity</code>.
     * @param input a <code>CrmsfaCreateContentForOpportunity</code>
     */
    public static CrmsfaCreateContentForOpportunity fromInput(CrmsfaCreateContentForOpportunity input) {
        CrmsfaCreateContentForOpportunity service = new CrmsfaCreateContentForOpportunity();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaCreateContentForOpportunity</code> from the output values of the given <code>CrmsfaCreateContentForOpportunity</code>.
     * @param output a <code>CrmsfaCreateContentForOpportunity</code>
     */
    public static CrmsfaCreateContentForOpportunity fromOutput(CrmsfaCreateContentForOpportunity output) {
        CrmsfaCreateContentForOpportunity service = new CrmsfaCreateContentForOpportunity();
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForOpportunity</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateContentForOpportunity fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateContentForOpportunity service = new CrmsfaCreateContentForOpportunity();
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForOpportunity</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateContentForOpportunity fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateContentForOpportunity service = new CrmsfaCreateContentForOpportunity();
