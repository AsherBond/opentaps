 ...
 */
public class ProjectMgrPermission extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ProjectMgrPermission</code> from the input values of the given <code>ProjectMgrPermission</code>.
     * @param input a <code>ProjectMgrPermission</code>
     */
    public static ProjectMgrPermission fromInput(ProjectMgrPermission input) {
        ProjectMgrPermission service = new ProjectMgrPermission();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ProjectMgrPermission</code> from the output values of the given <code>ProjectMgrPermission</code>.
     * @param output a <code>ProjectMgrPermission</code>
     */
    public static ProjectMgrPermission fromOutput(ProjectMgrPermission output) {
        ProjectMgrPermission service = new ProjectMgrPermission();
    ...
    /**
     * Construct a <code>ProjectMgrPermission</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ProjectMgrPermission fromInput(Map<String, Object> mapValue) {
        ProjectMgrPermission service = new ProjectMgrPermission();
    ...
    /**
     * Construct a <code>ProjectMgrPermission</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ProjectMgrPermission fromOutput(Map<String, Object> mapValue) {
        ProjectMgrPermission service = new ProjectMgrPermission();
