 ...
 */
public class CreatePartyFinAccountFromPurchase extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyFinAccountFromPurchase</code> from the input values of the given <code>CreatePartyFinAccountFromPurchase</code>.
     * @param input a <code>CreatePartyFinAccountFromPurchase</code>
     */
    public static CreatePartyFinAccountFromPurchase fromInput(CreatePartyFinAccountFromPurchase input) {
        CreatePartyFinAccountFromPurchase service = new CreatePartyFinAccountFromPurchase();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePartyFinAccountFromPurchase</code> from the output values of the given <code>CreatePartyFinAccountFromPurchase</code>.
     * @param output a <code>CreatePartyFinAccountFromPurchase</code>
     */
    public static CreatePartyFinAccountFromPurchase fromOutput(CreatePartyFinAccountFromPurchase output) {
        CreatePartyFinAccountFromPurchase service = new CreatePartyFinAccountFromPurchase();
    ...
    /**
     * Construct a <code>CreatePartyFinAccountFromPurchase</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyFinAccountFromPurchase fromInput(Map<String, Object> mapValue) {
        CreatePartyFinAccountFromPurchase service = new CreatePartyFinAccountFromPurchase();
    ...
    /**
     * Construct a <code>CreatePartyFinAccountFromPurchase</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyFinAccountFromPurchase fromOutput(Map<String, Object> mapValue) {
        CreatePartyFinAccountFromPurchase service = new CreatePartyFinAccountFromPurchase();
