 ...
 */
public class OagisReceiveConfirmBod extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OagisReceiveConfirmBod</code> from the input values of the given <code>OagisReceiveConfirmBod</code>.
     * @param input a <code>OagisReceiveConfirmBod</code>
     */
    public static OagisReceiveConfirmBod fromInput(OagisReceiveConfirmBod input) {
        OagisReceiveConfirmBod service = new OagisReceiveConfirmBod();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OagisReceiveConfirmBod</code> from the output values of the given <code>OagisReceiveConfirmBod</code>.
     * @param output a <code>OagisReceiveConfirmBod</code>
     */
    public static OagisReceiveConfirmBod fromOutput(OagisReceiveConfirmBod output) {
        OagisReceiveConfirmBod service = new OagisReceiveConfirmBod();
    ...
    /**
     * Construct a <code>OagisReceiveConfirmBod</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OagisReceiveConfirmBod fromInput(Map<String, Object> mapValue) {
        OagisReceiveConfirmBod service = new OagisReceiveConfirmBod();
    ...
    /**
     * Construct a <code>OagisReceiveConfirmBod</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OagisReceiveConfirmBod fromOutput(Map<String, Object> mapValue) {
        OagisReceiveConfirmBod service = new OagisReceiveConfirmBod();
