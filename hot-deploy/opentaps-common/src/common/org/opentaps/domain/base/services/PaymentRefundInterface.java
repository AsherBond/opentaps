 ...
 */
public class PaymentRefundInterface extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PaymentRefundInterface</code> from the input values of the given <code>PaymentRefundInterface</code>.
     * @param input a <code>PaymentRefundInterface</code>
     */
    public static PaymentRefundInterface fromInput(PaymentRefundInterface input) {
        PaymentRefundInterface service = new PaymentRefundInterface();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PaymentRefundInterface</code> from the output values of the given <code>PaymentRefundInterface</code>.
     * @param output a <code>PaymentRefundInterface</code>
     */
    public static PaymentRefundInterface fromOutput(PaymentRefundInterface output) {
        PaymentRefundInterface service = new PaymentRefundInterface();
    ...
    /**
     * Construct a <code>PaymentRefundInterface</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PaymentRefundInterface fromInput(Map<String, Object> mapValue) {
        PaymentRefundInterface service = new PaymentRefundInterface();
    ...
    /**
     * Construct a <code>PaymentRefundInterface</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PaymentRefundInterface fromOutput(Map<String, Object> mapValue) {
        PaymentRefundInterface service = new PaymentRefundInterface();
