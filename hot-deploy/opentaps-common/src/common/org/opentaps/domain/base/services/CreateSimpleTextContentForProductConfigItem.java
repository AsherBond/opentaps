 ...
 */
public class CreateSimpleTextContentForProductConfigItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForProductConfigItem</code> from the input values of the given <code>CreateSimpleTextContentForProductConfigItem</code>.
     * @param input a <code>CreateSimpleTextContentForProductConfigItem</code>
     */
    public static CreateSimpleTextContentForProductConfigItem fromInput(CreateSimpleTextContentForProductConfigItem input) {
        CreateSimpleTextContentForProductConfigItem service = new CreateSimpleTextContentForProductConfigItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateSimpleTextContentForProductConfigItem</code> from the output values of the given <code>CreateSimpleTextContentForProductConfigItem</code>.
     * @param output a <code>CreateSimpleTextContentForProductConfigItem</code>
     */
    public static CreateSimpleTextContentForProductConfigItem fromOutput(CreateSimpleTextContentForProductConfigItem output) {
        CreateSimpleTextContentForProductConfigItem service = new CreateSimpleTextContentForProductConfigItem();
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForProductConfigItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateSimpleTextContentForProductConfigItem fromInput(Map<String, Object> mapValue) {
        CreateSimpleTextContentForProductConfigItem service = new CreateSimpleTextContentForProductConfigItem();
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForProductConfigItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateSimpleTextContentForProductConfigItem fromOutput(Map<String, Object> mapValue) {
        CreateSimpleTextContentForProductConfigItem service = new CreateSimpleTextContentForProductConfigItem();
