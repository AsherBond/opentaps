 ...
 */
public class CreateContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateContent</code> from the input values of the given <code>CreateContent</code>.
     * @param input a <code>CreateContent</code>
     */
    public static CreateContent fromInput(CreateContent input) {
        CreateContent service = new CreateContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateContent</code> from the output values of the given <code>CreateContent</code>.
     * @param output a <code>CreateContent</code>
     */
    public static CreateContent fromOutput(CreateContent output) {
        CreateContent service = new CreateContent();
    ...
    /**
     * Construct a <code>CreateContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateContent fromInput(Map<String, Object> mapValue) {
        CreateContent service = new CreateContent();
    ...
    /**
     * Construct a <code>CreateContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateContent fromOutput(Map<String, Object> mapValue) {
        CreateContent service = new CreateContent();
