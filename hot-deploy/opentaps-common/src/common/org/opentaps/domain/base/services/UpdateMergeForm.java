 ...
 */
public class UpdateMergeForm extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateMergeForm</code> from the input values of the given <code>UpdateMergeForm</code>.
     * @param input a <code>UpdateMergeForm</code>
     */
    public static UpdateMergeForm fromInput(UpdateMergeForm input) {
        UpdateMergeForm service = new UpdateMergeForm();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateMergeForm</code> from the output values of the given <code>UpdateMergeForm</code>.
     * @param output a <code>UpdateMergeForm</code>
     */
    public static UpdateMergeForm fromOutput(UpdateMergeForm output) {
        UpdateMergeForm service = new UpdateMergeForm();
    ...
    /**
     * Construct a <code>UpdateMergeForm</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateMergeForm fromInput(Map<String, Object> mapValue) {
        UpdateMergeForm service = new UpdateMergeForm();
    ...
    /**
     * Construct a <code>UpdateMergeForm</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateMergeForm fromOutput(Map<String, Object> mapValue) {
        UpdateMergeForm service = new UpdateMergeForm();
