 ...
 */
public class UpdateContentRevisionItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateContentRevisionItem</code> from the input values of the given <code>UpdateContentRevisionItem</code>.
     * @param input a <code>UpdateContentRevisionItem</code>
     */
    public static UpdateContentRevisionItem fromInput(UpdateContentRevisionItem input) {
        UpdateContentRevisionItem service = new UpdateContentRevisionItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateContentRevisionItem</code> from the output values of the given <code>UpdateContentRevisionItem</code>.
     * @param output a <code>UpdateContentRevisionItem</code>
     */
    public static UpdateContentRevisionItem fromOutput(UpdateContentRevisionItem output) {
        UpdateContentRevisionItem service = new UpdateContentRevisionItem();
    ...
    /**
     * Construct a <code>UpdateContentRevisionItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateContentRevisionItem fromInput(Map<String, Object> mapValue) {
        UpdateContentRevisionItem service = new UpdateContentRevisionItem();
    ...
    /**
     * Construct a <code>UpdateContentRevisionItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateContentRevisionItem fromOutput(Map<String, Object> mapValue) {
        UpdateContentRevisionItem service = new UpdateContentRevisionItem();
