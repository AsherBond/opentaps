 ...
 */
public class UpdateEmplPositionTypeRate extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateEmplPositionTypeRate</code> from the input values of the given <code>UpdateEmplPositionTypeRate</code>.
     * @param input a <code>UpdateEmplPositionTypeRate</code>
     */
    public static UpdateEmplPositionTypeRate fromInput(UpdateEmplPositionTypeRate input) {
        UpdateEmplPositionTypeRate service = new UpdateEmplPositionTypeRate();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateEmplPositionTypeRate</code> from the output values of the given <code>UpdateEmplPositionTypeRate</code>.
     * @param output a <code>UpdateEmplPositionTypeRate</code>
     */
    public static UpdateEmplPositionTypeRate fromOutput(UpdateEmplPositionTypeRate output) {
        UpdateEmplPositionTypeRate service = new UpdateEmplPositionTypeRate();
    ...
    /**
     * Construct a <code>UpdateEmplPositionTypeRate</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateEmplPositionTypeRate fromInput(Map<String, Object> mapValue) {
        UpdateEmplPositionTypeRate service = new UpdateEmplPositionTypeRate();
    ...
    /**
     * Construct a <code>UpdateEmplPositionTypeRate</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateEmplPositionTypeRate fromOutput(Map<String, Object> mapValue) {
        UpdateEmplPositionTypeRate service = new UpdateEmplPositionTypeRate();
