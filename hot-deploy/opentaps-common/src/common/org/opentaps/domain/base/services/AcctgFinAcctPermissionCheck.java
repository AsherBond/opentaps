 ...
 */
public class AcctgFinAcctPermissionCheck extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AcctgFinAcctPermissionCheck</code> from the input values of the given <code>AcctgFinAcctPermissionCheck</code>.
     * @param input a <code>AcctgFinAcctPermissionCheck</code>
     */
    public static AcctgFinAcctPermissionCheck fromInput(AcctgFinAcctPermissionCheck input) {
        AcctgFinAcctPermissionCheck service = new AcctgFinAcctPermissionCheck();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AcctgFinAcctPermissionCheck</code> from the output values of the given <code>AcctgFinAcctPermissionCheck</code>.
     * @param output a <code>AcctgFinAcctPermissionCheck</code>
     */
    public static AcctgFinAcctPermissionCheck fromOutput(AcctgFinAcctPermissionCheck output) {
        AcctgFinAcctPermissionCheck service = new AcctgFinAcctPermissionCheck();
    ...
    /**
     * Construct a <code>AcctgFinAcctPermissionCheck</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgFinAcctPermissionCheck fromInput(Map<String, Object> mapValue) {
        AcctgFinAcctPermissionCheck service = new AcctgFinAcctPermissionCheck();
    ...
    /**
     * Construct a <code>AcctgFinAcctPermissionCheck</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgFinAcctPermissionCheck fromOutput(Map<String, Object> mapValue) {
        AcctgFinAcctPermissionCheck service = new AcctgFinAcctPermissionCheck();
