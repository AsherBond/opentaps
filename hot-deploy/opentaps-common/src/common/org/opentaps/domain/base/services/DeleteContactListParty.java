 ...
 */
public class DeleteContactListParty extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteContactListParty</code> from the input values of the given <code>DeleteContactListParty</code>.
     * @param input a <code>DeleteContactListParty</code>
     */
    public static DeleteContactListParty fromInput(DeleteContactListParty input) {
        DeleteContactListParty service = new DeleteContactListParty();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteContactListParty</code> from the output values of the given <code>DeleteContactListParty</code>.
     * @param output a <code>DeleteContactListParty</code>
     */
    public static DeleteContactListParty fromOutput(DeleteContactListParty output) {
        DeleteContactListParty service = new DeleteContactListParty();
    ...
    /**
     * Construct a <code>DeleteContactListParty</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteContactListParty fromInput(Map<String, Object> mapValue) {
        DeleteContactListParty service = new DeleteContactListParty();
    ...
    /**
     * Construct a <code>DeleteContactListParty</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteContactListParty fromOutput(Map<String, Object> mapValue) {
        DeleteContactListParty service = new DeleteContactListParty();
