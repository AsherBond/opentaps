 ...
 */
public class CreateSimpleNonProductSalesOrder extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateSimpleNonProductSalesOrder</code> from the input values of the given <code>CreateSimpleNonProductSalesOrder</code>.
     * @param input a <code>CreateSimpleNonProductSalesOrder</code>
     */
    public static CreateSimpleNonProductSalesOrder fromInput(CreateSimpleNonProductSalesOrder input) {
        CreateSimpleNonProductSalesOrder service = new CreateSimpleNonProductSalesOrder();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateSimpleNonProductSalesOrder</code> from the output values of the given <code>CreateSimpleNonProductSalesOrder</code>.
     * @param output a <code>CreateSimpleNonProductSalesOrder</code>
     */
    public static CreateSimpleNonProductSalesOrder fromOutput(CreateSimpleNonProductSalesOrder output) {
        CreateSimpleNonProductSalesOrder service = new CreateSimpleNonProductSalesOrder();
    ...
    /**
     * Construct a <code>CreateSimpleNonProductSalesOrder</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateSimpleNonProductSalesOrder fromInput(Map<String, Object> mapValue) {
        CreateSimpleNonProductSalesOrder service = new CreateSimpleNonProductSalesOrder();
    ...
    /**
     * Construct a <code>CreateSimpleNonProductSalesOrder</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateSimpleNonProductSalesOrder fromOutput(Map<String, Object> mapValue) {
        CreateSimpleNonProductSalesOrder service = new CreateSimpleNonProductSalesOrder();
