 ...
 */
public class GetComparativeBalanceSheet extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetComparativeBalanceSheet</code> from the input values of the given <code>GetComparativeBalanceSheet</code>.
     * @param input a <code>GetComparativeBalanceSheet</code>
     */
    public static GetComparativeBalanceSheet fromInput(GetComparativeBalanceSheet input) {
        GetComparativeBalanceSheet service = new GetComparativeBalanceSheet();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetComparativeBalanceSheet</code> from the output values of the given <code>GetComparativeBalanceSheet</code>.
     * @param output a <code>GetComparativeBalanceSheet</code>
     */
    public static GetComparativeBalanceSheet fromOutput(GetComparativeBalanceSheet output) {
        GetComparativeBalanceSheet service = new GetComparativeBalanceSheet();
    ...
    /**
     * Construct a <code>GetComparativeBalanceSheet</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetComparativeBalanceSheet fromInput(Map<String, Object> mapValue) {
        GetComparativeBalanceSheet service = new GetComparativeBalanceSheet();
    ...
    /**
     * Construct a <code>GetComparativeBalanceSheet</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetComparativeBalanceSheet fromOutput(Map<String, Object> mapValue) {
        GetComparativeBalanceSheet service = new GetComparativeBalanceSheet();
