...
/**
 * Auto generated base entity WorkflowFormalParam.
 */
@javax.persistence.Entity
@Table(name="WORKFLOW_FORMAL_PARAM")
public class WorkflowFormalParam extends Entity {
static {
java.util.Map<String, String> fields = new java.util.HashMap<String, String>();
        ...
        fields.put("formalParamId", "FORMAL_PARAM_ID");
        fields.put("indexNumber", "INDEX_NUMBER");
        fields.put("modeEnumId", "MODE_ENUM_ID");
...
fieldMapColumns.put("WorkflowFormalParam", fields);
}
  public static enum Fields implements EntityFieldInterface<WorkflowFormalParam> {
    packageId("packageId"),
    packageVersion("packageVersion"),
    processId("processId"),
    processVersion("processVersion"),
    applicationId("applicationId"),
    formalParamId("formalParamId"),
    indexNumber("indexNumber"),
    modeEnumId("modeEnumId"),
   ...
   @FieldBridge(impl = org.opentaps.domain.base.entities.bridge.WorkflowFormalParamPkBridge.class)
     private WorkflowFormalParamPk id = new WorkflowFormalParamPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>WorkflowFormalParamPk</code>
     */
      public WorkflowFormalParamPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>WorkflowFormalParamPk</code> value to set
    */   
      public void setId(WorkflowFormalParamPk id) {
         this.id = id;
      }
   @Column(name="INDEX_NUMBER")
   private Long indexNumber;
   @Column(name="MODE_ENUM_ID")
   private String modeEnumId;
   ...
   @JoinColumn(name="MODE_ENUM_ID", insertable=false, updatable=false)
   @org.hibernate.annotations.Generated(
      org.hibernate.annotations.GenerationTime.ALWAYS
   )
   
   private Enumeration modeEnumeration = null;
   @ManyToOne(cascade = {CascadeType.PERSIST, CascadeType.MERGE}, fetch=FetchType.LAZY)
   ...
   private transient WorkflowApplication workflowApplication = null;

  /**
   * Default constructor.
   */
  public WorkflowFormalParam() {
      super();
      this.baseEntityName = "WorkflowFormalParam";
      this.isView = false;
      
      this.primaryKeyNames = new ArrayList<String>();
      this.primaryKeyNames.add("packageId");this.primaryKeyNames.add("packageVersion");this.primaryKeyNames.add("processId");this.primaryKeyNames.add("processVersion");this.primaryKeyNames.add("applicationId");this.primaryKeyNames.add("formalParamId");
      this.allFieldsNames = new ArrayList<String>();
      this.allFieldsNames.add("packageId");this.allFieldsNames.add("packageVersion");this.allFieldsNames.add("processId");this.allFieldsNames.add("processVersion");this.allFieldsNames.add("applicationId");this.allFieldsNames.add("formalParamId");this.allFieldsNames.add("indexNumber");this.allFieldsNames.add("modeEnumId");this.allFieldsNames.add("description");this.allFieldsNames.add("dataTypeEnumId");this.allFieldsNames.add("complexTypeInfoId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
   ...
   */
  public WorkflowFormalParam(RepositoryInterface repository) {
      this();
    ...
    /**
     * Auto generated value setter.
     * @param formalParamId the formalParamId to set
     */
    public void setFormalParamId(String formalParamId) {
        id.setFormalParamId(formalParamId);
    }
    /**
     * Auto generated value setter.
    ...
    /**
     * Auto generated value setter.
     * @param modeEnumId the modeEnumId to set
     */
    public void setModeEnumId(String modeEnumId) {
        this.modeEnumId = modeEnumId;
    }
    /**
     * Auto generated value setter.
    ...
    public String getFormalParamId() {
        return this.id.getFormalParamId();
    }
    /**
     * Auto generated value accessor.
     ...
     * @return <code>String</code>
     */
    public String getModeEnumId() {
        return this.modeEnumId;
    }
    /**
     * Auto generated value accessor.
     * @return <code>String</code>
    ...
    /**
     * Auto generated method that gets the related <code>Enumeration</code> by the relation named <code>ModeEnumeration</code>.
     * @return the <code>Enumeration</code>
     * @throws RepositoryException if an error occurs
     */
    public Enumeration getModeEnumeration() throws RepositoryException {
        if (this.modeEnumeration == null) {
            this.modeEnumeration = getRelatedOne(Enumeration.class, "ModeEnumeration");
        }
        return this.modeEnumeration;
    }
    /**
     ...
     * @return the <code>WorkflowApplication</code>
     * @throws RepositoryException if an error occurs
     */
    public WorkflowApplication getWorkflowApplication() throws RepositoryException {
        if (this.workflowApplication == null) {
            this.workflowApplication = getRelatedOne(WorkflowApplication.class, "WorkflowApplication");
        }
    ...
    /**
     * Auto generated value setter.
     * @param modeEnumeration the modeEnumeration to set
    */
    public void setModeEnumeration(Enumeration modeEnumeration) {
        this.modeEnumeration = modeEnumeration;
    }
    /**
     * Auto generated value setter.
    ...
    */
    ...
    /**
     * Auto generated value setter.
     * @param workflowApplication the workflowApplication to set
    */
    ...
    public void fromMap(Map<String, Object> mapValue) {
        ...
        setFormalParamId((String) mapValue.get("formalParamId"));
        setIndexNumber((Long) mapValue.get("indexNumber"));
        setModeEnumId((String) mapValue.get("modeEnumId"));
    ...
    public Map<String, Object> toMap() {
        ...
        mapValue.put("formalParamId", getFormalParamId());
        mapValue.put("indexNumber", getIndexNumber());
        mapValue.put("modeEnumId", getModeEnumId());
