 ...
 */
public class OpentapsUpdateOrderItems extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsUpdateOrderItems</code> from the input values of the given <code>OpentapsUpdateOrderItems</code>.
     * @param input a <code>OpentapsUpdateOrderItems</code>
     */
    public static OpentapsUpdateOrderItems fromInput(OpentapsUpdateOrderItems input) {
        OpentapsUpdateOrderItems service = new OpentapsUpdateOrderItems();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsUpdateOrderItems</code> from the output values of the given <code>OpentapsUpdateOrderItems</code>.
     * @param output a <code>OpentapsUpdateOrderItems</code>
     */
    public static OpentapsUpdateOrderItems fromOutput(OpentapsUpdateOrderItems output) {
        OpentapsUpdateOrderItems service = new OpentapsUpdateOrderItems();
    ...
    /**
     * Construct a <code>OpentapsUpdateOrderItems</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsUpdateOrderItems fromInput(Map<String, Object> mapValue) {
        OpentapsUpdateOrderItems service = new OpentapsUpdateOrderItems();
    ...
    /**
     * Construct a <code>OpentapsUpdateOrderItems</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsUpdateOrderItems fromOutput(Map<String, Object> mapValue) {
        OpentapsUpdateOrderItems service = new OpentapsUpdateOrderItems();
