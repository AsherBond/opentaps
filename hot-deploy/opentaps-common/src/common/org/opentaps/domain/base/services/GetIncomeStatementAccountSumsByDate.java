 ...
 */
public class GetIncomeStatementAccountSumsByDate extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetIncomeStatementAccountSumsByDate</code> from the input values of the given <code>GetIncomeStatementAccountSumsByDate</code>.
     * @param input a <code>GetIncomeStatementAccountSumsByDate</code>
     */
    public static GetIncomeStatementAccountSumsByDate fromInput(GetIncomeStatementAccountSumsByDate input) {
        GetIncomeStatementAccountSumsByDate service = new GetIncomeStatementAccountSumsByDate();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetIncomeStatementAccountSumsByDate</code> from the output values of the given <code>GetIncomeStatementAccountSumsByDate</code>.
     * @param output a <code>GetIncomeStatementAccountSumsByDate</code>
     */
    public static GetIncomeStatementAccountSumsByDate fromOutput(GetIncomeStatementAccountSumsByDate output) {
        GetIncomeStatementAccountSumsByDate service = new GetIncomeStatementAccountSumsByDate();
    ...
    /**
     * Construct a <code>GetIncomeStatementAccountSumsByDate</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetIncomeStatementAccountSumsByDate fromInput(Map<String, Object> mapValue) {
        GetIncomeStatementAccountSumsByDate service = new GetIncomeStatementAccountSumsByDate();
    ...
    /**
     * Construct a <code>GetIncomeStatementAccountSumsByDate</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetIncomeStatementAccountSumsByDate fromOutput(Map<String, Object> mapValue) {
        GetIncomeStatementAccountSumsByDate service = new GetIncomeStatementAccountSumsByDate();
