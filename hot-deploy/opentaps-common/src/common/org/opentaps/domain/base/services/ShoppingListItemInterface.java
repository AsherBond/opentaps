 ...
 */
public class ShoppingListItemInterface extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ShoppingListItemInterface</code> from the input values of the given <code>ShoppingListItemInterface</code>.
     * @param input a <code>ShoppingListItemInterface</code>
     */
    public static ShoppingListItemInterface fromInput(ShoppingListItemInterface input) {
        ShoppingListItemInterface service = new ShoppingListItemInterface();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ShoppingListItemInterface</code> from the output values of the given <code>ShoppingListItemInterface</code>.
     * @param output a <code>ShoppingListItemInterface</code>
     */
    public static ShoppingListItemInterface fromOutput(ShoppingListItemInterface output) {
        ShoppingListItemInterface service = new ShoppingListItemInterface();
    ...
    /**
     * Construct a <code>ShoppingListItemInterface</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ShoppingListItemInterface fromInput(Map<String, Object> mapValue) {
        ShoppingListItemInterface service = new ShoppingListItemInterface();
    ...
    /**
     * Construct a <code>ShoppingListItemInterface</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ShoppingListItemInterface fromOutput(Map<String, Object> mapValue) {
        ShoppingListItemInterface service = new ShoppingListItemInterface();
