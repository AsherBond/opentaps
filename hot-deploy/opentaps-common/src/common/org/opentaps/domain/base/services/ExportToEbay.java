 ...
 */
public class ExportToEbay extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ExportToEbay</code> from the input values of the given <code>ExportToEbay</code>.
     * @param input a <code>ExportToEbay</code>
     */
    public static ExportToEbay fromInput(ExportToEbay input) {
        ExportToEbay service = new ExportToEbay();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ExportToEbay</code> from the output values of the given <code>ExportToEbay</code>.
     * @param output a <code>ExportToEbay</code>
     */
    public static ExportToEbay fromOutput(ExportToEbay output) {
        ExportToEbay service = new ExportToEbay();
    ...
    /**
     * Construct a <code>ExportToEbay</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ExportToEbay fromInput(Map<String, Object> mapValue) {
        ExportToEbay service = new ExportToEbay();
    ...
    /**
     * Construct a <code>ExportToEbay</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ExportToEbay fromOutput(Map<String, Object> mapValue) {
        ExportToEbay service = new ExportToEbay();
