 ...
 */
public class DuplicateProduct extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DuplicateProduct</code> from the input values of the given <code>DuplicateProduct</code>.
     * @param input a <code>DuplicateProduct</code>
     */
    public static DuplicateProduct fromInput(DuplicateProduct input) {
        DuplicateProduct service = new DuplicateProduct();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DuplicateProduct</code> from the output values of the given <code>DuplicateProduct</code>.
     * @param output a <code>DuplicateProduct</code>
     */
    public static DuplicateProduct fromOutput(DuplicateProduct output) {
        DuplicateProduct service = new DuplicateProduct();
    ...
    /**
     * Construct a <code>DuplicateProduct</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DuplicateProduct fromInput(Map<String, Object> mapValue) {
        DuplicateProduct service = new DuplicateProduct();
    ...
    /**
     * Construct a <code>DuplicateProduct</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DuplicateProduct fromOutput(Map<String, Object> mapValue) {
        DuplicateProduct service = new DuplicateProduct();
