 ...
 */
public class RemoteStoreEntitySyncDataHttp extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemoteStoreEntitySyncDataHttp</code> from the input values of the given <code>RemoteStoreEntitySyncDataHttp</code>.
     * @param input a <code>RemoteStoreEntitySyncDataHttp</code>
     */
    public static RemoteStoreEntitySyncDataHttp fromInput(RemoteStoreEntitySyncDataHttp input) {
        RemoteStoreEntitySyncDataHttp service = new RemoteStoreEntitySyncDataHttp();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemoteStoreEntitySyncDataHttp</code> from the output values of the given <code>RemoteStoreEntitySyncDataHttp</code>.
     * @param output a <code>RemoteStoreEntitySyncDataHttp</code>
     */
    public static RemoteStoreEntitySyncDataHttp fromOutput(RemoteStoreEntitySyncDataHttp output) {
        RemoteStoreEntitySyncDataHttp service = new RemoteStoreEntitySyncDataHttp();
    ...
    /**
     * Construct a <code>RemoteStoreEntitySyncDataHttp</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoteStoreEntitySyncDataHttp fromInput(Map<String, Object> mapValue) {
        RemoteStoreEntitySyncDataHttp service = new RemoteStoreEntitySyncDataHttp();
    ...
    /**
     * Construct a <code>RemoteStoreEntitySyncDataHttp</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoteStoreEntitySyncDataHttp fromOutput(Map<String, Object> mapValue) {
        RemoteStoreEntitySyncDataHttp service = new RemoteStoreEntitySyncDataHttp();
