 ...
 */
public class AppendOrderItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AppendOrderItem</code> from the input values of the given <code>AppendOrderItem</code>.
     * @param input a <code>AppendOrderItem</code>
     */
    public static AppendOrderItem fromInput(AppendOrderItem input) {
        AppendOrderItem service = new AppendOrderItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AppendOrderItem</code> from the output values of the given <code>AppendOrderItem</code>.
     * @param output a <code>AppendOrderItem</code>
     */
    public static AppendOrderItem fromOutput(AppendOrderItem output) {
        AppendOrderItem service = new AppendOrderItem();
    ...
    /**
     * Construct a <code>AppendOrderItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AppendOrderItem fromInput(Map<String, Object> mapValue) {
        AppendOrderItem service = new AppendOrderItem();
    ...
    /**
     * Construct a <code>AppendOrderItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AppendOrderItem fromOutput(Map<String, Object> mapValue) {
        AppendOrderItem service = new AppendOrderItem();
