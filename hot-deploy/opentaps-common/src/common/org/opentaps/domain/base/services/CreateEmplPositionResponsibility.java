 ...
 */
public class CreateEmplPositionResponsibility extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateEmplPositionResponsibility</code> from the input values of the given <code>CreateEmplPositionResponsibility</code>.
     * @param input a <code>CreateEmplPositionResponsibility</code>
     */
    public static CreateEmplPositionResponsibility fromInput(CreateEmplPositionResponsibility input) {
        CreateEmplPositionResponsibility service = new CreateEmplPositionResponsibility();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateEmplPositionResponsibility</code> from the output values of the given <code>CreateEmplPositionResponsibility</code>.
     * @param output a <code>CreateEmplPositionResponsibility</code>
     */
    public static CreateEmplPositionResponsibility fromOutput(CreateEmplPositionResponsibility output) {
        CreateEmplPositionResponsibility service = new CreateEmplPositionResponsibility();
    ...
    /**
     * Construct a <code>CreateEmplPositionResponsibility</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateEmplPositionResponsibility fromInput(Map<String, Object> mapValue) {
        CreateEmplPositionResponsibility service = new CreateEmplPositionResponsibility();
    ...
    /**
     * Construct a <code>CreateEmplPositionResponsibility</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateEmplPositionResponsibility fromOutput(Map<String, Object> mapValue) {
        CreateEmplPositionResponsibility service = new CreateEmplPositionResponsibility();
