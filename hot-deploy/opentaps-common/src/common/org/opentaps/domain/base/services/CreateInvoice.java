 ...
 */
public class CreateInvoice extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateInvoice</code> from the input values of the given <code>CreateInvoice</code>.
     * @param input a <code>CreateInvoice</code>
     */
    public static CreateInvoice fromInput(CreateInvoice input) {
        CreateInvoice service = new CreateInvoice();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateInvoice</code> from the output values of the given <code>CreateInvoice</code>.
     * @param output a <code>CreateInvoice</code>
     */
    public static CreateInvoice fromOutput(CreateInvoice output) {
        CreateInvoice service = new CreateInvoice();
    ...
    /**
     * Construct a <code>CreateInvoice</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateInvoice fromInput(Map<String, Object> mapValue) {
        CreateInvoice service = new CreateInvoice();
    ...
    /**
     * Construct a <code>CreateInvoice</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateInvoice fromOutput(Map<String, Object> mapValue) {
        CreateInvoice service = new CreateInvoice();
