 ...
 */
public class ReturnAdjustmentInterface extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ReturnAdjustmentInterface</code> from the input values of the given <code>ReturnAdjustmentInterface</code>.
     * @param input a <code>ReturnAdjustmentInterface</code>
     */
    public static ReturnAdjustmentInterface fromInput(ReturnAdjustmentInterface input) {
        ReturnAdjustmentInterface service = new ReturnAdjustmentInterface();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ReturnAdjustmentInterface</code> from the output values of the given <code>ReturnAdjustmentInterface</code>.
     * @param output a <code>ReturnAdjustmentInterface</code>
     */
    public static ReturnAdjustmentInterface fromOutput(ReturnAdjustmentInterface output) {
        ReturnAdjustmentInterface service = new ReturnAdjustmentInterface();
    ...
    /**
     * Construct a <code>ReturnAdjustmentInterface</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ReturnAdjustmentInterface fromInput(Map<String, Object> mapValue) {
        ReturnAdjustmentInterface service = new ReturnAdjustmentInterface();
    ...
    /**
     * Construct a <code>ReturnAdjustmentInterface</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ReturnAdjustmentInterface fromOutput(Map<String, Object> mapValue) {
        ReturnAdjustmentInterface service = new ReturnAdjustmentInterface();
