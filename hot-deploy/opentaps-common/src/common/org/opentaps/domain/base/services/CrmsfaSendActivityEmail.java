 ...
 */
public class CrmsfaSendActivityEmail extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaSendActivityEmail</code> from the input values of the given <code>CrmsfaSendActivityEmail</code>.
     * @param input a <code>CrmsfaSendActivityEmail</code>
     */
    public static CrmsfaSendActivityEmail fromInput(CrmsfaSendActivityEmail input) {
        CrmsfaSendActivityEmail service = new CrmsfaSendActivityEmail();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaSendActivityEmail</code> from the output values of the given <code>CrmsfaSendActivityEmail</code>.
     * @param output a <code>CrmsfaSendActivityEmail</code>
     */
    public static CrmsfaSendActivityEmail fromOutput(CrmsfaSendActivityEmail output) {
        CrmsfaSendActivityEmail service = new CrmsfaSendActivityEmail();
    ...
    /**
     * Construct a <code>CrmsfaSendActivityEmail</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaSendActivityEmail fromInput(Map<String, Object> mapValue) {
        CrmsfaSendActivityEmail service = new CrmsfaSendActivityEmail();
    ...
    /**
     * Construct a <code>CrmsfaSendActivityEmail</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaSendActivityEmail fromOutput(Map<String, Object> mapValue) {
        CrmsfaSendActivityEmail service = new CrmsfaSendActivityEmail();
