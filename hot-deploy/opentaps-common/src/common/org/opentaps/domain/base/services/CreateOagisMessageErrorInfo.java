 ...
 */
public class CreateOagisMessageErrorInfo extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateOagisMessageErrorInfo</code> from the input values of the given <code>CreateOagisMessageErrorInfo</code>.
     * @param input a <code>CreateOagisMessageErrorInfo</code>
     */
    public static CreateOagisMessageErrorInfo fromInput(CreateOagisMessageErrorInfo input) {
        CreateOagisMessageErrorInfo service = new CreateOagisMessageErrorInfo();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateOagisMessageErrorInfo</code> from the output values of the given <code>CreateOagisMessageErrorInfo</code>.
     * @param output a <code>CreateOagisMessageErrorInfo</code>
     */
    public static CreateOagisMessageErrorInfo fromOutput(CreateOagisMessageErrorInfo output) {
        CreateOagisMessageErrorInfo service = new CreateOagisMessageErrorInfo();
    ...
    /**
     * Construct a <code>CreateOagisMessageErrorInfo</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateOagisMessageErrorInfo fromInput(Map<String, Object> mapValue) {
        CreateOagisMessageErrorInfo service = new CreateOagisMessageErrorInfo();
    ...
    /**
     * Construct a <code>CreateOagisMessageErrorInfo</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateOagisMessageErrorInfo fromOutput(Map<String, Object> mapValue) {
        CreateOagisMessageErrorInfo service = new CreateOagisMessageErrorInfo();
