 ...
 */
public class AcctgTransactionPermissionCheck extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AcctgTransactionPermissionCheck</code> from the input values of the given <code>AcctgTransactionPermissionCheck</code>.
     * @param input a <code>AcctgTransactionPermissionCheck</code>
     */
    public static AcctgTransactionPermissionCheck fromInput(AcctgTransactionPermissionCheck input) {
        AcctgTransactionPermissionCheck service = new AcctgTransactionPermissionCheck();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AcctgTransactionPermissionCheck</code> from the output values of the given <code>AcctgTransactionPermissionCheck</code>.
     * @param output a <code>AcctgTransactionPermissionCheck</code>
     */
    public static AcctgTransactionPermissionCheck fromOutput(AcctgTransactionPermissionCheck output) {
        AcctgTransactionPermissionCheck service = new AcctgTransactionPermissionCheck();
    ...
    /**
     * Construct a <code>AcctgTransactionPermissionCheck</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgTransactionPermissionCheck fromInput(Map<String, Object> mapValue) {
        AcctgTransactionPermissionCheck service = new AcctgTransactionPermissionCheck();
    ...
    /**
     * Construct a <code>AcctgTransactionPermissionCheck</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgTransactionPermissionCheck fromOutput(Map<String, Object> mapValue) {
        AcctgTransactionPermissionCheck service = new AcctgTransactionPermissionCheck();
