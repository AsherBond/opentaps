 ...
 */
public class RedeemGiftCard extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RedeemGiftCard</code> from the input values of the given <code>RedeemGiftCard</code>.
     * @param input a <code>RedeemGiftCard</code>
     */
    public static RedeemGiftCard fromInput(RedeemGiftCard input) {
        RedeemGiftCard service = new RedeemGiftCard();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RedeemGiftCard</code> from the output values of the given <code>RedeemGiftCard</code>.
     * @param output a <code>RedeemGiftCard</code>
     */
    public static RedeemGiftCard fromOutput(RedeemGiftCard output) {
        RedeemGiftCard service = new RedeemGiftCard();
    ...
    /**
     * Construct a <code>RedeemGiftCard</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RedeemGiftCard fromInput(Map<String, Object> mapValue) {
        RedeemGiftCard service = new RedeemGiftCard();
    ...
    /**
     * Construct a <code>RedeemGiftCard</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RedeemGiftCard fromOutput(Map<String, Object> mapValue) {
        RedeemGiftCard service = new RedeemGiftCard();
