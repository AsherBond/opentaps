 ...
 */
public class ProcessExtendSubscriptionByProduct extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ProcessExtendSubscriptionByProduct</code> from the input values of the given <code>ProcessExtendSubscriptionByProduct</code>.
     * @param input a <code>ProcessExtendSubscriptionByProduct</code>
     */
    public static ProcessExtendSubscriptionByProduct fromInput(ProcessExtendSubscriptionByProduct input) {
        ProcessExtendSubscriptionByProduct service = new ProcessExtendSubscriptionByProduct();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ProcessExtendSubscriptionByProduct</code> from the output values of the given <code>ProcessExtendSubscriptionByProduct</code>.
     * @param output a <code>ProcessExtendSubscriptionByProduct</code>
     */
    public static ProcessExtendSubscriptionByProduct fromOutput(ProcessExtendSubscriptionByProduct output) {
        ProcessExtendSubscriptionByProduct service = new ProcessExtendSubscriptionByProduct();
    ...
    /**
     * Construct a <code>ProcessExtendSubscriptionByProduct</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ProcessExtendSubscriptionByProduct fromInput(Map<String, Object> mapValue) {
        ProcessExtendSubscriptionByProduct service = new ProcessExtendSubscriptionByProduct();
    ...
    /**
     * Construct a <code>ProcessExtendSubscriptionByProduct</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ProcessExtendSubscriptionByProduct fromOutput(Map<String, Object> mapValue) {
        ProcessExtendSubscriptionByProduct service = new ProcessExtendSubscriptionByProduct();
