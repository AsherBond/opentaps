 ...
 */
public class CreatePartyAcctgPreference extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyAcctgPreference</code> from the input values of the given <code>CreatePartyAcctgPreference</code>.
     * @param input a <code>CreatePartyAcctgPreference</code>
     */
    public static CreatePartyAcctgPreference fromInput(CreatePartyAcctgPreference input) {
        CreatePartyAcctgPreference service = new CreatePartyAcctgPreference();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePartyAcctgPreference</code> from the output values of the given <code>CreatePartyAcctgPreference</code>.
     * @param output a <code>CreatePartyAcctgPreference</code>
     */
    public static CreatePartyAcctgPreference fromOutput(CreatePartyAcctgPreference output) {
        CreatePartyAcctgPreference service = new CreatePartyAcctgPreference();
    ...
    /**
     * Construct a <code>CreatePartyAcctgPreference</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyAcctgPreference fromInput(Map<String, Object> mapValue) {
        CreatePartyAcctgPreference service = new CreatePartyAcctgPreference();
    ...
    /**
     * Construct a <code>CreatePartyAcctgPreference</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyAcctgPreference fromOutput(Map<String, Object> mapValue) {
        CreatePartyAcctgPreference service = new CreatePartyAcctgPreference();
