...
import org.opentaps.domain.base.entities.WorkflowActivityLoopPk;

/**
 * A FieldBridge for WorkflowActivityLoopPk.
 */
public class WorkflowActivityLoopPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkflowActivityLoopPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkflowActivityLoopPk id = new WorkflowActivityLoopPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkflowActivityLoopPk id = (WorkflowActivityLoopPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkflowActivityLoopPk id = (WorkflowActivityLoopPk) value;
