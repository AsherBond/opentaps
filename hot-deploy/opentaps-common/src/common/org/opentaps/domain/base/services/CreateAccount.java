 ...
 */
public class CreateAccount extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateAccount</code> from the input values of the given <code>CreateAccount</code>.
     * @param input a <code>CreateAccount</code>
     */
    public static CreateAccount fromInput(CreateAccount input) {
    ...
    /**
     * Construct a <code>CreateAccount</code> from the output values of the given <code>CreateAccount</code>.
     * @param output a <code>CreateAccount</code>
     */
    public static CreateAccount fromOutput(CreateAccount output) {
        CreateAccount service = new CreateAccount();
    ...
    /**
     * Construct a <code>CreateAccount</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateAccount fromInput(Map<String, Object> mapValue) {
        CreateAccount service = new CreateAccount();
    ...
    /**
     * Construct a <code>CreateAccount</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateAccount fromOutput(Map<String, Object> mapValue) {
        CreateAccount service = new CreateAccount();
