 ...
 */
public class UpdateContentAndUploadedFile extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateContentAndUploadedFile</code> from the input values of the given <code>UpdateContentAndUploadedFile</code>.
     * @param input a <code>UpdateContentAndUploadedFile</code>
     */
    public static UpdateContentAndUploadedFile fromInput(UpdateContentAndUploadedFile input) {
        UpdateContentAndUploadedFile service = new UpdateContentAndUploadedFile();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateContentAndUploadedFile</code> from the output values of the given <code>UpdateContentAndUploadedFile</code>.
     * @param output a <code>UpdateContentAndUploadedFile</code>
     */
    public static UpdateContentAndUploadedFile fromOutput(UpdateContentAndUploadedFile output) {
        UpdateContentAndUploadedFile service = new UpdateContentAndUploadedFile();
    ...
    /**
     * Construct a <code>UpdateContentAndUploadedFile</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateContentAndUploadedFile fromInput(Map<String, Object> mapValue) {
        UpdateContentAndUploadedFile service = new UpdateContentAndUploadedFile();
    ...
    /**
     * Construct a <code>UpdateContentAndUploadedFile</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateContentAndUploadedFile fromOutput(Map<String, Object> mapValue) {
        UpdateContentAndUploadedFile service = new UpdateContentAndUploadedFile();
