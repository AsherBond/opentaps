 ...
 */
public class CrmsfaUpdateActivity extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaUpdateActivity</code> from the input values of the given <code>CrmsfaUpdateActivity</code>.
     * @param input a <code>CrmsfaUpdateActivity</code>
     */
    public static CrmsfaUpdateActivity fromInput(CrmsfaUpdateActivity input) {
        CrmsfaUpdateActivity service = new CrmsfaUpdateActivity();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaUpdateActivity</code> from the output values of the given <code>CrmsfaUpdateActivity</code>.
     * @param output a <code>CrmsfaUpdateActivity</code>
     */
    public static CrmsfaUpdateActivity fromOutput(CrmsfaUpdateActivity output) {
        CrmsfaUpdateActivity service = new CrmsfaUpdateActivity();
    ...
    /**
     * Construct a <code>CrmsfaUpdateActivity</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaUpdateActivity fromInput(Map<String, Object> mapValue) {
        CrmsfaUpdateActivity service = new CrmsfaUpdateActivity();
    ...
    /**
     * Construct a <code>CrmsfaUpdateActivity</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaUpdateActivity fromOutput(Map<String, Object> mapValue) {
        CrmsfaUpdateActivity service = new CrmsfaUpdateActivity();
