 ...
 */
public class CrmsfaUpdateContentForOpportunity extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaUpdateContentForOpportunity</code> from the input values of the given <code>CrmsfaUpdateContentForOpportunity</code>.
     * @param input a <code>CrmsfaUpdateContentForOpportunity</code>
     */
    public static CrmsfaUpdateContentForOpportunity fromInput(CrmsfaUpdateContentForOpportunity input) {
        CrmsfaUpdateContentForOpportunity service = new CrmsfaUpdateContentForOpportunity();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaUpdateContentForOpportunity</code> from the output values of the given <code>CrmsfaUpdateContentForOpportunity</code>.
     * @param output a <code>CrmsfaUpdateContentForOpportunity</code>
     */
    public static CrmsfaUpdateContentForOpportunity fromOutput(CrmsfaUpdateContentForOpportunity output) {
        CrmsfaUpdateContentForOpportunity service = new CrmsfaUpdateContentForOpportunity();
    ...
    /**
     * Construct a <code>CrmsfaUpdateContentForOpportunity</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaUpdateContentForOpportunity fromInput(Map<String, Object> mapValue) {
        CrmsfaUpdateContentForOpportunity service = new CrmsfaUpdateContentForOpportunity();
    ...
    /**
     * Construct a <code>CrmsfaUpdateContentForOpportunity</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaUpdateContentForOpportunity fromOutput(Map<String, Object> mapValue) {
        CrmsfaUpdateContentForOpportunity service = new CrmsfaUpdateContentForOpportunity();
