 ...
 */
public class PersistDataResourceAndData extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PersistDataResourceAndData</code> from the input values of the given <code>PersistDataResourceAndData</code>.
     * @param input a <code>PersistDataResourceAndData</code>
     */
    public static PersistDataResourceAndData fromInput(PersistDataResourceAndData input) {
        PersistDataResourceAndData service = new PersistDataResourceAndData();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PersistDataResourceAndData</code> from the output values of the given <code>PersistDataResourceAndData</code>.
     * @param output a <code>PersistDataResourceAndData</code>
     */
    public static PersistDataResourceAndData fromOutput(PersistDataResourceAndData output) {
        PersistDataResourceAndData service = new PersistDataResourceAndData();
    ...
    /**
     * Construct a <code>PersistDataResourceAndData</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PersistDataResourceAndData fromInput(Map<String, Object> mapValue) {
        PersistDataResourceAndData service = new PersistDataResourceAndData();
    ...
    /**
     * Construct a <code>PersistDataResourceAndData</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PersistDataResourceAndData fromOutput(Map<String, Object> mapValue) {
        PersistDataResourceAndData service = new PersistDataResourceAndData();
