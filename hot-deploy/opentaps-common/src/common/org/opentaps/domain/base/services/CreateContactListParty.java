 ...
 */
public class CreateContactListParty extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateContactListParty</code> from the input values of the given <code>CreateContactListParty</code>.
     * @param input a <code>CreateContactListParty</code>
     */
    public static CreateContactListParty fromInput(CreateContactListParty input) {
        CreateContactListParty service = new CreateContactListParty();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateContactListParty</code> from the output values of the given <code>CreateContactListParty</code>.
     * @param output a <code>CreateContactListParty</code>
     */
    public static CreateContactListParty fromOutput(CreateContactListParty output) {
        CreateContactListParty service = new CreateContactListParty();
    ...
    /**
     * Construct a <code>CreateContactListParty</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateContactListParty fromInput(Map<String, Object> mapValue) {
        CreateContactListParty service = new CreateContactListParty();
    ...
    /**
     * Construct a <code>CreateContactListParty</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateContactListParty fromOutput(Map<String, Object> mapValue) {
        CreateContactListParty service = new CreateContactListParty();
