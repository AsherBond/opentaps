 ...
 */
public class CreateAgreementPartyApplic extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateAgreementPartyApplic</code> from the input values of the given <code>CreateAgreementPartyApplic</code>.
     * @param input a <code>CreateAgreementPartyApplic</code>
     */
    public static CreateAgreementPartyApplic fromInput(CreateAgreementPartyApplic input) {
        CreateAgreementPartyApplic service = new CreateAgreementPartyApplic();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateAgreementPartyApplic</code> from the output values of the given <code>CreateAgreementPartyApplic</code>.
     * @param output a <code>CreateAgreementPartyApplic</code>
     */
    public static CreateAgreementPartyApplic fromOutput(CreateAgreementPartyApplic output) {
        CreateAgreementPartyApplic service = new CreateAgreementPartyApplic();
    ...
    /**
     * Construct a <code>CreateAgreementPartyApplic</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateAgreementPartyApplic fromInput(Map<String, Object> mapValue) {
        CreateAgreementPartyApplic service = new CreateAgreementPartyApplic();
    ...
    /**
     * Construct a <code>CreateAgreementPartyApplic</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateAgreementPartyApplic fromOutput(Map<String, Object> mapValue) {
        CreateAgreementPartyApplic service = new CreateAgreementPartyApplic();
