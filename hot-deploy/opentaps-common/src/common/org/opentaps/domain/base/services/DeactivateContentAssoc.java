 ...
 */
public class DeactivateContentAssoc extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeactivateContentAssoc</code> from the input values of the given <code>DeactivateContentAssoc</code>.
     * @param input a <code>DeactivateContentAssoc</code>
     */
    public static DeactivateContentAssoc fromInput(DeactivateContentAssoc input) {
        DeactivateContentAssoc service = new DeactivateContentAssoc();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeactivateContentAssoc</code> from the output values of the given <code>DeactivateContentAssoc</code>.
     * @param output a <code>DeactivateContentAssoc</code>
     */
    public static DeactivateContentAssoc fromOutput(DeactivateContentAssoc output) {
        DeactivateContentAssoc service = new DeactivateContentAssoc();
    ...
    /**
     * Construct a <code>DeactivateContentAssoc</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeactivateContentAssoc fromInput(Map<String, Object> mapValue) {
        DeactivateContentAssoc service = new DeactivateContentAssoc();
    ...
    /**
     * Construct a <code>DeactivateContentAssoc</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeactivateContentAssoc fromOutput(Map<String, Object> mapValue) {
        DeactivateContentAssoc service = new DeactivateContentAssoc();
