 ...
 */
public class ReserveProductInventoryByFacility extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ReserveProductInventoryByFacility</code> from the input values of the given <code>ReserveProductInventoryByFacility</code>.
     * @param input a <code>ReserveProductInventoryByFacility</code>
     */
    public static ReserveProductInventoryByFacility fromInput(ReserveProductInventoryByFacility input) {
        ReserveProductInventoryByFacility service = new ReserveProductInventoryByFacility();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ReserveProductInventoryByFacility</code> from the output values of the given <code>ReserveProductInventoryByFacility</code>.
     * @param output a <code>ReserveProductInventoryByFacility</code>
     */
    public static ReserveProductInventoryByFacility fromOutput(ReserveProductInventoryByFacility output) {
        ReserveProductInventoryByFacility service = new ReserveProductInventoryByFacility();
    ...
    /**
     * Construct a <code>ReserveProductInventoryByFacility</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ReserveProductInventoryByFacility fromInput(Map<String, Object> mapValue) {
        ReserveProductInventoryByFacility service = new ReserveProductInventoryByFacility();
    ...
    /**
     * Construct a <code>ReserveProductInventoryByFacility</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ReserveProductInventoryByFacility fromOutput(Map<String, Object> mapValue) {
        ReserveProductInventoryByFacility service = new ReserveProductInventoryByFacility();
