 ...
 */
public class AIMCCRelease extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AIMCCRelease</code> from the input values of the given <code>AIMCCRelease</code>.
     * @param input a <code>AIMCCRelease</code>
     */
    public static AIMCCRelease fromInput(AIMCCRelease input) {
        AIMCCRelease service = new AIMCCRelease();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AIMCCRelease</code> from the output values of the given <code>AIMCCRelease</code>.
     * @param output a <code>AIMCCRelease</code>
     */
    public static AIMCCRelease fromOutput(AIMCCRelease output) {
        AIMCCRelease service = new AIMCCRelease();
    ...
    /**
     * Construct a <code>AIMCCRelease</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AIMCCRelease fromInput(Map<String, Object> mapValue) {
        AIMCCRelease service = new AIMCCRelease();
    ...
    /**
     * Construct a <code>AIMCCRelease</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AIMCCRelease fromOutput(Map<String, Object> mapValue) {
        AIMCCRelease service = new AIMCCRelease();
