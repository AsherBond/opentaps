 ...
 */
public class ProdCatalogToPartyPermissionCheck extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ProdCatalogToPartyPermissionCheck</code> from the input values of the given <code>ProdCatalogToPartyPermissionCheck</code>.
     * @param input a <code>ProdCatalogToPartyPermissionCheck</code>
     */
    public static ProdCatalogToPartyPermissionCheck fromInput(ProdCatalogToPartyPermissionCheck input) {
        ProdCatalogToPartyPermissionCheck service = new ProdCatalogToPartyPermissionCheck();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ProdCatalogToPartyPermissionCheck</code> from the output values of the given <code>ProdCatalogToPartyPermissionCheck</code>.
     * @param output a <code>ProdCatalogToPartyPermissionCheck</code>
     */
    public static ProdCatalogToPartyPermissionCheck fromOutput(ProdCatalogToPartyPermissionCheck output) {
        ProdCatalogToPartyPermissionCheck service = new ProdCatalogToPartyPermissionCheck();
    ...
    /**
     * Construct a <code>ProdCatalogToPartyPermissionCheck</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ProdCatalogToPartyPermissionCheck fromInput(Map<String, Object> mapValue) {
        ProdCatalogToPartyPermissionCheck service = new ProdCatalogToPartyPermissionCheck();
    ...
    /**
     * Construct a <code>ProdCatalogToPartyPermissionCheck</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ProdCatalogToPartyPermissionCheck fromOutput(Map<String, Object> mapValue) {
        ProdCatalogToPartyPermissionCheck service = new ProdCatalogToPartyPermissionCheck();
