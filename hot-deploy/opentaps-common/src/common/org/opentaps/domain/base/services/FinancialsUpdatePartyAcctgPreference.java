 ...
 */
public class FinancialsUpdatePartyAcctgPreference extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>FinancialsUpdatePartyAcctgPreference</code> from the input values of the given <code>FinancialsUpdatePartyAcctgPreference</code>.
     * @param input a <code>FinancialsUpdatePartyAcctgPreference</code>
     */
    public static FinancialsUpdatePartyAcctgPreference fromInput(FinancialsUpdatePartyAcctgPreference input) {
        FinancialsUpdatePartyAcctgPreference service = new FinancialsUpdatePartyAcctgPreference();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>FinancialsUpdatePartyAcctgPreference</code> from the output values of the given <code>FinancialsUpdatePartyAcctgPreference</code>.
     * @param output a <code>FinancialsUpdatePartyAcctgPreference</code>
     */
    public static FinancialsUpdatePartyAcctgPreference fromOutput(FinancialsUpdatePartyAcctgPreference output) {
        FinancialsUpdatePartyAcctgPreference service = new FinancialsUpdatePartyAcctgPreference();
    ...
    /**
     * Construct a <code>FinancialsUpdatePartyAcctgPreference</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static FinancialsUpdatePartyAcctgPreference fromInput(Map<String, Object> mapValue) {
        FinancialsUpdatePartyAcctgPreference service = new FinancialsUpdatePartyAcctgPreference();
    ...
    /**
     * Construct a <code>FinancialsUpdatePartyAcctgPreference</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static FinancialsUpdatePartyAcctgPreference fromOutput(Map<String, Object> mapValue) {
        FinancialsUpdatePartyAcctgPreference service = new FinancialsUpdatePartyAcctgPreference();
