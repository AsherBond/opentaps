...
import org.opentaps.domain.base.entities.WorkflowApplicationPk;

/**
 * A FieldBridge for WorkflowApplicationPk.
 */
public class WorkflowApplicationPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkflowApplicationPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkflowApplicationPk id = new WorkflowApplicationPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkflowApplicationPk id = (WorkflowApplicationPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkflowApplicationPk id = (WorkflowApplicationPk) value;
