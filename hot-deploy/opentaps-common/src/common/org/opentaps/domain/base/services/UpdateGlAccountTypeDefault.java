 ...
 */
public class UpdateGlAccountTypeDefault extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateGlAccountTypeDefault</code> from the input values of the given <code>UpdateGlAccountTypeDefault</code>.
     * @param input a <code>UpdateGlAccountTypeDefault</code>
     */
    public static UpdateGlAccountTypeDefault fromInput(UpdateGlAccountTypeDefault input) {
        UpdateGlAccountTypeDefault service = new UpdateGlAccountTypeDefault();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateGlAccountTypeDefault</code> from the output values of the given <code>UpdateGlAccountTypeDefault</code>.
     * @param output a <code>UpdateGlAccountTypeDefault</code>
     */
    public static UpdateGlAccountTypeDefault fromOutput(UpdateGlAccountTypeDefault output) {
        UpdateGlAccountTypeDefault service = new UpdateGlAccountTypeDefault();
    ...
    /**
     * Construct a <code>UpdateGlAccountTypeDefault</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateGlAccountTypeDefault fromInput(Map<String, Object> mapValue) {
        UpdateGlAccountTypeDefault service = new UpdateGlAccountTypeDefault();
    ...
    /**
     * Construct a <code>UpdateGlAccountTypeDefault</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateGlAccountTypeDefault fromOutput(Map<String, Object> mapValue) {
        UpdateGlAccountTypeDefault service = new UpdateGlAccountTypeDefault();
