 ...
 */
public class FinancialsUpdatePayment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>FinancialsUpdatePayment</code> from the input values of the given <code>FinancialsUpdatePayment</code>.
     * @param input a <code>FinancialsUpdatePayment</code>
     */
    public static FinancialsUpdatePayment fromInput(FinancialsUpdatePayment input) {
        FinancialsUpdatePayment service = new FinancialsUpdatePayment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>FinancialsUpdatePayment</code> from the output values of the given <code>FinancialsUpdatePayment</code>.
     * @param output a <code>FinancialsUpdatePayment</code>
     */
    public static FinancialsUpdatePayment fromOutput(FinancialsUpdatePayment output) {
        FinancialsUpdatePayment service = new FinancialsUpdatePayment();
    ...
    /**
     * Construct a <code>FinancialsUpdatePayment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static FinancialsUpdatePayment fromInput(Map<String, Object> mapValue) {
        FinancialsUpdatePayment service = new FinancialsUpdatePayment();
    ...
    /**
     * Construct a <code>FinancialsUpdatePayment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static FinancialsUpdatePayment fromOutput(Map<String, Object> mapValue) {
        FinancialsUpdatePayment service = new FinancialsUpdatePayment();
