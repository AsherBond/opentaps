 ...
 */
public class CreateCustomerDigitalDownloadProduct extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateCustomerDigitalDownloadProduct</code> from the input values of the given <code>CreateCustomerDigitalDownloadProduct</code>.
     * @param input a <code>CreateCustomerDigitalDownloadProduct</code>
     */
    public static CreateCustomerDigitalDownloadProduct fromInput(CreateCustomerDigitalDownloadProduct input) {
        CreateCustomerDigitalDownloadProduct service = new CreateCustomerDigitalDownloadProduct();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateCustomerDigitalDownloadProduct</code> from the output values of the given <code>CreateCustomerDigitalDownloadProduct</code>.
     * @param output a <code>CreateCustomerDigitalDownloadProduct</code>
     */
    public static CreateCustomerDigitalDownloadProduct fromOutput(CreateCustomerDigitalDownloadProduct output) {
        CreateCustomerDigitalDownloadProduct service = new CreateCustomerDigitalDownloadProduct();
    ...
    /**
     * Construct a <code>CreateCustomerDigitalDownloadProduct</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCustomerDigitalDownloadProduct fromInput(Map<String, Object> mapValue) {
        CreateCustomerDigitalDownloadProduct service = new CreateCustomerDigitalDownloadProduct();
    ...
    /**
     * Construct a <code>CreateCustomerDigitalDownloadProduct</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCustomerDigitalDownloadProduct fromOutput(Map<String, Object> mapValue) {
        CreateCustomerDigitalDownloadProduct service = new CreateCustomerDigitalDownloadProduct();
