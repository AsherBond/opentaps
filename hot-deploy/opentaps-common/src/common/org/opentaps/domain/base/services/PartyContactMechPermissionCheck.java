 ...
 */
public class PartyContactMechPermissionCheck extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PartyContactMechPermissionCheck</code> from the input values of the given <code>PartyContactMechPermissionCheck</code>.
     * @param input a <code>PartyContactMechPermissionCheck</code>
     */
    public static PartyContactMechPermissionCheck fromInput(PartyContactMechPermissionCheck input) {
        PartyContactMechPermissionCheck service = new PartyContactMechPermissionCheck();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PartyContactMechPermissionCheck</code> from the output values of the given <code>PartyContactMechPermissionCheck</code>.
     * @param output a <code>PartyContactMechPermissionCheck</code>
     */
    public static PartyContactMechPermissionCheck fromOutput(PartyContactMechPermissionCheck output) {
        PartyContactMechPermissionCheck service = new PartyContactMechPermissionCheck();
    ...
    /**
     * Construct a <code>PartyContactMechPermissionCheck</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PartyContactMechPermissionCheck fromInput(Map<String, Object> mapValue) {
        PartyContactMechPermissionCheck service = new PartyContactMechPermissionCheck();
    ...
    /**
     * Construct a <code>PartyContactMechPermissionCheck</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PartyContactMechPermissionCheck fromOutput(Map<String, Object> mapValue) {
        PartyContactMechPermissionCheck service = new PartyContactMechPermissionCheck();
