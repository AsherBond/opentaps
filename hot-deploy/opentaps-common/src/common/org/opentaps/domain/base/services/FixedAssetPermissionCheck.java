 ...
 */
public class FixedAssetPermissionCheck extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>FixedAssetPermissionCheck</code> from the input values of the given <code>FixedAssetPermissionCheck</code>.
     * @param input a <code>FixedAssetPermissionCheck</code>
     */
    public static FixedAssetPermissionCheck fromInput(FixedAssetPermissionCheck input) {
        FixedAssetPermissionCheck service = new FixedAssetPermissionCheck();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>FixedAssetPermissionCheck</code> from the output values of the given <code>FixedAssetPermissionCheck</code>.
     * @param output a <code>FixedAssetPermissionCheck</code>
     */
    public static FixedAssetPermissionCheck fromOutput(FixedAssetPermissionCheck output) {
        FixedAssetPermissionCheck service = new FixedAssetPermissionCheck();
    ...
    /**
     * Construct a <code>FixedAssetPermissionCheck</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static FixedAssetPermissionCheck fromInput(Map<String, Object> mapValue) {
        FixedAssetPermissionCheck service = new FixedAssetPermissionCheck();
    ...
    /**
     * Construct a <code>FixedAssetPermissionCheck</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static FixedAssetPermissionCheck fromOutput(Map<String, Object> mapValue) {
        FixedAssetPermissionCheck service = new FixedAssetPermissionCheck();
