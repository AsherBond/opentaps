 ...
 */
public class UpdateGlAccount extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateGlAccount</code> from the input values of the given <code>UpdateGlAccount</code>.
     * @param input a <code>UpdateGlAccount</code>
     */
    public static UpdateGlAccount fromInput(UpdateGlAccount input) {
        UpdateGlAccount service = new UpdateGlAccount();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateGlAccount</code> from the output values of the given <code>UpdateGlAccount</code>.
     * @param output a <code>UpdateGlAccount</code>
     */
    public static UpdateGlAccount fromOutput(UpdateGlAccount output) {
        UpdateGlAccount service = new UpdateGlAccount();
    ...
    /**
     * Construct a <code>UpdateGlAccount</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateGlAccount fromInput(Map<String, Object> mapValue) {
        UpdateGlAccount service = new UpdateGlAccount();
    ...
    /**
     * Construct a <code>UpdateGlAccount</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateGlAccount fromOutput(Map<String, Object> mapValue) {
        UpdateGlAccount service = new UpdateGlAccount();
