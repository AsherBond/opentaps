 ...
 */
public class SafeAddProductToCategory extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>SafeAddProductToCategory</code> from the input values of the given <code>SafeAddProductToCategory</code>.
     * @param input a <code>SafeAddProductToCategory</code>
     */
    public static SafeAddProductToCategory fromInput(SafeAddProductToCategory input) {
        SafeAddProductToCategory service = new SafeAddProductToCategory();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>SafeAddProductToCategory</code> from the output values of the given <code>SafeAddProductToCategory</code>.
     * @param output a <code>SafeAddProductToCategory</code>
     */
    public static SafeAddProductToCategory fromOutput(SafeAddProductToCategory output) {
        SafeAddProductToCategory service = new SafeAddProductToCategory();
    ...
    /**
     * Construct a <code>SafeAddProductToCategory</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SafeAddProductToCategory fromInput(Map<String, Object> mapValue) {
        SafeAddProductToCategory service = new SafeAddProductToCategory();
    ...
    /**
     * Construct a <code>SafeAddProductToCategory</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SafeAddProductToCategory fromOutput(Map<String, Object> mapValue) {
        SafeAddProductToCategory service = new SafeAddProductToCategory();
