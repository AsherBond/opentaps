 ...
 */
public class CreateContentAssoc extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateContentAssoc</code> from the input values of the given <code>CreateContentAssoc</code>.
     * @param input a <code>CreateContentAssoc</code>
     */
    public static CreateContentAssoc fromInput(CreateContentAssoc input) {
        CreateContentAssoc service = new CreateContentAssoc();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateContentAssoc</code> from the output values of the given <code>CreateContentAssoc</code>.
     * @param output a <code>CreateContentAssoc</code>
     */
    public static CreateContentAssoc fromOutput(CreateContentAssoc output) {
        CreateContentAssoc service = new CreateContentAssoc();
    ...
    /**
     * Construct a <code>CreateContentAssoc</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateContentAssoc fromInput(Map<String, Object> mapValue) {
        CreateContentAssoc service = new CreateContentAssoc();
    ...
    /**
     * Construct a <code>CreateContentAssoc</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateContentAssoc fromOutput(Map<String, Object> mapValue) {
        CreateContentAssoc service = new CreateContentAssoc();
