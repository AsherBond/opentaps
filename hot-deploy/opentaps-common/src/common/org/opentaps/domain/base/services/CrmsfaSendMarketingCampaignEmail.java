 ...
 */
public class CrmsfaSendMarketingCampaignEmail extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaSendMarketingCampaignEmail</code> from the input values of the given <code>CrmsfaSendMarketingCampaignEmail</code>.
     * @param input a <code>CrmsfaSendMarketingCampaignEmail</code>
     */
    public static CrmsfaSendMarketingCampaignEmail fromInput(CrmsfaSendMarketingCampaignEmail input) {
        CrmsfaSendMarketingCampaignEmail service = new CrmsfaSendMarketingCampaignEmail();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaSendMarketingCampaignEmail</code> from the output values of the given <code>CrmsfaSendMarketingCampaignEmail</code>.
     * @param output a <code>CrmsfaSendMarketingCampaignEmail</code>
     */
    public static CrmsfaSendMarketingCampaignEmail fromOutput(CrmsfaSendMarketingCampaignEmail output) {
        CrmsfaSendMarketingCampaignEmail service = new CrmsfaSendMarketingCampaignEmail();
    ...
    /**
     * Construct a <code>CrmsfaSendMarketingCampaignEmail</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaSendMarketingCampaignEmail fromInput(Map<String, Object> mapValue) {
        CrmsfaSendMarketingCampaignEmail service = new CrmsfaSendMarketingCampaignEmail();
    ...
    /**
     * Construct a <code>CrmsfaSendMarketingCampaignEmail</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaSendMarketingCampaignEmail fromOutput(Map<String, Object> mapValue) {
        CrmsfaSendMarketingCampaignEmail service = new CrmsfaSendMarketingCampaignEmail();
