 ...
 */
public class UspsRateInquire extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UspsRateInquire</code> from the input values of the given <code>UspsRateInquire</code>.
     * @param input a <code>UspsRateInquire</code>
     */
    public static UspsRateInquire fromInput(UspsRateInquire input) {
        UspsRateInquire service = new UspsRateInquire();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UspsRateInquire</code> from the output values of the given <code>UspsRateInquire</code>.
     * @param output a <code>UspsRateInquire</code>
     */
    public static UspsRateInquire fromOutput(UspsRateInquire output) {
        UspsRateInquire service = new UspsRateInquire();
    ...
    /**
     * Construct a <code>UspsRateInquire</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UspsRateInquire fromInput(Map<String, Object> mapValue) {
        UspsRateInquire service = new UspsRateInquire();
    ...
    /**
     * Construct a <code>UspsRateInquire</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UspsRateInquire fromOutput(Map<String, Object> mapValue) {
        UspsRateInquire service = new UspsRateInquire();
