 ...
 */
public class CreateGcFulFillmentRecord extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateGcFulFillmentRecord</code> from the input values of the given <code>CreateGcFulFillmentRecord</code>.
     * @param input a <code>CreateGcFulFillmentRecord</code>
     */
    public static CreateGcFulFillmentRecord fromInput(CreateGcFulFillmentRecord input) {
        CreateGcFulFillmentRecord service = new CreateGcFulFillmentRecord();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateGcFulFillmentRecord</code> from the output values of the given <code>CreateGcFulFillmentRecord</code>.
     * @param output a <code>CreateGcFulFillmentRecord</code>
     */
    public static CreateGcFulFillmentRecord fromOutput(CreateGcFulFillmentRecord output) {
        CreateGcFulFillmentRecord service = new CreateGcFulFillmentRecord();
    ...
    /**
     * Construct a <code>CreateGcFulFillmentRecord</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateGcFulFillmentRecord fromInput(Map<String, Object> mapValue) {
        CreateGcFulFillmentRecord service = new CreateGcFulFillmentRecord();
    ...
    /**
     * Construct a <code>CreateGcFulFillmentRecord</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateGcFulFillmentRecord fromOutput(Map<String, Object> mapValue) {
        CreateGcFulFillmentRecord service = new CreateGcFulFillmentRecord();
