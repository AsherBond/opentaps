 ...
 */
public class ClearCommerceCCRefund extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ClearCommerceCCRefund</code> from the input values of the given <code>ClearCommerceCCRefund</code>.
     * @param input a <code>ClearCommerceCCRefund</code>
     */
    public static ClearCommerceCCRefund fromInput(ClearCommerceCCRefund input) {
        ClearCommerceCCRefund service = new ClearCommerceCCRefund();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ClearCommerceCCRefund</code> from the output values of the given <code>ClearCommerceCCRefund</code>.
     * @param output a <code>ClearCommerceCCRefund</code>
     */
    public static ClearCommerceCCRefund fromOutput(ClearCommerceCCRefund output) {
        ClearCommerceCCRefund service = new ClearCommerceCCRefund();
    ...
    /**
     * Construct a <code>ClearCommerceCCRefund</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ClearCommerceCCRefund fromInput(Map<String, Object> mapValue) {
        ClearCommerceCCRefund service = new ClearCommerceCCRefund();
    ...
    /**
     * Construct a <code>ClearCommerceCCRefund</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ClearCommerceCCRefund fromOutput(Map<String, Object> mapValue) {
        ClearCommerceCCRefund service = new ClearCommerceCCRefund();
