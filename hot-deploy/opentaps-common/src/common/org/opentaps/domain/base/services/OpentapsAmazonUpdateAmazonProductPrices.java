 ...
 */
public class OpentapsAmazonUpdateAmazonProductPrices extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsAmazonUpdateAmazonProductPrices</code> from the input values of the given <code>OpentapsAmazonUpdateAmazonProductPrices</code>.
     * @param input a <code>OpentapsAmazonUpdateAmazonProductPrices</code>
     */
    public static OpentapsAmazonUpdateAmazonProductPrices fromInput(OpentapsAmazonUpdateAmazonProductPrices input) {
        OpentapsAmazonUpdateAmazonProductPrices service = new OpentapsAmazonUpdateAmazonProductPrices();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsAmazonUpdateAmazonProductPrices</code> from the output values of the given <code>OpentapsAmazonUpdateAmazonProductPrices</code>.
     * @param output a <code>OpentapsAmazonUpdateAmazonProductPrices</code>
     */
    public static OpentapsAmazonUpdateAmazonProductPrices fromOutput(OpentapsAmazonUpdateAmazonProductPrices output) {
        OpentapsAmazonUpdateAmazonProductPrices service = new OpentapsAmazonUpdateAmazonProductPrices();
    ...
    /**
     * Construct a <code>OpentapsAmazonUpdateAmazonProductPrices</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsAmazonUpdateAmazonProductPrices fromInput(Map<String, Object> mapValue) {
        OpentapsAmazonUpdateAmazonProductPrices service = new OpentapsAmazonUpdateAmazonProductPrices();
    ...
    /**
     * Construct a <code>OpentapsAmazonUpdateAmazonProductPrices</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsAmazonUpdateAmazonProductPrices fromOutput(Map<String, Object> mapValue) {
        OpentapsAmazonUpdateAmazonProductPrices service = new OpentapsAmazonUpdateAmazonProductPrices();
