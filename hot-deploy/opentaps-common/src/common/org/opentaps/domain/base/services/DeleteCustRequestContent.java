 ...
 */
public class DeleteCustRequestContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteCustRequestContent</code> from the input values of the given <code>DeleteCustRequestContent</code>.
     * @param input a <code>DeleteCustRequestContent</code>
     */
    public static DeleteCustRequestContent fromInput(DeleteCustRequestContent input) {
        DeleteCustRequestContent service = new DeleteCustRequestContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteCustRequestContent</code> from the output values of the given <code>DeleteCustRequestContent</code>.
     * @param output a <code>DeleteCustRequestContent</code>
     */
    public static DeleteCustRequestContent fromOutput(DeleteCustRequestContent output) {
        DeleteCustRequestContent service = new DeleteCustRequestContent();
    ...
    /**
     * Construct a <code>DeleteCustRequestContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteCustRequestContent fromInput(Map<String, Object> mapValue) {
        DeleteCustRequestContent service = new DeleteCustRequestContent();
    ...
    /**
     * Construct a <code>DeleteCustRequestContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteCustRequestContent fromOutput(Map<String, Object> mapValue) {
        DeleteCustRequestContent service = new DeleteCustRequestContent();
