 ...
 */
public class CreateProductStorePaymentSetting extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateProductStorePaymentSetting</code> from the input values of the given <code>CreateProductStorePaymentSetting</code>.
     * @param input a <code>CreateProductStorePaymentSetting</code>
     */
    public static CreateProductStorePaymentSetting fromInput(CreateProductStorePaymentSetting input) {
        CreateProductStorePaymentSetting service = new CreateProductStorePaymentSetting();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateProductStorePaymentSetting</code> from the output values of the given <code>CreateProductStorePaymentSetting</code>.
     * @param output a <code>CreateProductStorePaymentSetting</code>
     */
    public static CreateProductStorePaymentSetting fromOutput(CreateProductStorePaymentSetting output) {
        CreateProductStorePaymentSetting service = new CreateProductStorePaymentSetting();
    ...
    /**
     * Construct a <code>CreateProductStorePaymentSetting</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateProductStorePaymentSetting fromInput(Map<String, Object> mapValue) {
        CreateProductStorePaymentSetting service = new CreateProductStorePaymentSetting();
    ...
    /**
     * Construct a <code>CreateProductStorePaymentSetting</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateProductStorePaymentSetting fromOutput(Map<String, Object> mapValue) {
        CreateProductStorePaymentSetting service = new CreateProductStorePaymentSetting();
