 ...
 */
public class CyberSourceCCCredit extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CyberSourceCCCredit</code> from the input values of the given <code>CyberSourceCCCredit</code>.
     * @param input a <code>CyberSourceCCCredit</code>
     */
    public static CyberSourceCCCredit fromInput(CyberSourceCCCredit input) {
        CyberSourceCCCredit service = new CyberSourceCCCredit();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CyberSourceCCCredit</code> from the output values of the given <code>CyberSourceCCCredit</code>.
     * @param output a <code>CyberSourceCCCredit</code>
     */
    public static CyberSourceCCCredit fromOutput(CyberSourceCCCredit output) {
        CyberSourceCCCredit service = new CyberSourceCCCredit();
    ...
    /**
     * Construct a <code>CyberSourceCCCredit</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CyberSourceCCCredit fromInput(Map<String, Object> mapValue) {
        CyberSourceCCCredit service = new CyberSourceCCCredit();
    ...
    /**
     * Construct a <code>CyberSourceCCCredit</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CyberSourceCCCredit fromOutput(Map<String, Object> mapValue) {
        CyberSourceCCCredit service = new CyberSourceCCCredit();
