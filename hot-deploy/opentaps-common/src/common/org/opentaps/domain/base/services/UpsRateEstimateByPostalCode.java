 ...
 */
public class UpsRateEstimateByPostalCode extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpsRateEstimateByPostalCode</code> from the input values of the given <code>UpsRateEstimateByPostalCode</code>.
     * @param input a <code>UpsRateEstimateByPostalCode</code>
     */
    public static UpsRateEstimateByPostalCode fromInput(UpsRateEstimateByPostalCode input) {
        UpsRateEstimateByPostalCode service = new UpsRateEstimateByPostalCode();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpsRateEstimateByPostalCode</code> from the output values of the given <code>UpsRateEstimateByPostalCode</code>.
     * @param output a <code>UpsRateEstimateByPostalCode</code>
     */
    public static UpsRateEstimateByPostalCode fromOutput(UpsRateEstimateByPostalCode output) {
        UpsRateEstimateByPostalCode service = new UpsRateEstimateByPostalCode();
    ...
    /**
     * Construct a <code>UpsRateEstimateByPostalCode</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpsRateEstimateByPostalCode fromInput(Map<String, Object> mapValue) {
        UpsRateEstimateByPostalCode service = new UpsRateEstimateByPostalCode();
    ...
    /**
     * Construct a <code>UpsRateEstimateByPostalCode</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpsRateEstimateByPostalCode fromOutput(Map<String, Object> mapValue) {
        UpsRateEstimateByPostalCode service = new UpsRateEstimateByPostalCode();
