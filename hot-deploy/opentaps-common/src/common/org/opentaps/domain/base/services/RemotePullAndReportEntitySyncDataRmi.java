 ...
 */
public class RemotePullAndReportEntitySyncDataRmi extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemotePullAndReportEntitySyncDataRmi</code> from the input values of the given <code>RemotePullAndReportEntitySyncDataRmi</code>.
     * @param input a <code>RemotePullAndReportEntitySyncDataRmi</code>
     */
    public static RemotePullAndReportEntitySyncDataRmi fromInput(RemotePullAndReportEntitySyncDataRmi input) {
        RemotePullAndReportEntitySyncDataRmi service = new RemotePullAndReportEntitySyncDataRmi();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemotePullAndReportEntitySyncDataRmi</code> from the output values of the given <code>RemotePullAndReportEntitySyncDataRmi</code>.
     * @param output a <code>RemotePullAndReportEntitySyncDataRmi</code>
     */
    public static RemotePullAndReportEntitySyncDataRmi fromOutput(RemotePullAndReportEntitySyncDataRmi output) {
        RemotePullAndReportEntitySyncDataRmi service = new RemotePullAndReportEntitySyncDataRmi();
    ...
    /**
     * Construct a <code>RemotePullAndReportEntitySyncDataRmi</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemotePullAndReportEntitySyncDataRmi fromInput(Map<String, Object> mapValue) {
        RemotePullAndReportEntitySyncDataRmi service = new RemotePullAndReportEntitySyncDataRmi();
    ...
    /**
     * Construct a <code>RemotePullAndReportEntitySyncDataRmi</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemotePullAndReportEntitySyncDataRmi fromOutput(Map<String, Object> mapValue) {
        RemotePullAndReportEntitySyncDataRmi service = new RemotePullAndReportEntitySyncDataRmi();
