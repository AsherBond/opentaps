 ...
 */
public class FinancialsCreatePayment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>FinancialsCreatePayment</code> from the input values of the given <code>FinancialsCreatePayment</code>.
     * @param input a <code>FinancialsCreatePayment</code>
     */
    public static FinancialsCreatePayment fromInput(FinancialsCreatePayment input) {
        FinancialsCreatePayment service = new FinancialsCreatePayment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>FinancialsCreatePayment</code> from the output values of the given <code>FinancialsCreatePayment</code>.
     * @param output a <code>FinancialsCreatePayment</code>
     */
    public static FinancialsCreatePayment fromOutput(FinancialsCreatePayment output) {
        FinancialsCreatePayment service = new FinancialsCreatePayment();
    ...
    /**
     * Construct a <code>FinancialsCreatePayment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static FinancialsCreatePayment fromInput(Map<String, Object> mapValue) {
        FinancialsCreatePayment service = new FinancialsCreatePayment();
    ...
    /**
     * Construct a <code>FinancialsCreatePayment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static FinancialsCreatePayment fromOutput(Map<String, Object> mapValue) {
        FinancialsCreatePayment service = new FinancialsCreatePayment();
