 ...
 */
public class GetAcctgTransAndEntriesByType extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetAcctgTransAndEntriesByType</code> from the input values of the given <code>GetAcctgTransAndEntriesByType</code>.
     * @param input a <code>GetAcctgTransAndEntriesByType</code>
     */
    public static GetAcctgTransAndEntriesByType fromInput(GetAcctgTransAndEntriesByType input) {
        GetAcctgTransAndEntriesByType service = new GetAcctgTransAndEntriesByType();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetAcctgTransAndEntriesByType</code> from the output values of the given <code>GetAcctgTransAndEntriesByType</code>.
     * @param output a <code>GetAcctgTransAndEntriesByType</code>
     */
    public static GetAcctgTransAndEntriesByType fromOutput(GetAcctgTransAndEntriesByType output) {
        GetAcctgTransAndEntriesByType service = new GetAcctgTransAndEntriesByType();
    ...
    /**
     * Construct a <code>GetAcctgTransAndEntriesByType</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetAcctgTransAndEntriesByType fromInput(Map<String, Object> mapValue) {
        GetAcctgTransAndEntriesByType service = new GetAcctgTransAndEntriesByType();
    ...
    /**
     * Construct a <code>GetAcctgTransAndEntriesByType</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetAcctgTransAndEntriesByType fromOutput(Map<String, Object> mapValue) {
        GetAcctgTransAndEntriesByType service = new GetAcctgTransAndEntriesByType();
