 ...
 */
public class GetRequirementsForSupplier extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetRequirementsForSupplier</code> from the input values of the given <code>GetRequirementsForSupplier</code>.
     * @param input a <code>GetRequirementsForSupplier</code>
     */
    public static GetRequirementsForSupplier fromInput(GetRequirementsForSupplier input) {
        GetRequirementsForSupplier service = new GetRequirementsForSupplier();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetRequirementsForSupplier</code> from the output values of the given <code>GetRequirementsForSupplier</code>.
     * @param output a <code>GetRequirementsForSupplier</code>
     */
    public static GetRequirementsForSupplier fromOutput(GetRequirementsForSupplier output) {
        GetRequirementsForSupplier service = new GetRequirementsForSupplier();
    ...
    /**
     * Construct a <code>GetRequirementsForSupplier</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetRequirementsForSupplier fromInput(Map<String, Object> mapValue) {
        GetRequirementsForSupplier service = new GetRequirementsForSupplier();
    ...
    /**
     * Construct a <code>GetRequirementsForSupplier</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetRequirementsForSupplier fromOutput(Map<String, Object> mapValue) {
        GetRequirementsForSupplier service = new GetRequirementsForSupplier();
