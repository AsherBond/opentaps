 ...
 */
public class CrmsfaLogTask extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaLogTask</code> from the input values of the given <code>CrmsfaLogTask</code>.
     * @param input a <code>CrmsfaLogTask</code>
     */
    public static CrmsfaLogTask fromInput(CrmsfaLogTask input) {
        CrmsfaLogTask service = new CrmsfaLogTask();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaLogTask</code> from the output values of the given <code>CrmsfaLogTask</code>.
     * @param output a <code>CrmsfaLogTask</code>
     */
    public static CrmsfaLogTask fromOutput(CrmsfaLogTask output) {
        CrmsfaLogTask service = new CrmsfaLogTask();
    ...
    /**
     * Construct a <code>CrmsfaLogTask</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaLogTask fromInput(Map<String, Object> mapValue) {
        CrmsfaLogTask service = new CrmsfaLogTask();
    ...
    /**
     * Construct a <code>CrmsfaLogTask</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaLogTask fromOutput(Map<String, Object> mapValue) {
        CrmsfaLogTask service = new CrmsfaLogTask();
