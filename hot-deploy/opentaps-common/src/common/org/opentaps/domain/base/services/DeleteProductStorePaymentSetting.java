 ...
 */
public class DeleteProductStorePaymentSetting extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductStorePaymentSetting</code> from the input values of the given <code>DeleteProductStorePaymentSetting</code>.
     * @param input a <code>DeleteProductStorePaymentSetting</code>
     */
    public static DeleteProductStorePaymentSetting fromInput(DeleteProductStorePaymentSetting input) {
        DeleteProductStorePaymentSetting service = new DeleteProductStorePaymentSetting();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteProductStorePaymentSetting</code> from the output values of the given <code>DeleteProductStorePaymentSetting</code>.
     * @param output a <code>DeleteProductStorePaymentSetting</code>
     */
    public static DeleteProductStorePaymentSetting fromOutput(DeleteProductStorePaymentSetting output) {
        DeleteProductStorePaymentSetting service = new DeleteProductStorePaymentSetting();
    ...
    /**
     * Construct a <code>DeleteProductStorePaymentSetting</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductStorePaymentSetting fromInput(Map<String, Object> mapValue) {
        DeleteProductStorePaymentSetting service = new DeleteProductStorePaymentSetting();
    ...
    /**
     * Construct a <code>DeleteProductStorePaymentSetting</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductStorePaymentSetting fromOutput(Map<String, Object> mapValue) {
        DeleteProductStorePaymentSetting service = new DeleteProductStorePaymentSetting();
