 ...
 */
public class RemoteStoreEntitySyncDataRmi extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemoteStoreEntitySyncDataRmi</code> from the input values of the given <code>RemoteStoreEntitySyncDataRmi</code>.
     * @param input a <code>RemoteStoreEntitySyncDataRmi</code>
     */
    public static RemoteStoreEntitySyncDataRmi fromInput(RemoteStoreEntitySyncDataRmi input) {
        RemoteStoreEntitySyncDataRmi service = new RemoteStoreEntitySyncDataRmi();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemoteStoreEntitySyncDataRmi</code> from the output values of the given <code>RemoteStoreEntitySyncDataRmi</code>.
     * @param output a <code>RemoteStoreEntitySyncDataRmi</code>
     */
    public static RemoteStoreEntitySyncDataRmi fromOutput(RemoteStoreEntitySyncDataRmi output) {
        RemoteStoreEntitySyncDataRmi service = new RemoteStoreEntitySyncDataRmi();
    ...
    /**
     * Construct a <code>RemoteStoreEntitySyncDataRmi</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoteStoreEntitySyncDataRmi fromInput(Map<String, Object> mapValue) {
        RemoteStoreEntitySyncDataRmi service = new RemoteStoreEntitySyncDataRmi();
    ...
    /**
     * Construct a <code>RemoteStoreEntitySyncDataRmi</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoteStoreEntitySyncDataRmi fromOutput(Map<String, Object> mapValue) {
        RemoteStoreEntitySyncDataRmi service = new RemoteStoreEntitySyncDataRmi();
