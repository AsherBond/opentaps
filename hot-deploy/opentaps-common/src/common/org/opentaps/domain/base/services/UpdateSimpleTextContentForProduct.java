 ...
 */
public class UpdateSimpleTextContentForProduct extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateSimpleTextContentForProduct</code> from the input values of the given <code>UpdateSimpleTextContentForProduct</code>.
     * @param input a <code>UpdateSimpleTextContentForProduct</code>
     */
    public static UpdateSimpleTextContentForProduct fromInput(UpdateSimpleTextContentForProduct input) {
        UpdateSimpleTextContentForProduct service = new UpdateSimpleTextContentForProduct();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateSimpleTextContentForProduct</code> from the output values of the given <code>UpdateSimpleTextContentForProduct</code>.
     * @param output a <code>UpdateSimpleTextContentForProduct</code>
     */
    public static UpdateSimpleTextContentForProduct fromOutput(UpdateSimpleTextContentForProduct output) {
        UpdateSimpleTextContentForProduct service = new UpdateSimpleTextContentForProduct();
    ...
    /**
     * Construct a <code>UpdateSimpleTextContentForProduct</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateSimpleTextContentForProduct fromInput(Map<String, Object> mapValue) {
        UpdateSimpleTextContentForProduct service = new UpdateSimpleTextContentForProduct();
    ...
    /**
     * Construct a <code>UpdateSimpleTextContentForProduct</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateSimpleTextContentForProduct fromOutput(Map<String, Object> mapValue) {
        UpdateSimpleTextContentForProduct service = new UpdateSimpleTextContentForProduct();
