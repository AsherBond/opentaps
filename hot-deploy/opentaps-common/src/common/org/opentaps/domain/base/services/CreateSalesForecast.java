 ...
 */
public class CreateSalesForecast extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateSalesForecast</code> from the input values of the given <code>CreateSalesForecast</code>.
     * @param input a <code>CreateSalesForecast</code>
     */
    public static CreateSalesForecast fromInput(CreateSalesForecast input) {
        CreateSalesForecast service = new CreateSalesForecast();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateSalesForecast</code> from the output values of the given <code>CreateSalesForecast</code>.
     * @param output a <code>CreateSalesForecast</code>
     */
    public static CreateSalesForecast fromOutput(CreateSalesForecast output) {
        CreateSalesForecast service = new CreateSalesForecast();
    ...
    /**
     * Construct a <code>CreateSalesForecast</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateSalesForecast fromInput(Map<String, Object> mapValue) {
        CreateSalesForecast service = new CreateSalesForecast();
    ...
    /**
     * Construct a <code>CreateSalesForecast</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateSalesForecast fromOutput(Map<String, Object> mapValue) {
        CreateSalesForecast service = new CreateSalesForecast();
