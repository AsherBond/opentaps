 ...
 */
public class CreatePartyTextContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyTextContent</code> from the input values of the given <code>CreatePartyTextContent</code>.
     * @param input a <code>CreatePartyTextContent</code>
     */
    public static CreatePartyTextContent fromInput(CreatePartyTextContent input) {
        CreatePartyTextContent service = new CreatePartyTextContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePartyTextContent</code> from the output values of the given <code>CreatePartyTextContent</code>.
     * @param output a <code>CreatePartyTextContent</code>
     */
    public static CreatePartyTextContent fromOutput(CreatePartyTextContent output) {
        CreatePartyTextContent service = new CreatePartyTextContent();
    ...
    /**
     * Construct a <code>CreatePartyTextContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyTextContent fromInput(Map<String, Object> mapValue) {
        CreatePartyTextContent service = new CreatePartyTextContent();
    ...
    /**
     * Construct a <code>CreatePartyTextContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyTextContent fromOutput(Map<String, Object> mapValue) {
        CreatePartyTextContent service = new CreatePartyTextContent();
