 ...
 */
public class UpdateProductFeatureGroupAppl extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateProductFeatureGroupAppl</code> from the input values of the given <code>UpdateProductFeatureGroupAppl</code>.
     * @param input a <code>UpdateProductFeatureGroupAppl</code>
     */
    public static UpdateProductFeatureGroupAppl fromInput(UpdateProductFeatureGroupAppl input) {
        UpdateProductFeatureGroupAppl service = new UpdateProductFeatureGroupAppl();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateProductFeatureGroupAppl</code> from the output values of the given <code>UpdateProductFeatureGroupAppl</code>.
     * @param output a <code>UpdateProductFeatureGroupAppl</code>
     */
    public static UpdateProductFeatureGroupAppl fromOutput(UpdateProductFeatureGroupAppl output) {
        UpdateProductFeatureGroupAppl service = new UpdateProductFeatureGroupAppl();
    ...
    /**
     * Construct a <code>UpdateProductFeatureGroupAppl</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateProductFeatureGroupAppl fromInput(Map<String, Object> mapValue) {
        UpdateProductFeatureGroupAppl service = new UpdateProductFeatureGroupAppl();
    ...
    /**
     * Construct a <code>UpdateProductFeatureGroupAppl</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateProductFeatureGroupAppl fromOutput(Map<String, Object> mapValue) {
        UpdateProductFeatureGroupAppl service = new UpdateProductFeatureGroupAppl();
