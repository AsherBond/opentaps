 ...
 */
public class ProductionRunTaskProduce extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ProductionRunTaskProduce</code> from the input values of the given <code>ProductionRunTaskProduce</code>.
     * @param input a <code>ProductionRunTaskProduce</code>
     */
    public static ProductionRunTaskProduce fromInput(ProductionRunTaskProduce input) {
        ProductionRunTaskProduce service = new ProductionRunTaskProduce();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ProductionRunTaskProduce</code> from the output values of the given <code>ProductionRunTaskProduce</code>.
     * @param output a <code>ProductionRunTaskProduce</code>
     */
    public static ProductionRunTaskProduce fromOutput(ProductionRunTaskProduce output) {
        ProductionRunTaskProduce service = new ProductionRunTaskProduce();
    ...
    /**
     * Construct a <code>ProductionRunTaskProduce</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ProductionRunTaskProduce fromInput(Map<String, Object> mapValue) {
        ProductionRunTaskProduce service = new ProductionRunTaskProduce();
    ...
    /**
     * Construct a <code>ProductionRunTaskProduce</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ProductionRunTaskProduce fromOutput(Map<String, Object> mapValue) {
        ProductionRunTaskProduce service = new ProductionRunTaskProduce();
