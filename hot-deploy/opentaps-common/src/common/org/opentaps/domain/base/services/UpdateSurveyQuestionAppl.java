 ...
 */
public class UpdateSurveyQuestionAppl extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateSurveyQuestionAppl</code> from the input values of the given <code>UpdateSurveyQuestionAppl</code>.
     * @param input a <code>UpdateSurveyQuestionAppl</code>
     */
    public static UpdateSurveyQuestionAppl fromInput(UpdateSurveyQuestionAppl input) {
        UpdateSurveyQuestionAppl service = new UpdateSurveyQuestionAppl();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateSurveyQuestionAppl</code> from the output values of the given <code>UpdateSurveyQuestionAppl</code>.
     * @param output a <code>UpdateSurveyQuestionAppl</code>
     */
    public static UpdateSurveyQuestionAppl fromOutput(UpdateSurveyQuestionAppl output) {
        UpdateSurveyQuestionAppl service = new UpdateSurveyQuestionAppl();
    ...
    /**
     * Construct a <code>UpdateSurveyQuestionAppl</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateSurveyQuestionAppl fromInput(Map<String, Object> mapValue) {
        UpdateSurveyQuestionAppl service = new UpdateSurveyQuestionAppl();
    ...
    /**
     * Construct a <code>UpdateSurveyQuestionAppl</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateSurveyQuestionAppl fromOutput(Map<String, Object> mapValue) {
        UpdateSurveyQuestionAppl service = new UpdateSurveyQuestionAppl();
