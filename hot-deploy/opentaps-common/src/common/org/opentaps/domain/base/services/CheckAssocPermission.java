 ...
 */
public class CheckAssocPermission extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CheckAssocPermission</code> from the input values of the given <code>CheckAssocPermission</code>.
     * @param input a <code>CheckAssocPermission</code>
     */
    public static CheckAssocPermission fromInput(CheckAssocPermission input) {
        CheckAssocPermission service = new CheckAssocPermission();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CheckAssocPermission</code> from the output values of the given <code>CheckAssocPermission</code>.
     * @param output a <code>CheckAssocPermission</code>
     */
    public static CheckAssocPermission fromOutput(CheckAssocPermission output) {
        CheckAssocPermission service = new CheckAssocPermission();
    ...
    /**
     * Construct a <code>CheckAssocPermission</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CheckAssocPermission fromInput(Map<String, Object> mapValue) {
        CheckAssocPermission service = new CheckAssocPermission();
    ...
    /**
     * Construct a <code>CheckAssocPermission</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CheckAssocPermission fromOutput(Map<String, Object> mapValue) {
        CheckAssocPermission service = new CheckAssocPermission();
