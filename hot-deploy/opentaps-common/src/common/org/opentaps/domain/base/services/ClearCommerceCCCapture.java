 ...
 */
public class ClearCommerceCCCapture extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ClearCommerceCCCapture</code> from the input values of the given <code>ClearCommerceCCCapture</code>.
     * @param input a <code>ClearCommerceCCCapture</code>
     */
    public static ClearCommerceCCCapture fromInput(ClearCommerceCCCapture input) {
        ClearCommerceCCCapture service = new ClearCommerceCCCapture();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ClearCommerceCCCapture</code> from the output values of the given <code>ClearCommerceCCCapture</code>.
     * @param output a <code>ClearCommerceCCCapture</code>
     */
    public static ClearCommerceCCCapture fromOutput(ClearCommerceCCCapture output) {
        ClearCommerceCCCapture service = new ClearCommerceCCCapture();
    ...
    /**
     * Construct a <code>ClearCommerceCCCapture</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ClearCommerceCCCapture fromInput(Map<String, Object> mapValue) {
        ClearCommerceCCCapture service = new ClearCommerceCCCapture();
    ...
    /**
     * Construct a <code>ClearCommerceCCCapture</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ClearCommerceCCCapture fromOutput(Map<String, Object> mapValue) {
        ClearCommerceCCCapture service = new ClearCommerceCCCapture();
