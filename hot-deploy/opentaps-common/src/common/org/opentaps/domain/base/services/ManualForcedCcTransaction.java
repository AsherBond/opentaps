 ...
 */
public class ManualForcedCcTransaction extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ManualForcedCcTransaction</code> from the input values of the given <code>ManualForcedCcTransaction</code>.
     * @param input a <code>ManualForcedCcTransaction</code>
     */
    public static ManualForcedCcTransaction fromInput(ManualForcedCcTransaction input) {
        ManualForcedCcTransaction service = new ManualForcedCcTransaction();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ManualForcedCcTransaction</code> from the output values of the given <code>ManualForcedCcTransaction</code>.
     * @param output a <code>ManualForcedCcTransaction</code>
     */
    public static ManualForcedCcTransaction fromOutput(ManualForcedCcTransaction output) {
        ManualForcedCcTransaction service = new ManualForcedCcTransaction();
    ...
    /**
     * Construct a <code>ManualForcedCcTransaction</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ManualForcedCcTransaction fromInput(Map<String, Object> mapValue) {
        ManualForcedCcTransaction service = new ManualForcedCcTransaction();
    ...
    /**
     * Construct a <code>ManualForcedCcTransaction</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ManualForcedCcTransaction fromOutput(Map<String, Object> mapValue) {
        ManualForcedCcTransaction service = new ManualForcedCcTransaction();
