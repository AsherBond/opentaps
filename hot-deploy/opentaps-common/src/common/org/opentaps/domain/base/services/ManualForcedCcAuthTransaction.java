 ...
 */
public class ManualForcedCcAuthTransaction extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ManualForcedCcAuthTransaction</code> from the input values of the given <code>ManualForcedCcAuthTransaction</code>.
     * @param input a <code>ManualForcedCcAuthTransaction</code>
     */
    public static ManualForcedCcAuthTransaction fromInput(ManualForcedCcAuthTransaction input) {
        ManualForcedCcAuthTransaction service = new ManualForcedCcAuthTransaction();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ManualForcedCcAuthTransaction</code> from the output values of the given <code>ManualForcedCcAuthTransaction</code>.
     * @param output a <code>ManualForcedCcAuthTransaction</code>
     */
    public static ManualForcedCcAuthTransaction fromOutput(ManualForcedCcAuthTransaction output) {
        ManualForcedCcAuthTransaction service = new ManualForcedCcAuthTransaction();
    ...
    /**
     * Construct a <code>ManualForcedCcAuthTransaction</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ManualForcedCcAuthTransaction fromInput(Map<String, Object> mapValue) {
        ManualForcedCcAuthTransaction service = new ManualForcedCcAuthTransaction();
    ...
    /**
     * Construct a <code>ManualForcedCcAuthTransaction</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ManualForcedCcAuthTransaction fromOutput(Map<String, Object> mapValue) {
        ManualForcedCcAuthTransaction service = new ManualForcedCcAuthTransaction();
