 ...
 */
public class ClearCommerceCCRelease extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ClearCommerceCCRelease</code> from the input values of the given <code>ClearCommerceCCRelease</code>.
     * @param input a <code>ClearCommerceCCRelease</code>
     */
    public static ClearCommerceCCRelease fromInput(ClearCommerceCCRelease input) {
        ClearCommerceCCRelease service = new ClearCommerceCCRelease();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ClearCommerceCCRelease</code> from the output values of the given <code>ClearCommerceCCRelease</code>.
     * @param output a <code>ClearCommerceCCRelease</code>
     */
    public static ClearCommerceCCRelease fromOutput(ClearCommerceCCRelease output) {
        ClearCommerceCCRelease service = new ClearCommerceCCRelease();
    ...
    /**
     * Construct a <code>ClearCommerceCCRelease</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ClearCommerceCCRelease fromInput(Map<String, Object> mapValue) {
        ClearCommerceCCRelease service = new ClearCommerceCCRelease();
    ...
    /**
     * Construct a <code>ClearCommerceCCRelease</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ClearCommerceCCRelease fromOutput(Map<String, Object> mapValue) {
        ClearCommerceCCRelease service = new ClearCommerceCCRelease();
