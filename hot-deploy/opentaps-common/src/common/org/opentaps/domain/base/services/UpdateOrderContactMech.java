 ...
 */
public class UpdateOrderContactMech extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateOrderContactMech</code> from the input values of the given <code>UpdateOrderContactMech</code>.
     * @param input a <code>UpdateOrderContactMech</code>
     */
    public static UpdateOrderContactMech fromInput(UpdateOrderContactMech input) {
        UpdateOrderContactMech service = new UpdateOrderContactMech();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateOrderContactMech</code> from the output values of the given <code>UpdateOrderContactMech</code>.
     * @param output a <code>UpdateOrderContactMech</code>
     */
    public static UpdateOrderContactMech fromOutput(UpdateOrderContactMech output) {
        UpdateOrderContactMech service = new UpdateOrderContactMech();
    ...
    /**
     * Construct a <code>UpdateOrderContactMech</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateOrderContactMech fromInput(Map<String, Object> mapValue) {
        UpdateOrderContactMech service = new UpdateOrderContactMech();
    ...
    /**
     * Construct a <code>UpdateOrderContactMech</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateOrderContactMech fromOutput(Map<String, Object> mapValue) {
        UpdateOrderContactMech service = new UpdateOrderContactMech();
