 ...
 */
public class CreateAcctgTransForWorkEffortIssuance extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateAcctgTransForWorkEffortIssuance</code> from the input values of the given <code>CreateAcctgTransForWorkEffortIssuance</code>.
     * @param input a <code>CreateAcctgTransForWorkEffortIssuance</code>
     */
    public static CreateAcctgTransForWorkEffortIssuance fromInput(CreateAcctgTransForWorkEffortIssuance input) {
        CreateAcctgTransForWorkEffortIssuance service = new CreateAcctgTransForWorkEffortIssuance();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateAcctgTransForWorkEffortIssuance</code> from the output values of the given <code>CreateAcctgTransForWorkEffortIssuance</code>.
     * @param output a <code>CreateAcctgTransForWorkEffortIssuance</code>
     */
    public static CreateAcctgTransForWorkEffortIssuance fromOutput(CreateAcctgTransForWorkEffortIssuance output) {
        CreateAcctgTransForWorkEffortIssuance service = new CreateAcctgTransForWorkEffortIssuance();
    ...
    /**
     * Construct a <code>CreateAcctgTransForWorkEffortIssuance</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateAcctgTransForWorkEffortIssuance fromInput(Map<String, Object> mapValue) {
        CreateAcctgTransForWorkEffortIssuance service = new CreateAcctgTransForWorkEffortIssuance();
    ...
    /**
     * Construct a <code>CreateAcctgTransForWorkEffortIssuance</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateAcctgTransForWorkEffortIssuance fromOutput(Map<String, Object> mapValue) {
        CreateAcctgTransForWorkEffortIssuance service = new CreateAcctgTransForWorkEffortIssuance();
