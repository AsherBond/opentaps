 ...
 */
public class UploadPartyContentFile extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UploadPartyContentFile</code> from the input values of the given <code>UploadPartyContentFile</code>.
     * @param input a <code>UploadPartyContentFile</code>
     */
    public static UploadPartyContentFile fromInput(UploadPartyContentFile input) {
        UploadPartyContentFile service = new UploadPartyContentFile();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UploadPartyContentFile</code> from the output values of the given <code>UploadPartyContentFile</code>.
     * @param output a <code>UploadPartyContentFile</code>
     */
    public static UploadPartyContentFile fromOutput(UploadPartyContentFile output) {
        UploadPartyContentFile service = new UploadPartyContentFile();
    ...
    /**
     * Construct a <code>UploadPartyContentFile</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UploadPartyContentFile fromInput(Map<String, Object> mapValue) {
        UploadPartyContentFile service = new UploadPartyContentFile();
    ...
    /**
     * Construct a <code>UploadPartyContentFile</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UploadPartyContentFile fromOutput(Map<String, Object> mapValue) {
        UploadPartyContentFile service = new UploadPartyContentFile();
