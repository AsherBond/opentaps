 ...
 */
public class CreateMrpEvent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateMrpEvent</code> from the input values of the given <code>CreateMrpEvent</code>.
     * @param input a <code>CreateMrpEvent</code>
     */
    public static CreateMrpEvent fromInput(CreateMrpEvent input) {
        CreateMrpEvent service = new CreateMrpEvent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateMrpEvent</code> from the output values of the given <code>CreateMrpEvent</code>.
     * @param output a <code>CreateMrpEvent</code>
     */
    public static CreateMrpEvent fromOutput(CreateMrpEvent output) {
        CreateMrpEvent service = new CreateMrpEvent();
    ...
    /**
     * Construct a <code>CreateMrpEvent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateMrpEvent fromInput(Map<String, Object> mapValue) {
        CreateMrpEvent service = new CreateMrpEvent();
    ...
    /**
     * Construct a <code>CreateMrpEvent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateMrpEvent fromOutput(Map<String, Object> mapValue) {
        CreateMrpEvent service = new CreateMrpEvent();
