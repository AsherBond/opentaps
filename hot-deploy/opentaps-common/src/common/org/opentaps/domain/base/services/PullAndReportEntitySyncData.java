 ...
 */
public class PullAndReportEntitySyncData extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PullAndReportEntitySyncData</code> from the input values of the given <code>PullAndReportEntitySyncData</code>.
     * @param input a <code>PullAndReportEntitySyncData</code>
     */
    public static PullAndReportEntitySyncData fromInput(PullAndReportEntitySyncData input) {
        PullAndReportEntitySyncData service = new PullAndReportEntitySyncData();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PullAndReportEntitySyncData</code> from the output values of the given <code>PullAndReportEntitySyncData</code>.
     * @param output a <code>PullAndReportEntitySyncData</code>
     */
    public static PullAndReportEntitySyncData fromOutput(PullAndReportEntitySyncData output) {
        PullAndReportEntitySyncData service = new PullAndReportEntitySyncData();
    ...
    /**
     * Construct a <code>PullAndReportEntitySyncData</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PullAndReportEntitySyncData fromInput(Map<String, Object> mapValue) {
        PullAndReportEntitySyncData service = new PullAndReportEntitySyncData();
    ...
    /**
     * Construct a <code>PullAndReportEntitySyncData</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PullAndReportEntitySyncData fromOutput(Map<String, Object> mapValue) {
        PullAndReportEntitySyncData service = new PullAndReportEntitySyncData();
