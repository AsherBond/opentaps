 ...
 */
public class DeleteProductPaymentMethodType extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductPaymentMethodType</code> from the input values of the given <code>DeleteProductPaymentMethodType</code>.
     * @param input a <code>DeleteProductPaymentMethodType</code>
     */
    public static DeleteProductPaymentMethodType fromInput(DeleteProductPaymentMethodType input) {
        DeleteProductPaymentMethodType service = new DeleteProductPaymentMethodType();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteProductPaymentMethodType</code> from the output values of the given <code>DeleteProductPaymentMethodType</code>.
     * @param output a <code>DeleteProductPaymentMethodType</code>
     */
    public static DeleteProductPaymentMethodType fromOutput(DeleteProductPaymentMethodType output) {
        DeleteProductPaymentMethodType service = new DeleteProductPaymentMethodType();
    ...
    /**
     * Construct a <code>DeleteProductPaymentMethodType</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductPaymentMethodType fromInput(Map<String, Object> mapValue) {
        DeleteProductPaymentMethodType service = new DeleteProductPaymentMethodType();
    ...
    /**
     * Construct a <code>DeleteProductPaymentMethodType</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductPaymentMethodType fromOutput(Map<String, Object> mapValue) {
        DeleteProductPaymentMethodType service = new DeleteProductPaymentMethodType();
