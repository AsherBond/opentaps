 ...
 */
public class OagisReceiveSyncInventory extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OagisReceiveSyncInventory</code> from the input values of the given <code>OagisReceiveSyncInventory</code>.
     * @param input a <code>OagisReceiveSyncInventory</code>
     */
    public static OagisReceiveSyncInventory fromInput(OagisReceiveSyncInventory input) {
        OagisReceiveSyncInventory service = new OagisReceiveSyncInventory();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OagisReceiveSyncInventory</code> from the output values of the given <code>OagisReceiveSyncInventory</code>.
     * @param output a <code>OagisReceiveSyncInventory</code>
     */
    public static OagisReceiveSyncInventory fromOutput(OagisReceiveSyncInventory output) {
        OagisReceiveSyncInventory service = new OagisReceiveSyncInventory();
    ...
    /**
     * Construct a <code>OagisReceiveSyncInventory</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OagisReceiveSyncInventory fromInput(Map<String, Object> mapValue) {
        OagisReceiveSyncInventory service = new OagisReceiveSyncInventory();
    ...
    /**
     * Construct a <code>OagisReceiveSyncInventory</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OagisReceiveSyncInventory fromOutput(Map<String, Object> mapValue) {
        OagisReceiveSyncInventory service = new OagisReceiveSyncInventory();
