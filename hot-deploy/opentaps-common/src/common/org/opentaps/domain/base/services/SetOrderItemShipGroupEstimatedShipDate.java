 ...
 */
public class SetOrderItemShipGroupEstimatedShipDate extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>SetOrderItemShipGroupEstimatedShipDate</code> from the input values of the given <code>SetOrderItemShipGroupEstimatedShipDate</code>.
     * @param input a <code>SetOrderItemShipGroupEstimatedShipDate</code>
     */
    public static SetOrderItemShipGroupEstimatedShipDate fromInput(SetOrderItemShipGroupEstimatedShipDate input) {
        SetOrderItemShipGroupEstimatedShipDate service = new SetOrderItemShipGroupEstimatedShipDate();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>SetOrderItemShipGroupEstimatedShipDate</code> from the output values of the given <code>SetOrderItemShipGroupEstimatedShipDate</code>.
     * @param output a <code>SetOrderItemShipGroupEstimatedShipDate</code>
     */
    public static SetOrderItemShipGroupEstimatedShipDate fromOutput(SetOrderItemShipGroupEstimatedShipDate output) {
        SetOrderItemShipGroupEstimatedShipDate service = new SetOrderItemShipGroupEstimatedShipDate();
    ...
    /**
     * Construct a <code>SetOrderItemShipGroupEstimatedShipDate</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SetOrderItemShipGroupEstimatedShipDate fromInput(Map<String, Object> mapValue) {
        SetOrderItemShipGroupEstimatedShipDate service = new SetOrderItemShipGroupEstimatedShipDate();
    ...
    /**
     * Construct a <code>SetOrderItemShipGroupEstimatedShipDate</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SetOrderItemShipGroupEstimatedShipDate fromOutput(Map<String, Object> mapValue) {
        SetOrderItemShipGroupEstimatedShipDate service = new SetOrderItemShipGroupEstimatedShipDate();
