 ...
 */
public class UpdatePostalAddressAndPurposes extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdatePostalAddressAndPurposes</code> from the input values of the given <code>UpdatePostalAddressAndPurposes</code>.
     * @param input a <code>UpdatePostalAddressAndPurposes</code>
     */
    public static UpdatePostalAddressAndPurposes fromInput(UpdatePostalAddressAndPurposes input) {
        UpdatePostalAddressAndPurposes service = new UpdatePostalAddressAndPurposes();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdatePostalAddressAndPurposes</code> from the output values of the given <code>UpdatePostalAddressAndPurposes</code>.
     * @param output a <code>UpdatePostalAddressAndPurposes</code>
     */
    public static UpdatePostalAddressAndPurposes fromOutput(UpdatePostalAddressAndPurposes output) {
        UpdatePostalAddressAndPurposes service = new UpdatePostalAddressAndPurposes();
    ...
    /**
     * Construct a <code>UpdatePostalAddressAndPurposes</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdatePostalAddressAndPurposes fromInput(Map<String, Object> mapValue) {
        UpdatePostalAddressAndPurposes service = new UpdatePostalAddressAndPurposes();
    ...
    /**
     * Construct a <code>UpdatePostalAddressAndPurposes</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdatePostalAddressAndPurposes fromOutput(Map<String, Object> mapValue) {
        UpdatePostalAddressAndPurposes service = new UpdatePostalAddressAndPurposes();
