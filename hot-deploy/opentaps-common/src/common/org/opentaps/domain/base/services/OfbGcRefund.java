 ...
 */
public class OfbGcRefund extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OfbGcRefund</code> from the input values of the given <code>OfbGcRefund</code>.
     * @param input a <code>OfbGcRefund</code>
     */
    public static OfbGcRefund fromInput(OfbGcRefund input) {
        OfbGcRefund service = new OfbGcRefund();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OfbGcRefund</code> from the output values of the given <code>OfbGcRefund</code>.
     * @param output a <code>OfbGcRefund</code>
     */
    public static OfbGcRefund fromOutput(OfbGcRefund output) {
        OfbGcRefund service = new OfbGcRefund();
    ...
    /**
     * Construct a <code>OfbGcRefund</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OfbGcRefund fromInput(Map<String, Object> mapValue) {
        OfbGcRefund service = new OfbGcRefund();
    ...
    /**
     * Construct a <code>OfbGcRefund</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OfbGcRefund fromOutput(Map<String, Object> mapValue) {
        OfbGcRefund service = new OfbGcRefund();
