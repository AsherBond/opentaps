 ...
 */
public class CreateEntitySyncHistory extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateEntitySyncHistory</code> from the input values of the given <code>CreateEntitySyncHistory</code>.
     * @param input a <code>CreateEntitySyncHistory</code>
     */
    public static CreateEntitySyncHistory fromInput(CreateEntitySyncHistory input) {
        CreateEntitySyncHistory service = new CreateEntitySyncHistory();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateEntitySyncHistory</code> from the output values of the given <code>CreateEntitySyncHistory</code>.
     * @param output a <code>CreateEntitySyncHistory</code>
     */
    public static CreateEntitySyncHistory fromOutput(CreateEntitySyncHistory output) {
        CreateEntitySyncHistory service = new CreateEntitySyncHistory();
    ...
    /**
     * Construct a <code>CreateEntitySyncHistory</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateEntitySyncHistory fromInput(Map<String, Object> mapValue) {
        CreateEntitySyncHistory service = new CreateEntitySyncHistory();
    ...
    /**
     * Construct a <code>CreateEntitySyncHistory</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateEntitySyncHistory fromOutput(Map<String, Object> mapValue) {
        CreateEntitySyncHistory service = new CreateEntitySyncHistory();
