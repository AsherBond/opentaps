 ...
 */
public class DeleteProductStoreVendorShipment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductStoreVendorShipment</code> from the input values of the given <code>DeleteProductStoreVendorShipment</code>.
     * @param input a <code>DeleteProductStoreVendorShipment</code>
     */
    public static DeleteProductStoreVendorShipment fromInput(DeleteProductStoreVendorShipment input) {
        DeleteProductStoreVendorShipment service = new DeleteProductStoreVendorShipment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteProductStoreVendorShipment</code> from the output values of the given <code>DeleteProductStoreVendorShipment</code>.
     * @param output a <code>DeleteProductStoreVendorShipment</code>
     */
    public static DeleteProductStoreVendorShipment fromOutput(DeleteProductStoreVendorShipment output) {
        DeleteProductStoreVendorShipment service = new DeleteProductStoreVendorShipment();
    ...
    /**
     * Construct a <code>DeleteProductStoreVendorShipment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductStoreVendorShipment fromInput(Map<String, Object> mapValue) {
        DeleteProductStoreVendorShipment service = new DeleteProductStoreVendorShipment();
    ...
    /**
     * Construct a <code>DeleteProductStoreVendorShipment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductStoreVendorShipment fromOutput(Map<String, Object> mapValue) {
        DeleteProductStoreVendorShipment service = new DeleteProductStoreVendorShipment();
