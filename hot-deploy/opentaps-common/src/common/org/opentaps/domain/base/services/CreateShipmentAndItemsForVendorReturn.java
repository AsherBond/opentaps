 ...
 */
public class CreateShipmentAndItemsForVendorReturn extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateShipmentAndItemsForVendorReturn</code> from the input values of the given <code>CreateShipmentAndItemsForVendorReturn</code>.
     * @param input a <code>CreateShipmentAndItemsForVendorReturn</code>
     */
    public static CreateShipmentAndItemsForVendorReturn fromInput(CreateShipmentAndItemsForVendorReturn input) {
        CreateShipmentAndItemsForVendorReturn service = new CreateShipmentAndItemsForVendorReturn();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateShipmentAndItemsForVendorReturn</code> from the output values of the given <code>CreateShipmentAndItemsForVendorReturn</code>.
     * @param output a <code>CreateShipmentAndItemsForVendorReturn</code>
     */
    public static CreateShipmentAndItemsForVendorReturn fromOutput(CreateShipmentAndItemsForVendorReturn output) {
        CreateShipmentAndItemsForVendorReturn service = new CreateShipmentAndItemsForVendorReturn();
    ...
    /**
     * Construct a <code>CreateShipmentAndItemsForVendorReturn</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateShipmentAndItemsForVendorReturn fromInput(Map<String, Object> mapValue) {
        CreateShipmentAndItemsForVendorReturn service = new CreateShipmentAndItemsForVendorReturn();
    ...
    /**
     * Construct a <code>CreateShipmentAndItemsForVendorReturn</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateShipmentAndItemsForVendorReturn fromOutput(Map<String, Object> mapValue) {
        CreateShipmentAndItemsForVendorReturn service = new CreateShipmentAndItemsForVendorReturn();
