 ...
 */
public class CreateFinAccountForStore extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateFinAccountForStore</code> from the input values of the given <code>CreateFinAccountForStore</code>.
     * @param input a <code>CreateFinAccountForStore</code>
     */
    public static CreateFinAccountForStore fromInput(CreateFinAccountForStore input) {
        CreateFinAccountForStore service = new CreateFinAccountForStore();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateFinAccountForStore</code> from the output values of the given <code>CreateFinAccountForStore</code>.
     * @param output a <code>CreateFinAccountForStore</code>
     */
    public static CreateFinAccountForStore fromOutput(CreateFinAccountForStore output) {
        CreateFinAccountForStore service = new CreateFinAccountForStore();
    ...
    /**
     * Construct a <code>CreateFinAccountForStore</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFinAccountForStore fromInput(Map<String, Object> mapValue) {
        CreateFinAccountForStore service = new CreateFinAccountForStore();
    ...
    /**
     * Construct a <code>CreateFinAccountForStore</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFinAccountForStore fromOutput(Map<String, Object> mapValue) {
        CreateFinAccountForStore service = new CreateFinAccountForStore();
