 ...
 */
public class AcctgCostPermissionCheck extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AcctgCostPermissionCheck</code> from the input values of the given <code>AcctgCostPermissionCheck</code>.
     * @param input a <code>AcctgCostPermissionCheck</code>
     */
    public static AcctgCostPermissionCheck fromInput(AcctgCostPermissionCheck input) {
        AcctgCostPermissionCheck service = new AcctgCostPermissionCheck();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AcctgCostPermissionCheck</code> from the output values of the given <code>AcctgCostPermissionCheck</code>.
     * @param output a <code>AcctgCostPermissionCheck</code>
     */
    public static AcctgCostPermissionCheck fromOutput(AcctgCostPermissionCheck output) {
        AcctgCostPermissionCheck service = new AcctgCostPermissionCheck();
    ...
    /**
     * Construct a <code>AcctgCostPermissionCheck</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgCostPermissionCheck fromInput(Map<String, Object> mapValue) {
        AcctgCostPermissionCheck service = new AcctgCostPermissionCheck();
    ...
    /**
     * Construct a <code>AcctgCostPermissionCheck</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgCostPermissionCheck fromOutput(Map<String, Object> mapValue) {
        AcctgCostPermissionCheck service = new AcctgCostPermissionCheck();
