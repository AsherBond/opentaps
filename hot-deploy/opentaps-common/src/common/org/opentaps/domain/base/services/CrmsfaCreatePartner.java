 ...
 */
public class CrmsfaCreatePartner extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreatePartner</code> from the input values of the given <code>CrmsfaCreatePartner</code>.
     * @param input a <code>CrmsfaCreatePartner</code>
     */
    public static CrmsfaCreatePartner fromInput(CrmsfaCreatePartner input) {
        CrmsfaCreatePartner service = new CrmsfaCreatePartner();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaCreatePartner</code> from the output values of the given <code>CrmsfaCreatePartner</code>.
     * @param output a <code>CrmsfaCreatePartner</code>
     */
    public static CrmsfaCreatePartner fromOutput(CrmsfaCreatePartner output) {
        CrmsfaCreatePartner service = new CrmsfaCreatePartner();
    ...
    /**
     * Construct a <code>CrmsfaCreatePartner</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreatePartner fromInput(Map<String, Object> mapValue) {
        CrmsfaCreatePartner service = new CrmsfaCreatePartner();
    ...
    /**
     * Construct a <code>CrmsfaCreatePartner</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreatePartner fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreatePartner service = new CrmsfaCreatePartner();
