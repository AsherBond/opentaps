 ...
 */
public class LoadCartForUpdate extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>LoadCartForUpdate</code> from the input values of the given <code>LoadCartForUpdate</code>.
     * @param input a <code>LoadCartForUpdate</code>
     */
    public static LoadCartForUpdate fromInput(LoadCartForUpdate input) {
        LoadCartForUpdate service = new LoadCartForUpdate();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>LoadCartForUpdate</code> from the output values of the given <code>LoadCartForUpdate</code>.
     * @param output a <code>LoadCartForUpdate</code>
     */
    public static LoadCartForUpdate fromOutput(LoadCartForUpdate output) {
        LoadCartForUpdate service = new LoadCartForUpdate();
    ...
    /**
     * Construct a <code>LoadCartForUpdate</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static LoadCartForUpdate fromInput(Map<String, Object> mapValue) {
        LoadCartForUpdate service = new LoadCartForUpdate();
    ...
    /**
     * Construct a <code>LoadCartForUpdate</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static LoadCartForUpdate fromOutput(Map<String, Object> mapValue) {
        LoadCartForUpdate service = new LoadCartForUpdate();
