 ...
 */
public class CreatePartyContactMech extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyContactMech</code> from the input values of the given <code>CreatePartyContactMech</code>.
     * @param input a <code>CreatePartyContactMech</code>
     */
    public static CreatePartyContactMech fromInput(CreatePartyContactMech input) {
        CreatePartyContactMech service = new CreatePartyContactMech();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePartyContactMech</code> from the output values of the given <code>CreatePartyContactMech</code>.
     * @param output a <code>CreatePartyContactMech</code>
     */
    public static CreatePartyContactMech fromOutput(CreatePartyContactMech output) {
        CreatePartyContactMech service = new CreatePartyContactMech();
    ...
    /**
     * Construct a <code>CreatePartyContactMech</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyContactMech fromInput(Map<String, Object> mapValue) {
        CreatePartyContactMech service = new CreatePartyContactMech();
    ...
    /**
     * Construct a <code>CreatePartyContactMech</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyContactMech fromOutput(Map<String, Object> mapValue) {
        CreatePartyContactMech service = new CreatePartyContactMech();
