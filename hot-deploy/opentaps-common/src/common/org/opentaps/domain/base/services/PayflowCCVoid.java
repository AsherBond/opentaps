 ...
 */
public class PayflowCCVoid extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PayflowCCVoid</code> from the input values of the given <code>PayflowCCVoid</code>.
     * @param input a <code>PayflowCCVoid</code>
     */
    public static PayflowCCVoid fromInput(PayflowCCVoid input) {
        PayflowCCVoid service = new PayflowCCVoid();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PayflowCCVoid</code> from the output values of the given <code>PayflowCCVoid</code>.
     * @param output a <code>PayflowCCVoid</code>
     */
    public static PayflowCCVoid fromOutput(PayflowCCVoid output) {
        PayflowCCVoid service = new PayflowCCVoid();
    ...
    /**
     * Construct a <code>PayflowCCVoid</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PayflowCCVoid fromInput(Map<String, Object> mapValue) {
        PayflowCCVoid service = new PayflowCCVoid();
    ...
    /**
     * Construct a <code>PayflowCCVoid</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PayflowCCVoid fromOutput(Map<String, Object> mapValue) {
        PayflowCCVoid service = new PayflowCCVoid();
