 ...
 */
public class RemoveContentAssoc extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemoveContentAssoc</code> from the input values of the given <code>RemoveContentAssoc</code>.
     * @param input a <code>RemoveContentAssoc</code>
     */
    public static RemoveContentAssoc fromInput(RemoveContentAssoc input) {
        RemoveContentAssoc service = new RemoveContentAssoc();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemoveContentAssoc</code> from the output values of the given <code>RemoveContentAssoc</code>.
     * @param output a <code>RemoveContentAssoc</code>
     */
    public static RemoveContentAssoc fromOutput(RemoveContentAssoc output) {
        RemoveContentAssoc service = new RemoveContentAssoc();
    ...
    /**
     * Construct a <code>RemoveContentAssoc</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveContentAssoc fromInput(Map<String, Object> mapValue) {
        RemoveContentAssoc service = new RemoveContentAssoc();
    ...
    /**
     * Construct a <code>RemoveContentAssoc</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveContentAssoc fromOutput(Map<String, Object> mapValue) {
        RemoveContentAssoc service = new RemoveContentAssoc();
