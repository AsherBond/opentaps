 ...
 */
public class OpentapsDemoCarrierShipmentEstimate extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsDemoCarrierShipmentEstimate</code> from the input values of the given <code>OpentapsDemoCarrierShipmentEstimate</code>.
     * @param input a <code>OpentapsDemoCarrierShipmentEstimate</code>
     */
    public static OpentapsDemoCarrierShipmentEstimate fromInput(OpentapsDemoCarrierShipmentEstimate input) {
        OpentapsDemoCarrierShipmentEstimate service = new OpentapsDemoCarrierShipmentEstimate();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsDemoCarrierShipmentEstimate</code> from the output values of the given <code>OpentapsDemoCarrierShipmentEstimate</code>.
     * @param output a <code>OpentapsDemoCarrierShipmentEstimate</code>
     */
    public static OpentapsDemoCarrierShipmentEstimate fromOutput(OpentapsDemoCarrierShipmentEstimate output) {
        OpentapsDemoCarrierShipmentEstimate service = new OpentapsDemoCarrierShipmentEstimate();
    ...
    /**
     * Construct a <code>OpentapsDemoCarrierShipmentEstimate</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsDemoCarrierShipmentEstimate fromInput(Map<String, Object> mapValue) {
        OpentapsDemoCarrierShipmentEstimate service = new OpentapsDemoCarrierShipmentEstimate();
    ...
    /**
     * Construct a <code>OpentapsDemoCarrierShipmentEstimate</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsDemoCarrierShipmentEstimate fromOutput(Map<String, Object> mapValue) {
        OpentapsDemoCarrierShipmentEstimate service = new OpentapsDemoCarrierShipmentEstimate();
