 ...
 */
public class BasicGeneralLedgerPermissionCheck extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>BasicGeneralLedgerPermissionCheck</code> from the input values of the given <code>BasicGeneralLedgerPermissionCheck</code>.
     * @param input a <code>BasicGeneralLedgerPermissionCheck</code>
     */
    public static BasicGeneralLedgerPermissionCheck fromInput(BasicGeneralLedgerPermissionCheck input) {
        BasicGeneralLedgerPermissionCheck service = new BasicGeneralLedgerPermissionCheck();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>BasicGeneralLedgerPermissionCheck</code> from the output values of the given <code>BasicGeneralLedgerPermissionCheck</code>.
     * @param output a <code>BasicGeneralLedgerPermissionCheck</code>
     */
    public static BasicGeneralLedgerPermissionCheck fromOutput(BasicGeneralLedgerPermissionCheck output) {
        BasicGeneralLedgerPermissionCheck service = new BasicGeneralLedgerPermissionCheck();
    ...
    /**
     * Construct a <code>BasicGeneralLedgerPermissionCheck</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static BasicGeneralLedgerPermissionCheck fromInput(Map<String, Object> mapValue) {
        BasicGeneralLedgerPermissionCheck service = new BasicGeneralLedgerPermissionCheck();
    ...
    /**
     * Construct a <code>BasicGeneralLedgerPermissionCheck</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static BasicGeneralLedgerPermissionCheck fromOutput(Map<String, Object> mapValue) {
        BasicGeneralLedgerPermissionCheck service = new BasicGeneralLedgerPermissionCheck();
