 ...
 */
public class LinkPartyRecord extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>LinkPartyRecord</code> from the input values of the given <code>LinkPartyRecord</code>.
     * @param input a <code>LinkPartyRecord</code>
     */
    public static LinkPartyRecord fromInput(LinkPartyRecord input) {
        LinkPartyRecord service = new LinkPartyRecord();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>LinkPartyRecord</code> from the output values of the given <code>LinkPartyRecord</code>.
     * @param output a <code>LinkPartyRecord</code>
     */
    public static LinkPartyRecord fromOutput(LinkPartyRecord output) {
        LinkPartyRecord service = new LinkPartyRecord();
    ...
    /**
     * Construct a <code>LinkPartyRecord</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static LinkPartyRecord fromInput(Map<String, Object> mapValue) {
        LinkPartyRecord service = new LinkPartyRecord();
    ...
    /**
     * Construct a <code>LinkPartyRecord</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static LinkPartyRecord fromOutput(Map<String, Object> mapValue) {
        LinkPartyRecord service = new LinkPartyRecord();
