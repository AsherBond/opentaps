 ...
 */
public class GetPartiesByRelationship extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetPartiesByRelationship</code> from the input values of the given <code>GetPartiesByRelationship</code>.
     * @param input a <code>GetPartiesByRelationship</code>
     */
    public static GetPartiesByRelationship fromInput(GetPartiesByRelationship input) {
        GetPartiesByRelationship service = new GetPartiesByRelationship();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetPartiesByRelationship</code> from the output values of the given <code>GetPartiesByRelationship</code>.
     * @param output a <code>GetPartiesByRelationship</code>
     */
    public static GetPartiesByRelationship fromOutput(GetPartiesByRelationship output) {
        GetPartiesByRelationship service = new GetPartiesByRelationship();
    ...
    /**
     * Construct a <code>GetPartiesByRelationship</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetPartiesByRelationship fromInput(Map<String, Object> mapValue) {
        GetPartiesByRelationship service = new GetPartiesByRelationship();
    ...
    /**
     * Construct a <code>GetPartiesByRelationship</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetPartiesByRelationship fromOutput(Map<String, Object> mapValue) {
        GetPartiesByRelationship service = new GetPartiesByRelationship();
