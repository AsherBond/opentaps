 ...
 */
public class CreateArticleContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateArticleContent</code> from the input values of the given <code>CreateArticleContent</code>.
     * @param input a <code>CreateArticleContent</code>
     */
    public static CreateArticleContent fromInput(CreateArticleContent input) {
        CreateArticleContent service = new CreateArticleContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateArticleContent</code> from the output values of the given <code>CreateArticleContent</code>.
     * @param output a <code>CreateArticleContent</code>
     */
    public static CreateArticleContent fromOutput(CreateArticleContent output) {
        CreateArticleContent service = new CreateArticleContent();
    ...
    /**
     * Construct a <code>CreateArticleContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateArticleContent fromInput(Map<String, Object> mapValue) {
        CreateArticleContent service = new CreateArticleContent();
    ...
    /**
     * Construct a <code>CreateArticleContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateArticleContent fromOutput(Map<String, Object> mapValue) {
        CreateArticleContent service = new CreateArticleContent();
