 ...
 */
public class CreateContentRevisionItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateContentRevisionItem</code> from the input values of the given <code>CreateContentRevisionItem</code>.
     * @param input a <code>CreateContentRevisionItem</code>
     */
    public static CreateContentRevisionItem fromInput(CreateContentRevisionItem input) {
        CreateContentRevisionItem service = new CreateContentRevisionItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateContentRevisionItem</code> from the output values of the given <code>CreateContentRevisionItem</code>.
     * @param output a <code>CreateContentRevisionItem</code>
     */
    public static CreateContentRevisionItem fromOutput(CreateContentRevisionItem output) {
        CreateContentRevisionItem service = new CreateContentRevisionItem();
    ...
    /**
     * Construct a <code>CreateContentRevisionItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateContentRevisionItem fromInput(Map<String, Object> mapValue) {
        CreateContentRevisionItem service = new CreateContentRevisionItem();
    ...
    /**
     * Construct a <code>CreateContentRevisionItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateContentRevisionItem fromOutput(Map<String, Object> mapValue) {
        CreateContentRevisionItem service = new CreateContentRevisionItem();
