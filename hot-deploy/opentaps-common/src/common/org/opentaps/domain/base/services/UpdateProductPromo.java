 ...
 */
public class UpdateProductPromo extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateProductPromo</code> from the input values of the given <code>UpdateProductPromo</code>.
     * @param input a <code>UpdateProductPromo</code>
     */
    public static UpdateProductPromo fromInput(UpdateProductPromo input) {
        UpdateProductPromo service = new UpdateProductPromo();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateProductPromo</code> from the output values of the given <code>UpdateProductPromo</code>.
     * @param output a <code>UpdateProductPromo</code>
     */
    public static UpdateProductPromo fromOutput(UpdateProductPromo output) {
        UpdateProductPromo service = new UpdateProductPromo();
    ...
    /**
     * Construct a <code>UpdateProductPromo</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateProductPromo fromInput(Map<String, Object> mapValue) {
        UpdateProductPromo service = new UpdateProductPromo();
    ...
    /**
     * Construct a <code>UpdateProductPromo</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateProductPromo fromOutput(Map<String, Object> mapValue) {
        UpdateProductPromo service = new UpdateProductPromo();
