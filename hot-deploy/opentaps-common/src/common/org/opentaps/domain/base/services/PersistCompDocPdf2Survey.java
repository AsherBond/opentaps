 ...
 */
public class PersistCompDocPdf2Survey extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PersistCompDocPdf2Survey</code> from the input values of the given <code>PersistCompDocPdf2Survey</code>.
     * @param input a <code>PersistCompDocPdf2Survey</code>
     */
    public static PersistCompDocPdf2Survey fromInput(PersistCompDocPdf2Survey input) {
        PersistCompDocPdf2Survey service = new PersistCompDocPdf2Survey();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PersistCompDocPdf2Survey</code> from the output values of the given <code>PersistCompDocPdf2Survey</code>.
     * @param output a <code>PersistCompDocPdf2Survey</code>
     */
    public static PersistCompDocPdf2Survey fromOutput(PersistCompDocPdf2Survey output) {
        PersistCompDocPdf2Survey service = new PersistCompDocPdf2Survey();
    ...
    /**
     * Construct a <code>PersistCompDocPdf2Survey</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PersistCompDocPdf2Survey fromInput(Map<String, Object> mapValue) {
        PersistCompDocPdf2Survey service = new PersistCompDocPdf2Survey();
    ...
    /**
     * Construct a <code>PersistCompDocPdf2Survey</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PersistCompDocPdf2Survey fromOutput(Map<String, Object> mapValue) {
        PersistCompDocPdf2Survey service = new PersistCompDocPdf2Survey();
