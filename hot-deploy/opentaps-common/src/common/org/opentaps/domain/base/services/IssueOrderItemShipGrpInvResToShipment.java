 ...
 */
public class IssueOrderItemShipGrpInvResToShipment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>IssueOrderItemShipGrpInvResToShipment</code> from the input values of the given <code>IssueOrderItemShipGrpInvResToShipment</code>.
     * @param input a <code>IssueOrderItemShipGrpInvResToShipment</code>
     */
    public static IssueOrderItemShipGrpInvResToShipment fromInput(IssueOrderItemShipGrpInvResToShipment input) {
        IssueOrderItemShipGrpInvResToShipment service = new IssueOrderItemShipGrpInvResToShipment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>IssueOrderItemShipGrpInvResToShipment</code> from the output values of the given <code>IssueOrderItemShipGrpInvResToShipment</code>.
     * @param output a <code>IssueOrderItemShipGrpInvResToShipment</code>
     */
    public static IssueOrderItemShipGrpInvResToShipment fromOutput(IssueOrderItemShipGrpInvResToShipment output) {
        IssueOrderItemShipGrpInvResToShipment service = new IssueOrderItemShipGrpInvResToShipment();
    ...
    /**
     * Construct a <code>IssueOrderItemShipGrpInvResToShipment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static IssueOrderItemShipGrpInvResToShipment fromInput(Map<String, Object> mapValue) {
        IssueOrderItemShipGrpInvResToShipment service = new IssueOrderItemShipGrpInvResToShipment();
    ...
    /**
     * Construct a <code>IssueOrderItemShipGrpInvResToShipment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static IssueOrderItemShipGrpInvResToShipment fromOutput(Map<String, Object> mapValue) {
        IssueOrderItemShipGrpInvResToShipment service = new IssueOrderItemShipGrpInvResToShipment();
