 ...
 */
public class GetComparativeCashFlowStatement extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetComparativeCashFlowStatement</code> from the input values of the given <code>GetComparativeCashFlowStatement</code>.
     * @param input a <code>GetComparativeCashFlowStatement</code>
     */
    public static GetComparativeCashFlowStatement fromInput(GetComparativeCashFlowStatement input) {
        GetComparativeCashFlowStatement service = new GetComparativeCashFlowStatement();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetComparativeCashFlowStatement</code> from the output values of the given <code>GetComparativeCashFlowStatement</code>.
     * @param output a <code>GetComparativeCashFlowStatement</code>
     */
    public static GetComparativeCashFlowStatement fromOutput(GetComparativeCashFlowStatement output) {
        GetComparativeCashFlowStatement service = new GetComparativeCashFlowStatement();
    ...
    /**
     * Construct a <code>GetComparativeCashFlowStatement</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetComparativeCashFlowStatement fromInput(Map<String, Object> mapValue) {
        GetComparativeCashFlowStatement service = new GetComparativeCashFlowStatement();
    ...
    /**
     * Construct a <code>GetComparativeCashFlowStatement</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetComparativeCashFlowStatement fromOutput(Map<String, Object> mapValue) {
        GetComparativeCashFlowStatement service = new GetComparativeCashFlowStatement();
