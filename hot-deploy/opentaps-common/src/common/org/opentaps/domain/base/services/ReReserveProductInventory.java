 ...
 */
public class ReReserveProductInventory extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ReReserveProductInventory</code> from the input values of the given <code>ReReserveProductInventory</code>.
     * @param input a <code>ReReserveProductInventory</code>
     */
    public static ReReserveProductInventory fromInput(ReReserveProductInventory input) {
        ReReserveProductInventory service = new ReReserveProductInventory();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ReReserveProductInventory</code> from the output values of the given <code>ReReserveProductInventory</code>.
     * @param output a <code>ReReserveProductInventory</code>
     */
    public static ReReserveProductInventory fromOutput(ReReserveProductInventory output) {
        ReReserveProductInventory service = new ReReserveProductInventory();
    ...
    /**
     * Construct a <code>ReReserveProductInventory</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ReReserveProductInventory fromInput(Map<String, Object> mapValue) {
        ReReserveProductInventory service = new ReReserveProductInventory();
    ...
    /**
     * Construct a <code>ReReserveProductInventory</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ReReserveProductInventory fromOutput(Map<String, Object> mapValue) {
        ReReserveProductInventory service = new ReReserveProductInventory();
