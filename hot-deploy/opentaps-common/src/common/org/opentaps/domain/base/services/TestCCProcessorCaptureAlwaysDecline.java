 ...
 */
public class TestCCProcessorCaptureAlwaysDecline extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>TestCCProcessorCaptureAlwaysDecline</code> from the input values of the given <code>TestCCProcessorCaptureAlwaysDecline</code>.
     * @param input a <code>TestCCProcessorCaptureAlwaysDecline</code>
     */
    public static TestCCProcessorCaptureAlwaysDecline fromInput(TestCCProcessorCaptureAlwaysDecline input) {
        TestCCProcessorCaptureAlwaysDecline service = new TestCCProcessorCaptureAlwaysDecline();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>TestCCProcessorCaptureAlwaysDecline</code> from the output values of the given <code>TestCCProcessorCaptureAlwaysDecline</code>.
     * @param output a <code>TestCCProcessorCaptureAlwaysDecline</code>
     */
    public static TestCCProcessorCaptureAlwaysDecline fromOutput(TestCCProcessorCaptureAlwaysDecline output) {
        TestCCProcessorCaptureAlwaysDecline service = new TestCCProcessorCaptureAlwaysDecline();
    ...
    /**
     * Construct a <code>TestCCProcessorCaptureAlwaysDecline</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static TestCCProcessorCaptureAlwaysDecline fromInput(Map<String, Object> mapValue) {
        TestCCProcessorCaptureAlwaysDecline service = new TestCCProcessorCaptureAlwaysDecline();
    ...
    /**
     * Construct a <code>TestCCProcessorCaptureAlwaysDecline</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static TestCCProcessorCaptureAlwaysDecline fromOutput(Map<String, Object> mapValue) {
        TestCCProcessorCaptureAlwaysDecline service = new TestCCProcessorCaptureAlwaysDecline();
