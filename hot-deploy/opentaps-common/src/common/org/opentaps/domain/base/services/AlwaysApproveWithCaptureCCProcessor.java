 ...
 */
public class AlwaysApproveWithCaptureCCProcessor extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AlwaysApproveWithCaptureCCProcessor</code> from the input values of the given <code>AlwaysApproveWithCaptureCCProcessor</code>.
     * @param input a <code>AlwaysApproveWithCaptureCCProcessor</code>
     */
    public static AlwaysApproveWithCaptureCCProcessor fromInput(AlwaysApproveWithCaptureCCProcessor input) {
        AlwaysApproveWithCaptureCCProcessor service = new AlwaysApproveWithCaptureCCProcessor();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AlwaysApproveWithCaptureCCProcessor</code> from the output values of the given <code>AlwaysApproveWithCaptureCCProcessor</code>.
     * @param output a <code>AlwaysApproveWithCaptureCCProcessor</code>
     */
    public static AlwaysApproveWithCaptureCCProcessor fromOutput(AlwaysApproveWithCaptureCCProcessor output) {
        AlwaysApproveWithCaptureCCProcessor service = new AlwaysApproveWithCaptureCCProcessor();
    ...
    /**
     * Construct a <code>AlwaysApproveWithCaptureCCProcessor</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AlwaysApproveWithCaptureCCProcessor fromInput(Map<String, Object> mapValue) {
        AlwaysApproveWithCaptureCCProcessor service = new AlwaysApproveWithCaptureCCProcessor();
    ...
    /**
     * Construct a <code>AlwaysApproveWithCaptureCCProcessor</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AlwaysApproveWithCaptureCCProcessor fromOutput(Map<String, Object> mapValue) {
        AlwaysApproveWithCaptureCCProcessor service = new AlwaysApproveWithCaptureCCProcessor();
