 ...
 */
public class UpdateProductStorePaymentSetting extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateProductStorePaymentSetting</code> from the input values of the given <code>UpdateProductStorePaymentSetting</code>.
     * @param input a <code>UpdateProductStorePaymentSetting</code>
     */
    public static UpdateProductStorePaymentSetting fromInput(UpdateProductStorePaymentSetting input) {
        UpdateProductStorePaymentSetting service = new UpdateProductStorePaymentSetting();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateProductStorePaymentSetting</code> from the output values of the given <code>UpdateProductStorePaymentSetting</code>.
     * @param output a <code>UpdateProductStorePaymentSetting</code>
     */
    public static UpdateProductStorePaymentSetting fromOutput(UpdateProductStorePaymentSetting output) {
        UpdateProductStorePaymentSetting service = new UpdateProductStorePaymentSetting();
    ...
    /**
     * Construct a <code>UpdateProductStorePaymentSetting</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateProductStorePaymentSetting fromInput(Map<String, Object> mapValue) {
        UpdateProductStorePaymentSetting service = new UpdateProductStorePaymentSetting();
    ...
    /**
     * Construct a <code>UpdateProductStorePaymentSetting</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateProductStorePaymentSetting fromOutput(Map<String, Object> mapValue) {
        UpdateProductStorePaymentSetting service = new UpdateProductStorePaymentSetting();
