...
fieldMapColumns.put("EmploymentAppSourceType", fields);
  ...
  public EmploymentAppSourceType() {
      ...
      this.allFieldsNames.add("employmentAppSourceTypeId");this.allFieldsNames.add("description");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
