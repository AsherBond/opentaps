 ...
 */
public class IssueProductionRunTaskComponent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>IssueProductionRunTaskComponent</code> from the input values of the given <code>IssueProductionRunTaskComponent</code>.
     * @param input a <code>IssueProductionRunTaskComponent</code>
     */
    public static IssueProductionRunTaskComponent fromInput(IssueProductionRunTaskComponent input) {
        IssueProductionRunTaskComponent service = new IssueProductionRunTaskComponent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>IssueProductionRunTaskComponent</code> from the output values of the given <code>IssueProductionRunTaskComponent</code>.
     * @param output a <code>IssueProductionRunTaskComponent</code>
     */
    public static IssueProductionRunTaskComponent fromOutput(IssueProductionRunTaskComponent output) {
        IssueProductionRunTaskComponent service = new IssueProductionRunTaskComponent();
    ...
    /**
     * Construct a <code>IssueProductionRunTaskComponent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static IssueProductionRunTaskComponent fromInput(Map<String, Object> mapValue) {
        IssueProductionRunTaskComponent service = new IssueProductionRunTaskComponent();
    ...
    /**
     * Construct a <code>IssueProductionRunTaskComponent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static IssueProductionRunTaskComponent fromOutput(Map<String, Object> mapValue) {
        IssueProductionRunTaskComponent service = new IssueProductionRunTaskComponent();
