 ...
 */
public class UpdateReturnItemsStatus extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateReturnItemsStatus</code> from the input values of the given <code>UpdateReturnItemsStatus</code>.
     * @param input a <code>UpdateReturnItemsStatus</code>
     */
    public static UpdateReturnItemsStatus fromInput(UpdateReturnItemsStatus input) {
        UpdateReturnItemsStatus service = new UpdateReturnItemsStatus();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateReturnItemsStatus</code> from the output values of the given <code>UpdateReturnItemsStatus</code>.
     * @param output a <code>UpdateReturnItemsStatus</code>
     */
    public static UpdateReturnItemsStatus fromOutput(UpdateReturnItemsStatus output) {
        UpdateReturnItemsStatus service = new UpdateReturnItemsStatus();
    ...
    /**
     * Construct a <code>UpdateReturnItemsStatus</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateReturnItemsStatus fromInput(Map<String, Object> mapValue) {
        UpdateReturnItemsStatus service = new UpdateReturnItemsStatus();
    ...
    /**
     * Construct a <code>UpdateReturnItemsStatus</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateReturnItemsStatus fromOutput(Map<String, Object> mapValue) {
        UpdateReturnItemsStatus service = new UpdateReturnItemsStatus();
