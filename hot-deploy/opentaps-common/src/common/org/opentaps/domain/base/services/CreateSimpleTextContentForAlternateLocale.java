 ...
 */
public class CreateSimpleTextContentForAlternateLocale extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForAlternateLocale</code> from the input values of the given <code>CreateSimpleTextContentForAlternateLocale</code>.
     * @param input a <code>CreateSimpleTextContentForAlternateLocale</code>
     */
    public static CreateSimpleTextContentForAlternateLocale fromInput(CreateSimpleTextContentForAlternateLocale input) {
        CreateSimpleTextContentForAlternateLocale service = new CreateSimpleTextContentForAlternateLocale();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateSimpleTextContentForAlternateLocale</code> from the output values of the given <code>CreateSimpleTextContentForAlternateLocale</code>.
     * @param output a <code>CreateSimpleTextContentForAlternateLocale</code>
     */
    public static CreateSimpleTextContentForAlternateLocale fromOutput(CreateSimpleTextContentForAlternateLocale output) {
        CreateSimpleTextContentForAlternateLocale service = new CreateSimpleTextContentForAlternateLocale();
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForAlternateLocale</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateSimpleTextContentForAlternateLocale fromInput(Map<String, Object> mapValue) {
        CreateSimpleTextContentForAlternateLocale service = new CreateSimpleTextContentForAlternateLocale();
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForAlternateLocale</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateSimpleTextContentForAlternateLocale fromOutput(Map<String, Object> mapValue) {
        CreateSimpleTextContentForAlternateLocale service = new CreateSimpleTextContentForAlternateLocale();
