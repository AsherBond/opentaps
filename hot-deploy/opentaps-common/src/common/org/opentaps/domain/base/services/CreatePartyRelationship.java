 ...
 */
public class CreatePartyRelationship extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyRelationship</code> from the input values of the given <code>CreatePartyRelationship</code>.
     * @param input a <code>CreatePartyRelationship</code>
     */
    public static CreatePartyRelationship fromInput(CreatePartyRelationship input) {
        CreatePartyRelationship service = new CreatePartyRelationship();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePartyRelationship</code> from the output values of the given <code>CreatePartyRelationship</code>.
     * @param output a <code>CreatePartyRelationship</code>
     */
    public static CreatePartyRelationship fromOutput(CreatePartyRelationship output) {
        CreatePartyRelationship service = new CreatePartyRelationship();
    ...
    /**
     * Construct a <code>CreatePartyRelationship</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyRelationship fromInput(Map<String, Object> mapValue) {
        CreatePartyRelationship service = new CreatePartyRelationship();
    ...
    /**
     * Construct a <code>CreatePartyRelationship</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyRelationship fromOutput(Map<String, Object> mapValue) {
        CreatePartyRelationship service = new CreatePartyRelationship();
