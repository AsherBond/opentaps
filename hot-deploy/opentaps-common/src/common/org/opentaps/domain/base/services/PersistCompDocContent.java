 ...
 */
public class PersistCompDocContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PersistCompDocContent</code> from the input values of the given <code>PersistCompDocContent</code>.
     * @param input a <code>PersistCompDocContent</code>
     */
    public static PersistCompDocContent fromInput(PersistCompDocContent input) {
        PersistCompDocContent service = new PersistCompDocContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PersistCompDocContent</code> from the output values of the given <code>PersistCompDocContent</code>.
     * @param output a <code>PersistCompDocContent</code>
     */
    public static PersistCompDocContent fromOutput(PersistCompDocContent output) {
        PersistCompDocContent service = new PersistCompDocContent();
    ...
    /**
     * Construct a <code>PersistCompDocContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PersistCompDocContent fromInput(Map<String, Object> mapValue) {
        PersistCompDocContent service = new PersistCompDocContent();
    ...
    /**
     * Construct a <code>PersistCompDocContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PersistCompDocContent fromOutput(Map<String, Object> mapValue) {
        PersistCompDocContent service = new PersistCompDocContent();
