 ...
 */
public class UpdatePartyEmailAddress extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdatePartyEmailAddress</code> from the input values of the given <code>UpdatePartyEmailAddress</code>.
     * @param input a <code>UpdatePartyEmailAddress</code>
     */
    public static UpdatePartyEmailAddress fromInput(UpdatePartyEmailAddress input) {
        UpdatePartyEmailAddress service = new UpdatePartyEmailAddress();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdatePartyEmailAddress</code> from the output values of the given <code>UpdatePartyEmailAddress</code>.
     * @param output a <code>UpdatePartyEmailAddress</code>
     */
    public static UpdatePartyEmailAddress fromOutput(UpdatePartyEmailAddress output) {
        UpdatePartyEmailAddress service = new UpdatePartyEmailAddress();
    ...
    /**
     * Construct a <code>UpdatePartyEmailAddress</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdatePartyEmailAddress fromInput(Map<String, Object> mapValue) {
        UpdatePartyEmailAddress service = new UpdatePartyEmailAddress();
    ...
    /**
     * Construct a <code>UpdatePartyEmailAddress</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdatePartyEmailAddress fromOutput(Map<String, Object> mapValue) {
        UpdatePartyEmailAddress service = new UpdatePartyEmailAddress();
