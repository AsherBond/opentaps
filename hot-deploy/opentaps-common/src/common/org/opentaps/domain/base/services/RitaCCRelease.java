 ...
 */
public class RitaCCRelease extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RitaCCRelease</code> from the input values of the given <code>RitaCCRelease</code>.
     * @param input a <code>RitaCCRelease</code>
     */
    public static RitaCCRelease fromInput(RitaCCRelease input) {
        RitaCCRelease service = new RitaCCRelease();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RitaCCRelease</code> from the output values of the given <code>RitaCCRelease</code>.
     * @param output a <code>RitaCCRelease</code>
     */
    public static RitaCCRelease fromOutput(RitaCCRelease output) {
        RitaCCRelease service = new RitaCCRelease();
    ...
    /**
     * Construct a <code>RitaCCRelease</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RitaCCRelease fromInput(Map<String, Object> mapValue) {
        RitaCCRelease service = new RitaCCRelease();
    ...
    /**
     * Construct a <code>RitaCCRelease</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RitaCCRelease fromOutput(Map<String, Object> mapValue) {
        RitaCCRelease service = new RitaCCRelease();
