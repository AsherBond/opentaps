 ...
 */
public class DeleteAgreementTerm extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteAgreementTerm</code> from the input values of the given <code>DeleteAgreementTerm</code>.
     * @param input a <code>DeleteAgreementTerm</code>
     */
    public static DeleteAgreementTerm fromInput(DeleteAgreementTerm input) {
        DeleteAgreementTerm service = new DeleteAgreementTerm();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteAgreementTerm</code> from the output values of the given <code>DeleteAgreementTerm</code>.
     * @param output a <code>DeleteAgreementTerm</code>
     */
    public static DeleteAgreementTerm fromOutput(DeleteAgreementTerm output) {
        DeleteAgreementTerm service = new DeleteAgreementTerm();
    ...
    /**
     * Construct a <code>DeleteAgreementTerm</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteAgreementTerm fromInput(Map<String, Object> mapValue) {
        DeleteAgreementTerm service = new DeleteAgreementTerm();
    ...
    /**
     * Construct a <code>DeleteAgreementTerm</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteAgreementTerm fromOutput(Map<String, Object> mapValue) {
        DeleteAgreementTerm service = new DeleteAgreementTerm();
