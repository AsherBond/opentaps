 ...
 */
public class UpdateCreditCardAndAddress extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateCreditCardAndAddress</code> from the input values of the given <code>UpdateCreditCardAndAddress</code>.
     * @param input a <code>UpdateCreditCardAndAddress</code>
     */
    public static UpdateCreditCardAndAddress fromInput(UpdateCreditCardAndAddress input) {
        UpdateCreditCardAndAddress service = new UpdateCreditCardAndAddress();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateCreditCardAndAddress</code> from the output values of the given <code>UpdateCreditCardAndAddress</code>.
     * @param output a <code>UpdateCreditCardAndAddress</code>
     */
    public static UpdateCreditCardAndAddress fromOutput(UpdateCreditCardAndAddress output) {
        UpdateCreditCardAndAddress service = new UpdateCreditCardAndAddress();
    ...
    /**
     * Construct a <code>UpdateCreditCardAndAddress</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateCreditCardAndAddress fromInput(Map<String, Object> mapValue) {
        UpdateCreditCardAndAddress service = new UpdateCreditCardAndAddress();
    ...
    /**
     * Construct a <code>UpdateCreditCardAndAddress</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateCreditCardAndAddress fromOutput(Map<String, Object> mapValue) {
        UpdateCreditCardAndAddress service = new UpdateCreditCardAndAddress();
