 ...
 */
public class UpdateMarketingCampaignRole extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateMarketingCampaignRole</code> from the input values of the given <code>UpdateMarketingCampaignRole</code>.
     * @param input a <code>UpdateMarketingCampaignRole</code>
     */
    public static UpdateMarketingCampaignRole fromInput(UpdateMarketingCampaignRole input) {
        UpdateMarketingCampaignRole service = new UpdateMarketingCampaignRole();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateMarketingCampaignRole</code> from the output values of the given <code>UpdateMarketingCampaignRole</code>.
     * @param output a <code>UpdateMarketingCampaignRole</code>
     */
    public static UpdateMarketingCampaignRole fromOutput(UpdateMarketingCampaignRole output) {
        UpdateMarketingCampaignRole service = new UpdateMarketingCampaignRole();
    ...
    /**
     * Construct a <code>UpdateMarketingCampaignRole</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateMarketingCampaignRole fromInput(Map<String, Object> mapValue) {
        UpdateMarketingCampaignRole service = new UpdateMarketingCampaignRole();
    ...
    /**
     * Construct a <code>UpdateMarketingCampaignRole</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateMarketingCampaignRole fromOutput(Map<String, Object> mapValue) {
        UpdateMarketingCampaignRole service = new UpdateMarketingCampaignRole();
