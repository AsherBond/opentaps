 ...
 */
public class CrmsfaComputeForecastParentPeriod extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaComputeForecastParentPeriod</code> from the input values of the given <code>CrmsfaComputeForecastParentPeriod</code>.
     * @param input a <code>CrmsfaComputeForecastParentPeriod</code>
     */
    public static CrmsfaComputeForecastParentPeriod fromInput(CrmsfaComputeForecastParentPeriod input) {
        CrmsfaComputeForecastParentPeriod service = new CrmsfaComputeForecastParentPeriod();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaComputeForecastParentPeriod</code> from the output values of the given <code>CrmsfaComputeForecastParentPeriod</code>.
     * @param output a <code>CrmsfaComputeForecastParentPeriod</code>
     */
    public static CrmsfaComputeForecastParentPeriod fromOutput(CrmsfaComputeForecastParentPeriod output) {
        CrmsfaComputeForecastParentPeriod service = new CrmsfaComputeForecastParentPeriod();
    ...
    /**
     * Construct a <code>CrmsfaComputeForecastParentPeriod</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaComputeForecastParentPeriod fromInput(Map<String, Object> mapValue) {
        CrmsfaComputeForecastParentPeriod service = new CrmsfaComputeForecastParentPeriod();
    ...
    /**
     * Construct a <code>CrmsfaComputeForecastParentPeriod</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaComputeForecastParentPeriod fromOutput(Map<String, Object> mapValue) {
        CrmsfaComputeForecastParentPeriod service = new CrmsfaComputeForecastParentPeriod();
