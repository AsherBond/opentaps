 ...
 */
public class GetTrialBalanceForDate extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetTrialBalanceForDate</code> from the input values of the given <code>GetTrialBalanceForDate</code>.
     * @param input a <code>GetTrialBalanceForDate</code>
     */
    public static GetTrialBalanceForDate fromInput(GetTrialBalanceForDate input) {
        GetTrialBalanceForDate service = new GetTrialBalanceForDate();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetTrialBalanceForDate</code> from the output values of the given <code>GetTrialBalanceForDate</code>.
     * @param output a <code>GetTrialBalanceForDate</code>
     */
    public static GetTrialBalanceForDate fromOutput(GetTrialBalanceForDate output) {
        GetTrialBalanceForDate service = new GetTrialBalanceForDate();
    ...
    /**
     * Construct a <code>GetTrialBalanceForDate</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetTrialBalanceForDate fromInput(Map<String, Object> mapValue) {
        GetTrialBalanceForDate service = new GetTrialBalanceForDate();
    ...
    /**
     * Construct a <code>GetTrialBalanceForDate</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetTrialBalanceForDate fromOutput(Map<String, Object> mapValue) {
        GetTrialBalanceForDate service = new GetTrialBalanceForDate();
