 ...
 */
public class UpdateSimpleTextContentForCategory extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateSimpleTextContentForCategory</code> from the input values of the given <code>UpdateSimpleTextContentForCategory</code>.
     * @param input a <code>UpdateSimpleTextContentForCategory</code>
     */
    public static UpdateSimpleTextContentForCategory fromInput(UpdateSimpleTextContentForCategory input) {
        UpdateSimpleTextContentForCategory service = new UpdateSimpleTextContentForCategory();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateSimpleTextContentForCategory</code> from the output values of the given <code>UpdateSimpleTextContentForCategory</code>.
     * @param output a <code>UpdateSimpleTextContentForCategory</code>
     */
    public static UpdateSimpleTextContentForCategory fromOutput(UpdateSimpleTextContentForCategory output) {
        UpdateSimpleTextContentForCategory service = new UpdateSimpleTextContentForCategory();
    ...
    /**
     * Construct a <code>UpdateSimpleTextContentForCategory</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateSimpleTextContentForCategory fromInput(Map<String, Object> mapValue) {
        UpdateSimpleTextContentForCategory service = new UpdateSimpleTextContentForCategory();
    ...
    /**
     * Construct a <code>UpdateSimpleTextContentForCategory</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateSimpleTextContentForCategory fromOutput(Map<String, Object> mapValue) {
        UpdateSimpleTextContentForCategory service = new UpdateSimpleTextContentForCategory();
