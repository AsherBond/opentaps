 ...
 */
public class UpdateContactListParty extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateContactListParty</code> from the input values of the given <code>UpdateContactListParty</code>.
     * @param input a <code>UpdateContactListParty</code>
     */
    public static UpdateContactListParty fromInput(UpdateContactListParty input) {
        UpdateContactListParty service = new UpdateContactListParty();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateContactListParty</code> from the output values of the given <code>UpdateContactListParty</code>.
     * @param output a <code>UpdateContactListParty</code>
     */
    public static UpdateContactListParty fromOutput(UpdateContactListParty output) {
        UpdateContactListParty service = new UpdateContactListParty();
    ...
    /**
     * Construct a <code>UpdateContactListParty</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateContactListParty fromInput(Map<String, Object> mapValue) {
        UpdateContactListParty service = new UpdateContactListParty();
    ...
    /**
     * Construct a <code>UpdateContactListParty</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateContactListParty fromOutput(Map<String, Object> mapValue) {
        UpdateContactListParty service = new UpdateContactListParty();
