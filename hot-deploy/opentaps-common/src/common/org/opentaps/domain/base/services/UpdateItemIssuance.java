 ...
 */
public class UpdateItemIssuance extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateItemIssuance</code> from the input values of the given <code>UpdateItemIssuance</code>.
     * @param input a <code>UpdateItemIssuance</code>
     */
    public static UpdateItemIssuance fromInput(UpdateItemIssuance input) {
        UpdateItemIssuance service = new UpdateItemIssuance();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateItemIssuance</code> from the output values of the given <code>UpdateItemIssuance</code>.
     * @param output a <code>UpdateItemIssuance</code>
     */
    public static UpdateItemIssuance fromOutput(UpdateItemIssuance output) {
        UpdateItemIssuance service = new UpdateItemIssuance();
    ...
    /**
     * Construct a <code>UpdateItemIssuance</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateItemIssuance fromInput(Map<String, Object> mapValue) {
        UpdateItemIssuance service = new UpdateItemIssuance();
    ...
    /**
     * Construct a <code>UpdateItemIssuance</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateItemIssuance fromOutput(Map<String, Object> mapValue) {
        UpdateItemIssuance service = new UpdateItemIssuance();
