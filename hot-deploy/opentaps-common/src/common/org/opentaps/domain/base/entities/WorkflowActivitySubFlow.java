...
fieldMapColumns.put("WorkflowActivitySubFlow", fields);
  ...
  public static enum Fields implements EntityFieldInterface<WorkflowActivitySubFlow> {
   ...
   @FieldBridge(impl = org.opentaps.domain.base.entities.bridge.WorkflowActivitySubFlowPkBridge.class)
     private WorkflowActivitySubFlowPk id = new WorkflowActivitySubFlowPk();
   
    /**
     * Auto generated Id accessor.
     * @return <code>WorkflowActivitySubFlowPk</code>
     */
      public WorkflowActivitySubFlowPk getId() {
         return id;
      }
    /**
     * Auto generated Id setter.
     * @param id a <code>WorkflowActivitySubFlowPk</code> value to set
    */   
      public void setId(WorkflowActivitySubFlowPk id) {
         this.id = id;
      }
  ...
  public WorkflowActivitySubFlow() {
      ...
      this.allFieldsNames.add("packageId");this.allFieldsNames.add("packageVersion");this.allFieldsNames.add("processId");this.allFieldsNames.add("processVersion");this.allFieldsNames.add("activityId");this.allFieldsNames.add("actualParameters");this.allFieldsNames.add("subFlowProcessId");this.allFieldsNames.add("subFlowProcessVersion");this.allFieldsNames.add("executionEnumId");this.allFieldsNames.add("lastUpdatedStamp");this.allFieldsNames.add("lastUpdatedTxStamp");this.allFieldsNames.add("createdStamp");this.allFieldsNames.add("createdTxStamp");
