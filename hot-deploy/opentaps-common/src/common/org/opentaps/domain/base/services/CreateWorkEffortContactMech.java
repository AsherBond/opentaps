 ...
 */
public class CreateWorkEffortContactMech extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateWorkEffortContactMech</code> from the input values of the given <code>CreateWorkEffortContactMech</code>.
     * @param input a <code>CreateWorkEffortContactMech</code>
     */
    public static CreateWorkEffortContactMech fromInput(CreateWorkEffortContactMech input) {
        CreateWorkEffortContactMech service = new CreateWorkEffortContactMech();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateWorkEffortContactMech</code> from the output values of the given <code>CreateWorkEffortContactMech</code>.
     * @param output a <code>CreateWorkEffortContactMech</code>
     */
    public static CreateWorkEffortContactMech fromOutput(CreateWorkEffortContactMech output) {
        CreateWorkEffortContactMech service = new CreateWorkEffortContactMech();
    ...
    /**
     * Construct a <code>CreateWorkEffortContactMech</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateWorkEffortContactMech fromInput(Map<String, Object> mapValue) {
        CreateWorkEffortContactMech service = new CreateWorkEffortContactMech();
    ...
    /**
     * Construct a <code>CreateWorkEffortContactMech</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateWorkEffortContactMech fromOutput(Map<String, Object> mapValue) {
        CreateWorkEffortContactMech service = new CreateWorkEffortContactMech();
