 ...
 */
public class UnassignPartyFromWorkEffort extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UnassignPartyFromWorkEffort</code> from the input values of the given <code>UnassignPartyFromWorkEffort</code>.
     * @param input a <code>UnassignPartyFromWorkEffort</code>
     */
    public static UnassignPartyFromWorkEffort fromInput(UnassignPartyFromWorkEffort input) {
        UnassignPartyFromWorkEffort service = new UnassignPartyFromWorkEffort();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UnassignPartyFromWorkEffort</code> from the output values of the given <code>UnassignPartyFromWorkEffort</code>.
     * @param output a <code>UnassignPartyFromWorkEffort</code>
     */
    public static UnassignPartyFromWorkEffort fromOutput(UnassignPartyFromWorkEffort output) {
        UnassignPartyFromWorkEffort service = new UnassignPartyFromWorkEffort();
    ...
    /**
     * Construct a <code>UnassignPartyFromWorkEffort</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UnassignPartyFromWorkEffort fromInput(Map<String, Object> mapValue) {
        UnassignPartyFromWorkEffort service = new UnassignPartyFromWorkEffort();
    ...
    /**
     * Construct a <code>UnassignPartyFromWorkEffort</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UnassignPartyFromWorkEffort fromOutput(Map<String, Object> mapValue) {
        UnassignPartyFromWorkEffort service = new UnassignPartyFromWorkEffort();
