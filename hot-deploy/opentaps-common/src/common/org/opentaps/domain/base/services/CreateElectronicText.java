 ...
 */
public class CreateElectronicText extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateElectronicText</code> from the input values of the given <code>CreateElectronicText</code>.
     * @param input a <code>CreateElectronicText</code>
     */
    public static CreateElectronicText fromInput(CreateElectronicText input) {
        CreateElectronicText service = new CreateElectronicText();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateElectronicText</code> from the output values of the given <code>CreateElectronicText</code>.
     * @param output a <code>CreateElectronicText</code>
     */
    public static CreateElectronicText fromOutput(CreateElectronicText output) {
        CreateElectronicText service = new CreateElectronicText();
    ...
    /**
     * Construct a <code>CreateElectronicText</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateElectronicText fromInput(Map<String, Object> mapValue) {
        CreateElectronicText service = new CreateElectronicText();
    ...
    /**
     * Construct a <code>CreateElectronicText</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateElectronicText fromOutput(Map<String, Object> mapValue) {
        CreateElectronicText service = new CreateElectronicText();
