 ...
 */
public class CalcPackSessionAdditionalShippingCharge extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CalcPackSessionAdditionalShippingCharge</code> from the input values of the given <code>CalcPackSessionAdditionalShippingCharge</code>.
     * @param input a <code>CalcPackSessionAdditionalShippingCharge</code>
     */
    public static CalcPackSessionAdditionalShippingCharge fromInput(CalcPackSessionAdditionalShippingCharge input) {
        CalcPackSessionAdditionalShippingCharge service = new CalcPackSessionAdditionalShippingCharge();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CalcPackSessionAdditionalShippingCharge</code> from the output values of the given <code>CalcPackSessionAdditionalShippingCharge</code>.
     * @param output a <code>CalcPackSessionAdditionalShippingCharge</code>
     */
    public static CalcPackSessionAdditionalShippingCharge fromOutput(CalcPackSessionAdditionalShippingCharge output) {
        CalcPackSessionAdditionalShippingCharge service = new CalcPackSessionAdditionalShippingCharge();
    ...
    /**
     * Construct a <code>CalcPackSessionAdditionalShippingCharge</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CalcPackSessionAdditionalShippingCharge fromInput(Map<String, Object> mapValue) {
        CalcPackSessionAdditionalShippingCharge service = new CalcPackSessionAdditionalShippingCharge();
    ...
    /**
     * Construct a <code>CalcPackSessionAdditionalShippingCharge</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CalcPackSessionAdditionalShippingCharge fromOutput(Map<String, Object> mapValue) {
        CalcPackSessionAdditionalShippingCharge service = new CalcPackSessionAdditionalShippingCharge();
