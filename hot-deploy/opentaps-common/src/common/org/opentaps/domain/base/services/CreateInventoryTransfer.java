 ...
 */
public class CreateInventoryTransfer extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateInventoryTransfer</code> from the input values of the given <code>CreateInventoryTransfer</code>.
     * @param input a <code>CreateInventoryTransfer</code>
     */
    public static CreateInventoryTransfer fromInput(CreateInventoryTransfer input) {
        CreateInventoryTransfer service = new CreateInventoryTransfer();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateInventoryTransfer</code> from the output values of the given <code>CreateInventoryTransfer</code>.
     * @param output a <code>CreateInventoryTransfer</code>
     */
    public static CreateInventoryTransfer fromOutput(CreateInventoryTransfer output) {
        CreateInventoryTransfer service = new CreateInventoryTransfer();
    ...
    /**
     * Construct a <code>CreateInventoryTransfer</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateInventoryTransfer fromInput(Map<String, Object> mapValue) {
        CreateInventoryTransfer service = new CreateInventoryTransfer();
    ...
    /**
     * Construct a <code>CreateInventoryTransfer</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateInventoryTransfer fromOutput(Map<String, Object> mapValue) {
        CreateInventoryTransfer service = new CreateInventoryTransfer();
