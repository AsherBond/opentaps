 ...
 */
public class CreateFile extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateFile</code> from the input values of the given <code>CreateFile</code>.
     * @param input a <code>CreateFile</code>
     */
    public static CreateFile fromInput(CreateFile input) {
        CreateFile service = new CreateFile();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateFile</code> from the output values of the given <code>CreateFile</code>.
     * @param output a <code>CreateFile</code>
     */
    public static CreateFile fromOutput(CreateFile output) {
        CreateFile service = new CreateFile();
    ...
    /**
     * Construct a <code>CreateFile</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFile fromInput(Map<String, Object> mapValue) {
        CreateFile service = new CreateFile();
    ...
    /**
     * Construct a <code>CreateFile</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFile fromOutput(Map<String, Object> mapValue) {
        CreateFile service = new CreateFile();
