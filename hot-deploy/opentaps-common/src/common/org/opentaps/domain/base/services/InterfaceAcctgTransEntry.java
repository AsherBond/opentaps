 ...
 */
public class InterfaceAcctgTransEntry extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>InterfaceAcctgTransEntry</code> from the input values of the given <code>InterfaceAcctgTransEntry</code>.
     * @param input a <code>InterfaceAcctgTransEntry</code>
     */
    public static InterfaceAcctgTransEntry fromInput(InterfaceAcctgTransEntry input) {
        InterfaceAcctgTransEntry service = new InterfaceAcctgTransEntry();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>InterfaceAcctgTransEntry</code> from the output values of the given <code>InterfaceAcctgTransEntry</code>.
     * @param output a <code>InterfaceAcctgTransEntry</code>
     */
    public static InterfaceAcctgTransEntry fromOutput(InterfaceAcctgTransEntry output) {
        InterfaceAcctgTransEntry service = new InterfaceAcctgTransEntry();
    ...
    /**
     * Construct a <code>InterfaceAcctgTransEntry</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static InterfaceAcctgTransEntry fromInput(Map<String, Object> mapValue) {
        InterfaceAcctgTransEntry service = new InterfaceAcctgTransEntry();
    ...
    /**
     * Construct a <code>InterfaceAcctgTransEntry</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static InterfaceAcctgTransEntry fromOutput(Map<String, Object> mapValue) {
        InterfaceAcctgTransEntry service = new InterfaceAcctgTransEntry();
