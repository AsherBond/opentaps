 ...
 */
public class UpdateBillingAccount extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateBillingAccount</code> from the input values of the given <code>UpdateBillingAccount</code>.
     * @param input a <code>UpdateBillingAccount</code>
     */
    public static UpdateBillingAccount fromInput(UpdateBillingAccount input) {
        UpdateBillingAccount service = new UpdateBillingAccount();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateBillingAccount</code> from the output values of the given <code>UpdateBillingAccount</code>.
     * @param output a <code>UpdateBillingAccount</code>
     */
    public static UpdateBillingAccount fromOutput(UpdateBillingAccount output) {
        UpdateBillingAccount service = new UpdateBillingAccount();
    ...
    /**
     * Construct a <code>UpdateBillingAccount</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateBillingAccount fromInput(Map<String, Object> mapValue) {
        UpdateBillingAccount service = new UpdateBillingAccount();
    ...
    /**
     * Construct a <code>UpdateBillingAccount</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateBillingAccount fromOutput(Map<String, Object> mapValue) {
        UpdateBillingAccount service = new UpdateBillingAccount();
