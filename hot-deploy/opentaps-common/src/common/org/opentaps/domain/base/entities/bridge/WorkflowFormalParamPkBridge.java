...
import org.opentaps.domain.base.entities.WorkflowFormalParamPk;

/**
 * A FieldBridge for WorkflowFormalParamPk.
 */
public class WorkflowFormalParamPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkflowFormalParamPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkflowFormalParamPk id = new WorkflowFormalParamPk();
        Field field = null;
        ...
        field = document.getField(name + ".applicationId");
        id.setApplicationId(field.stringValue());
        field = document.getField(name + ".formalParamId");
        id.setFormalParamId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        WorkflowFormalParamPk id = (WorkflowFormalParamPk) object;
        ...
        sb.append(" ");
        sb.append(id.getApplicationId());
        sb.append(" ");
        sb.append(id.getFormalParamId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkflowFormalParamPk id = (WorkflowFormalParamPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".applicationId", id.getApplicationId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".formalParamId", id.getFormalParamId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
