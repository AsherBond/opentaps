 ...
 */
public class CreateUpdateBillingAddress extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateUpdateBillingAddress</code> from the input values of the given <code>CreateUpdateBillingAddress</code>.
     * @param input a <code>CreateUpdateBillingAddress</code>
     */
    public static CreateUpdateBillingAddress fromInput(CreateUpdateBillingAddress input) {
        CreateUpdateBillingAddress service = new CreateUpdateBillingAddress();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateUpdateBillingAddress</code> from the output values of the given <code>CreateUpdateBillingAddress</code>.
     * @param output a <code>CreateUpdateBillingAddress</code>
     */
    public static CreateUpdateBillingAddress fromOutput(CreateUpdateBillingAddress output) {
        CreateUpdateBillingAddress service = new CreateUpdateBillingAddress();
    ...
    /**
     * Construct a <code>CreateUpdateBillingAddress</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateUpdateBillingAddress fromInput(Map<String, Object> mapValue) {
        CreateUpdateBillingAddress service = new CreateUpdateBillingAddress();
    ...
    /**
     * Construct a <code>CreateUpdateBillingAddress</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateUpdateBillingAddress fromOutput(Map<String, Object> mapValue) {
        CreateUpdateBillingAddress service = new CreateUpdateBillingAddress();
