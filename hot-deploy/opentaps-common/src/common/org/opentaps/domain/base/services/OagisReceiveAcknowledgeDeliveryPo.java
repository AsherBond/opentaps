 ...
 */
public class OagisReceiveAcknowledgeDeliveryPo extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OagisReceiveAcknowledgeDeliveryPo</code> from the input values of the given <code>OagisReceiveAcknowledgeDeliveryPo</code>.
     * @param input a <code>OagisReceiveAcknowledgeDeliveryPo</code>
     */
    public static OagisReceiveAcknowledgeDeliveryPo fromInput(OagisReceiveAcknowledgeDeliveryPo input) {
        OagisReceiveAcknowledgeDeliveryPo service = new OagisReceiveAcknowledgeDeliveryPo();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OagisReceiveAcknowledgeDeliveryPo</code> from the output values of the given <code>OagisReceiveAcknowledgeDeliveryPo</code>.
     * @param output a <code>OagisReceiveAcknowledgeDeliveryPo</code>
     */
    public static OagisReceiveAcknowledgeDeliveryPo fromOutput(OagisReceiveAcknowledgeDeliveryPo output) {
        OagisReceiveAcknowledgeDeliveryPo service = new OagisReceiveAcknowledgeDeliveryPo();
    ...
    /**
     * Construct a <code>OagisReceiveAcknowledgeDeliveryPo</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OagisReceiveAcknowledgeDeliveryPo fromInput(Map<String, Object> mapValue) {
        OagisReceiveAcknowledgeDeliveryPo service = new OagisReceiveAcknowledgeDeliveryPo();
    ...
    /**
     * Construct a <code>OagisReceiveAcknowledgeDeliveryPo</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OagisReceiveAcknowledgeDeliveryPo fromOutput(Map<String, Object> mapValue) {
        OagisReceiveAcknowledgeDeliveryPo service = new OagisReceiveAcknowledgeDeliveryPo();
