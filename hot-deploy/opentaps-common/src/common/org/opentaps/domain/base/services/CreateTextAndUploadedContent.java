 ...
 */
public class CreateTextAndUploadedContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateTextAndUploadedContent</code> from the input values of the given <code>CreateTextAndUploadedContent</code>.
     * @param input a <code>CreateTextAndUploadedContent</code>
     */
    public static CreateTextAndUploadedContent fromInput(CreateTextAndUploadedContent input) {
        CreateTextAndUploadedContent service = new CreateTextAndUploadedContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateTextAndUploadedContent</code> from the output values of the given <code>CreateTextAndUploadedContent</code>.
     * @param output a <code>CreateTextAndUploadedContent</code>
     */
    public static CreateTextAndUploadedContent fromOutput(CreateTextAndUploadedContent output) {
        CreateTextAndUploadedContent service = new CreateTextAndUploadedContent();
    ...
    /**
     * Construct a <code>CreateTextAndUploadedContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateTextAndUploadedContent fromInput(Map<String, Object> mapValue) {
        CreateTextAndUploadedContent service = new CreateTextAndUploadedContent();
    ...
    /**
     * Construct a <code>CreateTextAndUploadedContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateTextAndUploadedContent fromOutput(Map<String, Object> mapValue) {
        CreateTextAndUploadedContent service = new CreateTextAndUploadedContent();
