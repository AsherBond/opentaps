 ...
 */
public class SendShipmentCompleteNotification extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>SendShipmentCompleteNotification</code> from the input values of the given <code>SendShipmentCompleteNotification</code>.
     * @param input a <code>SendShipmentCompleteNotification</code>
     */
    public static SendShipmentCompleteNotification fromInput(SendShipmentCompleteNotification input) {
        SendShipmentCompleteNotification service = new SendShipmentCompleteNotification();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>SendShipmentCompleteNotification</code> from the output values of the given <code>SendShipmentCompleteNotification</code>.
     * @param output a <code>SendShipmentCompleteNotification</code>
     */
    public static SendShipmentCompleteNotification fromOutput(SendShipmentCompleteNotification output) {
        SendShipmentCompleteNotification service = new SendShipmentCompleteNotification();
    ...
    /**
     * Construct a <code>SendShipmentCompleteNotification</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SendShipmentCompleteNotification fromInput(Map<String, Object> mapValue) {
        SendShipmentCompleteNotification service = new SendShipmentCompleteNotification();
    ...
    /**
     * Construct a <code>SendShipmentCompleteNotification</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SendShipmentCompleteNotification fromOutput(Map<String, Object> mapValue) {
        SendShipmentCompleteNotification service = new SendShipmentCompleteNotification();
