 ...
 */
public class OpentapsPrepareInvoiceEmail extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsPrepareInvoiceEmail</code> from the input values of the given <code>OpentapsPrepareInvoiceEmail</code>.
     * @param input a <code>OpentapsPrepareInvoiceEmail</code>
     */
    public static OpentapsPrepareInvoiceEmail fromInput(OpentapsPrepareInvoiceEmail input) {
        OpentapsPrepareInvoiceEmail service = new OpentapsPrepareInvoiceEmail();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsPrepareInvoiceEmail</code> from the output values of the given <code>OpentapsPrepareInvoiceEmail</code>.
     * @param output a <code>OpentapsPrepareInvoiceEmail</code>
     */
    public static OpentapsPrepareInvoiceEmail fromOutput(OpentapsPrepareInvoiceEmail output) {
        OpentapsPrepareInvoiceEmail service = new OpentapsPrepareInvoiceEmail();
    ...
    /**
     * Construct a <code>OpentapsPrepareInvoiceEmail</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsPrepareInvoiceEmail fromInput(Map<String, Object> mapValue) {
        OpentapsPrepareInvoiceEmail service = new OpentapsPrepareInvoiceEmail();
    ...
    /**
     * Construct a <code>OpentapsPrepareInvoiceEmail</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsPrepareInvoiceEmail fromOutput(Map<String, Object> mapValue) {
        OpentapsPrepareInvoiceEmail service = new OpentapsPrepareInvoiceEmail();
