 ...
 */
public class PcChargeCCRelease extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PcChargeCCRelease</code> from the input values of the given <code>PcChargeCCRelease</code>.
     * @param input a <code>PcChargeCCRelease</code>
     */
    public static PcChargeCCRelease fromInput(PcChargeCCRelease input) {
        PcChargeCCRelease service = new PcChargeCCRelease();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PcChargeCCRelease</code> from the output values of the given <code>PcChargeCCRelease</code>.
     * @param output a <code>PcChargeCCRelease</code>
     */
    public static PcChargeCCRelease fromOutput(PcChargeCCRelease output) {
        PcChargeCCRelease service = new PcChargeCCRelease();
    ...
    /**
     * Construct a <code>PcChargeCCRelease</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PcChargeCCRelease fromInput(Map<String, Object> mapValue) {
        PcChargeCCRelease service = new PcChargeCCRelease();
    ...
    /**
     * Construct a <code>PcChargeCCRelease</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PcChargeCCRelease fromOutput(Map<String, Object> mapValue) {
        PcChargeCCRelease service = new PcChargeCCRelease();
