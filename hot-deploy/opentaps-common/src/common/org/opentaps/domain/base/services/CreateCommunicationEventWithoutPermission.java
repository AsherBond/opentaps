 ...
 */
public class CreateCommunicationEventWithoutPermission extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateCommunicationEventWithoutPermission</code> from the input values of the given <code>CreateCommunicationEventWithoutPermission</code>.
     * @param input a <code>CreateCommunicationEventWithoutPermission</code>
     */
    public static CreateCommunicationEventWithoutPermission fromInput(CreateCommunicationEventWithoutPermission input) {
        CreateCommunicationEventWithoutPermission service = new CreateCommunicationEventWithoutPermission();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateCommunicationEventWithoutPermission</code> from the output values of the given <code>CreateCommunicationEventWithoutPermission</code>.
     * @param output a <code>CreateCommunicationEventWithoutPermission</code>
     */
    public static CreateCommunicationEventWithoutPermission fromOutput(CreateCommunicationEventWithoutPermission output) {
        CreateCommunicationEventWithoutPermission service = new CreateCommunicationEventWithoutPermission();
    ...
    /**
     * Construct a <code>CreateCommunicationEventWithoutPermission</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCommunicationEventWithoutPermission fromInput(Map<String, Object> mapValue) {
        CreateCommunicationEventWithoutPermission service = new CreateCommunicationEventWithoutPermission();
    ...
    /**
     * Construct a <code>CreateCommunicationEventWithoutPermission</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCommunicationEventWithoutPermission fromOutput(Map<String, Object> mapValue) {
        CreateCommunicationEventWithoutPermission service = new CreateCommunicationEventWithoutPermission();
