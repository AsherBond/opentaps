 ...
 */
public class CreateProductStoreVendorPayment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateProductStoreVendorPayment</code> from the input values of the given <code>CreateProductStoreVendorPayment</code>.
     * @param input a <code>CreateProductStoreVendorPayment</code>
     */
    public static CreateProductStoreVendorPayment fromInput(CreateProductStoreVendorPayment input) {
        CreateProductStoreVendorPayment service = new CreateProductStoreVendorPayment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateProductStoreVendorPayment</code> from the output values of the given <code>CreateProductStoreVendorPayment</code>.
     * @param output a <code>CreateProductStoreVendorPayment</code>
     */
    public static CreateProductStoreVendorPayment fromOutput(CreateProductStoreVendorPayment output) {
        CreateProductStoreVendorPayment service = new CreateProductStoreVendorPayment();
    ...
    /**
     * Construct a <code>CreateProductStoreVendorPayment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateProductStoreVendorPayment fromInput(Map<String, Object> mapValue) {
        CreateProductStoreVendorPayment service = new CreateProductStoreVendorPayment();
    ...
    /**
     * Construct a <code>CreateProductStoreVendorPayment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateProductStoreVendorPayment fromOutput(Map<String, Object> mapValue) {
        CreateProductStoreVendorPayment service = new CreateProductStoreVendorPayment();
