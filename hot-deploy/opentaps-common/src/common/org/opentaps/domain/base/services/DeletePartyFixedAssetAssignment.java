 ...
 */
public class DeletePartyFixedAssetAssignment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeletePartyFixedAssetAssignment</code> from the input values of the given <code>DeletePartyFixedAssetAssignment</code>.
     * @param input a <code>DeletePartyFixedAssetAssignment</code>
     */
    public static DeletePartyFixedAssetAssignment fromInput(DeletePartyFixedAssetAssignment input) {
        DeletePartyFixedAssetAssignment service = new DeletePartyFixedAssetAssignment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeletePartyFixedAssetAssignment</code> from the output values of the given <code>DeletePartyFixedAssetAssignment</code>.
     * @param output a <code>DeletePartyFixedAssetAssignment</code>
     */
    public static DeletePartyFixedAssetAssignment fromOutput(DeletePartyFixedAssetAssignment output) {
        DeletePartyFixedAssetAssignment service = new DeletePartyFixedAssetAssignment();
    ...
    /**
     * Construct a <code>DeletePartyFixedAssetAssignment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeletePartyFixedAssetAssignment fromInput(Map<String, Object> mapValue) {
        DeletePartyFixedAssetAssignment service = new DeletePartyFixedAssetAssignment();
    ...
    /**
     * Construct a <code>DeletePartyFixedAssetAssignment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeletePartyFixedAssetAssignment fromOutput(Map<String, Object> mapValue) {
        DeletePartyFixedAssetAssignment service = new DeletePartyFixedAssetAssignment();
