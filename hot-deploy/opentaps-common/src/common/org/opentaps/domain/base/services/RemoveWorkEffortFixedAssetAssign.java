 ...
 */
public class RemoveWorkEffortFixedAssetAssign extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemoveWorkEffortFixedAssetAssign</code> from the input values of the given <code>RemoveWorkEffortFixedAssetAssign</code>.
     * @param input a <code>RemoveWorkEffortFixedAssetAssign</code>
     */
    public static RemoveWorkEffortFixedAssetAssign fromInput(RemoveWorkEffortFixedAssetAssign input) {
        RemoveWorkEffortFixedAssetAssign service = new RemoveWorkEffortFixedAssetAssign();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemoveWorkEffortFixedAssetAssign</code> from the output values of the given <code>RemoveWorkEffortFixedAssetAssign</code>.
     * @param output a <code>RemoveWorkEffortFixedAssetAssign</code>
     */
    public static RemoveWorkEffortFixedAssetAssign fromOutput(RemoveWorkEffortFixedAssetAssign output) {
        RemoveWorkEffortFixedAssetAssign service = new RemoveWorkEffortFixedAssetAssign();
    ...
    /**
     * Construct a <code>RemoveWorkEffortFixedAssetAssign</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveWorkEffortFixedAssetAssign fromInput(Map<String, Object> mapValue) {
        RemoveWorkEffortFixedAssetAssign service = new RemoveWorkEffortFixedAssetAssign();
    ...
    /**
     * Construct a <code>RemoveWorkEffortFixedAssetAssign</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveWorkEffortFixedAssetAssign fromOutput(Map<String, Object> mapValue) {
        RemoveWorkEffortFixedAssetAssign service = new RemoveWorkEffortFixedAssetAssign();
