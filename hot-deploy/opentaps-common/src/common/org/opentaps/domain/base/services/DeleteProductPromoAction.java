 ...
 */
public class DeleteProductPromoAction extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductPromoAction</code> from the input values of the given <code>DeleteProductPromoAction</code>.
     * @param input a <code>DeleteProductPromoAction</code>
     */
    public static DeleteProductPromoAction fromInput(DeleteProductPromoAction input) {
        DeleteProductPromoAction service = new DeleteProductPromoAction();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteProductPromoAction</code> from the output values of the given <code>DeleteProductPromoAction</code>.
     * @param output a <code>DeleteProductPromoAction</code>
     */
    public static DeleteProductPromoAction fromOutput(DeleteProductPromoAction output) {
        DeleteProductPromoAction service = new DeleteProductPromoAction();
    ...
    /**
     * Construct a <code>DeleteProductPromoAction</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductPromoAction fromInput(Map<String, Object> mapValue) {
        DeleteProductPromoAction service = new DeleteProductPromoAction();
    ...
    /**
     * Construct a <code>DeleteProductPromoAction</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductPromoAction fromOutput(Map<String, Object> mapValue) {
        DeleteProductPromoAction service = new DeleteProductPromoAction();
