 ...
 */
public class GetComparativeIncomeStatement extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetComparativeIncomeStatement</code> from the input values of the given <code>GetComparativeIncomeStatement</code>.
     * @param input a <code>GetComparativeIncomeStatement</code>
     */
    public static GetComparativeIncomeStatement fromInput(GetComparativeIncomeStatement input) {
        GetComparativeIncomeStatement service = new GetComparativeIncomeStatement();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetComparativeIncomeStatement</code> from the output values of the given <code>GetComparativeIncomeStatement</code>.
     * @param output a <code>GetComparativeIncomeStatement</code>
     */
    public static GetComparativeIncomeStatement fromOutput(GetComparativeIncomeStatement output) {
        GetComparativeIncomeStatement service = new GetComparativeIncomeStatement();
    ...
    /**
     * Construct a <code>GetComparativeIncomeStatement</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetComparativeIncomeStatement fromInput(Map<String, Object> mapValue) {
        GetComparativeIncomeStatement service = new GetComparativeIncomeStatement();
    ...
    /**
     * Construct a <code>GetComparativeIncomeStatement</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetComparativeIncomeStatement fromOutput(Map<String, Object> mapValue) {
        GetComparativeIncomeStatement service = new GetComparativeIncomeStatement();
