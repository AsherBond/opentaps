 ...
 */
public class CrmsfaCreateCustRequestContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateCustRequestContent</code> from the input values of the given <code>CrmsfaCreateCustRequestContent</code>.
     * @param input a <code>CrmsfaCreateCustRequestContent</code>
     */
    public static CrmsfaCreateCustRequestContent fromInput(CrmsfaCreateCustRequestContent input) {
        CrmsfaCreateCustRequestContent service = new CrmsfaCreateCustRequestContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaCreateCustRequestContent</code> from the output values of the given <code>CrmsfaCreateCustRequestContent</code>.
     * @param output a <code>CrmsfaCreateCustRequestContent</code>
     */
    public static CrmsfaCreateCustRequestContent fromOutput(CrmsfaCreateCustRequestContent output) {
        CrmsfaCreateCustRequestContent service = new CrmsfaCreateCustRequestContent();
    ...
    /**
     * Construct a <code>CrmsfaCreateCustRequestContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateCustRequestContent fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateCustRequestContent service = new CrmsfaCreateCustRequestContent();
    ...
    /**
     * Construct a <code>CrmsfaCreateCustRequestContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateCustRequestContent fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateCustRequestContent service = new CrmsfaCreateCustRequestContent();
