 ...
 */
public class CrmsfaUpdateReturnHeader extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaUpdateReturnHeader</code> from the input values of the given <code>CrmsfaUpdateReturnHeader</code>.
     * @param input a <code>CrmsfaUpdateReturnHeader</code>
     */
    public static CrmsfaUpdateReturnHeader fromInput(CrmsfaUpdateReturnHeader input) {
        CrmsfaUpdateReturnHeader service = new CrmsfaUpdateReturnHeader();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaUpdateReturnHeader</code> from the output values of the given <code>CrmsfaUpdateReturnHeader</code>.
     * @param output a <code>CrmsfaUpdateReturnHeader</code>
     */
    public static CrmsfaUpdateReturnHeader fromOutput(CrmsfaUpdateReturnHeader output) {
        CrmsfaUpdateReturnHeader service = new CrmsfaUpdateReturnHeader();
    ...
    /**
     * Construct a <code>CrmsfaUpdateReturnHeader</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaUpdateReturnHeader fromInput(Map<String, Object> mapValue) {
        CrmsfaUpdateReturnHeader service = new CrmsfaUpdateReturnHeader();
    ...
    /**
     * Construct a <code>CrmsfaUpdateReturnHeader</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaUpdateReturnHeader fromOutput(Map<String, Object> mapValue) {
        CrmsfaUpdateReturnHeader service = new CrmsfaUpdateReturnHeader();
