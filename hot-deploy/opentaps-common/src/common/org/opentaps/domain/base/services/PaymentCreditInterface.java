 ...
 */
public class PaymentCreditInterface extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PaymentCreditInterface</code> from the input values of the given <code>PaymentCreditInterface</code>.
     * @param input a <code>PaymentCreditInterface</code>
     */
    public static PaymentCreditInterface fromInput(PaymentCreditInterface input) {
        PaymentCreditInterface service = new PaymentCreditInterface();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PaymentCreditInterface</code> from the output values of the given <code>PaymentCreditInterface</code>.
     * @param output a <code>PaymentCreditInterface</code>
     */
    public static PaymentCreditInterface fromOutput(PaymentCreditInterface output) {
        PaymentCreditInterface service = new PaymentCreditInterface();
    ...
    /**
     * Construct a <code>PaymentCreditInterface</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PaymentCreditInterface fromInput(Map<String, Object> mapValue) {
        PaymentCreditInterface service = new PaymentCreditInterface();
    ...
    /**
     * Construct a <code>PaymentCreditInterface</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PaymentCreditInterface fromOutput(Map<String, Object> mapValue) {
        PaymentCreditInterface service = new PaymentCreditInterface();
