 ...
 */
public class UpdateGlAccountOrganization extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateGlAccountOrganization</code> from the input values of the given <code>UpdateGlAccountOrganization</code>.
     * @param input a <code>UpdateGlAccountOrganization</code>
     */
    public static UpdateGlAccountOrganization fromInput(UpdateGlAccountOrganization input) {
        UpdateGlAccountOrganization service = new UpdateGlAccountOrganization();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateGlAccountOrganization</code> from the output values of the given <code>UpdateGlAccountOrganization</code>.
     * @param output a <code>UpdateGlAccountOrganization</code>
     */
    public static UpdateGlAccountOrganization fromOutput(UpdateGlAccountOrganization output) {
        UpdateGlAccountOrganization service = new UpdateGlAccountOrganization();
    ...
    /**
     * Construct a <code>UpdateGlAccountOrganization</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateGlAccountOrganization fromInput(Map<String, Object> mapValue) {
        UpdateGlAccountOrganization service = new UpdateGlAccountOrganization();
    ...
    /**
     * Construct a <code>UpdateGlAccountOrganization</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateGlAccountOrganization fromOutput(Map<String, Object> mapValue) {
        UpdateGlAccountOrganization service = new UpdateGlAccountOrganization();
