 ...
 */
public class AcctgInvoicePermissionCheck extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AcctgInvoicePermissionCheck</code> from the input values of the given <code>AcctgInvoicePermissionCheck</code>.
     * @param input a <code>AcctgInvoicePermissionCheck</code>
     */
    public static AcctgInvoicePermissionCheck fromInput(AcctgInvoicePermissionCheck input) {
        AcctgInvoicePermissionCheck service = new AcctgInvoicePermissionCheck();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AcctgInvoicePermissionCheck</code> from the output values of the given <code>AcctgInvoicePermissionCheck</code>.
     * @param output a <code>AcctgInvoicePermissionCheck</code>
     */
    public static AcctgInvoicePermissionCheck fromOutput(AcctgInvoicePermissionCheck output) {
        AcctgInvoicePermissionCheck service = new AcctgInvoicePermissionCheck();
    ...
    /**
     * Construct a <code>AcctgInvoicePermissionCheck</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AcctgInvoicePermissionCheck fromInput(Map<String, Object> mapValue) {
        AcctgInvoicePermissionCheck service = new AcctgInvoicePermissionCheck();
    ...
    /**
     * Construct a <code>AcctgInvoicePermissionCheck</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AcctgInvoicePermissionCheck fromOutput(Map<String, Object> mapValue) {
        AcctgInvoicePermissionCheck service = new AcctgInvoicePermissionCheck();
