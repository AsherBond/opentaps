 ...
 */
public class UpdateBillingAccountRole extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateBillingAccountRole</code> from the input values of the given <code>UpdateBillingAccountRole</code>.
     * @param input a <code>UpdateBillingAccountRole</code>
     */
    public static UpdateBillingAccountRole fromInput(UpdateBillingAccountRole input) {
        UpdateBillingAccountRole service = new UpdateBillingAccountRole();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateBillingAccountRole</code> from the output values of the given <code>UpdateBillingAccountRole</code>.
     * @param output a <code>UpdateBillingAccountRole</code>
     */
    public static UpdateBillingAccountRole fromOutput(UpdateBillingAccountRole output) {
        UpdateBillingAccountRole service = new UpdateBillingAccountRole();
    ...
    /**
     * Construct a <code>UpdateBillingAccountRole</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateBillingAccountRole fromInput(Map<String, Object> mapValue) {
        UpdateBillingAccountRole service = new UpdateBillingAccountRole();
    ...
    /**
     * Construct a <code>UpdateBillingAccountRole</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateBillingAccountRole fromOutput(Map<String, Object> mapValue) {
        UpdateBillingAccountRole service = new UpdateBillingAccountRole();
