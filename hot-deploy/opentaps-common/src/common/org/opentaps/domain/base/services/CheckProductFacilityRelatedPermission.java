 ...
 */
public class CheckProductFacilityRelatedPermission extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CheckProductFacilityRelatedPermission</code> from the input values of the given <code>CheckProductFacilityRelatedPermission</code>.
     * @param input a <code>CheckProductFacilityRelatedPermission</code>
     */
    public static CheckProductFacilityRelatedPermission fromInput(CheckProductFacilityRelatedPermission input) {
        CheckProductFacilityRelatedPermission service = new CheckProductFacilityRelatedPermission();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CheckProductFacilityRelatedPermission</code> from the output values of the given <code>CheckProductFacilityRelatedPermission</code>.
     * @param output a <code>CheckProductFacilityRelatedPermission</code>
     */
    public static CheckProductFacilityRelatedPermission fromOutput(CheckProductFacilityRelatedPermission output) {
        CheckProductFacilityRelatedPermission service = new CheckProductFacilityRelatedPermission();
    ...
    /**
     * Construct a <code>CheckProductFacilityRelatedPermission</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CheckProductFacilityRelatedPermission fromInput(Map<String, Object> mapValue) {
        CheckProductFacilityRelatedPermission service = new CheckProductFacilityRelatedPermission();
    ...
    /**
     * Construct a <code>CheckProductFacilityRelatedPermission</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CheckProductFacilityRelatedPermission fromOutput(Map<String, Object> mapValue) {
        CheckProductFacilityRelatedPermission service = new CheckProductFacilityRelatedPermission();
