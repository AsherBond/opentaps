 ...
 */
public class ByteBufferTest extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ByteBufferTest</code> from the input values of the given <code>ByteBufferTest</code>.
     * @param input a <code>ByteBufferTest</code>
     */
    public static ByteBufferTest fromInput(ByteBufferTest input) {
        ByteBufferTest service = new ByteBufferTest();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ByteBufferTest</code> from the output values of the given <code>ByteBufferTest</code>.
     * @param output a <code>ByteBufferTest</code>
     */
    public static ByteBufferTest fromOutput(ByteBufferTest output) {
        ByteBufferTest service = new ByteBufferTest();
    ...
    /**
     * Construct a <code>ByteBufferTest</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ByteBufferTest fromInput(Map<String, Object> mapValue) {
        ByteBufferTest service = new ByteBufferTest();
    ...
    /**
     * Construct a <code>ByteBufferTest</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ByteBufferTest fromOutput(Map<String, Object> mapValue) {
        ByteBufferTest service = new ByteBufferTest();
