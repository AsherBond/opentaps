 ...
 */
public class UpdateInvoiceItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateInvoiceItem</code> from the input values of the given <code>UpdateInvoiceItem</code>.
     * @param input a <code>UpdateInvoiceItem</code>
     */
    public static UpdateInvoiceItem fromInput(UpdateInvoiceItem input) {
        UpdateInvoiceItem service = new UpdateInvoiceItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateInvoiceItem</code> from the output values of the given <code>UpdateInvoiceItem</code>.
     * @param output a <code>UpdateInvoiceItem</code>
     */
    public static UpdateInvoiceItem fromOutput(UpdateInvoiceItem output) {
        UpdateInvoiceItem service = new UpdateInvoiceItem();
    ...
    /**
     * Construct a <code>UpdateInvoiceItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateInvoiceItem fromInput(Map<String, Object> mapValue) {
        UpdateInvoiceItem service = new UpdateInvoiceItem();
    ...
    /**
     * Construct a <code>UpdateInvoiceItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateInvoiceItem fromOutput(Map<String, Object> mapValue) {
        UpdateInvoiceItem service = new UpdateInvoiceItem();
