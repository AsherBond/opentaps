 ...
 */
public class CreateContentFromDataResource extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateContentFromDataResource</code> from the input values of the given <code>CreateContentFromDataResource</code>.
     * @param input a <code>CreateContentFromDataResource</code>
     */
    public static CreateContentFromDataResource fromInput(CreateContentFromDataResource input) {
        CreateContentFromDataResource service = new CreateContentFromDataResource();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateContentFromDataResource</code> from the output values of the given <code>CreateContentFromDataResource</code>.
     * @param output a <code>CreateContentFromDataResource</code>
     */
    public static CreateContentFromDataResource fromOutput(CreateContentFromDataResource output) {
        CreateContentFromDataResource service = new CreateContentFromDataResource();
    ...
    /**
     * Construct a <code>CreateContentFromDataResource</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateContentFromDataResource fromInput(Map<String, Object> mapValue) {
        CreateContentFromDataResource service = new CreateContentFromDataResource();
    ...
    /**
     * Construct a <code>CreateContentFromDataResource</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateContentFromDataResource fromOutput(Map<String, Object> mapValue) {
        CreateContentFromDataResource service = new CreateContentFromDataResource();
