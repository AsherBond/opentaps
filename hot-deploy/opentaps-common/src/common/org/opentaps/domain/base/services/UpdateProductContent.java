 ...
 */
public class UpdateProductContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateProductContent</code> from the input values of the given <code>UpdateProductContent</code>.
     * @param input a <code>UpdateProductContent</code>
     */
    public static UpdateProductContent fromInput(UpdateProductContent input) {
        UpdateProductContent service = new UpdateProductContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateProductContent</code> from the output values of the given <code>UpdateProductContent</code>.
     * @param output a <code>UpdateProductContent</code>
     */
    public static UpdateProductContent fromOutput(UpdateProductContent output) {
        UpdateProductContent service = new UpdateProductContent();
    ...
    /**
     * Construct a <code>UpdateProductContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateProductContent fromInput(Map<String, Object> mapValue) {
        UpdateProductContent service = new UpdateProductContent();
    ...
    /**
     * Construct a <code>UpdateProductContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateProductContent fromOutput(Map<String, Object> mapValue) {
        UpdateProductContent service = new UpdateProductContent();
