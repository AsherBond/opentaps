 ...
 */
public class UpdateTextContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateTextContent</code> from the input values of the given <code>UpdateTextContent</code>.
     * @param input a <code>UpdateTextContent</code>
     */
    public static UpdateTextContent fromInput(UpdateTextContent input) {
        UpdateTextContent service = new UpdateTextContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateTextContent</code> from the output values of the given <code>UpdateTextContent</code>.
     * @param output a <code>UpdateTextContent</code>
     */
    public static UpdateTextContent fromOutput(UpdateTextContent output) {
        UpdateTextContent service = new UpdateTextContent();
    ...
    /**
     * Construct a <code>UpdateTextContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateTextContent fromInput(Map<String, Object> mapValue) {
        UpdateTextContent service = new UpdateTextContent();
    ...
    /**
     * Construct a <code>UpdateTextContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateTextContent fromOutput(Map<String, Object> mapValue) {
        UpdateTextContent service = new UpdateTextContent();
