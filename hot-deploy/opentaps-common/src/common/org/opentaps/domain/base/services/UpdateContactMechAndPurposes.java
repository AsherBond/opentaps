 ...
 */
public class UpdateContactMechAndPurposes extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateContactMechAndPurposes</code> from the input values of the given <code>UpdateContactMechAndPurposes</code>.
     * @param input a <code>UpdateContactMechAndPurposes</code>
     */
    public static UpdateContactMechAndPurposes fromInput(UpdateContactMechAndPurposes input) {
        UpdateContactMechAndPurposes service = new UpdateContactMechAndPurposes();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateContactMechAndPurposes</code> from the output values of the given <code>UpdateContactMechAndPurposes</code>.
     * @param output a <code>UpdateContactMechAndPurposes</code>
     */
    public static UpdateContactMechAndPurposes fromOutput(UpdateContactMechAndPurposes output) {
        UpdateContactMechAndPurposes service = new UpdateContactMechAndPurposes();
    ...
    /**
     * Construct a <code>UpdateContactMechAndPurposes</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateContactMechAndPurposes fromInput(Map<String, Object> mapValue) {
        UpdateContactMechAndPurposes service = new UpdateContactMechAndPurposes();
    ...
    /**
     * Construct a <code>UpdateContactMechAndPurposes</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateContactMechAndPurposes fromOutput(Map<String, Object> mapValue) {
        UpdateContactMechAndPurposes service = new UpdateContactMechAndPurposes();
