 ...
 */
public class UpdatePartyRelationship extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdatePartyRelationship</code> from the input values of the given <code>UpdatePartyRelationship</code>.
     * @param input a <code>UpdatePartyRelationship</code>
     */
    public static UpdatePartyRelationship fromInput(UpdatePartyRelationship input) {
        UpdatePartyRelationship service = new UpdatePartyRelationship();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdatePartyRelationship</code> from the output values of the given <code>UpdatePartyRelationship</code>.
     * @param output a <code>UpdatePartyRelationship</code>
     */
    public static UpdatePartyRelationship fromOutput(UpdatePartyRelationship output) {
        UpdatePartyRelationship service = new UpdatePartyRelationship();
    ...
    /**
     * Construct a <code>UpdatePartyRelationship</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdatePartyRelationship fromInput(Map<String, Object> mapValue) {
        UpdatePartyRelationship service = new UpdatePartyRelationship();
    ...
    /**
     * Construct a <code>UpdatePartyRelationship</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdatePartyRelationship fromOutput(Map<String, Object> mapValue) {
        UpdatePartyRelationship service = new UpdatePartyRelationship();
