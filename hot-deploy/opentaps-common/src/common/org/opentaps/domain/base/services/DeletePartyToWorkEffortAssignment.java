 ...
 */
public class DeletePartyToWorkEffortAssignment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeletePartyToWorkEffortAssignment</code> from the input values of the given <code>DeletePartyToWorkEffortAssignment</code>.
     * @param input a <code>DeletePartyToWorkEffortAssignment</code>
     */
    public static DeletePartyToWorkEffortAssignment fromInput(DeletePartyToWorkEffortAssignment input) {
        DeletePartyToWorkEffortAssignment service = new DeletePartyToWorkEffortAssignment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeletePartyToWorkEffortAssignment</code> from the output values of the given <code>DeletePartyToWorkEffortAssignment</code>.
     * @param output a <code>DeletePartyToWorkEffortAssignment</code>
     */
    public static DeletePartyToWorkEffortAssignment fromOutput(DeletePartyToWorkEffortAssignment output) {
        DeletePartyToWorkEffortAssignment service = new DeletePartyToWorkEffortAssignment();
    ...
    /**
     * Construct a <code>DeletePartyToWorkEffortAssignment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeletePartyToWorkEffortAssignment fromInput(Map<String, Object> mapValue) {
        DeletePartyToWorkEffortAssignment service = new DeletePartyToWorkEffortAssignment();
    ...
    /**
     * Construct a <code>DeletePartyToWorkEffortAssignment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeletePartyToWorkEffortAssignment fromOutput(Map<String, Object> mapValue) {
        DeletePartyToWorkEffortAssignment service = new DeletePartyToWorkEffortAssignment();
