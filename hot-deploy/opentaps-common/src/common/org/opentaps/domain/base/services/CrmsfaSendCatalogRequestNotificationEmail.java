 ...
 */
public class CrmsfaSendCatalogRequestNotificationEmail extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaSendCatalogRequestNotificationEmail</code> from the input values of the given <code>CrmsfaSendCatalogRequestNotificationEmail</code>.
     * @param input a <code>CrmsfaSendCatalogRequestNotificationEmail</code>
     */
    public static CrmsfaSendCatalogRequestNotificationEmail fromInput(CrmsfaSendCatalogRequestNotificationEmail input) {
        CrmsfaSendCatalogRequestNotificationEmail service = new CrmsfaSendCatalogRequestNotificationEmail();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaSendCatalogRequestNotificationEmail</code> from the output values of the given <code>CrmsfaSendCatalogRequestNotificationEmail</code>.
     * @param output a <code>CrmsfaSendCatalogRequestNotificationEmail</code>
     */
    public static CrmsfaSendCatalogRequestNotificationEmail fromOutput(CrmsfaSendCatalogRequestNotificationEmail output) {
        CrmsfaSendCatalogRequestNotificationEmail service = new CrmsfaSendCatalogRequestNotificationEmail();
    ...
    /**
     * Construct a <code>CrmsfaSendCatalogRequestNotificationEmail</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaSendCatalogRequestNotificationEmail fromInput(Map<String, Object> mapValue) {
        CrmsfaSendCatalogRequestNotificationEmail service = new CrmsfaSendCatalogRequestNotificationEmail();
    ...
    /**
     * Construct a <code>CrmsfaSendCatalogRequestNotificationEmail</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaSendCatalogRequestNotificationEmail fromOutput(Map<String, Object> mapValue) {
        CrmsfaSendCatalogRequestNotificationEmail service = new CrmsfaSendCatalogRequestNotificationEmail();
