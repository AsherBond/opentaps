 ...
 */
public class QuickCreateAcctgTransAndEntries extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>QuickCreateAcctgTransAndEntries</code> from the input values of the given <code>QuickCreateAcctgTransAndEntries</code>.
     * @param input a <code>QuickCreateAcctgTransAndEntries</code>
     */
    public static QuickCreateAcctgTransAndEntries fromInput(QuickCreateAcctgTransAndEntries input) {
        QuickCreateAcctgTransAndEntries service = new QuickCreateAcctgTransAndEntries();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>QuickCreateAcctgTransAndEntries</code> from the output values of the given <code>QuickCreateAcctgTransAndEntries</code>.
     * @param output a <code>QuickCreateAcctgTransAndEntries</code>
     */
    public static QuickCreateAcctgTransAndEntries fromOutput(QuickCreateAcctgTransAndEntries output) {
        QuickCreateAcctgTransAndEntries service = new QuickCreateAcctgTransAndEntries();
    ...
    /**
     * Construct a <code>QuickCreateAcctgTransAndEntries</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static QuickCreateAcctgTransAndEntries fromInput(Map<String, Object> mapValue) {
        QuickCreateAcctgTransAndEntries service = new QuickCreateAcctgTransAndEntries();
    ...
    /**
     * Construct a <code>QuickCreateAcctgTransAndEntries</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static QuickCreateAcctgTransAndEntries fromOutput(Map<String, Object> mapValue) {
        QuickCreateAcctgTransAndEntries service = new QuickCreateAcctgTransAndEntries();
