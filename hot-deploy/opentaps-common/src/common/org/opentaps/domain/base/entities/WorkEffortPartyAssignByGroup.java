...
fieldMapColumns.put("WorkEffortPartyAssignByGroup", fields);
  ...
  public WorkEffortPartyAssignByGroup(RepositoryInterface repository) {
     ...
     */
    private void setGroupPartyId(String groupPartyId) {
     ...
     */
    private void setPrelFromDate(Timestamp prelFromDate) {
     ...
     */
    private void setPrelThruDate(Timestamp prelThruDate) {
     ...
     */
    private void setPrelStatusId(String prelStatusId) {
     ...
     */
    private void setPrelComments(String prelComments) {
