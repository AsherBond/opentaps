 ...
 */
public class CreateFacilityContactMech extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateFacilityContactMech</code> from the input values of the given <code>CreateFacilityContactMech</code>.
     * @param input a <code>CreateFacilityContactMech</code>
     */
    public static CreateFacilityContactMech fromInput(CreateFacilityContactMech input) {
        CreateFacilityContactMech service = new CreateFacilityContactMech();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateFacilityContactMech</code> from the output values of the given <code>CreateFacilityContactMech</code>.
     * @param output a <code>CreateFacilityContactMech</code>
     */
    public static CreateFacilityContactMech fromOutput(CreateFacilityContactMech output) {
        CreateFacilityContactMech service = new CreateFacilityContactMech();
    ...
    /**
     * Construct a <code>CreateFacilityContactMech</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFacilityContactMech fromInput(Map<String, Object> mapValue) {
        CreateFacilityContactMech service = new CreateFacilityContactMech();
    ...
    /**
     * Construct a <code>CreateFacilityContactMech</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFacilityContactMech fromOutput(Map<String, Object> mapValue) {
        CreateFacilityContactMech service = new CreateFacilityContactMech();
