 ...
 */
public class CreatePartyTelecomNumber extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyTelecomNumber</code> from the input values of the given <code>CreatePartyTelecomNumber</code>.
     * @param input a <code>CreatePartyTelecomNumber</code>
     */
    public static CreatePartyTelecomNumber fromInput(CreatePartyTelecomNumber input) {
        CreatePartyTelecomNumber service = new CreatePartyTelecomNumber();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePartyTelecomNumber</code> from the output values of the given <code>CreatePartyTelecomNumber</code>.
     * @param output a <code>CreatePartyTelecomNumber</code>
     */
    public static CreatePartyTelecomNumber fromOutput(CreatePartyTelecomNumber output) {
        CreatePartyTelecomNumber service = new CreatePartyTelecomNumber();
    ...
    /**
     * Construct a <code>CreatePartyTelecomNumber</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyTelecomNumber fromInput(Map<String, Object> mapValue) {
        CreatePartyTelecomNumber service = new CreatePartyTelecomNumber();
    ...
    /**
     * Construct a <code>CreatePartyTelecomNumber</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyTelecomNumber fromOutput(Map<String, Object> mapValue) {
        CreatePartyTelecomNumber service = new CreatePartyTelecomNumber();
