 ...
 */
public class OagisReceiveShowShipment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OagisReceiveShowShipment</code> from the input values of the given <code>OagisReceiveShowShipment</code>.
     * @param input a <code>OagisReceiveShowShipment</code>
     */
    public static OagisReceiveShowShipment fromInput(OagisReceiveShowShipment input) {
        OagisReceiveShowShipment service = new OagisReceiveShowShipment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OagisReceiveShowShipment</code> from the output values of the given <code>OagisReceiveShowShipment</code>.
     * @param output a <code>OagisReceiveShowShipment</code>
     */
    public static OagisReceiveShowShipment fromOutput(OagisReceiveShowShipment output) {
        OagisReceiveShowShipment service = new OagisReceiveShowShipment();
    ...
    /**
     * Construct a <code>OagisReceiveShowShipment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OagisReceiveShowShipment fromInput(Map<String, Object> mapValue) {
        OagisReceiveShowShipment service = new OagisReceiveShowShipment();
    ...
    /**
     * Construct a <code>OagisReceiveShowShipment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OagisReceiveShowShipment fromOutput(Map<String, Object> mapValue) {
        OagisReceiveShowShipment service = new OagisReceiveShowShipment();
