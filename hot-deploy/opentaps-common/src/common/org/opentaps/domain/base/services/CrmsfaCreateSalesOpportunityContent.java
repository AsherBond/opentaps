 ...
 */
public class CrmsfaCreateSalesOpportunityContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateSalesOpportunityContent</code> from the input values of the given <code>CrmsfaCreateSalesOpportunityContent</code>.
     * @param input a <code>CrmsfaCreateSalesOpportunityContent</code>
     */
    public static CrmsfaCreateSalesOpportunityContent fromInput(CrmsfaCreateSalesOpportunityContent input) {
        CrmsfaCreateSalesOpportunityContent service = new CrmsfaCreateSalesOpportunityContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaCreateSalesOpportunityContent</code> from the output values of the given <code>CrmsfaCreateSalesOpportunityContent</code>.
     * @param output a <code>CrmsfaCreateSalesOpportunityContent</code>
     */
    public static CrmsfaCreateSalesOpportunityContent fromOutput(CrmsfaCreateSalesOpportunityContent output) {
        CrmsfaCreateSalesOpportunityContent service = new CrmsfaCreateSalesOpportunityContent();
    ...
    /**
     * Construct a <code>CrmsfaCreateSalesOpportunityContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateSalesOpportunityContent fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateSalesOpportunityContent service = new CrmsfaCreateSalesOpportunityContent();
    ...
    /**
     * Construct a <code>CrmsfaCreateSalesOpportunityContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateSalesOpportunityContent fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateSalesOpportunityContent service = new CrmsfaCreateSalesOpportunityContent();
