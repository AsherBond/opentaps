 ...
 */
public class CreateCreditCardAndAddress extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateCreditCardAndAddress</code> from the input values of the given <code>CreateCreditCardAndAddress</code>.
     * @param input a <code>CreateCreditCardAndAddress</code>
     */
    public static CreateCreditCardAndAddress fromInput(CreateCreditCardAndAddress input) {
        CreateCreditCardAndAddress service = new CreateCreditCardAndAddress();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateCreditCardAndAddress</code> from the output values of the given <code>CreateCreditCardAndAddress</code>.
     * @param output a <code>CreateCreditCardAndAddress</code>
     */
    public static CreateCreditCardAndAddress fromOutput(CreateCreditCardAndAddress output) {
        CreateCreditCardAndAddress service = new CreateCreditCardAndAddress();
    ...
    /**
     * Construct a <code>CreateCreditCardAndAddress</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCreditCardAndAddress fromInput(Map<String, Object> mapValue) {
        CreateCreditCardAndAddress service = new CreateCreditCardAndAddress();
    ...
    /**
     * Construct a <code>CreateCreditCardAndAddress</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCreditCardAndAddress fromOutput(Map<String, Object> mapValue) {
        CreateCreditCardAndAddress service = new CreateCreditCardAndAddress();
