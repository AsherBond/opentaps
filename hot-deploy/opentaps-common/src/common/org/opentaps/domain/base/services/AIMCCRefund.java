 ...
 */
public class AIMCCRefund extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AIMCCRefund</code> from the input values of the given <code>AIMCCRefund</code>.
     * @param input a <code>AIMCCRefund</code>
     */
    public static AIMCCRefund fromInput(AIMCCRefund input) {
        AIMCCRefund service = new AIMCCRefund();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AIMCCRefund</code> from the output values of the given <code>AIMCCRefund</code>.
     * @param output a <code>AIMCCRefund</code>
     */
    public static AIMCCRefund fromOutput(AIMCCRefund output) {
        AIMCCRefund service = new AIMCCRefund();
    ...
    /**
     * Construct a <code>AIMCCRefund</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AIMCCRefund fromInput(Map<String, Object> mapValue) {
        AIMCCRefund service = new AIMCCRefund();
    ...
    /**
     * Construct a <code>AIMCCRefund</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AIMCCRefund fromOutput(Map<String, Object> mapValue) {
        AIMCCRefund service = new AIMCCRefund();
