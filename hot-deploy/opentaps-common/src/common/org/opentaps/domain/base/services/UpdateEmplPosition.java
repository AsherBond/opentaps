 ...
 */
public class UpdateEmplPosition extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateEmplPosition</code> from the input values of the given <code>UpdateEmplPosition</code>.
     * @param input a <code>UpdateEmplPosition</code>
     */
    public static UpdateEmplPosition fromInput(UpdateEmplPosition input) {
        UpdateEmplPosition service = new UpdateEmplPosition();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateEmplPosition</code> from the output values of the given <code>UpdateEmplPosition</code>.
     * @param output a <code>UpdateEmplPosition</code>
     */
    public static UpdateEmplPosition fromOutput(UpdateEmplPosition output) {
        UpdateEmplPosition service = new UpdateEmplPosition();
    ...
    /**
     * Construct a <code>UpdateEmplPosition</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateEmplPosition fromInput(Map<String, Object> mapValue) {
        UpdateEmplPosition service = new UpdateEmplPosition();
    ...
    /**
     * Construct a <code>UpdateEmplPosition</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateEmplPosition fromOutput(Map<String, Object> mapValue) {
        UpdateEmplPosition service = new UpdateEmplPosition();
