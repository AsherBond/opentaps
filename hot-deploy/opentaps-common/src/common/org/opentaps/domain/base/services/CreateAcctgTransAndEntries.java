 ...
 */
public class CreateAcctgTransAndEntries extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateAcctgTransAndEntries</code> from the input values of the given <code>CreateAcctgTransAndEntries</code>.
     * @param input a <code>CreateAcctgTransAndEntries</code>
     */
    public static CreateAcctgTransAndEntries fromInput(CreateAcctgTransAndEntries input) {
        CreateAcctgTransAndEntries service = new CreateAcctgTransAndEntries();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateAcctgTransAndEntries</code> from the output values of the given <code>CreateAcctgTransAndEntries</code>.
     * @param output a <code>CreateAcctgTransAndEntries</code>
     */
    public static CreateAcctgTransAndEntries fromOutput(CreateAcctgTransAndEntries output) {
        CreateAcctgTransAndEntries service = new CreateAcctgTransAndEntries();
    ...
    /**
     * Construct a <code>CreateAcctgTransAndEntries</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateAcctgTransAndEntries fromInput(Map<String, Object> mapValue) {
        CreateAcctgTransAndEntries service = new CreateAcctgTransAndEntries();
    ...
    /**
     * Construct a <code>CreateAcctgTransAndEntries</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateAcctgTransAndEntries fromOutput(Map<String, Object> mapValue) {
        CreateAcctgTransAndEntries service = new CreateAcctgTransAndEntries();
