 ...
 */
public class UpdateDownloadContentForProduct extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateDownloadContentForProduct</code> from the input values of the given <code>UpdateDownloadContentForProduct</code>.
     * @param input a <code>UpdateDownloadContentForProduct</code>
     */
    public static UpdateDownloadContentForProduct fromInput(UpdateDownloadContentForProduct input) {
        UpdateDownloadContentForProduct service = new UpdateDownloadContentForProduct();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateDownloadContentForProduct</code> from the output values of the given <code>UpdateDownloadContentForProduct</code>.
     * @param output a <code>UpdateDownloadContentForProduct</code>
     */
    public static UpdateDownloadContentForProduct fromOutput(UpdateDownloadContentForProduct output) {
        UpdateDownloadContentForProduct service = new UpdateDownloadContentForProduct();
    ...
    /**
     * Construct a <code>UpdateDownloadContentForProduct</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateDownloadContentForProduct fromInput(Map<String, Object> mapValue) {
        UpdateDownloadContentForProduct service = new UpdateDownloadContentForProduct();
    ...
    /**
     * Construct a <code>UpdateDownloadContentForProduct</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateDownloadContentForProduct fromOutput(Map<String, Object> mapValue) {
        UpdateDownloadContentForProduct service = new UpdateDownloadContentForProduct();
