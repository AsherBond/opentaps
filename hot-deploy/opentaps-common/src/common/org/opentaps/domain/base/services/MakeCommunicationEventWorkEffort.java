 ...
 */
public class MakeCommunicationEventWorkEffort extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>MakeCommunicationEventWorkEffort</code> from the input values of the given <code>MakeCommunicationEventWorkEffort</code>.
     * @param input a <code>MakeCommunicationEventWorkEffort</code>
     */
    public static MakeCommunicationEventWorkEffort fromInput(MakeCommunicationEventWorkEffort input) {
        MakeCommunicationEventWorkEffort service = new MakeCommunicationEventWorkEffort();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>MakeCommunicationEventWorkEffort</code> from the output values of the given <code>MakeCommunicationEventWorkEffort</code>.
     * @param output a <code>MakeCommunicationEventWorkEffort</code>
     */
    public static MakeCommunicationEventWorkEffort fromOutput(MakeCommunicationEventWorkEffort output) {
        MakeCommunicationEventWorkEffort service = new MakeCommunicationEventWorkEffort();
    ...
    /**
     * Construct a <code>MakeCommunicationEventWorkEffort</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static MakeCommunicationEventWorkEffort fromInput(Map<String, Object> mapValue) {
        MakeCommunicationEventWorkEffort service = new MakeCommunicationEventWorkEffort();
    ...
    /**
     * Construct a <code>MakeCommunicationEventWorkEffort</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static MakeCommunicationEventWorkEffort fromOutput(Map<String, Object> mapValue) {
        MakeCommunicationEventWorkEffort service = new MakeCommunicationEventWorkEffort();
