 ...
 */
public class UpdateContentPurposeOperation extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateContentPurposeOperation</code> from the input values of the given <code>UpdateContentPurposeOperation</code>.
     * @param input a <code>UpdateContentPurposeOperation</code>
     */
    public static UpdateContentPurposeOperation fromInput(UpdateContentPurposeOperation input) {
        UpdateContentPurposeOperation service = new UpdateContentPurposeOperation();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateContentPurposeOperation</code> from the output values of the given <code>UpdateContentPurposeOperation</code>.
     * @param output a <code>UpdateContentPurposeOperation</code>
     */
    public static UpdateContentPurposeOperation fromOutput(UpdateContentPurposeOperation output) {
        UpdateContentPurposeOperation service = new UpdateContentPurposeOperation();
    ...
    /**
     * Construct a <code>UpdateContentPurposeOperation</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateContentPurposeOperation fromInput(Map<String, Object> mapValue) {
        UpdateContentPurposeOperation service = new UpdateContentPurposeOperation();
    ...
    /**
     * Construct a <code>UpdateContentPurposeOperation</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateContentPurposeOperation fromOutput(Map<String, Object> mapValue) {
        UpdateContentPurposeOperation service = new UpdateContentPurposeOperation();
