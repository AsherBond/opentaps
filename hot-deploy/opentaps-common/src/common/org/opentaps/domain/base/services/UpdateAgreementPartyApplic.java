 ...
 */
public class UpdateAgreementPartyApplic extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateAgreementPartyApplic</code> from the input values of the given <code>UpdateAgreementPartyApplic</code>.
     * @param input a <code>UpdateAgreementPartyApplic</code>
     */
    public static UpdateAgreementPartyApplic fromInput(UpdateAgreementPartyApplic input) {
        UpdateAgreementPartyApplic service = new UpdateAgreementPartyApplic();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateAgreementPartyApplic</code> from the output values of the given <code>UpdateAgreementPartyApplic</code>.
     * @param output a <code>UpdateAgreementPartyApplic</code>
     */
    public static UpdateAgreementPartyApplic fromOutput(UpdateAgreementPartyApplic output) {
        UpdateAgreementPartyApplic service = new UpdateAgreementPartyApplic();
    ...
    /**
     * Construct a <code>UpdateAgreementPartyApplic</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateAgreementPartyApplic fromInput(Map<String, Object> mapValue) {
        UpdateAgreementPartyApplic service = new UpdateAgreementPartyApplic();
    ...
    /**
     * Construct a <code>UpdateAgreementPartyApplic</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateAgreementPartyApplic fromOutput(Map<String, Object> mapValue) {
        UpdateAgreementPartyApplic service = new UpdateAgreementPartyApplic();
