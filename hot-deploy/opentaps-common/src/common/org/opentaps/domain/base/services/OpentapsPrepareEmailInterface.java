 ...
 */
public class OpentapsPrepareEmailInterface extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsPrepareEmailInterface</code> from the input values of the given <code>OpentapsPrepareEmailInterface</code>.
     * @param input a <code>OpentapsPrepareEmailInterface</code>
     */
    public static OpentapsPrepareEmailInterface fromInput(OpentapsPrepareEmailInterface input) {
        OpentapsPrepareEmailInterface service = new OpentapsPrepareEmailInterface();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsPrepareEmailInterface</code> from the output values of the given <code>OpentapsPrepareEmailInterface</code>.
     * @param output a <code>OpentapsPrepareEmailInterface</code>
     */
    public static OpentapsPrepareEmailInterface fromOutput(OpentapsPrepareEmailInterface output) {
        OpentapsPrepareEmailInterface service = new OpentapsPrepareEmailInterface();
    ...
    /**
     * Construct a <code>OpentapsPrepareEmailInterface</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsPrepareEmailInterface fromInput(Map<String, Object> mapValue) {
        OpentapsPrepareEmailInterface service = new OpentapsPrepareEmailInterface();
    ...
    /**
     * Construct a <code>OpentapsPrepareEmailInterface</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsPrepareEmailInterface fromOutput(Map<String, Object> mapValue) {
        OpentapsPrepareEmailInterface service = new OpentapsPrepareEmailInterface();
