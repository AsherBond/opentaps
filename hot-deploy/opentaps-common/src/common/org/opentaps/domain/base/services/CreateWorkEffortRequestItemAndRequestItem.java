 ...
 */
public class CreateWorkEffortRequestItemAndRequestItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateWorkEffortRequestItemAndRequestItem</code> from the input values of the given <code>CreateWorkEffortRequestItemAndRequestItem</code>.
     * @param input a <code>CreateWorkEffortRequestItemAndRequestItem</code>
     */
    public static CreateWorkEffortRequestItemAndRequestItem fromInput(CreateWorkEffortRequestItemAndRequestItem input) {
        CreateWorkEffortRequestItemAndRequestItem service = new CreateWorkEffortRequestItemAndRequestItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateWorkEffortRequestItemAndRequestItem</code> from the output values of the given <code>CreateWorkEffortRequestItemAndRequestItem</code>.
     * @param output a <code>CreateWorkEffortRequestItemAndRequestItem</code>
     */
    public static CreateWorkEffortRequestItemAndRequestItem fromOutput(CreateWorkEffortRequestItemAndRequestItem output) {
        CreateWorkEffortRequestItemAndRequestItem service = new CreateWorkEffortRequestItemAndRequestItem();
    ...
    /**
     * Construct a <code>CreateWorkEffortRequestItemAndRequestItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateWorkEffortRequestItemAndRequestItem fromInput(Map<String, Object> mapValue) {
        CreateWorkEffortRequestItemAndRequestItem service = new CreateWorkEffortRequestItemAndRequestItem();
    ...
    /**
     * Construct a <code>CreateWorkEffortRequestItemAndRequestItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateWorkEffortRequestItemAndRequestItem fromOutput(Map<String, Object> mapValue) {
        CreateWorkEffortRequestItemAndRequestItem service = new CreateWorkEffortRequestItemAndRequestItem();
