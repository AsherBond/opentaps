 ...
 */
public class CrmsfaUpdateAccount extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaUpdateAccount</code> from the input values of the given <code>CrmsfaUpdateAccount</code>.
     * @param input a <code>CrmsfaUpdateAccount</code>
     */
    public static CrmsfaUpdateAccount fromInput(CrmsfaUpdateAccount input) {
        CrmsfaUpdateAccount service = new CrmsfaUpdateAccount();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaUpdateAccount</code> from the output values of the given <code>CrmsfaUpdateAccount</code>.
     * @param output a <code>CrmsfaUpdateAccount</code>
     */
    public static CrmsfaUpdateAccount fromOutput(CrmsfaUpdateAccount output) {
        CrmsfaUpdateAccount service = new CrmsfaUpdateAccount();
    ...
    /**
     * Construct a <code>CrmsfaUpdateAccount</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaUpdateAccount fromInput(Map<String, Object> mapValue) {
        CrmsfaUpdateAccount service = new CrmsfaUpdateAccount();
    ...
    /**
     * Construct a <code>CrmsfaUpdateAccount</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaUpdateAccount fromOutput(Map<String, Object> mapValue) {
        CrmsfaUpdateAccount service = new CrmsfaUpdateAccount();
