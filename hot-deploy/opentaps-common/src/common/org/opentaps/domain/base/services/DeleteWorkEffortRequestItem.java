 ...
 */
public class DeleteWorkEffortRequestItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteWorkEffortRequestItem</code> from the input values of the given <code>DeleteWorkEffortRequestItem</code>.
     * @param input a <code>DeleteWorkEffortRequestItem</code>
     */
    public static DeleteWorkEffortRequestItem fromInput(DeleteWorkEffortRequestItem input) {
        DeleteWorkEffortRequestItem service = new DeleteWorkEffortRequestItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteWorkEffortRequestItem</code> from the output values of the given <code>DeleteWorkEffortRequestItem</code>.
     * @param output a <code>DeleteWorkEffortRequestItem</code>
     */
    public static DeleteWorkEffortRequestItem fromOutput(DeleteWorkEffortRequestItem output) {
        DeleteWorkEffortRequestItem service = new DeleteWorkEffortRequestItem();
    ...
    /**
     * Construct a <code>DeleteWorkEffortRequestItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteWorkEffortRequestItem fromInput(Map<String, Object> mapValue) {
        DeleteWorkEffortRequestItem service = new DeleteWorkEffortRequestItem();
    ...
    /**
     * Construct a <code>DeleteWorkEffortRequestItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteWorkEffortRequestItem fromOutput(Map<String, Object> mapValue) {
        DeleteWorkEffortRequestItem service = new DeleteWorkEffortRequestItem();
