 ...
 */
public class CrmsfaCreateContentForCase extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForCase</code> from the input values of the given <code>CrmsfaCreateContentForCase</code>.
     * @param input a <code>CrmsfaCreateContentForCase</code>
     */
    public static CrmsfaCreateContentForCase fromInput(CrmsfaCreateContentForCase input) {
        CrmsfaCreateContentForCase service = new CrmsfaCreateContentForCase();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaCreateContentForCase</code> from the output values of the given <code>CrmsfaCreateContentForCase</code>.
     * @param output a <code>CrmsfaCreateContentForCase</code>
     */
    public static CrmsfaCreateContentForCase fromOutput(CrmsfaCreateContentForCase output) {
        CrmsfaCreateContentForCase service = new CrmsfaCreateContentForCase();
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForCase</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateContentForCase fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateContentForCase service = new CrmsfaCreateContentForCase();
    ...
    /**
     * Construct a <code>CrmsfaCreateContentForCase</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateContentForCase fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateContentForCase service = new CrmsfaCreateContentForCase();
