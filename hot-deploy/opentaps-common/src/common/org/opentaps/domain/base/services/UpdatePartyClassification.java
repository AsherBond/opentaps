 ...
 */
public class UpdatePartyClassification extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdatePartyClassification</code> from the input values of the given <code>UpdatePartyClassification</code>.
     * @param input a <code>UpdatePartyClassification</code>
     */
    public static UpdatePartyClassification fromInput(UpdatePartyClassification input) {
        UpdatePartyClassification service = new UpdatePartyClassification();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdatePartyClassification</code> from the output values of the given <code>UpdatePartyClassification</code>.
     * @param output a <code>UpdatePartyClassification</code>
     */
    public static UpdatePartyClassification fromOutput(UpdatePartyClassification output) {
        UpdatePartyClassification service = new UpdatePartyClassification();
    ...
    /**
     * Construct a <code>UpdatePartyClassification</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdatePartyClassification fromInput(Map<String, Object> mapValue) {
        UpdatePartyClassification service = new UpdatePartyClassification();
    ...
    /**
     * Construct a <code>UpdatePartyClassification</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdatePartyClassification fromOutput(Map<String, Object> mapValue) {
        UpdatePartyClassification service = new UpdatePartyClassification();
