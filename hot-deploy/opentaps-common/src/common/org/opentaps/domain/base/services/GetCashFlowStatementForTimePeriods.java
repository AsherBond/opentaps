 ...
 */
public class GetCashFlowStatementForTimePeriods extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetCashFlowStatementForTimePeriods</code> from the input values of the given <code>GetCashFlowStatementForTimePeriods</code>.
     * @param input a <code>GetCashFlowStatementForTimePeriods</code>
     */
    public static GetCashFlowStatementForTimePeriods fromInput(GetCashFlowStatementForTimePeriods input) {
        GetCashFlowStatementForTimePeriods service = new GetCashFlowStatementForTimePeriods();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetCashFlowStatementForTimePeriods</code> from the output values of the given <code>GetCashFlowStatementForTimePeriods</code>.
     * @param output a <code>GetCashFlowStatementForTimePeriods</code>
     */
    public static GetCashFlowStatementForTimePeriods fromOutput(GetCashFlowStatementForTimePeriods output) {
        GetCashFlowStatementForTimePeriods service = new GetCashFlowStatementForTimePeriods();
    ...
    /**
     * Construct a <code>GetCashFlowStatementForTimePeriods</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetCashFlowStatementForTimePeriods fromInput(Map<String, Object> mapValue) {
        GetCashFlowStatementForTimePeriods service = new GetCashFlowStatementForTimePeriods();
    ...
    /**
     * Construct a <code>GetCashFlowStatementForTimePeriods</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetCashFlowStatementForTimePeriods fromOutput(Map<String, Object> mapValue) {
        GetCashFlowStatementForTimePeriods service = new GetCashFlowStatementForTimePeriods();
