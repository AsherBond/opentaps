 ...
 */
public class OpentapsAppendOrderItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsAppendOrderItem</code> from the input values of the given <code>OpentapsAppendOrderItem</code>.
     * @param input a <code>OpentapsAppendOrderItem</code>
     */
    public static OpentapsAppendOrderItem fromInput(OpentapsAppendOrderItem input) {
    ...
    /**
     * Construct a <code>OpentapsAppendOrderItem</code> from the output values of the given <code>OpentapsAppendOrderItem</code>.
     * @param output a <code>OpentapsAppendOrderItem</code>
     */
    public static OpentapsAppendOrderItem fromOutput(OpentapsAppendOrderItem output) {
        OpentapsAppendOrderItem service = new OpentapsAppendOrderItem();
    ...
    /**
     * Construct a <code>OpentapsAppendOrderItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsAppendOrderItem fromInput(Map<String, Object> mapValue) {
        OpentapsAppendOrderItem service = new OpentapsAppendOrderItem();
    ...
    /**
     * Construct a <code>OpentapsAppendOrderItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsAppendOrderItem fromOutput(Map<String, Object> mapValue) {
        OpentapsAppendOrderItem service = new OpentapsAppendOrderItem();
