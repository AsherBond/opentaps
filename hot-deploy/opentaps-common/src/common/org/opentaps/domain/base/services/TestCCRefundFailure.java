 ...
 */
public class TestCCRefundFailure extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>TestCCRefundFailure</code> from the input values of the given <code>TestCCRefundFailure</code>.
     * @param input a <code>TestCCRefundFailure</code>
     */
    public static TestCCRefundFailure fromInput(TestCCRefundFailure input) {
        TestCCRefundFailure service = new TestCCRefundFailure();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>TestCCRefundFailure</code> from the output values of the given <code>TestCCRefundFailure</code>.
     * @param output a <code>TestCCRefundFailure</code>
     */
    public static TestCCRefundFailure fromOutput(TestCCRefundFailure output) {
        TestCCRefundFailure service = new TestCCRefundFailure();
    ...
    /**
     * Construct a <code>TestCCRefundFailure</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static TestCCRefundFailure fromInput(Map<String, Object> mapValue) {
        TestCCRefundFailure service = new TestCCRefundFailure();
    ...
    /**
     * Construct a <code>TestCCRefundFailure</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static TestCCRefundFailure fromOutput(Map<String, Object> mapValue) {
        TestCCRefundFailure service = new TestCCRefundFailure();
