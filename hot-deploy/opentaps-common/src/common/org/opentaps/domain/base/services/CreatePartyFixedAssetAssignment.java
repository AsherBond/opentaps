 ...
 */
public class CreatePartyFixedAssetAssignment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyFixedAssetAssignment</code> from the input values of the given <code>CreatePartyFixedAssetAssignment</code>.
     * @param input a <code>CreatePartyFixedAssetAssignment</code>
     */
    public static CreatePartyFixedAssetAssignment fromInput(CreatePartyFixedAssetAssignment input) {
        CreatePartyFixedAssetAssignment service = new CreatePartyFixedAssetAssignment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePartyFixedAssetAssignment</code> from the output values of the given <code>CreatePartyFixedAssetAssignment</code>.
     * @param output a <code>CreatePartyFixedAssetAssignment</code>
     */
    public static CreatePartyFixedAssetAssignment fromOutput(CreatePartyFixedAssetAssignment output) {
        CreatePartyFixedAssetAssignment service = new CreatePartyFixedAssetAssignment();
    ...
    /**
     * Construct a <code>CreatePartyFixedAssetAssignment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyFixedAssetAssignment fromInput(Map<String, Object> mapValue) {
        CreatePartyFixedAssetAssignment service = new CreatePartyFixedAssetAssignment();
    ...
    /**
     * Construct a <code>CreatePartyFixedAssetAssignment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyFixedAssetAssignment fromOutput(Map<String, Object> mapValue) {
        CreatePartyFixedAssetAssignment service = new CreatePartyFixedAssetAssignment();
