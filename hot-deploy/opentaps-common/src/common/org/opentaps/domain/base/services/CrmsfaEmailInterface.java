 ...
 */
public class CrmsfaEmailInterface extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaEmailInterface</code> from the input values of the given <code>CrmsfaEmailInterface</code>.
     * @param input a <code>CrmsfaEmailInterface</code>
     */
    public static CrmsfaEmailInterface fromInput(CrmsfaEmailInterface input) {
        CrmsfaEmailInterface service = new CrmsfaEmailInterface();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaEmailInterface</code> from the output values of the given <code>CrmsfaEmailInterface</code>.
     * @param output a <code>CrmsfaEmailInterface</code>
     */
    public static CrmsfaEmailInterface fromOutput(CrmsfaEmailInterface output) {
        CrmsfaEmailInterface service = new CrmsfaEmailInterface();
    ...
    /**
     * Construct a <code>CrmsfaEmailInterface</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaEmailInterface fromInput(Map<String, Object> mapValue) {
        CrmsfaEmailInterface service = new CrmsfaEmailInterface();
    ...
    /**
     * Construct a <code>CrmsfaEmailInterface</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaEmailInterface fromOutput(Map<String, Object> mapValue) {
        CrmsfaEmailInterface service = new CrmsfaEmailInterface();
