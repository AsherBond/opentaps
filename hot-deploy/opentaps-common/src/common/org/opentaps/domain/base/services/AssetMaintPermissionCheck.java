 ...
 */
public class AssetMaintPermissionCheck extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AssetMaintPermissionCheck</code> from the input values of the given <code>AssetMaintPermissionCheck</code>.
     * @param input a <code>AssetMaintPermissionCheck</code>
     */
    public static AssetMaintPermissionCheck fromInput(AssetMaintPermissionCheck input) {
        AssetMaintPermissionCheck service = new AssetMaintPermissionCheck();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AssetMaintPermissionCheck</code> from the output values of the given <code>AssetMaintPermissionCheck</code>.
     * @param output a <code>AssetMaintPermissionCheck</code>
     */
    public static AssetMaintPermissionCheck fromOutput(AssetMaintPermissionCheck output) {
        AssetMaintPermissionCheck service = new AssetMaintPermissionCheck();
    ...
    /**
     * Construct a <code>AssetMaintPermissionCheck</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AssetMaintPermissionCheck fromInput(Map<String, Object> mapValue) {
        AssetMaintPermissionCheck service = new AssetMaintPermissionCheck();
    ...
    /**
     * Construct a <code>AssetMaintPermissionCheck</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AssetMaintPermissionCheck fromOutput(Map<String, Object> mapValue) {
        AssetMaintPermissionCheck service = new AssetMaintPermissionCheck();
