...
import org.opentaps.domain.base.entities.WorkflowTransitionPk;

/**
 * A FieldBridge for WorkflowTransitionPk.
 */
public class WorkflowTransitionPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkflowTransitionPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkflowTransitionPk id = new WorkflowTransitionPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkflowTransitionPk id = (WorkflowTransitionPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkflowTransitionPk id = (WorkflowTransitionPk) value;
