 ...
 */
public class RemovePaymentApplication extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemovePaymentApplication</code> from the input values of the given <code>RemovePaymentApplication</code>.
     * @param input a <code>RemovePaymentApplication</code>
     */
    public static RemovePaymentApplication fromInput(RemovePaymentApplication input) {
        RemovePaymentApplication service = new RemovePaymentApplication();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemovePaymentApplication</code> from the output values of the given <code>RemovePaymentApplication</code>.
     * @param output a <code>RemovePaymentApplication</code>
     */
    public static RemovePaymentApplication fromOutput(RemovePaymentApplication output) {
        RemovePaymentApplication service = new RemovePaymentApplication();
    ...
    /**
     * Construct a <code>RemovePaymentApplication</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemovePaymentApplication fromInput(Map<String, Object> mapValue) {
        RemovePaymentApplication service = new RemovePaymentApplication();
    ...
    /**
     * Construct a <code>RemovePaymentApplication</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemovePaymentApplication fromOutput(Map<String, Object> mapValue) {
        RemovePaymentApplication service = new RemovePaymentApplication();
