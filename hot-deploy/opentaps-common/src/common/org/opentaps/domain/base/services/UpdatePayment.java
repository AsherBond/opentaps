 ...
 */
public class UpdatePayment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdatePayment</code> from the input values of the given <code>UpdatePayment</code>.
     * @param input a <code>UpdatePayment</code>
     */
    public static UpdatePayment fromInput(UpdatePayment input) {
        UpdatePayment service = new UpdatePayment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdatePayment</code> from the output values of the given <code>UpdatePayment</code>.
     * @param output a <code>UpdatePayment</code>
     */
    public static UpdatePayment fromOutput(UpdatePayment output) {
        UpdatePayment service = new UpdatePayment();
    ...
    /**
     * Construct a <code>UpdatePayment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdatePayment fromInput(Map<String, Object> mapValue) {
        UpdatePayment service = new UpdatePayment();
    ...
    /**
     * Construct a <code>UpdatePayment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdatePayment fromOutput(Map<String, Object> mapValue) {
        UpdatePayment service = new UpdatePayment();
