 ...
 */
public class UpdateAcctgTrans extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateAcctgTrans</code> from the input values of the given <code>UpdateAcctgTrans</code>.
     * @param input a <code>UpdateAcctgTrans</code>
     */
    public static UpdateAcctgTrans fromInput(UpdateAcctgTrans input) {
        UpdateAcctgTrans service = new UpdateAcctgTrans();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateAcctgTrans</code> from the output values of the given <code>UpdateAcctgTrans</code>.
     * @param output a <code>UpdateAcctgTrans</code>
     */
    public static UpdateAcctgTrans fromOutput(UpdateAcctgTrans output) {
        UpdateAcctgTrans service = new UpdateAcctgTrans();
    ...
    /**
     * Construct a <code>UpdateAcctgTrans</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateAcctgTrans fromInput(Map<String, Object> mapValue) {
        UpdateAcctgTrans service = new UpdateAcctgTrans();
    ...
    /**
     * Construct a <code>UpdateAcctgTrans</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateAcctgTrans fromOutput(Map<String, Object> mapValue) {
        UpdateAcctgTrans service = new UpdateAcctgTrans();
