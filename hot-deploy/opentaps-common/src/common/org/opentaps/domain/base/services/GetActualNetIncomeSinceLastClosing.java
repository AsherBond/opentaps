 ...
 */
public class GetActualNetIncomeSinceLastClosing extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetActualNetIncomeSinceLastClosing</code> from the input values of the given <code>GetActualNetIncomeSinceLastClosing</code>.
     * @param input a <code>GetActualNetIncomeSinceLastClosing</code>
     */
    public static GetActualNetIncomeSinceLastClosing fromInput(GetActualNetIncomeSinceLastClosing input) {
        GetActualNetIncomeSinceLastClosing service = new GetActualNetIncomeSinceLastClosing();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetActualNetIncomeSinceLastClosing</code> from the output values of the given <code>GetActualNetIncomeSinceLastClosing</code>.
     * @param output a <code>GetActualNetIncomeSinceLastClosing</code>
     */
    public static GetActualNetIncomeSinceLastClosing fromOutput(GetActualNetIncomeSinceLastClosing output) {
        GetActualNetIncomeSinceLastClosing service = new GetActualNetIncomeSinceLastClosing();
    ...
    /**
     * Construct a <code>GetActualNetIncomeSinceLastClosing</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetActualNetIncomeSinceLastClosing fromInput(Map<String, Object> mapValue) {
        GetActualNetIncomeSinceLastClosing service = new GetActualNetIncomeSinceLastClosing();
    ...
    /**
     * Construct a <code>GetActualNetIncomeSinceLastClosing</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetActualNetIncomeSinceLastClosing fromOutput(Map<String, Object> mapValue) {
        GetActualNetIncomeSinceLastClosing service = new GetActualNetIncomeSinceLastClosing();
