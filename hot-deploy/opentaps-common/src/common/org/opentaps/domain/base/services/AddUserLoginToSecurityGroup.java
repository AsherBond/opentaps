 ...
 */
public class AddUserLoginToSecurityGroup extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AddUserLoginToSecurityGroup</code> from the input values of the given <code>AddUserLoginToSecurityGroup</code>.
     * @param input a <code>AddUserLoginToSecurityGroup</code>
     */
    public static AddUserLoginToSecurityGroup fromInput(AddUserLoginToSecurityGroup input) {
        AddUserLoginToSecurityGroup service = new AddUserLoginToSecurityGroup();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AddUserLoginToSecurityGroup</code> from the output values of the given <code>AddUserLoginToSecurityGroup</code>.
     * @param output a <code>AddUserLoginToSecurityGroup</code>
     */
    public static AddUserLoginToSecurityGroup fromOutput(AddUserLoginToSecurityGroup output) {
        AddUserLoginToSecurityGroup service = new AddUserLoginToSecurityGroup();
    ...
    /**
     * Construct a <code>AddUserLoginToSecurityGroup</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AddUserLoginToSecurityGroup fromInput(Map<String, Object> mapValue) {
        AddUserLoginToSecurityGroup service = new AddUserLoginToSecurityGroup();
    ...
    /**
     * Construct a <code>AddUserLoginToSecurityGroup</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AddUserLoginToSecurityGroup fromOutput(Map<String, Object> mapValue) {
        AddUserLoginToSecurityGroup service = new AddUserLoginToSecurityGroup();
