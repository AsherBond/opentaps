 ...
 */
public class CreateInventoryItemDetail extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateInventoryItemDetail</code> from the input values of the given <code>CreateInventoryItemDetail</code>.
     * @param input a <code>CreateInventoryItemDetail</code>
     */
    public static CreateInventoryItemDetail fromInput(CreateInventoryItemDetail input) {
        CreateInventoryItemDetail service = new CreateInventoryItemDetail();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateInventoryItemDetail</code> from the output values of the given <code>CreateInventoryItemDetail</code>.
     * @param output a <code>CreateInventoryItemDetail</code>
     */
    public static CreateInventoryItemDetail fromOutput(CreateInventoryItemDetail output) {
        CreateInventoryItemDetail service = new CreateInventoryItemDetail();
    ...
    /**
     * Construct a <code>CreateInventoryItemDetail</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateInventoryItemDetail fromInput(Map<String, Object> mapValue) {
        CreateInventoryItemDetail service = new CreateInventoryItemDetail();
    ...
    /**
     * Construct a <code>CreateInventoryItemDetail</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateInventoryItemDetail fromOutput(Map<String, Object> mapValue) {
        CreateInventoryItemDetail service = new CreateInventoryItemDetail();
