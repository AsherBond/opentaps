 ...
 */
public class RitaCCRefundRemote extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RitaCCRefundRemote</code> from the input values of the given <code>RitaCCRefundRemote</code>.
     * @param input a <code>RitaCCRefundRemote</code>
     */
    public static RitaCCRefundRemote fromInput(RitaCCRefundRemote input) {
        RitaCCRefundRemote service = new RitaCCRefundRemote();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RitaCCRefundRemote</code> from the output values of the given <code>RitaCCRefundRemote</code>.
     * @param output a <code>RitaCCRefundRemote</code>
     */
    public static RitaCCRefundRemote fromOutput(RitaCCRefundRemote output) {
        RitaCCRefundRemote service = new RitaCCRefundRemote();
    ...
    /**
     * Construct a <code>RitaCCRefundRemote</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RitaCCRefundRemote fromInput(Map<String, Object> mapValue) {
        RitaCCRefundRemote service = new RitaCCRefundRemote();
    ...
    /**
     * Construct a <code>RitaCCRefundRemote</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RitaCCRefundRemote fromOutput(Map<String, Object> mapValue) {
        RitaCCRefundRemote service = new RitaCCRefundRemote();
