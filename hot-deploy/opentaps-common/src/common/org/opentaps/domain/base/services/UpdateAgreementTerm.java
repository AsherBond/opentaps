 ...
 */
public class UpdateAgreementTerm extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateAgreementTerm</code> from the input values of the given <code>UpdateAgreementTerm</code>.
     * @param input a <code>UpdateAgreementTerm</code>
     */
    public static UpdateAgreementTerm fromInput(UpdateAgreementTerm input) {
        UpdateAgreementTerm service = new UpdateAgreementTerm();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateAgreementTerm</code> from the output values of the given <code>UpdateAgreementTerm</code>.
     * @param output a <code>UpdateAgreementTerm</code>
     */
    public static UpdateAgreementTerm fromOutput(UpdateAgreementTerm output) {
        UpdateAgreementTerm service = new UpdateAgreementTerm();
    ...
    /**
     * Construct a <code>UpdateAgreementTerm</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateAgreementTerm fromInput(Map<String, Object> mapValue) {
        UpdateAgreementTerm service = new UpdateAgreementTerm();
    ...
    /**
     * Construct a <code>UpdateAgreementTerm</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateAgreementTerm fromOutput(Map<String, Object> mapValue) {
        UpdateAgreementTerm service = new UpdateAgreementTerm();
