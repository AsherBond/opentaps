 ...
 */
public class UpdateProductCategoryToProdCatalog extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateProductCategoryToProdCatalog</code> from the input values of the given <code>UpdateProductCategoryToProdCatalog</code>.
     * @param input a <code>UpdateProductCategoryToProdCatalog</code>
     */
    public static UpdateProductCategoryToProdCatalog fromInput(UpdateProductCategoryToProdCatalog input) {
        UpdateProductCategoryToProdCatalog service = new UpdateProductCategoryToProdCatalog();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateProductCategoryToProdCatalog</code> from the output values of the given <code>UpdateProductCategoryToProdCatalog</code>.
     * @param output a <code>UpdateProductCategoryToProdCatalog</code>
     */
    public static UpdateProductCategoryToProdCatalog fromOutput(UpdateProductCategoryToProdCatalog output) {
        UpdateProductCategoryToProdCatalog service = new UpdateProductCategoryToProdCatalog();
    ...
    /**
     * Construct a <code>UpdateProductCategoryToProdCatalog</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateProductCategoryToProdCatalog fromInput(Map<String, Object> mapValue) {
        UpdateProductCategoryToProdCatalog service = new UpdateProductCategoryToProdCatalog();
    ...
    /**
     * Construct a <code>UpdateProductCategoryToProdCatalog</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateProductCategoryToProdCatalog fromOutput(Map<String, Object> mapValue) {
        UpdateProductCategoryToProdCatalog service = new UpdateProductCategoryToProdCatalog();
