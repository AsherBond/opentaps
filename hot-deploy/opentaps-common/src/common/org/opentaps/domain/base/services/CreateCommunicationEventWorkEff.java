 ...
 */
public class CreateCommunicationEventWorkEff extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateCommunicationEventWorkEff</code> from the input values of the given <code>CreateCommunicationEventWorkEff</code>.
     * @param input a <code>CreateCommunicationEventWorkEff</code>
     */
    public static CreateCommunicationEventWorkEff fromInput(CreateCommunicationEventWorkEff input) {
        CreateCommunicationEventWorkEff service = new CreateCommunicationEventWorkEff();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateCommunicationEventWorkEff</code> from the output values of the given <code>CreateCommunicationEventWorkEff</code>.
     * @param output a <code>CreateCommunicationEventWorkEff</code>
     */
    public static CreateCommunicationEventWorkEff fromOutput(CreateCommunicationEventWorkEff output) {
        CreateCommunicationEventWorkEff service = new CreateCommunicationEventWorkEff();
    ...
    /**
     * Construct a <code>CreateCommunicationEventWorkEff</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCommunicationEventWorkEff fromInput(Map<String, Object> mapValue) {
        CreateCommunicationEventWorkEff service = new CreateCommunicationEventWorkEff();
    ...
    /**
     * Construct a <code>CreateCommunicationEventWorkEff</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCommunicationEventWorkEff fromOutput(Map<String, Object> mapValue) {
        CreateCommunicationEventWorkEff service = new CreateCommunicationEventWorkEff();
