 ...
 */
public class CreateQuoteAndQuoteItemForRequest extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateQuoteAndQuoteItemForRequest</code> from the input values of the given <code>CreateQuoteAndQuoteItemForRequest</code>.
     * @param input a <code>CreateQuoteAndQuoteItemForRequest</code>
     */
    public static CreateQuoteAndQuoteItemForRequest fromInput(CreateQuoteAndQuoteItemForRequest input) {
        CreateQuoteAndQuoteItemForRequest service = new CreateQuoteAndQuoteItemForRequest();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateQuoteAndQuoteItemForRequest</code> from the output values of the given <code>CreateQuoteAndQuoteItemForRequest</code>.
     * @param output a <code>CreateQuoteAndQuoteItemForRequest</code>
     */
    public static CreateQuoteAndQuoteItemForRequest fromOutput(CreateQuoteAndQuoteItemForRequest output) {
        CreateQuoteAndQuoteItemForRequest service = new CreateQuoteAndQuoteItemForRequest();
    ...
    /**
     * Construct a <code>CreateQuoteAndQuoteItemForRequest</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateQuoteAndQuoteItemForRequest fromInput(Map<String, Object> mapValue) {
        CreateQuoteAndQuoteItemForRequest service = new CreateQuoteAndQuoteItemForRequest();
    ...
    /**
     * Construct a <code>CreateQuoteAndQuoteItemForRequest</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateQuoteAndQuoteItemForRequest fromOutput(Map<String, Object> mapValue) {
        CreateQuoteAndQuoteItemForRequest service = new CreateQuoteAndQuoteItemForRequest();
