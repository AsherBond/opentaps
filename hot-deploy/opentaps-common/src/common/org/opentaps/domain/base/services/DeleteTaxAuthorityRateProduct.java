 ...
 */
public class DeleteTaxAuthorityRateProduct extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityRateProduct</code> from the input values of the given <code>DeleteTaxAuthorityRateProduct</code>.
     * @param input a <code>DeleteTaxAuthorityRateProduct</code>
     */
    public static DeleteTaxAuthorityRateProduct fromInput(DeleteTaxAuthorityRateProduct input) {
        DeleteTaxAuthorityRateProduct service = new DeleteTaxAuthorityRateProduct();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteTaxAuthorityRateProduct</code> from the output values of the given <code>DeleteTaxAuthorityRateProduct</code>.
     * @param output a <code>DeleteTaxAuthorityRateProduct</code>
     */
    public static DeleteTaxAuthorityRateProduct fromOutput(DeleteTaxAuthorityRateProduct output) {
        DeleteTaxAuthorityRateProduct service = new DeleteTaxAuthorityRateProduct();
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityRateProduct</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteTaxAuthorityRateProduct fromInput(Map<String, Object> mapValue) {
        DeleteTaxAuthorityRateProduct service = new DeleteTaxAuthorityRateProduct();
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityRateProduct</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteTaxAuthorityRateProduct fromOutput(Map<String, Object> mapValue) {
        DeleteTaxAuthorityRateProduct service = new DeleteTaxAuthorityRateProduct();
