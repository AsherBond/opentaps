 ...
 */
public class OpentapsCreatePartnerSalesInvoice extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsCreatePartnerSalesInvoice</code> from the input values of the given <code>OpentapsCreatePartnerSalesInvoice</code>.
     * @param input a <code>OpentapsCreatePartnerSalesInvoice</code>
     */
    public static OpentapsCreatePartnerSalesInvoice fromInput(OpentapsCreatePartnerSalesInvoice input) {
        OpentapsCreatePartnerSalesInvoice service = new OpentapsCreatePartnerSalesInvoice();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsCreatePartnerSalesInvoice</code> from the output values of the given <code>OpentapsCreatePartnerSalesInvoice</code>.
     * @param output a <code>OpentapsCreatePartnerSalesInvoice</code>
     */
    public static OpentapsCreatePartnerSalesInvoice fromOutput(OpentapsCreatePartnerSalesInvoice output) {
        OpentapsCreatePartnerSalesInvoice service = new OpentapsCreatePartnerSalesInvoice();
    ...
    /**
     * Construct a <code>OpentapsCreatePartnerSalesInvoice</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsCreatePartnerSalesInvoice fromInput(Map<String, Object> mapValue) {
        OpentapsCreatePartnerSalesInvoice service = new OpentapsCreatePartnerSalesInvoice();
    ...
    /**
     * Construct a <code>OpentapsCreatePartnerSalesInvoice</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsCreatePartnerSalesInvoice fromOutput(Map<String, Object> mapValue) {
        OpentapsCreatePartnerSalesInvoice service = new OpentapsCreatePartnerSalesInvoice();
