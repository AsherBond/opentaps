 ...
 */
public class UpdateEftAccountAndAddress extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateEftAccountAndAddress</code> from the input values of the given <code>UpdateEftAccountAndAddress</code>.
     * @param input a <code>UpdateEftAccountAndAddress</code>
     */
    public static UpdateEftAccountAndAddress fromInput(UpdateEftAccountAndAddress input) {
        UpdateEftAccountAndAddress service = new UpdateEftAccountAndAddress();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateEftAccountAndAddress</code> from the output values of the given <code>UpdateEftAccountAndAddress</code>.
     * @param output a <code>UpdateEftAccountAndAddress</code>
     */
    public static UpdateEftAccountAndAddress fromOutput(UpdateEftAccountAndAddress output) {
        UpdateEftAccountAndAddress service = new UpdateEftAccountAndAddress();
    ...
    /**
     * Construct a <code>UpdateEftAccountAndAddress</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateEftAccountAndAddress fromInput(Map<String, Object> mapValue) {
        UpdateEftAccountAndAddress service = new UpdateEftAccountAndAddress();
    ...
    /**
     * Construct a <code>UpdateEftAccountAndAddress</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateEftAccountAndAddress fromOutput(Map<String, Object> mapValue) {
        UpdateEftAccountAndAddress service = new UpdateEftAccountAndAddress();
