 ...
 */
public class CaptureBillingAccountPayment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CaptureBillingAccountPayment</code> from the input values of the given <code>CaptureBillingAccountPayment</code>.
     * @param input a <code>CaptureBillingAccountPayment</code>
     */
    public static CaptureBillingAccountPayment fromInput(CaptureBillingAccountPayment input) {
        CaptureBillingAccountPayment service = new CaptureBillingAccountPayment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CaptureBillingAccountPayment</code> from the output values of the given <code>CaptureBillingAccountPayment</code>.
     * @param output a <code>CaptureBillingAccountPayment</code>
     */
    public static CaptureBillingAccountPayment fromOutput(CaptureBillingAccountPayment output) {
        CaptureBillingAccountPayment service = new CaptureBillingAccountPayment();
    ...
    /**
     * Construct a <code>CaptureBillingAccountPayment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CaptureBillingAccountPayment fromInput(Map<String, Object> mapValue) {
        CaptureBillingAccountPayment service = new CaptureBillingAccountPayment();
    ...
    /**
     * Construct a <code>CaptureBillingAccountPayment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CaptureBillingAccountPayment fromOutput(Map<String, Object> mapValue) {
        CaptureBillingAccountPayment service = new CaptureBillingAccountPayment();
