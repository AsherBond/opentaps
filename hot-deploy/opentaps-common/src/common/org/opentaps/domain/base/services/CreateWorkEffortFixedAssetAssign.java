 ...
 */
public class CreateWorkEffortFixedAssetAssign extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateWorkEffortFixedAssetAssign</code> from the input values of the given <code>CreateWorkEffortFixedAssetAssign</code>.
     * @param input a <code>CreateWorkEffortFixedAssetAssign</code>
     */
    public static CreateWorkEffortFixedAssetAssign fromInput(CreateWorkEffortFixedAssetAssign input) {
        CreateWorkEffortFixedAssetAssign service = new CreateWorkEffortFixedAssetAssign();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateWorkEffortFixedAssetAssign</code> from the output values of the given <code>CreateWorkEffortFixedAssetAssign</code>.
     * @param output a <code>CreateWorkEffortFixedAssetAssign</code>
     */
    public static CreateWorkEffortFixedAssetAssign fromOutput(CreateWorkEffortFixedAssetAssign output) {
        CreateWorkEffortFixedAssetAssign service = new CreateWorkEffortFixedAssetAssign();
    ...
    /**
     * Construct a <code>CreateWorkEffortFixedAssetAssign</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateWorkEffortFixedAssetAssign fromInput(Map<String, Object> mapValue) {
        CreateWorkEffortFixedAssetAssign service = new CreateWorkEffortFixedAssetAssign();
    ...
    /**
     * Construct a <code>CreateWorkEffortFixedAssetAssign</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateWorkEffortFixedAssetAssign fromOutput(Map<String, Object> mapValue) {
        CreateWorkEffortFixedAssetAssign service = new CreateWorkEffortFixedAssetAssign();
