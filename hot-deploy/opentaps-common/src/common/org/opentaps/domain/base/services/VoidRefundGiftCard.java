 ...
 */
public class VoidRefundGiftCard extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>VoidRefundGiftCard</code> from the input values of the given <code>VoidRefundGiftCard</code>.
     * @param input a <code>VoidRefundGiftCard</code>
     */
    public static VoidRefundGiftCard fromInput(VoidRefundGiftCard input) {
        VoidRefundGiftCard service = new VoidRefundGiftCard();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>VoidRefundGiftCard</code> from the output values of the given <code>VoidRefundGiftCard</code>.
     * @param output a <code>VoidRefundGiftCard</code>
     */
    public static VoidRefundGiftCard fromOutput(VoidRefundGiftCard output) {
        VoidRefundGiftCard service = new VoidRefundGiftCard();
    ...
    /**
     * Construct a <code>VoidRefundGiftCard</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static VoidRefundGiftCard fromInput(Map<String, Object> mapValue) {
        VoidRefundGiftCard service = new VoidRefundGiftCard();
    ...
    /**
     * Construct a <code>VoidRefundGiftCard</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static VoidRefundGiftCard fromOutput(Map<String, Object> mapValue) {
        VoidRefundGiftCard service = new VoidRefundGiftCard();
