 ...
 */
public class RemoveOrderTerm extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemoveOrderTerm</code> from the input values of the given <code>RemoveOrderTerm</code>.
     * @param input a <code>RemoveOrderTerm</code>
     */
    public static RemoveOrderTerm fromInput(RemoveOrderTerm input) {
        RemoveOrderTerm service = new RemoveOrderTerm();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemoveOrderTerm</code> from the output values of the given <code>RemoveOrderTerm</code>.
     * @param output a <code>RemoveOrderTerm</code>
     */
    public static RemoveOrderTerm fromOutput(RemoveOrderTerm output) {
        RemoveOrderTerm service = new RemoveOrderTerm();
    ...
    /**
     * Construct a <code>RemoveOrderTerm</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveOrderTerm fromInput(Map<String, Object> mapValue) {
        RemoveOrderTerm service = new RemoveOrderTerm();
    ...
    /**
     * Construct a <code>RemoveOrderTerm</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveOrderTerm fromOutput(Map<String, Object> mapValue) {
        RemoveOrderTerm service = new RemoveOrderTerm();
