 ...
 */
public class DeleteFacilityContactMechPurpose extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteFacilityContactMechPurpose</code> from the input values of the given <code>DeleteFacilityContactMechPurpose</code>.
     * @param input a <code>DeleteFacilityContactMechPurpose</code>
     */
    public static DeleteFacilityContactMechPurpose fromInput(DeleteFacilityContactMechPurpose input) {
        DeleteFacilityContactMechPurpose service = new DeleteFacilityContactMechPurpose();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteFacilityContactMechPurpose</code> from the output values of the given <code>DeleteFacilityContactMechPurpose</code>.
     * @param output a <code>DeleteFacilityContactMechPurpose</code>
     */
    public static DeleteFacilityContactMechPurpose fromOutput(DeleteFacilityContactMechPurpose output) {
        DeleteFacilityContactMechPurpose service = new DeleteFacilityContactMechPurpose();
    ...
    /**
     * Construct a <code>DeleteFacilityContactMechPurpose</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteFacilityContactMechPurpose fromInput(Map<String, Object> mapValue) {
        DeleteFacilityContactMechPurpose service = new DeleteFacilityContactMechPurpose();
    ...
    /**
     * Construct a <code>DeleteFacilityContactMechPurpose</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteFacilityContactMechPurpose fromOutput(Map<String, Object> mapValue) {
        DeleteFacilityContactMechPurpose service = new DeleteFacilityContactMechPurpose();
