...
import org.opentaps.domain.base.entities.WorkflowDataFieldPk;

/**
 * A FieldBridge for WorkflowDataFieldPk.
 */
public class WorkflowDataFieldPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkflowDataFieldPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkflowDataFieldPk id = new WorkflowDataFieldPk();
        Field field = null;
        ...
        field = document.getField(name + ".dataFieldId");
        id.setDataFieldId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        WorkflowDataFieldPk id = (WorkflowDataFieldPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkflowDataFieldPk id = (WorkflowDataFieldPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".dataFieldId", id.getDataFieldId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
