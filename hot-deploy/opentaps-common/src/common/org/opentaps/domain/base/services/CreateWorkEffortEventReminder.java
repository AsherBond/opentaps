 ...
 */
public class CreateWorkEffortEventReminder extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateWorkEffortEventReminder</code> from the input values of the given <code>CreateWorkEffortEventReminder</code>.
     * @param input a <code>CreateWorkEffortEventReminder</code>
     */
    public static CreateWorkEffortEventReminder fromInput(CreateWorkEffortEventReminder input) {
        CreateWorkEffortEventReminder service = new CreateWorkEffortEventReminder();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateWorkEffortEventReminder</code> from the output values of the given <code>CreateWorkEffortEventReminder</code>.
     * @param output a <code>CreateWorkEffortEventReminder</code>
     */
    public static CreateWorkEffortEventReminder fromOutput(CreateWorkEffortEventReminder output) {
        CreateWorkEffortEventReminder service = new CreateWorkEffortEventReminder();
    ...
    /**
     * Construct a <code>CreateWorkEffortEventReminder</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateWorkEffortEventReminder fromInput(Map<String, Object> mapValue) {
        CreateWorkEffortEventReminder service = new CreateWorkEffortEventReminder();
    ...
    /**
     * Construct a <code>CreateWorkEffortEventReminder</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateWorkEffortEventReminder fromOutput(Map<String, Object> mapValue) {
        CreateWorkEffortEventReminder service = new CreateWorkEffortEventReminder();
