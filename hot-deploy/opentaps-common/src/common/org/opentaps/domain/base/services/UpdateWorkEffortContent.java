 ...
 */
public class UpdateWorkEffortContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateWorkEffortContent</code> from the input values of the given <code>UpdateWorkEffortContent</code>.
     * @param input a <code>UpdateWorkEffortContent</code>
     */
    public static UpdateWorkEffortContent fromInput(UpdateWorkEffortContent input) {
        UpdateWorkEffortContent service = new UpdateWorkEffortContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateWorkEffortContent</code> from the output values of the given <code>UpdateWorkEffortContent</code>.
     * @param output a <code>UpdateWorkEffortContent</code>
     */
    public static UpdateWorkEffortContent fromOutput(UpdateWorkEffortContent output) {
        UpdateWorkEffortContent service = new UpdateWorkEffortContent();
    ...
    /**
     * Construct a <code>UpdateWorkEffortContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateWorkEffortContent fromInput(Map<String, Object> mapValue) {
        UpdateWorkEffortContent service = new UpdateWorkEffortContent();
    ...
    /**
     * Construct a <code>UpdateWorkEffortContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateWorkEffortContent fromOutput(Map<String, Object> mapValue) {
        UpdateWorkEffortContent service = new UpdateWorkEffortContent();
