 ...
 */
public class VoidRedeemGiftCard extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>VoidRedeemGiftCard</code> from the input values of the given <code>VoidRedeemGiftCard</code>.
     * @param input a <code>VoidRedeemGiftCard</code>
     */
    public static VoidRedeemGiftCard fromInput(VoidRedeemGiftCard input) {
        VoidRedeemGiftCard service = new VoidRedeemGiftCard();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>VoidRedeemGiftCard</code> from the output values of the given <code>VoidRedeemGiftCard</code>.
     * @param output a <code>VoidRedeemGiftCard</code>
     */
    public static VoidRedeemGiftCard fromOutput(VoidRedeemGiftCard output) {
        VoidRedeemGiftCard service = new VoidRedeemGiftCard();
    ...
    /**
     * Construct a <code>VoidRedeemGiftCard</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static VoidRedeemGiftCard fromInput(Map<String, Object> mapValue) {
        VoidRedeemGiftCard service = new VoidRedeemGiftCard();
    ...
    /**
     * Construct a <code>VoidRedeemGiftCard</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static VoidRedeemGiftCard fromOutput(Map<String, Object> mapValue) {
        VoidRedeemGiftCard service = new VoidRedeemGiftCard();
