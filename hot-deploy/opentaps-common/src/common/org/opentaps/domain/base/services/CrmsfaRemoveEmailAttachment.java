 ...
 */
public class CrmsfaRemoveEmailAttachment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaRemoveEmailAttachment</code> from the input values of the given <code>CrmsfaRemoveEmailAttachment</code>.
     * @param input a <code>CrmsfaRemoveEmailAttachment</code>
     */
    public static CrmsfaRemoveEmailAttachment fromInput(CrmsfaRemoveEmailAttachment input) {
        CrmsfaRemoveEmailAttachment service = new CrmsfaRemoveEmailAttachment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaRemoveEmailAttachment</code> from the output values of the given <code>CrmsfaRemoveEmailAttachment</code>.
     * @param output a <code>CrmsfaRemoveEmailAttachment</code>
     */
    public static CrmsfaRemoveEmailAttachment fromOutput(CrmsfaRemoveEmailAttachment output) {
        CrmsfaRemoveEmailAttachment service = new CrmsfaRemoveEmailAttachment();
    ...
    /**
     * Construct a <code>CrmsfaRemoveEmailAttachment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaRemoveEmailAttachment fromInput(Map<String, Object> mapValue) {
        CrmsfaRemoveEmailAttachment service = new CrmsfaRemoveEmailAttachment();
    ...
    /**
     * Construct a <code>CrmsfaRemoveEmailAttachment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaRemoveEmailAttachment fromOutput(Map<String, Object> mapValue) {
        CrmsfaRemoveEmailAttachment service = new CrmsfaRemoveEmailAttachment();
