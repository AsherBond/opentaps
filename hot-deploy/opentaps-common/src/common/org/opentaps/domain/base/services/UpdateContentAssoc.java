 ...
 */
public class UpdateContentAssoc extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateContentAssoc</code> from the input values of the given <code>UpdateContentAssoc</code>.
     * @param input a <code>UpdateContentAssoc</code>
     */
    public static UpdateContentAssoc fromInput(UpdateContentAssoc input) {
        UpdateContentAssoc service = new UpdateContentAssoc();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateContentAssoc</code> from the output values of the given <code>UpdateContentAssoc</code>.
     * @param output a <code>UpdateContentAssoc</code>
     */
    public static UpdateContentAssoc fromOutput(UpdateContentAssoc output) {
        UpdateContentAssoc service = new UpdateContentAssoc();
    ...
    /**
     * Construct a <code>UpdateContentAssoc</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateContentAssoc fromInput(Map<String, Object> mapValue) {
        UpdateContentAssoc service = new UpdateContentAssoc();
    ...
    /**
     * Construct a <code>UpdateContentAssoc</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateContentAssoc fromOutput(Map<String, Object> mapValue) {
        UpdateContentAssoc service = new UpdateContentAssoc();
