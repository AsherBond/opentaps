 ...
 */
public class OpentapsRunMrpFromForm extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsRunMrpFromForm</code> from the input values of the given <code>OpentapsRunMrpFromForm</code>.
     * @param input a <code>OpentapsRunMrpFromForm</code>
     */
    public static OpentapsRunMrpFromForm fromInput(OpentapsRunMrpFromForm input) {
        OpentapsRunMrpFromForm service = new OpentapsRunMrpFromForm();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsRunMrpFromForm</code> from the output values of the given <code>OpentapsRunMrpFromForm</code>.
     * @param output a <code>OpentapsRunMrpFromForm</code>
     */
    public static OpentapsRunMrpFromForm fromOutput(OpentapsRunMrpFromForm output) {
        OpentapsRunMrpFromForm service = new OpentapsRunMrpFromForm();
    ...
    /**
     * Construct a <code>OpentapsRunMrpFromForm</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsRunMrpFromForm fromInput(Map<String, Object> mapValue) {
        OpentapsRunMrpFromForm service = new OpentapsRunMrpFromForm();
    ...
    /**
     * Construct a <code>OpentapsRunMrpFromForm</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsRunMrpFromForm fromOutput(Map<String, Object> mapValue) {
        OpentapsRunMrpFromForm service = new OpentapsRunMrpFromForm();
