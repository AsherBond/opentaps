 ...
 */
public class DeleteProductStoreVendorPayment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductStoreVendorPayment</code> from the input values of the given <code>DeleteProductStoreVendorPayment</code>.
     * @param input a <code>DeleteProductStoreVendorPayment</code>
     */
    public static DeleteProductStoreVendorPayment fromInput(DeleteProductStoreVendorPayment input) {
        DeleteProductStoreVendorPayment service = new DeleteProductStoreVendorPayment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteProductStoreVendorPayment</code> from the output values of the given <code>DeleteProductStoreVendorPayment</code>.
     * @param output a <code>DeleteProductStoreVendorPayment</code>
     */
    public static DeleteProductStoreVendorPayment fromOutput(DeleteProductStoreVendorPayment output) {
        DeleteProductStoreVendorPayment service = new DeleteProductStoreVendorPayment();
    ...
    /**
     * Construct a <code>DeleteProductStoreVendorPayment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductStoreVendorPayment fromInput(Map<String, Object> mapValue) {
        DeleteProductStoreVendorPayment service = new DeleteProductStoreVendorPayment();
    ...
    /**
     * Construct a <code>DeleteProductStoreVendorPayment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductStoreVendorPayment fromOutput(Map<String, Object> mapValue) {
        DeleteProductStoreVendorPayment service = new DeleteProductStoreVendorPayment();
