 ...
 */
public class CreateWorkEffortTextContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateWorkEffortTextContent</code> from the input values of the given <code>CreateWorkEffortTextContent</code>.
     * @param input a <code>CreateWorkEffortTextContent</code>
     */
    public static CreateWorkEffortTextContent fromInput(CreateWorkEffortTextContent input) {
        CreateWorkEffortTextContent service = new CreateWorkEffortTextContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateWorkEffortTextContent</code> from the output values of the given <code>CreateWorkEffortTextContent</code>.
     * @param output a <code>CreateWorkEffortTextContent</code>
     */
    public static CreateWorkEffortTextContent fromOutput(CreateWorkEffortTextContent output) {
        CreateWorkEffortTextContent service = new CreateWorkEffortTextContent();
    ...
    /**
     * Construct a <code>CreateWorkEffortTextContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateWorkEffortTextContent fromInput(Map<String, Object> mapValue) {
        CreateWorkEffortTextContent service = new CreateWorkEffortTextContent();
    ...
    /**
     * Construct a <code>CreateWorkEffortTextContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateWorkEffortTextContent fromOutput(Map<String, Object> mapValue) {
        CreateWorkEffortTextContent service = new CreateWorkEffortTextContent();
