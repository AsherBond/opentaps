 ...
 */
public class BalanceStatementReport extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>BalanceStatementReport</code> from the input values of the given <code>BalanceStatementReport</code>.
     * @param input a <code>BalanceStatementReport</code>
     */
    public static BalanceStatementReport fromInput(BalanceStatementReport input) {
        BalanceStatementReport service = new BalanceStatementReport();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>BalanceStatementReport</code> from the output values of the given <code>BalanceStatementReport</code>.
     * @param output a <code>BalanceStatementReport</code>
     */
    public static BalanceStatementReport fromOutput(BalanceStatementReport output) {
        BalanceStatementReport service = new BalanceStatementReport();
    ...
    /**
     * Construct a <code>BalanceStatementReport</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static BalanceStatementReport fromInput(Map<String, Object> mapValue) {
        BalanceStatementReport service = new BalanceStatementReport();
    ...
    /**
     * Construct a <code>BalanceStatementReport</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static BalanceStatementReport fromOutput(Map<String, Object> mapValue) {
        BalanceStatementReport service = new BalanceStatementReport();
