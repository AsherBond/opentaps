 ...
 */
public class CreateDataResource extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateDataResource</code> from the input values of the given <code>CreateDataResource</code>.
     * @param input a <code>CreateDataResource</code>
     */
    public static CreateDataResource fromInput(CreateDataResource input) {
        CreateDataResource service = new CreateDataResource();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateDataResource</code> from the output values of the given <code>CreateDataResource</code>.
     * @param output a <code>CreateDataResource</code>
     */
    public static CreateDataResource fromOutput(CreateDataResource output) {
        CreateDataResource service = new CreateDataResource();
    ...
    /**
     * Construct a <code>CreateDataResource</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateDataResource fromInput(Map<String, Object> mapValue) {
        CreateDataResource service = new CreateDataResource();
    ...
    /**
     * Construct a <code>CreateDataResource</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateDataResource fromOutput(Map<String, Object> mapValue) {
        CreateDataResource service = new CreateDataResource();
