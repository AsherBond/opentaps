 ...
 */
public class PcChargeCCAuth extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PcChargeCCAuth</code> from the input values of the given <code>PcChargeCCAuth</code>.
     * @param input a <code>PcChargeCCAuth</code>
     */
    public static PcChargeCCAuth fromInput(PcChargeCCAuth input) {
        PcChargeCCAuth service = new PcChargeCCAuth();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PcChargeCCAuth</code> from the output values of the given <code>PcChargeCCAuth</code>.
     * @param output a <code>PcChargeCCAuth</code>
     */
    public static PcChargeCCAuth fromOutput(PcChargeCCAuth output) {
        PcChargeCCAuth service = new PcChargeCCAuth();
    ...
    /**
     * Construct a <code>PcChargeCCAuth</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PcChargeCCAuth fromInput(Map<String, Object> mapValue) {
        PcChargeCCAuth service = new PcChargeCCAuth();
    ...
    /**
     * Construct a <code>PcChargeCCAuth</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PcChargeCCAuth fromOutput(Map<String, Object> mapValue) {
        PcChargeCCAuth service = new PcChargeCCAuth();
