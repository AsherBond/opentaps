 ...
 */
public class UpdateTaxAuthorityGlAccount extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityGlAccount</code> from the input values of the given <code>UpdateTaxAuthorityGlAccount</code>.
     * @param input a <code>UpdateTaxAuthorityGlAccount</code>
     */
    public static UpdateTaxAuthorityGlAccount fromInput(UpdateTaxAuthorityGlAccount input) {
        UpdateTaxAuthorityGlAccount service = new UpdateTaxAuthorityGlAccount();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateTaxAuthorityGlAccount</code> from the output values of the given <code>UpdateTaxAuthorityGlAccount</code>.
     * @param output a <code>UpdateTaxAuthorityGlAccount</code>
     */
    public static UpdateTaxAuthorityGlAccount fromOutput(UpdateTaxAuthorityGlAccount output) {
        UpdateTaxAuthorityGlAccount service = new UpdateTaxAuthorityGlAccount();
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityGlAccount</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateTaxAuthorityGlAccount fromInput(Map<String, Object> mapValue) {
        UpdateTaxAuthorityGlAccount service = new UpdateTaxAuthorityGlAccount();
    ...
    /**
     * Construct a <code>UpdateTaxAuthorityGlAccount</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateTaxAuthorityGlAccount fromOutput(Map<String, Object> mapValue) {
        UpdateTaxAuthorityGlAccount service = new UpdateTaxAuthorityGlAccount();
