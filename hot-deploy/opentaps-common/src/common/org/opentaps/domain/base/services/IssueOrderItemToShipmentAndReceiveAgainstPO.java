 ...
 */
public class IssueOrderItemToShipmentAndReceiveAgainstPO extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>IssueOrderItemToShipmentAndReceiveAgainstPO</code> from the input values of the given <code>IssueOrderItemToShipmentAndReceiveAgainstPO</code>.
     * @param input a <code>IssueOrderItemToShipmentAndReceiveAgainstPO</code>
     */
    public static IssueOrderItemToShipmentAndReceiveAgainstPO fromInput(IssueOrderItemToShipmentAndReceiveAgainstPO input) {
        IssueOrderItemToShipmentAndReceiveAgainstPO service = new IssueOrderItemToShipmentAndReceiveAgainstPO();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>IssueOrderItemToShipmentAndReceiveAgainstPO</code> from the output values of the given <code>IssueOrderItemToShipmentAndReceiveAgainstPO</code>.
     * @param output a <code>IssueOrderItemToShipmentAndReceiveAgainstPO</code>
     */
    public static IssueOrderItemToShipmentAndReceiveAgainstPO fromOutput(IssueOrderItemToShipmentAndReceiveAgainstPO output) {
        IssueOrderItemToShipmentAndReceiveAgainstPO service = new IssueOrderItemToShipmentAndReceiveAgainstPO();
    ...
    /**
     * Construct a <code>IssueOrderItemToShipmentAndReceiveAgainstPO</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static IssueOrderItemToShipmentAndReceiveAgainstPO fromInput(Map<String, Object> mapValue) {
        IssueOrderItemToShipmentAndReceiveAgainstPO service = new IssueOrderItemToShipmentAndReceiveAgainstPO();
    ...
    /**
     * Construct a <code>IssueOrderItemToShipmentAndReceiveAgainstPO</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static IssueOrderItemToShipmentAndReceiveAgainstPO fromOutput(Map<String, Object> mapValue) {
        IssueOrderItemToShipmentAndReceiveAgainstPO service = new IssueOrderItemToShipmentAndReceiveAgainstPO();
