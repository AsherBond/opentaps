 ...
 */
public class CreateFinAccountTrans extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateFinAccountTrans</code> from the input values of the given <code>CreateFinAccountTrans</code>.
     * @param input a <code>CreateFinAccountTrans</code>
     */
    public static CreateFinAccountTrans fromInput(CreateFinAccountTrans input) {
        CreateFinAccountTrans service = new CreateFinAccountTrans();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateFinAccountTrans</code> from the output values of the given <code>CreateFinAccountTrans</code>.
     * @param output a <code>CreateFinAccountTrans</code>
     */
    public static CreateFinAccountTrans fromOutput(CreateFinAccountTrans output) {
        CreateFinAccountTrans service = new CreateFinAccountTrans();
    ...
    /**
     * Construct a <code>CreateFinAccountTrans</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFinAccountTrans fromInput(Map<String, Object> mapValue) {
        CreateFinAccountTrans service = new CreateFinAccountTrans();
    ...
    /**
     * Construct a <code>CreateFinAccountTrans</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFinAccountTrans fromOutput(Map<String, Object> mapValue) {
        CreateFinAccountTrans service = new CreateFinAccountTrans();
