...
import org.opentaps.domain.base.entities.WorkEffortAssignmentRatePk;

/**
 * A FieldBridge for WorkEffortAssignmentRatePk.
 */
public class WorkEffortAssignmentRatePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkEffortAssignmentRatePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkEffortAssignmentRatePk id = new WorkEffortAssignmentRatePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkEffortAssignmentRatePk id = (WorkEffortAssignmentRatePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkEffortAssignmentRatePk id = (WorkEffortAssignmentRatePk) value;
