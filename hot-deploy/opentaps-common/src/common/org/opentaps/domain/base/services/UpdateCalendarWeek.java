 ...
 */
public class UpdateCalendarWeek extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateCalendarWeek</code> from the input values of the given <code>UpdateCalendarWeek</code>.
     * @param input a <code>UpdateCalendarWeek</code>
     */
    public static UpdateCalendarWeek fromInput(UpdateCalendarWeek input) {
        UpdateCalendarWeek service = new UpdateCalendarWeek();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateCalendarWeek</code> from the output values of the given <code>UpdateCalendarWeek</code>.
     * @param output a <code>UpdateCalendarWeek</code>
     */
    public static UpdateCalendarWeek fromOutput(UpdateCalendarWeek output) {
        UpdateCalendarWeek service = new UpdateCalendarWeek();
    ...
    /**
     * Construct a <code>UpdateCalendarWeek</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateCalendarWeek fromInput(Map<String, Object> mapValue) {
        UpdateCalendarWeek service = new UpdateCalendarWeek();
    ...
    /**
     * Construct a <code>UpdateCalendarWeek</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateCalendarWeek fromOutput(Map<String, Object> mapValue) {
        UpdateCalendarWeek service = new UpdateCalendarWeek();
