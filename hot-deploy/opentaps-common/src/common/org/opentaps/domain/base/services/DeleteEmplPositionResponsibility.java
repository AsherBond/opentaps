 ...
 */
public class DeleteEmplPositionResponsibility extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteEmplPositionResponsibility</code> from the input values of the given <code>DeleteEmplPositionResponsibility</code>.
     * @param input a <code>DeleteEmplPositionResponsibility</code>
     */
    public static DeleteEmplPositionResponsibility fromInput(DeleteEmplPositionResponsibility input) {
        DeleteEmplPositionResponsibility service = new DeleteEmplPositionResponsibility();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteEmplPositionResponsibility</code> from the output values of the given <code>DeleteEmplPositionResponsibility</code>.
     * @param output a <code>DeleteEmplPositionResponsibility</code>
     */
    public static DeleteEmplPositionResponsibility fromOutput(DeleteEmplPositionResponsibility output) {
        DeleteEmplPositionResponsibility service = new DeleteEmplPositionResponsibility();
    ...
    /**
     * Construct a <code>DeleteEmplPositionResponsibility</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteEmplPositionResponsibility fromInput(Map<String, Object> mapValue) {
        DeleteEmplPositionResponsibility service = new DeleteEmplPositionResponsibility();
    ...
    /**
     * Construct a <code>DeleteEmplPositionResponsibility</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteEmplPositionResponsibility fromOutput(Map<String, Object> mapValue) {
        DeleteEmplPositionResponsibility service = new DeleteEmplPositionResponsibility();
