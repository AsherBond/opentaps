 ...
 */
public class CreateFixedAsset extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateFixedAsset</code> from the input values of the given <code>CreateFixedAsset</code>.
     * @param input a <code>CreateFixedAsset</code>
     */
    public static CreateFixedAsset fromInput(CreateFixedAsset input) {
        CreateFixedAsset service = new CreateFixedAsset();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateFixedAsset</code> from the output values of the given <code>CreateFixedAsset</code>.
     * @param output a <code>CreateFixedAsset</code>
     */
    public static CreateFixedAsset fromOutput(CreateFixedAsset output) {
        CreateFixedAsset service = new CreateFixedAsset();
    ...
    /**
     * Construct a <code>CreateFixedAsset</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFixedAsset fromInput(Map<String, Object> mapValue) {
        CreateFixedAsset service = new CreateFixedAsset();
    ...
    /**
     * Construct a <code>CreateFixedAsset</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFixedAsset fromOutput(Map<String, Object> mapValue) {
        CreateFixedAsset service = new CreateFixedAsset();
