 ...
 */
public class PaymentReleaseInterface extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PaymentReleaseInterface</code> from the input values of the given <code>PaymentReleaseInterface</code>.
     * @param input a <code>PaymentReleaseInterface</code>
     */
    public static PaymentReleaseInterface fromInput(PaymentReleaseInterface input) {
        PaymentReleaseInterface service = new PaymentReleaseInterface();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PaymentReleaseInterface</code> from the output values of the given <code>PaymentReleaseInterface</code>.
     * @param output a <code>PaymentReleaseInterface</code>
     */
    public static PaymentReleaseInterface fromOutput(PaymentReleaseInterface output) {
        PaymentReleaseInterface service = new PaymentReleaseInterface();
    ...
    /**
     * Construct a <code>PaymentReleaseInterface</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PaymentReleaseInterface fromInput(Map<String, Object> mapValue) {
        PaymentReleaseInterface service = new PaymentReleaseInterface();
    ...
    /**
     * Construct a <code>PaymentReleaseInterface</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PaymentReleaseInterface fromOutput(Map<String, Object> mapValue) {
        PaymentReleaseInterface service = new PaymentReleaseInterface();
