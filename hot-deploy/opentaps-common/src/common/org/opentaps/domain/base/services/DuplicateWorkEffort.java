 ...
 */
public class DuplicateWorkEffort extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DuplicateWorkEffort</code> from the input values of the given <code>DuplicateWorkEffort</code>.
     * @param input a <code>DuplicateWorkEffort</code>
     */
    public static DuplicateWorkEffort fromInput(DuplicateWorkEffort input) {
        DuplicateWorkEffort service = new DuplicateWorkEffort();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DuplicateWorkEffort</code> from the output values of the given <code>DuplicateWorkEffort</code>.
     * @param output a <code>DuplicateWorkEffort</code>
     */
    public static DuplicateWorkEffort fromOutput(DuplicateWorkEffort output) {
        DuplicateWorkEffort service = new DuplicateWorkEffort();
    ...
    /**
     * Construct a <code>DuplicateWorkEffort</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DuplicateWorkEffort fromInput(Map<String, Object> mapValue) {
        DuplicateWorkEffort service = new DuplicateWorkEffort();
    ...
    /**
     * Construct a <code>DuplicateWorkEffort</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DuplicateWorkEffort fromOutput(Map<String, Object> mapValue) {
        DuplicateWorkEffort service = new DuplicateWorkEffort();
