 ...
 */
public class Resequence extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>Resequence</code> from the input values of the given <code>Resequence</code>.
     * @param input a <code>Resequence</code>
     */
    public static Resequence fromInput(Resequence input) {
        Resequence service = new Resequence();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>Resequence</code> from the output values of the given <code>Resequence</code>.
     * @param output a <code>Resequence</code>
     */
    public static Resequence fromOutput(Resequence output) {
        Resequence service = new Resequence();
    ...
    /**
     * Construct a <code>Resequence</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static Resequence fromInput(Map<String, Object> mapValue) {
        Resequence service = new Resequence();
    ...
    /**
     * Construct a <code>Resequence</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static Resequence fromOutput(Map<String, Object> mapValue) {
        Resequence service = new Resequence();
