 ...
 */
public class UpdateEntitySyncRunning extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateEntitySyncRunning</code> from the input values of the given <code>UpdateEntitySyncRunning</code>.
     * @param input a <code>UpdateEntitySyncRunning</code>
     */
    public static UpdateEntitySyncRunning fromInput(UpdateEntitySyncRunning input) {
        UpdateEntitySyncRunning service = new UpdateEntitySyncRunning();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateEntitySyncRunning</code> from the output values of the given <code>UpdateEntitySyncRunning</code>.
     * @param output a <code>UpdateEntitySyncRunning</code>
     */
    public static UpdateEntitySyncRunning fromOutput(UpdateEntitySyncRunning output) {
        UpdateEntitySyncRunning service = new UpdateEntitySyncRunning();
    ...
    /**
     * Construct a <code>UpdateEntitySyncRunning</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateEntitySyncRunning fromInput(Map<String, Object> mapValue) {
        UpdateEntitySyncRunning service = new UpdateEntitySyncRunning();
    ...
    /**
     * Construct a <code>UpdateEntitySyncRunning</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateEntitySyncRunning fromOutput(Map<String, Object> mapValue) {
        UpdateEntitySyncRunning service = new UpdateEntitySyncRunning();
