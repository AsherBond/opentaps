 ...
 */
public class FinancialsCreateInterestInvoice extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>FinancialsCreateInterestInvoice</code> from the input values of the given <code>FinancialsCreateInterestInvoice</code>.
     * @param input a <code>FinancialsCreateInterestInvoice</code>
     */
    public static FinancialsCreateInterestInvoice fromInput(FinancialsCreateInterestInvoice input) {
        FinancialsCreateInterestInvoice service = new FinancialsCreateInterestInvoice();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>FinancialsCreateInterestInvoice</code> from the output values of the given <code>FinancialsCreateInterestInvoice</code>.
     * @param output a <code>FinancialsCreateInterestInvoice</code>
     */
    public static FinancialsCreateInterestInvoice fromOutput(FinancialsCreateInterestInvoice output) {
        FinancialsCreateInterestInvoice service = new FinancialsCreateInterestInvoice();
    ...
    /**
     * Construct a <code>FinancialsCreateInterestInvoice</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static FinancialsCreateInterestInvoice fromInput(Map<String, Object> mapValue) {
        FinancialsCreateInterestInvoice service = new FinancialsCreateInterestInvoice();
    ...
    /**
     * Construct a <code>FinancialsCreateInterestInvoice</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static FinancialsCreateInterestInvoice fromOutput(Map<String, Object> mapValue) {
        FinancialsCreateInterestInvoice service = new FinancialsCreateInterestInvoice();
