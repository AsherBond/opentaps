 ...
 */
public class TimesheetUpdatePermission extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>TimesheetUpdatePermission</code> from the input values of the given <code>TimesheetUpdatePermission</code>.
     * @param input a <code>TimesheetUpdatePermission</code>
     */
    public static TimesheetUpdatePermission fromInput(TimesheetUpdatePermission input) {
        TimesheetUpdatePermission service = new TimesheetUpdatePermission();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>TimesheetUpdatePermission</code> from the output values of the given <code>TimesheetUpdatePermission</code>.
     * @param output a <code>TimesheetUpdatePermission</code>
     */
    public static TimesheetUpdatePermission fromOutput(TimesheetUpdatePermission output) {
        TimesheetUpdatePermission service = new TimesheetUpdatePermission();
    ...
    /**
     * Construct a <code>TimesheetUpdatePermission</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static TimesheetUpdatePermission fromInput(Map<String, Object> mapValue) {
        TimesheetUpdatePermission service = new TimesheetUpdatePermission();
    ...
    /**
     * Construct a <code>TimesheetUpdatePermission</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static TimesheetUpdatePermission fromOutput(Map<String, Object> mapValue) {
        TimesheetUpdatePermission service = new TimesheetUpdatePermission();
