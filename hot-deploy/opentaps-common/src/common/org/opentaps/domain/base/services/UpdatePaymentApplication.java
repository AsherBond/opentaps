 ...
 */
public class UpdatePaymentApplication extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdatePaymentApplication</code> from the input values of the given <code>UpdatePaymentApplication</code>.
     * @param input a <code>UpdatePaymentApplication</code>
     */
    public static UpdatePaymentApplication fromInput(UpdatePaymentApplication input) {
        UpdatePaymentApplication service = new UpdatePaymentApplication();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdatePaymentApplication</code> from the output values of the given <code>UpdatePaymentApplication</code>.
     * @param output a <code>UpdatePaymentApplication</code>
     */
    public static UpdatePaymentApplication fromOutput(UpdatePaymentApplication output) {
        UpdatePaymentApplication service = new UpdatePaymentApplication();
    ...
    /**
     * Construct a <code>UpdatePaymentApplication</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdatePaymentApplication fromInput(Map<String, Object> mapValue) {
        UpdatePaymentApplication service = new UpdatePaymentApplication();
    ...
    /**
     * Construct a <code>UpdatePaymentApplication</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdatePaymentApplication fromOutput(Map<String, Object> mapValue) {
        UpdatePaymentApplication service = new UpdatePaymentApplication();
