...
import org.opentaps.domain.base.entities.WorkflowTypeDeclarationPk;

/**
 * A FieldBridge for WorkflowTypeDeclarationPk.
 */
public class WorkflowTypeDeclarationPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkflowTypeDeclarationPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkflowTypeDeclarationPk id = new WorkflowTypeDeclarationPk();
        Field field = null;
        ...
        field = document.getField(name + ".typeId");
        id.setTypeId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        WorkflowTypeDeclarationPk id = (WorkflowTypeDeclarationPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkflowTypeDeclarationPk id = (WorkflowTypeDeclarationPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".typeId", id.getTypeId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
