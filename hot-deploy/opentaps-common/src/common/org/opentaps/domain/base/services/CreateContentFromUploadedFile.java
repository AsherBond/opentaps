 ...
 */
public class CreateContentFromUploadedFile extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateContentFromUploadedFile</code> from the input values of the given <code>CreateContentFromUploadedFile</code>.
     * @param input a <code>CreateContentFromUploadedFile</code>
     */
    public static CreateContentFromUploadedFile fromInput(CreateContentFromUploadedFile input) {
        CreateContentFromUploadedFile service = new CreateContentFromUploadedFile();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateContentFromUploadedFile</code> from the output values of the given <code>CreateContentFromUploadedFile</code>.
     * @param output a <code>CreateContentFromUploadedFile</code>
     */
    public static CreateContentFromUploadedFile fromOutput(CreateContentFromUploadedFile output) {
        CreateContentFromUploadedFile service = new CreateContentFromUploadedFile();
    ...
    /**
     * Construct a <code>CreateContentFromUploadedFile</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateContentFromUploadedFile fromInput(Map<String, Object> mapValue) {
        CreateContentFromUploadedFile service = new CreateContentFromUploadedFile();
    ...
    /**
     * Construct a <code>CreateContentFromUploadedFile</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateContentFromUploadedFile fromOutput(Map<String, Object> mapValue) {
        CreateContentFromUploadedFile service = new CreateContentFromUploadedFile();
