 ...
 */
public class CreateProductionRunsForProductBom extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateProductionRunsForProductBom</code> from the input values of the given <code>CreateProductionRunsForProductBom</code>.
     * @param input a <code>CreateProductionRunsForProductBom</code>
     */
    public static CreateProductionRunsForProductBom fromInput(CreateProductionRunsForProductBom input) {
        CreateProductionRunsForProductBom service = new CreateProductionRunsForProductBom();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateProductionRunsForProductBom</code> from the output values of the given <code>CreateProductionRunsForProductBom</code>.
     * @param output a <code>CreateProductionRunsForProductBom</code>
     */
    public static CreateProductionRunsForProductBom fromOutput(CreateProductionRunsForProductBom output) {
        CreateProductionRunsForProductBom service = new CreateProductionRunsForProductBom();
    ...
    /**
     * Construct a <code>CreateProductionRunsForProductBom</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateProductionRunsForProductBom fromInput(Map<String, Object> mapValue) {
        CreateProductionRunsForProductBom service = new CreateProductionRunsForProductBom();
    ...
    /**
     * Construct a <code>CreateProductionRunsForProductBom</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateProductionRunsForProductBom fromOutput(Map<String, Object> mapValue) {
        CreateProductionRunsForProductBom service = new CreateProductionRunsForProductBom();
