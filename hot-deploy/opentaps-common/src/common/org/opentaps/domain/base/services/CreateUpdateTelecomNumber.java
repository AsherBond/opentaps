 ...
 */
public class CreateUpdateTelecomNumber extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateUpdateTelecomNumber</code> from the input values of the given <code>CreateUpdateTelecomNumber</code>.
     * @param input a <code>CreateUpdateTelecomNumber</code>
     */
    public static CreateUpdateTelecomNumber fromInput(CreateUpdateTelecomNumber input) {
        CreateUpdateTelecomNumber service = new CreateUpdateTelecomNumber();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateUpdateTelecomNumber</code> from the output values of the given <code>CreateUpdateTelecomNumber</code>.
     * @param output a <code>CreateUpdateTelecomNumber</code>
     */
    public static CreateUpdateTelecomNumber fromOutput(CreateUpdateTelecomNumber output) {
        CreateUpdateTelecomNumber service = new CreateUpdateTelecomNumber();
    ...
    /**
     * Construct a <code>CreateUpdateTelecomNumber</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateUpdateTelecomNumber fromInput(Map<String, Object> mapValue) {
        CreateUpdateTelecomNumber service = new CreateUpdateTelecomNumber();
    ...
    /**
     * Construct a <code>CreateUpdateTelecomNumber</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateUpdateTelecomNumber fromOutput(Map<String, Object> mapValue) {
        CreateUpdateTelecomNumber service = new CreateUpdateTelecomNumber();
