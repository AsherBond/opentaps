 ...
 */
public class UpdateCommunicationEventWorkEff extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateCommunicationEventWorkEff</code> from the input values of the given <code>UpdateCommunicationEventWorkEff</code>.
     * @param input a <code>UpdateCommunicationEventWorkEff</code>
     */
    public static UpdateCommunicationEventWorkEff fromInput(UpdateCommunicationEventWorkEff input) {
        UpdateCommunicationEventWorkEff service = new UpdateCommunicationEventWorkEff();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateCommunicationEventWorkEff</code> from the output values of the given <code>UpdateCommunicationEventWorkEff</code>.
     * @param output a <code>UpdateCommunicationEventWorkEff</code>
     */
    public static UpdateCommunicationEventWorkEff fromOutput(UpdateCommunicationEventWorkEff output) {
        UpdateCommunicationEventWorkEff service = new UpdateCommunicationEventWorkEff();
    ...
    /**
     * Construct a <code>UpdateCommunicationEventWorkEff</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateCommunicationEventWorkEff fromInput(Map<String, Object> mapValue) {
        UpdateCommunicationEventWorkEff service = new UpdateCommunicationEventWorkEff();
    ...
    /**
     * Construct a <code>UpdateCommunicationEventWorkEff</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateCommunicationEventWorkEff fromOutput(Map<String, Object> mapValue) {
        UpdateCommunicationEventWorkEff service = new UpdateCommunicationEventWorkEff();
