 ...
 */
public class CyberSourceCCCapture extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CyberSourceCCCapture</code> from the input values of the given <code>CyberSourceCCCapture</code>.
     * @param input a <code>CyberSourceCCCapture</code>
     */
    public static CyberSourceCCCapture fromInput(CyberSourceCCCapture input) {
        CyberSourceCCCapture service = new CyberSourceCCCapture();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CyberSourceCCCapture</code> from the output values of the given <code>CyberSourceCCCapture</code>.
     * @param output a <code>CyberSourceCCCapture</code>
     */
    public static CyberSourceCCCapture fromOutput(CyberSourceCCCapture output) {
        CyberSourceCCCapture service = new CyberSourceCCCapture();
    ...
    /**
     * Construct a <code>CyberSourceCCCapture</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CyberSourceCCCapture fromInput(Map<String, Object> mapValue) {
        CyberSourceCCCapture service = new CyberSourceCCCapture();
    ...
    /**
     * Construct a <code>CyberSourceCCCapture</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CyberSourceCCCapture fromOutput(Map<String, Object> mapValue) {
        CyberSourceCCCapture service = new CyberSourceCCCapture();
