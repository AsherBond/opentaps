 ...
 */
public class CalculateProductPrice extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CalculateProductPrice</code> from the input values of the given <code>CalculateProductPrice</code>.
     * @param input a <code>CalculateProductPrice</code>
     */
    public static CalculateProductPrice fromInput(CalculateProductPrice input) {
        CalculateProductPrice service = new CalculateProductPrice();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CalculateProductPrice</code> from the output values of the given <code>CalculateProductPrice</code>.
     * @param output a <code>CalculateProductPrice</code>
     */
    public static CalculateProductPrice fromOutput(CalculateProductPrice output) {
        CalculateProductPrice service = new CalculateProductPrice();
    ...
    /**
     * Construct a <code>CalculateProductPrice</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CalculateProductPrice fromInput(Map<String, Object> mapValue) {
        CalculateProductPrice service = new CalculateProductPrice();
    ...
    /**
     * Construct a <code>CalculateProductPrice</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CalculateProductPrice fromOutput(Map<String, Object> mapValue) {
        CalculateProductPrice service = new CalculateProductPrice();
