 ...
 */
public class TestCCRelease extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>TestCCRelease</code> from the input values of the given <code>TestCCRelease</code>.
     * @param input a <code>TestCCRelease</code>
     */
    public static TestCCRelease fromInput(TestCCRelease input) {
        TestCCRelease service = new TestCCRelease();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>TestCCRelease</code> from the output values of the given <code>TestCCRelease</code>.
     * @param output a <code>TestCCRelease</code>
     */
    public static TestCCRelease fromOutput(TestCCRelease output) {
        TestCCRelease service = new TestCCRelease();
    ...
    /**
     * Construct a <code>TestCCRelease</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static TestCCRelease fromInput(Map<String, Object> mapValue) {
        TestCCRelease service = new TestCCRelease();
    ...
    /**
     * Construct a <code>TestCCRelease</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static TestCCRelease fromOutput(Map<String, Object> mapValue) {
        TestCCRelease service = new TestCCRelease();
