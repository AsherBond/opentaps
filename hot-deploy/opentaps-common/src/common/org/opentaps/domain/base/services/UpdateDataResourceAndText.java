 ...
 */
public class UpdateDataResourceAndText extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateDataResourceAndText</code> from the input values of the given <code>UpdateDataResourceAndText</code>.
     * @param input a <code>UpdateDataResourceAndText</code>
     */
    public static UpdateDataResourceAndText fromInput(UpdateDataResourceAndText input) {
        UpdateDataResourceAndText service = new UpdateDataResourceAndText();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateDataResourceAndText</code> from the output values of the given <code>UpdateDataResourceAndText</code>.
     * @param output a <code>UpdateDataResourceAndText</code>
     */
    public static UpdateDataResourceAndText fromOutput(UpdateDataResourceAndText output) {
        UpdateDataResourceAndText service = new UpdateDataResourceAndText();
    ...
    /**
     * Construct a <code>UpdateDataResourceAndText</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateDataResourceAndText fromInput(Map<String, Object> mapValue) {
        UpdateDataResourceAndText service = new UpdateDataResourceAndText();
    ...
    /**
     * Construct a <code>UpdateDataResourceAndText</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateDataResourceAndText fromOutput(Map<String, Object> mapValue) {
        UpdateDataResourceAndText service = new UpdateDataResourceAndText();
