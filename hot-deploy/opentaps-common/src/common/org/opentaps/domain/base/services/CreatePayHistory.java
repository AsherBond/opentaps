 ...
 */
public class CreatePayHistory extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePayHistory</code> from the input values of the given <code>CreatePayHistory</code>.
     * @param input a <code>CreatePayHistory</code>
     */
    public static CreatePayHistory fromInput(CreatePayHistory input) {
        CreatePayHistory service = new CreatePayHistory();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePayHistory</code> from the output values of the given <code>CreatePayHistory</code>.
     * @param output a <code>CreatePayHistory</code>
     */
    public static CreatePayHistory fromOutput(CreatePayHistory output) {
        CreatePayHistory service = new CreatePayHistory();
    ...
    /**
     * Construct a <code>CreatePayHistory</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePayHistory fromInput(Map<String, Object> mapValue) {
        CreatePayHistory service = new CreatePayHistory();
    ...
    /**
     * Construct a <code>CreatePayHistory</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePayHistory fromOutput(Map<String, Object> mapValue) {
        CreatePayHistory service = new CreatePayHistory();
