 ...
 */
public class CreateOrderHeader extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateOrderHeader</code> from the input values of the given <code>CreateOrderHeader</code>.
     * @param input a <code>CreateOrderHeader</code>
     */
    public static CreateOrderHeader fromInput(CreateOrderHeader input) {
        CreateOrderHeader service = new CreateOrderHeader();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateOrderHeader</code> from the output values of the given <code>CreateOrderHeader</code>.
     * @param output a <code>CreateOrderHeader</code>
     */
    public static CreateOrderHeader fromOutput(CreateOrderHeader output) {
        CreateOrderHeader service = new CreateOrderHeader();
    ...
    /**
     * Construct a <code>CreateOrderHeader</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateOrderHeader fromInput(Map<String, Object> mapValue) {
        CreateOrderHeader service = new CreateOrderHeader();
    ...
    /**
     * Construct a <code>CreateOrderHeader</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateOrderHeader fromOutput(Map<String, Object> mapValue) {
        CreateOrderHeader service = new CreateOrderHeader();
