 ...
 */
public class CreateAgreement extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateAgreement</code> from the input values of the given <code>CreateAgreement</code>.
     * @param input a <code>CreateAgreement</code>
     */
    public static CreateAgreement fromInput(CreateAgreement input) {
        CreateAgreement service = new CreateAgreement();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateAgreement</code> from the output values of the given <code>CreateAgreement</code>.
     * @param output a <code>CreateAgreement</code>
     */
    public static CreateAgreement fromOutput(CreateAgreement output) {
        CreateAgreement service = new CreateAgreement();
    ...
    /**
     * Construct a <code>CreateAgreement</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateAgreement fromInput(Map<String, Object> mapValue) {
        CreateAgreement service = new CreateAgreement();
    ...
    /**
     * Construct a <code>CreateAgreement</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateAgreement fromOutput(Map<String, Object> mapValue) {
        CreateAgreement service = new CreateAgreement();
