 ...
 */
public class ReserveProductInventory extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ReserveProductInventory</code> from the input values of the given <code>ReserveProductInventory</code>.
     * @param input a <code>ReserveProductInventory</code>
     */
    public static ReserveProductInventory fromInput(ReserveProductInventory input) {
        ReserveProductInventory service = new ReserveProductInventory();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ReserveProductInventory</code> from the output values of the given <code>ReserveProductInventory</code>.
     * @param output a <code>ReserveProductInventory</code>
     */
    public static ReserveProductInventory fromOutput(ReserveProductInventory output) {
        ReserveProductInventory service = new ReserveProductInventory();
    ...
    /**
     * Construct a <code>ReserveProductInventory</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ReserveProductInventory fromInput(Map<String, Object> mapValue) {
        ReserveProductInventory service = new ReserveProductInventory();
    ...
    /**
     * Construct a <code>ReserveProductInventory</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ReserveProductInventory fromOutput(Map<String, Object> mapValue) {
        ReserveProductInventory service = new ReserveProductInventory();
