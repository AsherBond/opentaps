...
import org.opentaps.domain.base.entities.WorkflowActivityPk;

/**
 * A FieldBridge for WorkflowActivityPk.
 */
public class WorkflowActivityPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkflowActivityPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkflowActivityPk id = new WorkflowActivityPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkflowActivityPk id = (WorkflowActivityPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkflowActivityPk id = (WorkflowActivityPk) value;
