 ...
 */
public class CreatePartyGroup extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyGroup</code> from the input values of the given <code>CreatePartyGroup</code>.
     * @param input a <code>CreatePartyGroup</code>
     */
    public static CreatePartyGroup fromInput(CreatePartyGroup input) {
        CreatePartyGroup service = new CreatePartyGroup();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePartyGroup</code> from the output values of the given <code>CreatePartyGroup</code>.
     * @param output a <code>CreatePartyGroup</code>
     */
    public static CreatePartyGroup fromOutput(CreatePartyGroup output) {
        CreatePartyGroup service = new CreatePartyGroup();
    ...
    /**
     * Construct a <code>CreatePartyGroup</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyGroup fromInput(Map<String, Object> mapValue) {
        CreatePartyGroup service = new CreatePartyGroup();
    ...
    /**
     * Construct a <code>CreatePartyGroup</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyGroup fromOutput(Map<String, Object> mapValue) {
        CreatePartyGroup service = new CreatePartyGroup();
