...
import org.opentaps.domain.base.entities.WorkflowPackageExternalPk;

/**
 * A FieldBridge for WorkflowPackageExternalPk.
 */
public class WorkflowPackageExternalPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkflowPackageExternalPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkflowPackageExternalPk id = new WorkflowPackageExternalPk();
        Field field = null;
        ...
        field = document.getField(name + ".externalPackageId");
        id.setExternalPackageId(field.stringValue());
        return id;
    }
    ...
    public String objectToString(Object object) {
        WorkflowPackageExternalPk id = (WorkflowPackageExternalPk) object;
        ...
        sb.append(" ");
        sb.append(id.getExternalPackageId());
        return sb.toString();
    }
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkflowPackageExternalPk id = (WorkflowPackageExternalPk) value;
        ...
        field.setBoost(boost);
        document.add(field);
        field = new Field(name + ".externalPackageId", id.getExternalPackageId(), store, index, termVector);
        field.setBoost(boost);
        document.add(field);
