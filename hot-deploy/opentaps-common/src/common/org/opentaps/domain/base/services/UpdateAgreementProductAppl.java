 ...
 */
public class UpdateAgreementProductAppl extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateAgreementProductAppl</code> from the input values of the given <code>UpdateAgreementProductAppl</code>.
     * @param input a <code>UpdateAgreementProductAppl</code>
     */
    public static UpdateAgreementProductAppl fromInput(UpdateAgreementProductAppl input) {
        UpdateAgreementProductAppl service = new UpdateAgreementProductAppl();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateAgreementProductAppl</code> from the output values of the given <code>UpdateAgreementProductAppl</code>.
     * @param output a <code>UpdateAgreementProductAppl</code>
     */
    public static UpdateAgreementProductAppl fromOutput(UpdateAgreementProductAppl output) {
        UpdateAgreementProductAppl service = new UpdateAgreementProductAppl();
    ...
    /**
     * Construct a <code>UpdateAgreementProductAppl</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateAgreementProductAppl fromInput(Map<String, Object> mapValue) {
        UpdateAgreementProductAppl service = new UpdateAgreementProductAppl();
    ...
    /**
     * Construct a <code>UpdateAgreementProductAppl</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateAgreementProductAppl fromOutput(Map<String, Object> mapValue) {
        UpdateAgreementProductAppl service = new UpdateAgreementProductAppl();
