 ...
 */
public class UpdateDataText extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateDataText</code> from the input values of the given <code>UpdateDataText</code>.
     * @param input a <code>UpdateDataText</code>
     */
    public static UpdateDataText fromInput(UpdateDataText input) {
        UpdateDataText service = new UpdateDataText();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateDataText</code> from the output values of the given <code>UpdateDataText</code>.
     * @param output a <code>UpdateDataText</code>
     */
    public static UpdateDataText fromOutput(UpdateDataText output) {
        UpdateDataText service = new UpdateDataText();
    ...
    /**
     * Construct a <code>UpdateDataText</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateDataText fromInput(Map<String, Object> mapValue) {
        UpdateDataText service = new UpdateDataText();
    ...
    /**
     * Construct a <code>UpdateDataText</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateDataText fromOutput(Map<String, Object> mapValue) {
        UpdateDataText service = new UpdateDataText();
