 ...
 */
public class CalcShipmentCostEstimate extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CalcShipmentCostEstimate</code> from the input values of the given <code>CalcShipmentCostEstimate</code>.
     * @param input a <code>CalcShipmentCostEstimate</code>
     */
    public static CalcShipmentCostEstimate fromInput(CalcShipmentCostEstimate input) {
        CalcShipmentCostEstimate service = new CalcShipmentCostEstimate();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CalcShipmentCostEstimate</code> from the output values of the given <code>CalcShipmentCostEstimate</code>.
     * @param output a <code>CalcShipmentCostEstimate</code>
     */
    public static CalcShipmentCostEstimate fromOutput(CalcShipmentCostEstimate output) {
        CalcShipmentCostEstimate service = new CalcShipmentCostEstimate();
    ...
    /**
     * Construct a <code>CalcShipmentCostEstimate</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CalcShipmentCostEstimate fromInput(Map<String, Object> mapValue) {
        CalcShipmentCostEstimate service = new CalcShipmentCostEstimate();
    ...
    /**
     * Construct a <code>CalcShipmentCostEstimate</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CalcShipmentCostEstimate fromOutput(Map<String, Object> mapValue) {
        CalcShipmentCostEstimate service = new CalcShipmentCostEstimate();
