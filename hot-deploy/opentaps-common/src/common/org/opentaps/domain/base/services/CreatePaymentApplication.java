 ...
 */
public class CreatePaymentApplication extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePaymentApplication</code> from the input values of the given <code>CreatePaymentApplication</code>.
     * @param input a <code>CreatePaymentApplication</code>
     */
    public static CreatePaymentApplication fromInput(CreatePaymentApplication input) {
        CreatePaymentApplication service = new CreatePaymentApplication();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePaymentApplication</code> from the output values of the given <code>CreatePaymentApplication</code>.
     * @param output a <code>CreatePaymentApplication</code>
     */
    public static CreatePaymentApplication fromOutput(CreatePaymentApplication output) {
        CreatePaymentApplication service = new CreatePaymentApplication();
    ...
    /**
     * Construct a <code>CreatePaymentApplication</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePaymentApplication fromInput(Map<String, Object> mapValue) {
        CreatePaymentApplication service = new CreatePaymentApplication();
    ...
    /**
     * Construct a <code>CreatePaymentApplication</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePaymentApplication fromOutput(Map<String, Object> mapValue) {
        CreatePaymentApplication service = new CreatePaymentApplication();
