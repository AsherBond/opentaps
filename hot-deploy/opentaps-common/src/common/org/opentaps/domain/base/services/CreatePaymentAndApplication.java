 ...
 */
public class CreatePaymentAndApplication extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePaymentAndApplication</code> from the input values of the given <code>CreatePaymentAndApplication</code>.
     * @param input a <code>CreatePaymentAndApplication</code>
     */
    public static CreatePaymentAndApplication fromInput(CreatePaymentAndApplication input) {
        CreatePaymentAndApplication service = new CreatePaymentAndApplication();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePaymentAndApplication</code> from the output values of the given <code>CreatePaymentAndApplication</code>.
     * @param output a <code>CreatePaymentAndApplication</code>
     */
    public static CreatePaymentAndApplication fromOutput(CreatePaymentAndApplication output) {
        CreatePaymentAndApplication service = new CreatePaymentAndApplication();
    ...
    /**
     * Construct a <code>CreatePaymentAndApplication</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePaymentAndApplication fromInput(Map<String, Object> mapValue) {
        CreatePaymentAndApplication service = new CreatePaymentAndApplication();
    ...
    /**
     * Construct a <code>CreatePaymentAndApplication</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePaymentAndApplication fromOutput(Map<String, Object> mapValue) {
        CreatePaymentAndApplication service = new CreatePaymentAndApplication();
