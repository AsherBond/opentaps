...
import org.opentaps.domain.base.entities.WorkflowParticipantPk;

/**
 * A FieldBridge for WorkflowParticipantPk.
 */
public class WorkflowParticipantPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkflowParticipantPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkflowParticipantPk id = new WorkflowParticipantPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkflowParticipantPk id = (WorkflowParticipantPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkflowParticipantPk id = (WorkflowParticipantPk) value;
