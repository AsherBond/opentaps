 ...
 */
public class SendMailFromTemplateSetting extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>SendMailFromTemplateSetting</code> from the input values of the given <code>SendMailFromTemplateSetting</code>.
     * @param input a <code>SendMailFromTemplateSetting</code>
     */
    public static SendMailFromTemplateSetting fromInput(SendMailFromTemplateSetting input) {
        SendMailFromTemplateSetting service = new SendMailFromTemplateSetting();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>SendMailFromTemplateSetting</code> from the output values of the given <code>SendMailFromTemplateSetting</code>.
     * @param output a <code>SendMailFromTemplateSetting</code>
     */
    public static SendMailFromTemplateSetting fromOutput(SendMailFromTemplateSetting output) {
        SendMailFromTemplateSetting service = new SendMailFromTemplateSetting();
    ...
    /**
     * Construct a <code>SendMailFromTemplateSetting</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SendMailFromTemplateSetting fromInput(Map<String, Object> mapValue) {
        SendMailFromTemplateSetting service = new SendMailFromTemplateSetting();
    ...
    /**
     * Construct a <code>SendMailFromTemplateSetting</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SendMailFromTemplateSetting fromOutput(Map<String, Object> mapValue) {
        SendMailFromTemplateSetting service = new SendMailFromTemplateSetting();
