 ...
 */
public class PartyDatasourcePermissionCheck extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>PartyDatasourcePermissionCheck</code> from the input values of the given <code>PartyDatasourcePermissionCheck</code>.
     * @param input a <code>PartyDatasourcePermissionCheck</code>
     */
    public static PartyDatasourcePermissionCheck fromInput(PartyDatasourcePermissionCheck input) {
        PartyDatasourcePermissionCheck service = new PartyDatasourcePermissionCheck();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>PartyDatasourcePermissionCheck</code> from the output values of the given <code>PartyDatasourcePermissionCheck</code>.
     * @param output a <code>PartyDatasourcePermissionCheck</code>
     */
    public static PartyDatasourcePermissionCheck fromOutput(PartyDatasourcePermissionCheck output) {
        PartyDatasourcePermissionCheck service = new PartyDatasourcePermissionCheck();
    ...
    /**
     * Construct a <code>PartyDatasourcePermissionCheck</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static PartyDatasourcePermissionCheck fromInput(Map<String, Object> mapValue) {
        PartyDatasourcePermissionCheck service = new PartyDatasourcePermissionCheck();
    ...
    /**
     * Construct a <code>PartyDatasourcePermissionCheck</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static PartyDatasourcePermissionCheck fromOutput(Map<String, Object> mapValue) {
        PartyDatasourcePermissionCheck service = new PartyDatasourcePermissionCheck();
