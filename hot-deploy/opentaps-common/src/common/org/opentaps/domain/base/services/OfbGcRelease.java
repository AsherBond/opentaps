 ...
 */
public class OfbGcRelease extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OfbGcRelease</code> from the input values of the given <code>OfbGcRelease</code>.
     * @param input a <code>OfbGcRelease</code>
     */
    public static OfbGcRelease fromInput(OfbGcRelease input) {
        OfbGcRelease service = new OfbGcRelease();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OfbGcRelease</code> from the output values of the given <code>OfbGcRelease</code>.
     * @param output a <code>OfbGcRelease</code>
     */
    public static OfbGcRelease fromOutput(OfbGcRelease output) {
        OfbGcRelease service = new OfbGcRelease();
    ...
    /**
     * Construct a <code>OfbGcRelease</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OfbGcRelease fromInput(Map<String, Object> mapValue) {
        OfbGcRelease service = new OfbGcRelease();
    ...
    /**
     * Construct a <code>OfbGcRelease</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OfbGcRelease fromOutput(Map<String, Object> mapValue) {
        OfbGcRelease service = new OfbGcRelease();
