 ...
 */
public class CrmsfaPrepareOrderConfirmationEmail extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaPrepareOrderConfirmationEmail</code> from the input values of the given <code>CrmsfaPrepareOrderConfirmationEmail</code>.
     * @param input a <code>CrmsfaPrepareOrderConfirmationEmail</code>
     */
    public static CrmsfaPrepareOrderConfirmationEmail fromInput(CrmsfaPrepareOrderConfirmationEmail input) {
        CrmsfaPrepareOrderConfirmationEmail service = new CrmsfaPrepareOrderConfirmationEmail();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaPrepareOrderConfirmationEmail</code> from the output values of the given <code>CrmsfaPrepareOrderConfirmationEmail</code>.
     * @param output a <code>CrmsfaPrepareOrderConfirmationEmail</code>
     */
    public static CrmsfaPrepareOrderConfirmationEmail fromOutput(CrmsfaPrepareOrderConfirmationEmail output) {
        CrmsfaPrepareOrderConfirmationEmail service = new CrmsfaPrepareOrderConfirmationEmail();
    ...
    /**
     * Construct a <code>CrmsfaPrepareOrderConfirmationEmail</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaPrepareOrderConfirmationEmail fromInput(Map<String, Object> mapValue) {
        CrmsfaPrepareOrderConfirmationEmail service = new CrmsfaPrepareOrderConfirmationEmail();
    ...
    /**
     * Construct a <code>CrmsfaPrepareOrderConfirmationEmail</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaPrepareOrderConfirmationEmail fromOutput(Map<String, Object> mapValue) {
        CrmsfaPrepareOrderConfirmationEmail service = new CrmsfaPrepareOrderConfirmationEmail();
