 ...
 */
public class OpentapsFedexRateRequest extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsFedexRateRequest</code> from the input values of the given <code>OpentapsFedexRateRequest</code>.
     * @param input a <code>OpentapsFedexRateRequest</code>
     */
    public static OpentapsFedexRateRequest fromInput(OpentapsFedexRateRequest input) {
        OpentapsFedexRateRequest service = new OpentapsFedexRateRequest();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsFedexRateRequest</code> from the output values of the given <code>OpentapsFedexRateRequest</code>.
     * @param output a <code>OpentapsFedexRateRequest</code>
     */
    public static OpentapsFedexRateRequest fromOutput(OpentapsFedexRateRequest output) {
        OpentapsFedexRateRequest service = new OpentapsFedexRateRequest();
    ...
    /**
     * Construct a <code>OpentapsFedexRateRequest</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsFedexRateRequest fromInput(Map<String, Object> mapValue) {
        OpentapsFedexRateRequest service = new OpentapsFedexRateRequest();
    ...
    /**
     * Construct a <code>OpentapsFedexRateRequest</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsFedexRateRequest fromOutput(Map<String, Object> mapValue) {
        OpentapsFedexRateRequest service = new OpentapsFedexRateRequest();
