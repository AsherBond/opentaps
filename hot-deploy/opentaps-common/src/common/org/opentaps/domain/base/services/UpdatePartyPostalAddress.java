 ...
 */
public class UpdatePartyPostalAddress extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdatePartyPostalAddress</code> from the input values of the given <code>UpdatePartyPostalAddress</code>.
     * @param input a <code>UpdatePartyPostalAddress</code>
     */
    public static UpdatePartyPostalAddress fromInput(UpdatePartyPostalAddress input) {
        UpdatePartyPostalAddress service = new UpdatePartyPostalAddress();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdatePartyPostalAddress</code> from the output values of the given <code>UpdatePartyPostalAddress</code>.
     * @param output a <code>UpdatePartyPostalAddress</code>
     */
    public static UpdatePartyPostalAddress fromOutput(UpdatePartyPostalAddress output) {
        UpdatePartyPostalAddress service = new UpdatePartyPostalAddress();
    ...
    /**
     * Construct a <code>UpdatePartyPostalAddress</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdatePartyPostalAddress fromInput(Map<String, Object> mapValue) {
        UpdatePartyPostalAddress service = new UpdatePartyPostalAddress();
    ...
    /**
     * Construct a <code>UpdatePartyPostalAddress</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdatePartyPostalAddress fromOutput(Map<String, Object> mapValue) {
        UpdatePartyPostalAddress service = new UpdatePartyPostalAddress();
