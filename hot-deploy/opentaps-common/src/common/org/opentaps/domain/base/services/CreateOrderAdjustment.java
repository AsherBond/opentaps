 ...
 */
public class CreateOrderAdjustment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateOrderAdjustment</code> from the input values of the given <code>CreateOrderAdjustment</code>.
     * @param input a <code>CreateOrderAdjustment</code>
     */
    public static CreateOrderAdjustment fromInput(CreateOrderAdjustment input) {
        CreateOrderAdjustment service = new CreateOrderAdjustment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateOrderAdjustment</code> from the output values of the given <code>CreateOrderAdjustment</code>.
     * @param output a <code>CreateOrderAdjustment</code>
     */
    public static CreateOrderAdjustment fromOutput(CreateOrderAdjustment output) {
        CreateOrderAdjustment service = new CreateOrderAdjustment();
    ...
    /**
     * Construct a <code>CreateOrderAdjustment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateOrderAdjustment fromInput(Map<String, Object> mapValue) {
        CreateOrderAdjustment service = new CreateOrderAdjustment();
    ...
    /**
     * Construct a <code>CreateOrderAdjustment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateOrderAdjustment fromOutput(Map<String, Object> mapValue) {
        CreateOrderAdjustment service = new CreateOrderAdjustment();
