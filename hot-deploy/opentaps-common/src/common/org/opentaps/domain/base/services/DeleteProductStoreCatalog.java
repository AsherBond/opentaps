 ...
 */
public class DeleteProductStoreCatalog extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductStoreCatalog</code> from the input values of the given <code>DeleteProductStoreCatalog</code>.
     * @param input a <code>DeleteProductStoreCatalog</code>
     */
    public static DeleteProductStoreCatalog fromInput(DeleteProductStoreCatalog input) {
        DeleteProductStoreCatalog service = new DeleteProductStoreCatalog();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteProductStoreCatalog</code> from the output values of the given <code>DeleteProductStoreCatalog</code>.
     * @param output a <code>DeleteProductStoreCatalog</code>
     */
    public static DeleteProductStoreCatalog fromOutput(DeleteProductStoreCatalog output) {
        DeleteProductStoreCatalog service = new DeleteProductStoreCatalog();
    ...
    /**
     * Construct a <code>DeleteProductStoreCatalog</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductStoreCatalog fromInput(Map<String, Object> mapValue) {
        DeleteProductStoreCatalog service = new DeleteProductStoreCatalog();
    ...
    /**
     * Construct a <code>DeleteProductStoreCatalog</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductStoreCatalog fromOutput(Map<String, Object> mapValue) {
        DeleteProductStoreCatalog service = new DeleteProductStoreCatalog();
