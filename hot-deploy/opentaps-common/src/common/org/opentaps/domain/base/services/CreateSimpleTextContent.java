 ...
 */
public class CreateSimpleTextContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateSimpleTextContent</code> from the input values of the given <code>CreateSimpleTextContent</code>.
     * @param input a <code>CreateSimpleTextContent</code>
     */
    public static CreateSimpleTextContent fromInput(CreateSimpleTextContent input) {
        CreateSimpleTextContent service = new CreateSimpleTextContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateSimpleTextContent</code> from the output values of the given <code>CreateSimpleTextContent</code>.
     * @param output a <code>CreateSimpleTextContent</code>
     */
    public static CreateSimpleTextContent fromOutput(CreateSimpleTextContent output) {
        CreateSimpleTextContent service = new CreateSimpleTextContent();
    ...
    /**
     * Construct a <code>CreateSimpleTextContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateSimpleTextContent fromInput(Map<String, Object> mapValue) {
        CreateSimpleTextContent service = new CreateSimpleTextContent();
    ...
    /**
     * Construct a <code>CreateSimpleTextContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateSimpleTextContent fromOutput(Map<String, Object> mapValue) {
        CreateSimpleTextContent service = new CreateSimpleTextContent();
