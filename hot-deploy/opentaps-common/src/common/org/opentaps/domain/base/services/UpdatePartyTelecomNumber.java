 ...
 */
public class UpdatePartyTelecomNumber extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdatePartyTelecomNumber</code> from the input values of the given <code>UpdatePartyTelecomNumber</code>.
     * @param input a <code>UpdatePartyTelecomNumber</code>
     */
    public static UpdatePartyTelecomNumber fromInput(UpdatePartyTelecomNumber input) {
        UpdatePartyTelecomNumber service = new UpdatePartyTelecomNumber();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdatePartyTelecomNumber</code> from the output values of the given <code>UpdatePartyTelecomNumber</code>.
     * @param output a <code>UpdatePartyTelecomNumber</code>
     */
    public static UpdatePartyTelecomNumber fromOutput(UpdatePartyTelecomNumber output) {
        UpdatePartyTelecomNumber service = new UpdatePartyTelecomNumber();
    ...
    /**
     * Construct a <code>UpdatePartyTelecomNumber</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdatePartyTelecomNumber fromInput(Map<String, Object> mapValue) {
        UpdatePartyTelecomNumber service = new UpdatePartyTelecomNumber();
    ...
    /**
     * Construct a <code>UpdatePartyTelecomNumber</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdatePartyTelecomNumber fromOutput(Map<String, Object> mapValue) {
        UpdatePartyTelecomNumber service = new UpdatePartyTelecomNumber();
