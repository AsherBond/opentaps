...
import org.opentaps.domain.base.entities.AsteriskUserPk;

/**
 * A FieldBridge for AsteriskUserPk.
 */
public class AsteriskUserPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the AsteriskUserPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        AsteriskUserPk id = new AsteriskUserPk();
        Field field = null;
        field = document.getField(name + ".extension");
        id.setExtension(field.stringValue());
    ...
    public String objectToString(Object object) {
        AsteriskUserPk id = (AsteriskUserPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        AsteriskUserPk id = (AsteriskUserPk) value;
        ...
        Field field = null;
        field = new Field(name + ".extension", id.getExtension(), store, index, termVector);
