 ...
 */
public class IssueInventoryItemToFixedAssetMaint extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>IssueInventoryItemToFixedAssetMaint</code> from the input values of the given <code>IssueInventoryItemToFixedAssetMaint</code>.
     * @param input a <code>IssueInventoryItemToFixedAssetMaint</code>
     */
    public static IssueInventoryItemToFixedAssetMaint fromInput(IssueInventoryItemToFixedAssetMaint input) {
        IssueInventoryItemToFixedAssetMaint service = new IssueInventoryItemToFixedAssetMaint();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>IssueInventoryItemToFixedAssetMaint</code> from the output values of the given <code>IssueInventoryItemToFixedAssetMaint</code>.
     * @param output a <code>IssueInventoryItemToFixedAssetMaint</code>
     */
    public static IssueInventoryItemToFixedAssetMaint fromOutput(IssueInventoryItemToFixedAssetMaint output) {
        IssueInventoryItemToFixedAssetMaint service = new IssueInventoryItemToFixedAssetMaint();
    ...
    /**
     * Construct a <code>IssueInventoryItemToFixedAssetMaint</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static IssueInventoryItemToFixedAssetMaint fromInput(Map<String, Object> mapValue) {
        IssueInventoryItemToFixedAssetMaint service = new IssueInventoryItemToFixedAssetMaint();
    ...
    /**
     * Construct a <code>IssueInventoryItemToFixedAssetMaint</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static IssueInventoryItemToFixedAssetMaint fromOutput(Map<String, Object> mapValue) {
        IssueInventoryItemToFixedAssetMaint service = new IssueInventoryItemToFixedAssetMaint();
