 ...
 */
public class UpdatePartyContactMech extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdatePartyContactMech</code> from the input values of the given <code>UpdatePartyContactMech</code>.
     * @param input a <code>UpdatePartyContactMech</code>
     */
    public static UpdatePartyContactMech fromInput(UpdatePartyContactMech input) {
        UpdatePartyContactMech service = new UpdatePartyContactMech();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdatePartyContactMech</code> from the output values of the given <code>UpdatePartyContactMech</code>.
     * @param output a <code>UpdatePartyContactMech</code>
     */
    public static UpdatePartyContactMech fromOutput(UpdatePartyContactMech output) {
        UpdatePartyContactMech service = new UpdatePartyContactMech();
    ...
    /**
     * Construct a <code>UpdatePartyContactMech</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdatePartyContactMech fromInput(Map<String, Object> mapValue) {
        UpdatePartyContactMech service = new UpdatePartyContactMech();
    ...
    /**
     * Construct a <code>UpdatePartyContactMech</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdatePartyContactMech fromOutput(Map<String, Object> mapValue) {
        UpdatePartyContactMech service = new UpdatePartyContactMech();
