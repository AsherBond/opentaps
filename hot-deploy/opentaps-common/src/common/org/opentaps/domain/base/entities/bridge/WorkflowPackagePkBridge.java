...
import org.opentaps.domain.base.entities.WorkflowPackagePk;

/**
 * A FieldBridge for WorkflowPackagePk.
 */
public class WorkflowPackagePkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkflowPackagePk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkflowPackagePk id = new WorkflowPackagePk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkflowPackagePk id = (WorkflowPackagePk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkflowPackagePk id = (WorkflowPackagePk) value;
