 ...
 */
public class TestCCCapture extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>TestCCCapture</code> from the input values of the given <code>TestCCCapture</code>.
     * @param input a <code>TestCCCapture</code>
     */
    public static TestCCCapture fromInput(TestCCCapture input) {
        TestCCCapture service = new TestCCCapture();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>TestCCCapture</code> from the output values of the given <code>TestCCCapture</code>.
     * @param output a <code>TestCCCapture</code>
     */
    public static TestCCCapture fromOutput(TestCCCapture output) {
        TestCCCapture service = new TestCCCapture();
    ...
    /**
     * Construct a <code>TestCCCapture</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static TestCCCapture fromInput(Map<String, Object> mapValue) {
        TestCCCapture service = new TestCCCapture();
    ...
    /**
     * Construct a <code>TestCCCapture</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static TestCCCapture fromOutput(Map<String, Object> mapValue) {
        TestCCCapture service = new TestCCCapture();
