 ...
 */
public class WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO</code> from the input values of the given <code>WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO</code>.
     * @param input a <code>WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO</code>
     */
    public static WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO fromInput(WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO input) {
        WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO service = new WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO</code> from the output values of the given <code>WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO</code>.
     * @param output a <code>WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO</code>
     */
    public static WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO fromOutput(WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO output) {
        WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO service = new WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO();
    ...
    /**
     * Construct a <code>WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO fromInput(Map<String, Object> mapValue) {
        WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO service = new WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO();
    ...
    /**
     * Construct a <code>WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO fromOutput(Map<String, Object> mapValue) {
        WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO service = new WarehouseIssueOrderItemToShipmentAndReceiveAgainstPO();
