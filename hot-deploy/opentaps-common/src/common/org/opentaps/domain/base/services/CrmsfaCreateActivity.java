 ...
 */
public class CrmsfaCreateActivity extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateActivity</code> from the input values of the given <code>CrmsfaCreateActivity</code>.
     * @param input a <code>CrmsfaCreateActivity</code>
     */
    public static CrmsfaCreateActivity fromInput(CrmsfaCreateActivity input) {
        CrmsfaCreateActivity service = new CrmsfaCreateActivity();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaCreateActivity</code> from the output values of the given <code>CrmsfaCreateActivity</code>.
     * @param output a <code>CrmsfaCreateActivity</code>
     */
    public static CrmsfaCreateActivity fromOutput(CrmsfaCreateActivity output) {
        CrmsfaCreateActivity service = new CrmsfaCreateActivity();
    ...
    /**
     * Construct a <code>CrmsfaCreateActivity</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateActivity fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateActivity service = new CrmsfaCreateActivity();
    ...
    /**
     * Construct a <code>CrmsfaCreateActivity</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateActivity fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateActivity service = new CrmsfaCreateActivity();
