 ...
 */
public class OpentapsCreateBackupWarehouse extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsCreateBackupWarehouse</code> from the input values of the given <code>OpentapsCreateBackupWarehouse</code>.
     * @param input a <code>OpentapsCreateBackupWarehouse</code>
     */
    public static OpentapsCreateBackupWarehouse fromInput(OpentapsCreateBackupWarehouse input) {
        OpentapsCreateBackupWarehouse service = new OpentapsCreateBackupWarehouse();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsCreateBackupWarehouse</code> from the output values of the given <code>OpentapsCreateBackupWarehouse</code>.
     * @param output a <code>OpentapsCreateBackupWarehouse</code>
     */
    public static OpentapsCreateBackupWarehouse fromOutput(OpentapsCreateBackupWarehouse output) {
        OpentapsCreateBackupWarehouse service = new OpentapsCreateBackupWarehouse();
    ...
    /**
     * Construct a <code>OpentapsCreateBackupWarehouse</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsCreateBackupWarehouse fromInput(Map<String, Object> mapValue) {
        OpentapsCreateBackupWarehouse service = new OpentapsCreateBackupWarehouse();
    ...
    /**
     * Construct a <code>OpentapsCreateBackupWarehouse</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsCreateBackupWarehouse fromOutput(Map<String, Object> mapValue) {
        OpentapsCreateBackupWarehouse service = new OpentapsCreateBackupWarehouse();
