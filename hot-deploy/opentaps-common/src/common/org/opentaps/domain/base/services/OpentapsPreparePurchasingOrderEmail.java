 ...
 */
public class OpentapsPreparePurchasingOrderEmail extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsPreparePurchasingOrderEmail</code> from the input values of the given <code>OpentapsPreparePurchasingOrderEmail</code>.
     * @param input a <code>OpentapsPreparePurchasingOrderEmail</code>
     */
    public static OpentapsPreparePurchasingOrderEmail fromInput(OpentapsPreparePurchasingOrderEmail input) {
        OpentapsPreparePurchasingOrderEmail service = new OpentapsPreparePurchasingOrderEmail();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsPreparePurchasingOrderEmail</code> from the output values of the given <code>OpentapsPreparePurchasingOrderEmail</code>.
     * @param output a <code>OpentapsPreparePurchasingOrderEmail</code>
     */
    public static OpentapsPreparePurchasingOrderEmail fromOutput(OpentapsPreparePurchasingOrderEmail output) {
        OpentapsPreparePurchasingOrderEmail service = new OpentapsPreparePurchasingOrderEmail();
    ...
    /**
     * Construct a <code>OpentapsPreparePurchasingOrderEmail</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsPreparePurchasingOrderEmail fromInput(Map<String, Object> mapValue) {
        OpentapsPreparePurchasingOrderEmail service = new OpentapsPreparePurchasingOrderEmail();
    ...
    /**
     * Construct a <code>OpentapsPreparePurchasingOrderEmail</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsPreparePurchasingOrderEmail fromOutput(Map<String, Object> mapValue) {
        OpentapsPreparePurchasingOrderEmail service = new OpentapsPreparePurchasingOrderEmail();
