 ...
 */
public class CreatePartyEmailAddress extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePartyEmailAddress</code> from the input values of the given <code>CreatePartyEmailAddress</code>.
     * @param input a <code>CreatePartyEmailAddress</code>
     */
    public static CreatePartyEmailAddress fromInput(CreatePartyEmailAddress input) {
        CreatePartyEmailAddress service = new CreatePartyEmailAddress();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePartyEmailAddress</code> from the output values of the given <code>CreatePartyEmailAddress</code>.
     * @param output a <code>CreatePartyEmailAddress</code>
     */
    public static CreatePartyEmailAddress fromOutput(CreatePartyEmailAddress output) {
        CreatePartyEmailAddress service = new CreatePartyEmailAddress();
    ...
    /**
     * Construct a <code>CreatePartyEmailAddress</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePartyEmailAddress fromInput(Map<String, Object> mapValue) {
        CreatePartyEmailAddress service = new CreatePartyEmailAddress();
    ...
    /**
     * Construct a <code>CreatePartyEmailAddress</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePartyEmailAddress fromOutput(Map<String, Object> mapValue) {
        CreatePartyEmailAddress service = new CreatePartyEmailAddress();
