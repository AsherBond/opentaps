 ...
 */
public class UpdateEntitySync extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateEntitySync</code> from the input values of the given <code>UpdateEntitySync</code>.
     * @param input a <code>UpdateEntitySync</code>
     */
    public static UpdateEntitySync fromInput(UpdateEntitySync input) {
        UpdateEntitySync service = new UpdateEntitySync();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateEntitySync</code> from the output values of the given <code>UpdateEntitySync</code>.
     * @param output a <code>UpdateEntitySync</code>
     */
    public static UpdateEntitySync fromOutput(UpdateEntitySync output) {
        UpdateEntitySync service = new UpdateEntitySync();
    ...
    /**
     * Construct a <code>UpdateEntitySync</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateEntitySync fromInput(Map<String, Object> mapValue) {
        UpdateEntitySync service = new UpdateEntitySync();
    ...
    /**
     * Construct a <code>UpdateEntitySync</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateEntitySync fromOutput(Map<String, Object> mapValue) {
        UpdateEntitySync service = new UpdateEntitySync();
