 ...
 */
public class DeleteMarketingCampaign extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteMarketingCampaign</code> from the input values of the given <code>DeleteMarketingCampaign</code>.
     * @param input a <code>DeleteMarketingCampaign</code>
     */
    public static DeleteMarketingCampaign fromInput(DeleteMarketingCampaign input) {
        DeleteMarketingCampaign service = new DeleteMarketingCampaign();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteMarketingCampaign</code> from the output values of the given <code>DeleteMarketingCampaign</code>.
     * @param output a <code>DeleteMarketingCampaign</code>
     */
    public static DeleteMarketingCampaign fromOutput(DeleteMarketingCampaign output) {
        DeleteMarketingCampaign service = new DeleteMarketingCampaign();
    ...
    /**
     * Construct a <code>DeleteMarketingCampaign</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteMarketingCampaign fromInput(Map<String, Object> mapValue) {
        DeleteMarketingCampaign service = new DeleteMarketingCampaign();
    ...
    /**
     * Construct a <code>DeleteMarketingCampaign</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteMarketingCampaign fromOutput(Map<String, Object> mapValue) {
        DeleteMarketingCampaign service = new DeleteMarketingCampaign();
