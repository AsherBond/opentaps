 ...
 */
public class CyberSourceCCAuth extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CyberSourceCCAuth</code> from the input values of the given <code>CyberSourceCCAuth</code>.
     * @param input a <code>CyberSourceCCAuth</code>
     */
    public static CyberSourceCCAuth fromInput(CyberSourceCCAuth input) {
        CyberSourceCCAuth service = new CyberSourceCCAuth();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CyberSourceCCAuth</code> from the output values of the given <code>CyberSourceCCAuth</code>.
     * @param output a <code>CyberSourceCCAuth</code>
     */
    public static CyberSourceCCAuth fromOutput(CyberSourceCCAuth output) {
        CyberSourceCCAuth service = new CyberSourceCCAuth();
    ...
    /**
     * Construct a <code>CyberSourceCCAuth</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CyberSourceCCAuth fromInput(Map<String, Object> mapValue) {
        CyberSourceCCAuth service = new CyberSourceCCAuth();
    ...
    /**
     * Construct a <code>CyberSourceCCAuth</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CyberSourceCCAuth fromOutput(Map<String, Object> mapValue) {
        CyberSourceCCAuth service = new CyberSourceCCAuth();
