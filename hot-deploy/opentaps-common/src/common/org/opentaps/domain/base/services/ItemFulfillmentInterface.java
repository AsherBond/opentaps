 ...
 */
public class ItemFulfillmentInterface extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ItemFulfillmentInterface</code> from the input values of the given <code>ItemFulfillmentInterface</code>.
     * @param input a <code>ItemFulfillmentInterface</code>
     */
    public static ItemFulfillmentInterface fromInput(ItemFulfillmentInterface input) {
        ItemFulfillmentInterface service = new ItemFulfillmentInterface();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ItemFulfillmentInterface</code> from the output values of the given <code>ItemFulfillmentInterface</code>.
     * @param output a <code>ItemFulfillmentInterface</code>
     */
    public static ItemFulfillmentInterface fromOutput(ItemFulfillmentInterface output) {
        ItemFulfillmentInterface service = new ItemFulfillmentInterface();
    ...
    /**
     * Construct a <code>ItemFulfillmentInterface</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ItemFulfillmentInterface fromInput(Map<String, Object> mapValue) {
        ItemFulfillmentInterface service = new ItemFulfillmentInterface();
    ...
    /**
     * Construct a <code>ItemFulfillmentInterface</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ItemFulfillmentInterface fromOutput(Map<String, Object> mapValue) {
        ItemFulfillmentInterface service = new ItemFulfillmentInterface();
