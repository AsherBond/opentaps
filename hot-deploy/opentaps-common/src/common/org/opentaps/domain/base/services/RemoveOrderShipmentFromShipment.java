 ...
 */
public class RemoveOrderShipmentFromShipment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemoveOrderShipmentFromShipment</code> from the input values of the given <code>RemoveOrderShipmentFromShipment</code>.
     * @param input a <code>RemoveOrderShipmentFromShipment</code>
     */
    public static RemoveOrderShipmentFromShipment fromInput(RemoveOrderShipmentFromShipment input) {
        RemoveOrderShipmentFromShipment service = new RemoveOrderShipmentFromShipment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemoveOrderShipmentFromShipment</code> from the output values of the given <code>RemoveOrderShipmentFromShipment</code>.
     * @param output a <code>RemoveOrderShipmentFromShipment</code>
     */
    public static RemoveOrderShipmentFromShipment fromOutput(RemoveOrderShipmentFromShipment output) {
        RemoveOrderShipmentFromShipment service = new RemoveOrderShipmentFromShipment();
    ...
    /**
     * Construct a <code>RemoveOrderShipmentFromShipment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveOrderShipmentFromShipment fromInput(Map<String, Object> mapValue) {
        RemoveOrderShipmentFromShipment service = new RemoveOrderShipmentFromShipment();
    ...
    /**
     * Construct a <code>RemoveOrderShipmentFromShipment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveOrderShipmentFromShipment fromOutput(Map<String, Object> mapValue) {
        RemoveOrderShipmentFromShipment service = new RemoveOrderShipmentFromShipment();
