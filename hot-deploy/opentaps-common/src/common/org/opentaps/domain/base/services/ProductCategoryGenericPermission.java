 ...
 */
public class ProductCategoryGenericPermission extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ProductCategoryGenericPermission</code> from the input values of the given <code>ProductCategoryGenericPermission</code>.
     * @param input a <code>ProductCategoryGenericPermission</code>
     */
    public static ProductCategoryGenericPermission fromInput(ProductCategoryGenericPermission input) {
        ProductCategoryGenericPermission service = new ProductCategoryGenericPermission();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ProductCategoryGenericPermission</code> from the output values of the given <code>ProductCategoryGenericPermission</code>.
     * @param output a <code>ProductCategoryGenericPermission</code>
     */
    public static ProductCategoryGenericPermission fromOutput(ProductCategoryGenericPermission output) {
        ProductCategoryGenericPermission service = new ProductCategoryGenericPermission();
    ...
    /**
     * Construct a <code>ProductCategoryGenericPermission</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ProductCategoryGenericPermission fromInput(Map<String, Object> mapValue) {
        ProductCategoryGenericPermission service = new ProductCategoryGenericPermission();
    ...
    /**
     * Construct a <code>ProductCategoryGenericPermission</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ProductCategoryGenericPermission fromOutput(Map<String, Object> mapValue) {
        ProductCategoryGenericPermission service = new ProductCategoryGenericPermission();
