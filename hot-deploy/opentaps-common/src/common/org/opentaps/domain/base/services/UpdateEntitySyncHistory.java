 ...
 */
public class UpdateEntitySyncHistory extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateEntitySyncHistory</code> from the input values of the given <code>UpdateEntitySyncHistory</code>.
     * @param input a <code>UpdateEntitySyncHistory</code>
     */
    public static UpdateEntitySyncHistory fromInput(UpdateEntitySyncHistory input) {
        UpdateEntitySyncHistory service = new UpdateEntitySyncHistory();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateEntitySyncHistory</code> from the output values of the given <code>UpdateEntitySyncHistory</code>.
     * @param output a <code>UpdateEntitySyncHistory</code>
     */
    public static UpdateEntitySyncHistory fromOutput(UpdateEntitySyncHistory output) {
        UpdateEntitySyncHistory service = new UpdateEntitySyncHistory();
    ...
    /**
     * Construct a <code>UpdateEntitySyncHistory</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateEntitySyncHistory fromInput(Map<String, Object> mapValue) {
        UpdateEntitySyncHistory service = new UpdateEntitySyncHistory();
    ...
    /**
     * Construct a <code>UpdateEntitySyncHistory</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateEntitySyncHistory fromOutput(Map<String, Object> mapValue) {
        UpdateEntitySyncHistory service = new UpdateEntitySyncHistory();
