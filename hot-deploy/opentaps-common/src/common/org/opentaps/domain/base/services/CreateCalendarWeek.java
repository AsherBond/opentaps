 ...
 */
public class CreateCalendarWeek extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateCalendarWeek</code> from the input values of the given <code>CreateCalendarWeek</code>.
     * @param input a <code>CreateCalendarWeek</code>
     */
    public static CreateCalendarWeek fromInput(CreateCalendarWeek input) {
        CreateCalendarWeek service = new CreateCalendarWeek();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateCalendarWeek</code> from the output values of the given <code>CreateCalendarWeek</code>.
     * @param output a <code>CreateCalendarWeek</code>
     */
    public static CreateCalendarWeek fromOutput(CreateCalendarWeek output) {
        CreateCalendarWeek service = new CreateCalendarWeek();
    ...
    /**
     * Construct a <code>CreateCalendarWeek</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCalendarWeek fromInput(Map<String, Object> mapValue) {
        CreateCalendarWeek service = new CreateCalendarWeek();
    ...
    /**
     * Construct a <code>CreateCalendarWeek</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCalendarWeek fromOutput(Map<String, Object> mapValue) {
        CreateCalendarWeek service = new CreateCalendarWeek();
