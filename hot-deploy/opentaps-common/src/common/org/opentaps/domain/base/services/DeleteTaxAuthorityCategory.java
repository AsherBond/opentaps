 ...
 */
public class DeleteTaxAuthorityCategory extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityCategory</code> from the input values of the given <code>DeleteTaxAuthorityCategory</code>.
     * @param input a <code>DeleteTaxAuthorityCategory</code>
     */
    public static DeleteTaxAuthorityCategory fromInput(DeleteTaxAuthorityCategory input) {
        DeleteTaxAuthorityCategory service = new DeleteTaxAuthorityCategory();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteTaxAuthorityCategory</code> from the output values of the given <code>DeleteTaxAuthorityCategory</code>.
     * @param output a <code>DeleteTaxAuthorityCategory</code>
     */
    public static DeleteTaxAuthorityCategory fromOutput(DeleteTaxAuthorityCategory output) {
        DeleteTaxAuthorityCategory service = new DeleteTaxAuthorityCategory();
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityCategory</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteTaxAuthorityCategory fromInput(Map<String, Object> mapValue) {
        DeleteTaxAuthorityCategory service = new DeleteTaxAuthorityCategory();
    ...
    /**
     * Construct a <code>DeleteTaxAuthorityCategory</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteTaxAuthorityCategory fromOutput(Map<String, Object> mapValue) {
        DeleteTaxAuthorityCategory service = new DeleteTaxAuthorityCategory();
