 ...
 */
public class CreatePayment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreatePayment</code> from the input values of the given <code>CreatePayment</code>.
     * @param input a <code>CreatePayment</code>
     */
    public static CreatePayment fromInput(CreatePayment input) {
        CreatePayment service = new CreatePayment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreatePayment</code> from the output values of the given <code>CreatePayment</code>.
     * @param output a <code>CreatePayment</code>
     */
    public static CreatePayment fromOutput(CreatePayment output) {
        CreatePayment service = new CreatePayment();
    ...
    /**
     * Construct a <code>CreatePayment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreatePayment fromInput(Map<String, Object> mapValue) {
        CreatePayment service = new CreatePayment();
    ...
    /**
     * Construct a <code>CreatePayment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreatePayment fromOutput(Map<String, Object> mapValue) {
        CreatePayment service = new CreatePayment();
