 ...
 */
public class CreateReturnAdjustment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateReturnAdjustment</code> from the input values of the given <code>CreateReturnAdjustment</code>.
     * @param input a <code>CreateReturnAdjustment</code>
     */
    public static CreateReturnAdjustment fromInput(CreateReturnAdjustment input) {
        CreateReturnAdjustment service = new CreateReturnAdjustment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateReturnAdjustment</code> from the output values of the given <code>CreateReturnAdjustment</code>.
     * @param output a <code>CreateReturnAdjustment</code>
     */
    public static CreateReturnAdjustment fromOutput(CreateReturnAdjustment output) {
        CreateReturnAdjustment service = new CreateReturnAdjustment();
    ...
    /**
     * Construct a <code>CreateReturnAdjustment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateReturnAdjustment fromInput(Map<String, Object> mapValue) {
        CreateReturnAdjustment service = new CreateReturnAdjustment();
    ...
    /**
     * Construct a <code>CreateReturnAdjustment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateReturnAdjustment fromOutput(Map<String, Object> mapValue) {
        CreateReturnAdjustment service = new CreateReturnAdjustment();
