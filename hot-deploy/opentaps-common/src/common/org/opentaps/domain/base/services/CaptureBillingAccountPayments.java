 ...
 */
public class CaptureBillingAccountPayments extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CaptureBillingAccountPayments</code> from the input values of the given <code>CaptureBillingAccountPayments</code>.
     * @param input a <code>CaptureBillingAccountPayments</code>
     */
    public static CaptureBillingAccountPayments fromInput(CaptureBillingAccountPayments input) {
        CaptureBillingAccountPayments service = new CaptureBillingAccountPayments();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CaptureBillingAccountPayments</code> from the output values of the given <code>CaptureBillingAccountPayments</code>.
     * @param output a <code>CaptureBillingAccountPayments</code>
     */
    public static CaptureBillingAccountPayments fromOutput(CaptureBillingAccountPayments output) {
        CaptureBillingAccountPayments service = new CaptureBillingAccountPayments();
    ...
    /**
     * Construct a <code>CaptureBillingAccountPayments</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CaptureBillingAccountPayments fromInput(Map<String, Object> mapValue) {
        CaptureBillingAccountPayments service = new CaptureBillingAccountPayments();
    ...
    /**
     * Construct a <code>CaptureBillingAccountPayments</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CaptureBillingAccountPayments fromOutput(Map<String, Object> mapValue) {
        CaptureBillingAccountPayments service = new CaptureBillingAccountPayments();
