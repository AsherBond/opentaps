 ...
 */
public class CalcTax extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CalcTax</code> from the input values of the given <code>CalcTax</code>.
     * @param input a <code>CalcTax</code>
     */
    public static CalcTax fromInput(CalcTax input) {
        CalcTax service = new CalcTax();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CalcTax</code> from the output values of the given <code>CalcTax</code>.
     * @param output a <code>CalcTax</code>
     */
    public static CalcTax fromOutput(CalcTax output) {
        CalcTax service = new CalcTax();
    ...
    /**
     * Construct a <code>CalcTax</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CalcTax fromInput(Map<String, Object> mapValue) {
        CalcTax service = new CalcTax();
    ...
    /**
     * Construct a <code>CalcTax</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CalcTax fromOutput(Map<String, Object> mapValue) {
        CalcTax service = new CalcTax();
