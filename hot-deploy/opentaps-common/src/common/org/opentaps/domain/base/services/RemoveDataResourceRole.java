 ...
 */
public class RemoveDataResourceRole extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemoveDataResourceRole</code> from the input values of the given <code>RemoveDataResourceRole</code>.
     * @param input a <code>RemoveDataResourceRole</code>
     */
    public static RemoveDataResourceRole fromInput(RemoveDataResourceRole input) {
        RemoveDataResourceRole service = new RemoveDataResourceRole();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemoveDataResourceRole</code> from the output values of the given <code>RemoveDataResourceRole</code>.
     * @param output a <code>RemoveDataResourceRole</code>
     */
    public static RemoveDataResourceRole fromOutput(RemoveDataResourceRole output) {
        RemoveDataResourceRole service = new RemoveDataResourceRole();
    ...
    /**
     * Construct a <code>RemoveDataResourceRole</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveDataResourceRole fromInput(Map<String, Object> mapValue) {
        RemoveDataResourceRole service = new RemoveDataResourceRole();
    ...
    /**
     * Construct a <code>RemoveDataResourceRole</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveDataResourceRole fromOutput(Map<String, Object> mapValue) {
        RemoveDataResourceRole service = new RemoveDataResourceRole();
