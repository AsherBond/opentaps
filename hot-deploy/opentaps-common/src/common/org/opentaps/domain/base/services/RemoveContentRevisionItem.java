 ...
 */
public class RemoveContentRevisionItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemoveContentRevisionItem</code> from the input values of the given <code>RemoveContentRevisionItem</code>.
     * @param input a <code>RemoveContentRevisionItem</code>
     */
    public static RemoveContentRevisionItem fromInput(RemoveContentRevisionItem input) {
        RemoveContentRevisionItem service = new RemoveContentRevisionItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemoveContentRevisionItem</code> from the output values of the given <code>RemoveContentRevisionItem</code>.
     * @param output a <code>RemoveContentRevisionItem</code>
     */
    public static RemoveContentRevisionItem fromOutput(RemoveContentRevisionItem output) {
        RemoveContentRevisionItem service = new RemoveContentRevisionItem();
    ...
    /**
     * Construct a <code>RemoveContentRevisionItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveContentRevisionItem fromInput(Map<String, Object> mapValue) {
        RemoveContentRevisionItem service = new RemoveContentRevisionItem();
    ...
    /**
     * Construct a <code>RemoveContentRevisionItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveContentRevisionItem fromOutput(Map<String, Object> mapValue) {
        RemoveContentRevisionItem service = new RemoveContentRevisionItem();
