 ...
 */
public class UpdateGiftCard extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateGiftCard</code> from the input values of the given <code>UpdateGiftCard</code>.
     * @param input a <code>UpdateGiftCard</code>
     */
    public static UpdateGiftCard fromInput(UpdateGiftCard input) {
        UpdateGiftCard service = new UpdateGiftCard();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateGiftCard</code> from the output values of the given <code>UpdateGiftCard</code>.
     * @param output a <code>UpdateGiftCard</code>
     */
    public static UpdateGiftCard fromOutput(UpdateGiftCard output) {
        UpdateGiftCard service = new UpdateGiftCard();
    ...
    /**
     * Construct a <code>UpdateGiftCard</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateGiftCard fromInput(Map<String, Object> mapValue) {
        UpdateGiftCard service = new UpdateGiftCard();
    ...
    /**
     * Construct a <code>UpdateGiftCard</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateGiftCard fromOutput(Map<String, Object> mapValue) {
        UpdateGiftCard service = new UpdateGiftCard();
