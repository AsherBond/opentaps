 ...
 */
public class CreateWorkEffortRequestItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateWorkEffortRequestItem</code> from the input values of the given <code>CreateWorkEffortRequestItem</code>.
     * @param input a <code>CreateWorkEffortRequestItem</code>
     */
    public static CreateWorkEffortRequestItem fromInput(CreateWorkEffortRequestItem input) {
        CreateWorkEffortRequestItem service = new CreateWorkEffortRequestItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateWorkEffortRequestItem</code> from the output values of the given <code>CreateWorkEffortRequestItem</code>.
     * @param output a <code>CreateWorkEffortRequestItem</code>
     */
    public static CreateWorkEffortRequestItem fromOutput(CreateWorkEffortRequestItem output) {
        CreateWorkEffortRequestItem service = new CreateWorkEffortRequestItem();
    ...
    /**
     * Construct a <code>CreateWorkEffortRequestItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateWorkEffortRequestItem fromInput(Map<String, Object> mapValue) {
        CreateWorkEffortRequestItem service = new CreateWorkEffortRequestItem();
    ...
    /**
     * Construct a <code>CreateWorkEffortRequestItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateWorkEffortRequestItem fromOutput(Map<String, Object> mapValue) {
        CreateWorkEffortRequestItem service = new CreateWorkEffortRequestItem();
