 ...
 */
public class UpdateFinAccount extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateFinAccount</code> from the input values of the given <code>UpdateFinAccount</code>.
     * @param input a <code>UpdateFinAccount</code>
     */
    public static UpdateFinAccount fromInput(UpdateFinAccount input) {
        UpdateFinAccount service = new UpdateFinAccount();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateFinAccount</code> from the output values of the given <code>UpdateFinAccount</code>.
     * @param output a <code>UpdateFinAccount</code>
     */
    public static UpdateFinAccount fromOutput(UpdateFinAccount output) {
        UpdateFinAccount service = new UpdateFinAccount();
    ...
    /**
     * Construct a <code>UpdateFinAccount</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateFinAccount fromInput(Map<String, Object> mapValue) {
        UpdateFinAccount service = new UpdateFinAccount();
    ...
    /**
     * Construct a <code>UpdateFinAccount</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateFinAccount fromOutput(Map<String, Object> mapValue) {
        UpdateFinAccount service = new UpdateFinAccount();
