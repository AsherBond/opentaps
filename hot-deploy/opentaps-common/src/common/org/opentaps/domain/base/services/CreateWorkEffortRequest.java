 ...
 */
public class CreateWorkEffortRequest extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateWorkEffortRequest</code> from the input values of the given <code>CreateWorkEffortRequest</code>.
     * @param input a <code>CreateWorkEffortRequest</code>
     */
    public static CreateWorkEffortRequest fromInput(CreateWorkEffortRequest input) {
        CreateWorkEffortRequest service = new CreateWorkEffortRequest();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateWorkEffortRequest</code> from the output values of the given <code>CreateWorkEffortRequest</code>.
     * @param output a <code>CreateWorkEffortRequest</code>
     */
    public static CreateWorkEffortRequest fromOutput(CreateWorkEffortRequest output) {
        CreateWorkEffortRequest service = new CreateWorkEffortRequest();
    ...
    /**
     * Construct a <code>CreateWorkEffortRequest</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateWorkEffortRequest fromInput(Map<String, Object> mapValue) {
        CreateWorkEffortRequest service = new CreateWorkEffortRequest();
    ...
    /**
     * Construct a <code>CreateWorkEffortRequest</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateWorkEffortRequest fromOutput(Map<String, Object> mapValue) {
        CreateWorkEffortRequest service = new CreateWorkEffortRequest();
