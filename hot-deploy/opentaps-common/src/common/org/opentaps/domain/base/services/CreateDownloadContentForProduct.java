 ...
 */
public class CreateDownloadContentForProduct extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateDownloadContentForProduct</code> from the input values of the given <code>CreateDownloadContentForProduct</code>.
     * @param input a <code>CreateDownloadContentForProduct</code>
     */
    public static CreateDownloadContentForProduct fromInput(CreateDownloadContentForProduct input) {
        CreateDownloadContentForProduct service = new CreateDownloadContentForProduct();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateDownloadContentForProduct</code> from the output values of the given <code>CreateDownloadContentForProduct</code>.
     * @param output a <code>CreateDownloadContentForProduct</code>
     */
    public static CreateDownloadContentForProduct fromOutput(CreateDownloadContentForProduct output) {
        CreateDownloadContentForProduct service = new CreateDownloadContentForProduct();
    ...
    /**
     * Construct a <code>CreateDownloadContentForProduct</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateDownloadContentForProduct fromInput(Map<String, Object> mapValue) {
        CreateDownloadContentForProduct service = new CreateDownloadContentForProduct();
    ...
    /**
     * Construct a <code>CreateDownloadContentForProduct</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateDownloadContentForProduct fromOutput(Map<String, Object> mapValue) {
        CreateDownloadContentForProduct service = new CreateDownloadContentForProduct();
