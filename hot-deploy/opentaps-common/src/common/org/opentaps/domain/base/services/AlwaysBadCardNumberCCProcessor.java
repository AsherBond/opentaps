 ...
 */
public class AlwaysBadCardNumberCCProcessor extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AlwaysBadCardNumberCCProcessor</code> from the input values of the given <code>AlwaysBadCardNumberCCProcessor</code>.
     * @param input a <code>AlwaysBadCardNumberCCProcessor</code>
     */
    public static AlwaysBadCardNumberCCProcessor fromInput(AlwaysBadCardNumberCCProcessor input) {
        AlwaysBadCardNumberCCProcessor service = new AlwaysBadCardNumberCCProcessor();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AlwaysBadCardNumberCCProcessor</code> from the output values of the given <code>AlwaysBadCardNumberCCProcessor</code>.
     * @param output a <code>AlwaysBadCardNumberCCProcessor</code>
     */
    public static AlwaysBadCardNumberCCProcessor fromOutput(AlwaysBadCardNumberCCProcessor output) {
        AlwaysBadCardNumberCCProcessor service = new AlwaysBadCardNumberCCProcessor();
    ...
    /**
     * Construct a <code>AlwaysBadCardNumberCCProcessor</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AlwaysBadCardNumberCCProcessor fromInput(Map<String, Object> mapValue) {
        AlwaysBadCardNumberCCProcessor service = new AlwaysBadCardNumberCCProcessor();
    ...
    /**
     * Construct a <code>AlwaysBadCardNumberCCProcessor</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AlwaysBadCardNumberCCProcessor fromOutput(Map<String, Object> mapValue) {
        AlwaysBadCardNumberCCProcessor service = new AlwaysBadCardNumberCCProcessor();
