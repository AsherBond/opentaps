 ...
 */
public class UpdateWorkEffortTextContent extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateWorkEffortTextContent</code> from the input values of the given <code>UpdateWorkEffortTextContent</code>.
     * @param input a <code>UpdateWorkEffortTextContent</code>
     */
    public static UpdateWorkEffortTextContent fromInput(UpdateWorkEffortTextContent input) {
        UpdateWorkEffortTextContent service = new UpdateWorkEffortTextContent();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateWorkEffortTextContent</code> from the output values of the given <code>UpdateWorkEffortTextContent</code>.
     * @param output a <code>UpdateWorkEffortTextContent</code>
     */
    public static UpdateWorkEffortTextContent fromOutput(UpdateWorkEffortTextContent output) {
        UpdateWorkEffortTextContent service = new UpdateWorkEffortTextContent();
    ...
    /**
     * Construct a <code>UpdateWorkEffortTextContent</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateWorkEffortTextContent fromInput(Map<String, Object> mapValue) {
        UpdateWorkEffortTextContent service = new UpdateWorkEffortTextContent();
    ...
    /**
     * Construct a <code>UpdateWorkEffortTextContent</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateWorkEffortTextContent fromOutput(Map<String, Object> mapValue) {
        UpdateWorkEffortTextContent service = new UpdateWorkEffortTextContent();
