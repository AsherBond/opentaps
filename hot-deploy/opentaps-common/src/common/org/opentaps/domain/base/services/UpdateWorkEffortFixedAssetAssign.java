 ...
 */
public class UpdateWorkEffortFixedAssetAssign extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateWorkEffortFixedAssetAssign</code> from the input values of the given <code>UpdateWorkEffortFixedAssetAssign</code>.
     * @param input a <code>UpdateWorkEffortFixedAssetAssign</code>
     */
    public static UpdateWorkEffortFixedAssetAssign fromInput(UpdateWorkEffortFixedAssetAssign input) {
        UpdateWorkEffortFixedAssetAssign service = new UpdateWorkEffortFixedAssetAssign();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateWorkEffortFixedAssetAssign</code> from the output values of the given <code>UpdateWorkEffortFixedAssetAssign</code>.
     * @param output a <code>UpdateWorkEffortFixedAssetAssign</code>
     */
    public static UpdateWorkEffortFixedAssetAssign fromOutput(UpdateWorkEffortFixedAssetAssign output) {
        UpdateWorkEffortFixedAssetAssign service = new UpdateWorkEffortFixedAssetAssign();
    ...
    /**
     * Construct a <code>UpdateWorkEffortFixedAssetAssign</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateWorkEffortFixedAssetAssign fromInput(Map<String, Object> mapValue) {
        UpdateWorkEffortFixedAssetAssign service = new UpdateWorkEffortFixedAssetAssign();
    ...
    /**
     * Construct a <code>UpdateWorkEffortFixedAssetAssign</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateWorkEffortFixedAssetAssign fromOutput(Map<String, Object> mapValue) {
        UpdateWorkEffortFixedAssetAssign service = new UpdateWorkEffortFixedAssetAssign();
