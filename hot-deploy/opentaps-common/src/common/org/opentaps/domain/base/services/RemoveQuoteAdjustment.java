 ...
 */
public class RemoveQuoteAdjustment extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemoveQuoteAdjustment</code> from the input values of the given <code>RemoveQuoteAdjustment</code>.
     * @param input a <code>RemoveQuoteAdjustment</code>
     */
    public static RemoveQuoteAdjustment fromInput(RemoveQuoteAdjustment input) {
        RemoveQuoteAdjustment service = new RemoveQuoteAdjustment();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemoveQuoteAdjustment</code> from the output values of the given <code>RemoveQuoteAdjustment</code>.
     * @param output a <code>RemoveQuoteAdjustment</code>
     */
    public static RemoveQuoteAdjustment fromOutput(RemoveQuoteAdjustment output) {
        RemoveQuoteAdjustment service = new RemoveQuoteAdjustment();
    ...
    /**
     * Construct a <code>RemoveQuoteAdjustment</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveQuoteAdjustment fromInput(Map<String, Object> mapValue) {
        RemoveQuoteAdjustment service = new RemoveQuoteAdjustment();
    ...
    /**
     * Construct a <code>RemoveQuoteAdjustment</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveQuoteAdjustment fromOutput(Map<String, Object> mapValue) {
        RemoveQuoteAdjustment service = new RemoveQuoteAdjustment();
