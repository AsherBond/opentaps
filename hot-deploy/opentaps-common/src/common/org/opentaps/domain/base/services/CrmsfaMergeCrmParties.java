 ...
 */
public class CrmsfaMergeCrmParties extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaMergeCrmParties</code> from the input values of the given <code>CrmsfaMergeCrmParties</code>.
     * @param input a <code>CrmsfaMergeCrmParties</code>
     */
    public static CrmsfaMergeCrmParties fromInput(CrmsfaMergeCrmParties input) {
        CrmsfaMergeCrmParties service = new CrmsfaMergeCrmParties();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaMergeCrmParties</code> from the output values of the given <code>CrmsfaMergeCrmParties</code>.
     * @param output a <code>CrmsfaMergeCrmParties</code>
     */
    public static CrmsfaMergeCrmParties fromOutput(CrmsfaMergeCrmParties output) {
        CrmsfaMergeCrmParties service = new CrmsfaMergeCrmParties();
    ...
    /**
     * Construct a <code>CrmsfaMergeCrmParties</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaMergeCrmParties fromInput(Map<String, Object> mapValue) {
        CrmsfaMergeCrmParties service = new CrmsfaMergeCrmParties();
    ...
    /**
     * Construct a <code>CrmsfaMergeCrmParties</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaMergeCrmParties fromOutput(Map<String, Object> mapValue) {
        CrmsfaMergeCrmParties service = new CrmsfaMergeCrmParties();
