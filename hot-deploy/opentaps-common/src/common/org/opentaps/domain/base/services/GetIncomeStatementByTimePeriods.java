 ...
 */
public class GetIncomeStatementByTimePeriods extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetIncomeStatementByTimePeriods</code> from the input values of the given <code>GetIncomeStatementByTimePeriods</code>.
     * @param input a <code>GetIncomeStatementByTimePeriods</code>
     */
    public static GetIncomeStatementByTimePeriods fromInput(GetIncomeStatementByTimePeriods input) {
        GetIncomeStatementByTimePeriods service = new GetIncomeStatementByTimePeriods();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetIncomeStatementByTimePeriods</code> from the output values of the given <code>GetIncomeStatementByTimePeriods</code>.
     * @param output a <code>GetIncomeStatementByTimePeriods</code>
     */
    public static GetIncomeStatementByTimePeriods fromOutput(GetIncomeStatementByTimePeriods output) {
        GetIncomeStatementByTimePeriods service = new GetIncomeStatementByTimePeriods();
    ...
    /**
     * Construct a <code>GetIncomeStatementByTimePeriods</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetIncomeStatementByTimePeriods fromInput(Map<String, Object> mapValue) {
        GetIncomeStatementByTimePeriods service = new GetIncomeStatementByTimePeriods();
    ...
    /**
     * Construct a <code>GetIncomeStatementByTimePeriods</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetIncomeStatementByTimePeriods fromOutput(Map<String, Object> mapValue) {
        GetIncomeStatementByTimePeriods service = new GetIncomeStatementByTimePeriods();
