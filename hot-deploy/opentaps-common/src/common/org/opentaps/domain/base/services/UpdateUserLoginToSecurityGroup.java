 ...
 */
public class UpdateUserLoginToSecurityGroup extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateUserLoginToSecurityGroup</code> from the input values of the given <code>UpdateUserLoginToSecurityGroup</code>.
     * @param input a <code>UpdateUserLoginToSecurityGroup</code>
     */
    public static UpdateUserLoginToSecurityGroup fromInput(UpdateUserLoginToSecurityGroup input) {
        UpdateUserLoginToSecurityGroup service = new UpdateUserLoginToSecurityGroup();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateUserLoginToSecurityGroup</code> from the output values of the given <code>UpdateUserLoginToSecurityGroup</code>.
     * @param output a <code>UpdateUserLoginToSecurityGroup</code>
     */
    public static UpdateUserLoginToSecurityGroup fromOutput(UpdateUserLoginToSecurityGroup output) {
        UpdateUserLoginToSecurityGroup service = new UpdateUserLoginToSecurityGroup();
    ...
    /**
     * Construct a <code>UpdateUserLoginToSecurityGroup</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateUserLoginToSecurityGroup fromInput(Map<String, Object> mapValue) {
        UpdateUserLoginToSecurityGroup service = new UpdateUserLoginToSecurityGroup();
    ...
    /**
     * Construct a <code>UpdateUserLoginToSecurityGroup</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateUserLoginToSecurityGroup fromOutput(Map<String, Object> mapValue) {
        UpdateUserLoginToSecurityGroup service = new UpdateUserLoginToSecurityGroup();
