 ...
 */
public class SendMail extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>SendMail</code> from the input values of the given <code>SendMail</code>.
     * @param input a <code>SendMail</code>
     */
    public static SendMail fromInput(SendMail input) {
    ...
    /**
     * Construct a <code>SendMail</code> from the output values of the given <code>SendMail</code>.
     * @param output a <code>SendMail</code>
     */
    public static SendMail fromOutput(SendMail output) {
        SendMail service = new SendMail();
    ...
    /**
     * Construct a <code>SendMail</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SendMail fromInput(Map<String, Object> mapValue) {
        SendMail service = new SendMail();
    ...
    /**
     * Construct a <code>SendMail</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SendMail fromOutput(Map<String, Object> mapValue) {
        SendMail service = new SendMail();
