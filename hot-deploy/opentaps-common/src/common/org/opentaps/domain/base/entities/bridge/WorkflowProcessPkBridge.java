...
import org.opentaps.domain.base.entities.WorkflowProcessPk;

/**
 * A FieldBridge for WorkflowProcessPk.
 */
public class WorkflowProcessPkBridge implements TwoWayFieldBridge {

    /**
     * getter method, return the WorkflowProcessPk.
     * @param name a <code>String</code> value
     * @param document a <code>Document</code> value
     * @return a <code>Object</code> value
     */
    public Object get(String name, Document document) {
        WorkflowProcessPk id = new WorkflowProcessPk();
        Field field = null;
    ...
    public String objectToString(Object object) {
        WorkflowProcessPk id = (WorkflowProcessPk) object;
    ...
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        WorkflowProcessPk id = (WorkflowProcessPk) value;
