 ...
 */
public class DeleteProductCategoryGlAccount extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteProductCategoryGlAccount</code> from the input values of the given <code>DeleteProductCategoryGlAccount</code>.
     * @param input a <code>DeleteProductCategoryGlAccount</code>
     */
    public static DeleteProductCategoryGlAccount fromInput(DeleteProductCategoryGlAccount input) {
        DeleteProductCategoryGlAccount service = new DeleteProductCategoryGlAccount();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteProductCategoryGlAccount</code> from the output values of the given <code>DeleteProductCategoryGlAccount</code>.
     * @param output a <code>DeleteProductCategoryGlAccount</code>
     */
    public static DeleteProductCategoryGlAccount fromOutput(DeleteProductCategoryGlAccount output) {
        DeleteProductCategoryGlAccount service = new DeleteProductCategoryGlAccount();
    ...
    /**
     * Construct a <code>DeleteProductCategoryGlAccount</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteProductCategoryGlAccount fromInput(Map<String, Object> mapValue) {
        DeleteProductCategoryGlAccount service = new DeleteProductCategoryGlAccount();
    ...
    /**
     * Construct a <code>DeleteProductCategoryGlAccount</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteProductCategoryGlAccount fromOutput(Map<String, Object> mapValue) {
        DeleteProductCategoryGlAccount service = new DeleteProductCategoryGlAccount();
