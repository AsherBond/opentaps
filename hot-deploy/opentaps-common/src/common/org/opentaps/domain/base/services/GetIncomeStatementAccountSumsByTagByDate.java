 ...
 */
public class GetIncomeStatementAccountSumsByTagByDate extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetIncomeStatementAccountSumsByTagByDate</code> from the input values of the given <code>GetIncomeStatementAccountSumsByTagByDate</code>.
     * @param input a <code>GetIncomeStatementAccountSumsByTagByDate</code>
     */
    public static GetIncomeStatementAccountSumsByTagByDate fromInput(GetIncomeStatementAccountSumsByTagByDate input) {
        GetIncomeStatementAccountSumsByTagByDate service = new GetIncomeStatementAccountSumsByTagByDate();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetIncomeStatementAccountSumsByTagByDate</code> from the output values of the given <code>GetIncomeStatementAccountSumsByTagByDate</code>.
     * @param output a <code>GetIncomeStatementAccountSumsByTagByDate</code>
     */
    public static GetIncomeStatementAccountSumsByTagByDate fromOutput(GetIncomeStatementAccountSumsByTagByDate output) {
        GetIncomeStatementAccountSumsByTagByDate service = new GetIncomeStatementAccountSumsByTagByDate();
    ...
    /**
     * Construct a <code>GetIncomeStatementAccountSumsByTagByDate</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetIncomeStatementAccountSumsByTagByDate fromInput(Map<String, Object> mapValue) {
        GetIncomeStatementAccountSumsByTagByDate service = new GetIncomeStatementAccountSumsByTagByDate();
    ...
    /**
     * Construct a <code>GetIncomeStatementAccountSumsByTagByDate</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetIncomeStatementAccountSumsByTagByDate fromOutput(Map<String, Object> mapValue) {
        GetIncomeStatementAccountSumsByTagByDate service = new GetIncomeStatementAccountSumsByTagByDate();
