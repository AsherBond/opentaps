 ...
 */
public class CreateFacilityEmailAddress extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateFacilityEmailAddress</code> from the input values of the given <code>CreateFacilityEmailAddress</code>.
     * @param input a <code>CreateFacilityEmailAddress</code>
     */
    public static CreateFacilityEmailAddress fromInput(CreateFacilityEmailAddress input) {
        CreateFacilityEmailAddress service = new CreateFacilityEmailAddress();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateFacilityEmailAddress</code> from the output values of the given <code>CreateFacilityEmailAddress</code>.
     * @param output a <code>CreateFacilityEmailAddress</code>
     */
    public static CreateFacilityEmailAddress fromOutput(CreateFacilityEmailAddress output) {
        CreateFacilityEmailAddress service = new CreateFacilityEmailAddress();
    ...
    /**
     * Construct a <code>CreateFacilityEmailAddress</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFacilityEmailAddress fromInput(Map<String, Object> mapValue) {
        CreateFacilityEmailAddress service = new CreateFacilityEmailAddress();
    ...
    /**
     * Construct a <code>CreateFacilityEmailAddress</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFacilityEmailAddress fromOutput(Map<String, Object> mapValue) {
        CreateFacilityEmailAddress service = new CreateFacilityEmailAddress();
