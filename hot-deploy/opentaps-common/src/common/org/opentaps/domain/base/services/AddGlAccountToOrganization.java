 ...
 */
public class AddGlAccountToOrganization extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AddGlAccountToOrganization</code> from the input values of the given <code>AddGlAccountToOrganization</code>.
     * @param input a <code>AddGlAccountToOrganization</code>
     */
    public static AddGlAccountToOrganization fromInput(AddGlAccountToOrganization input) {
        AddGlAccountToOrganization service = new AddGlAccountToOrganization();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AddGlAccountToOrganization</code> from the output values of the given <code>AddGlAccountToOrganization</code>.
     * @param output a <code>AddGlAccountToOrganization</code>
     */
    public static AddGlAccountToOrganization fromOutput(AddGlAccountToOrganization output) {
        AddGlAccountToOrganization service = new AddGlAccountToOrganization();
    ...
    /**
     * Construct a <code>AddGlAccountToOrganization</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AddGlAccountToOrganization fromInput(Map<String, Object> mapValue) {
        AddGlAccountToOrganization service = new AddGlAccountToOrganization();
    ...
    /**
     * Construct a <code>AddGlAccountToOrganization</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AddGlAccountToOrganization fromOutput(Map<String, Object> mapValue) {
        AddGlAccountToOrganization service = new AddGlAccountToOrganization();
