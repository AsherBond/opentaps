 ...
 */
public class RemoveBillingAccountRole extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemoveBillingAccountRole</code> from the input values of the given <code>RemoveBillingAccountRole</code>.
     * @param input a <code>RemoveBillingAccountRole</code>
     */
    public static RemoveBillingAccountRole fromInput(RemoveBillingAccountRole input) {
        RemoveBillingAccountRole service = new RemoveBillingAccountRole();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemoveBillingAccountRole</code> from the output values of the given <code>RemoveBillingAccountRole</code>.
     * @param output a <code>RemoveBillingAccountRole</code>
     */
    public static RemoveBillingAccountRole fromOutput(RemoveBillingAccountRole output) {
        RemoveBillingAccountRole service = new RemoveBillingAccountRole();
    ...
    /**
     * Construct a <code>RemoveBillingAccountRole</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveBillingAccountRole fromInput(Map<String, Object> mapValue) {
        RemoveBillingAccountRole service = new RemoveBillingAccountRole();
    ...
    /**
     * Construct a <code>RemoveBillingAccountRole</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveBillingAccountRole fromOutput(Map<String, Object> mapValue) {
        RemoveBillingAccountRole service = new RemoveBillingAccountRole();
