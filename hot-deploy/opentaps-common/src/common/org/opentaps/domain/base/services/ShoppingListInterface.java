 ...
 */
public class ShoppingListInterface extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ShoppingListInterface</code> from the input values of the given <code>ShoppingListInterface</code>.
     * @param input a <code>ShoppingListInterface</code>
     */
    public static ShoppingListInterface fromInput(ShoppingListInterface input) {
        ShoppingListInterface service = new ShoppingListInterface();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ShoppingListInterface</code> from the output values of the given <code>ShoppingListInterface</code>.
     * @param output a <code>ShoppingListInterface</code>
     */
    public static ShoppingListInterface fromOutput(ShoppingListInterface output) {
        ShoppingListInterface service = new ShoppingListInterface();
    ...
    /**
     * Construct a <code>ShoppingListInterface</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ShoppingListInterface fromInput(Map<String, Object> mapValue) {
        ShoppingListInterface service = new ShoppingListInterface();
    ...
    /**
     * Construct a <code>ShoppingListInterface</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ShoppingListInterface fromOutput(Map<String, Object> mapValue) {
        ShoppingListInterface service = new ShoppingListInterface();
