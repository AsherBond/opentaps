 ...
 */
public class CreateEmplPosition extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateEmplPosition</code> from the input values of the given <code>CreateEmplPosition</code>.
     * @param input a <code>CreateEmplPosition</code>
     */
    public static CreateEmplPosition fromInput(CreateEmplPosition input) {
        CreateEmplPosition service = new CreateEmplPosition();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateEmplPosition</code> from the output values of the given <code>CreateEmplPosition</code>.
     * @param output a <code>CreateEmplPosition</code>
     */
    public static CreateEmplPosition fromOutput(CreateEmplPosition output) {
        CreateEmplPosition service = new CreateEmplPosition();
    ...
    /**
     * Construct a <code>CreateEmplPosition</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateEmplPosition fromInput(Map<String, Object> mapValue) {
        CreateEmplPosition service = new CreateEmplPosition();
    ...
    /**
     * Construct a <code>CreateEmplPosition</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateEmplPosition fromOutput(Map<String, Object> mapValue) {
        CreateEmplPosition service = new CreateEmplPosition();
