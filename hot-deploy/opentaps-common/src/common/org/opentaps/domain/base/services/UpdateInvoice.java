 ...
 */
public class UpdateInvoice extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateInvoice</code> from the input values of the given <code>UpdateInvoice</code>.
     * @param input a <code>UpdateInvoice</code>
     */
    public static UpdateInvoice fromInput(UpdateInvoice input) {
        UpdateInvoice service = new UpdateInvoice();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateInvoice</code> from the output values of the given <code>UpdateInvoice</code>.
     * @param output a <code>UpdateInvoice</code>
     */
    public static UpdateInvoice fromOutput(UpdateInvoice output) {
        UpdateInvoice service = new UpdateInvoice();
    ...
    /**
     * Construct a <code>UpdateInvoice</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateInvoice fromInput(Map<String, Object> mapValue) {
        UpdateInvoice service = new UpdateInvoice();
    ...
    /**
     * Construct a <code>UpdateInvoice</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateInvoice fromOutput(Map<String, Object> mapValue) {
        UpdateInvoice service = new UpdateInvoice();
