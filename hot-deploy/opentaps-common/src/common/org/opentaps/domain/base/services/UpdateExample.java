 ...
 */
public class UpdateExample extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateExample</code> from the input values of the given <code>UpdateExample</code>.
     * @param input a <code>UpdateExample</code>
     */
    public static UpdateExample fromInput(UpdateExample input) {
        UpdateExample service = new UpdateExample();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateExample</code> from the output values of the given <code>UpdateExample</code>.
     * @param output a <code>UpdateExample</code>
     */
    public static UpdateExample fromOutput(UpdateExample output) {
        UpdateExample service = new UpdateExample();
    ...
    /**
     * Construct a <code>UpdateExample</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateExample fromInput(Map<String, Object> mapValue) {
        UpdateExample service = new UpdateExample();
    ...
    /**
     * Construct a <code>UpdateExample</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateExample fromOutput(Map<String, Object> mapValue) {
        UpdateExample service = new UpdateExample();
