 ...
 */
public class RemoveContentPurposeOperation extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemoveContentPurposeOperation</code> from the input values of the given <code>RemoveContentPurposeOperation</code>.
     * @param input a <code>RemoveContentPurposeOperation</code>
     */
    public static RemoveContentPurposeOperation fromInput(RemoveContentPurposeOperation input) {
        RemoveContentPurposeOperation service = new RemoveContentPurposeOperation();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemoveContentPurposeOperation</code> from the output values of the given <code>RemoveContentPurposeOperation</code>.
     * @param output a <code>RemoveContentPurposeOperation</code>
     */
    public static RemoveContentPurposeOperation fromOutput(RemoveContentPurposeOperation output) {
        RemoveContentPurposeOperation service = new RemoveContentPurposeOperation();
    ...
    /**
     * Construct a <code>RemoveContentPurposeOperation</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveContentPurposeOperation fromInput(Map<String, Object> mapValue) {
        RemoveContentPurposeOperation service = new RemoveContentPurposeOperation();
    ...
    /**
     * Construct a <code>RemoveContentPurposeOperation</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveContentPurposeOperation fromOutput(Map<String, Object> mapValue) {
        RemoveContentPurposeOperation service = new RemoveContentPurposeOperation();
