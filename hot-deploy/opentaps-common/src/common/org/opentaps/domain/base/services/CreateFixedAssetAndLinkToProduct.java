 ...
 */
public class CreateFixedAssetAndLinkToProduct extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateFixedAssetAndLinkToProduct</code> from the input values of the given <code>CreateFixedAssetAndLinkToProduct</code>.
     * @param input a <code>CreateFixedAssetAndLinkToProduct</code>
     */
    public static CreateFixedAssetAndLinkToProduct fromInput(CreateFixedAssetAndLinkToProduct input) {
        CreateFixedAssetAndLinkToProduct service = new CreateFixedAssetAndLinkToProduct();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateFixedAssetAndLinkToProduct</code> from the output values of the given <code>CreateFixedAssetAndLinkToProduct</code>.
     * @param output a <code>CreateFixedAssetAndLinkToProduct</code>
     */
    public static CreateFixedAssetAndLinkToProduct fromOutput(CreateFixedAssetAndLinkToProduct output) {
        CreateFixedAssetAndLinkToProduct service = new CreateFixedAssetAndLinkToProduct();
    ...
    /**
     * Construct a <code>CreateFixedAssetAndLinkToProduct</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateFixedAssetAndLinkToProduct fromInput(Map<String, Object> mapValue) {
        CreateFixedAssetAndLinkToProduct service = new CreateFixedAssetAndLinkToProduct();
    ...
    /**
     * Construct a <code>CreateFixedAssetAndLinkToProduct</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateFixedAssetAndLinkToProduct fromOutput(Map<String, Object> mapValue) {
        CreateFixedAssetAndLinkToProduct service = new CreateFixedAssetAndLinkToProduct();
