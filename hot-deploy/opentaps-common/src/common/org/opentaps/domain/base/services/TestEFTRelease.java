 ...
 */
public class TestEFTRelease extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>TestEFTRelease</code> from the input values of the given <code>TestEFTRelease</code>.
     * @param input a <code>TestEFTRelease</code>
     */
    public static TestEFTRelease fromInput(TestEFTRelease input) {
        TestEFTRelease service = new TestEFTRelease();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>TestEFTRelease</code> from the output values of the given <code>TestEFTRelease</code>.
     * @param output a <code>TestEFTRelease</code>
     */
    public static TestEFTRelease fromOutput(TestEFTRelease output) {
        TestEFTRelease service = new TestEFTRelease();
    ...
    /**
     * Construct a <code>TestEFTRelease</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static TestEFTRelease fromInput(Map<String, Object> mapValue) {
        TestEFTRelease service = new TestEFTRelease();
    ...
    /**
     * Construct a <code>TestEFTRelease</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static TestEFTRelease fromOutput(Map<String, Object> mapValue) {
        TestEFTRelease service = new TestEFTRelease();
