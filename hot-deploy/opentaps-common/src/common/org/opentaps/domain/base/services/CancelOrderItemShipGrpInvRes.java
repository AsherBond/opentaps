 ...
 */
public class CancelOrderItemShipGrpInvRes extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CancelOrderItemShipGrpInvRes</code> from the input values of the given <code>CancelOrderItemShipGrpInvRes</code>.
     * @param input a <code>CancelOrderItemShipGrpInvRes</code>
     */
    public static CancelOrderItemShipGrpInvRes fromInput(CancelOrderItemShipGrpInvRes input) {
        CancelOrderItemShipGrpInvRes service = new CancelOrderItemShipGrpInvRes();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CancelOrderItemShipGrpInvRes</code> from the output values of the given <code>CancelOrderItemShipGrpInvRes</code>.
     * @param output a <code>CancelOrderItemShipGrpInvRes</code>
     */
    public static CancelOrderItemShipGrpInvRes fromOutput(CancelOrderItemShipGrpInvRes output) {
        CancelOrderItemShipGrpInvRes service = new CancelOrderItemShipGrpInvRes();
    ...
    /**
     * Construct a <code>CancelOrderItemShipGrpInvRes</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CancelOrderItemShipGrpInvRes fromInput(Map<String, Object> mapValue) {
        CancelOrderItemShipGrpInvRes service = new CancelOrderItemShipGrpInvRes();
    ...
    /**
     * Construct a <code>CancelOrderItemShipGrpInvRes</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CancelOrderItemShipGrpInvRes fromOutput(Map<String, Object> mapValue) {
        CancelOrderItemShipGrpInvRes service = new CancelOrderItemShipGrpInvRes();
