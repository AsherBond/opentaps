 ...
 */
public class OpentapsRunMrp extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsRunMrp</code> from the input values of the given <code>OpentapsRunMrp</code>.
     * @param input a <code>OpentapsRunMrp</code>
     */
    public static OpentapsRunMrp fromInput(OpentapsRunMrp input) {
        OpentapsRunMrp service = new OpentapsRunMrp();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsRunMrp</code> from the output values of the given <code>OpentapsRunMrp</code>.
     * @param output a <code>OpentapsRunMrp</code>
     */
    public static OpentapsRunMrp fromOutput(OpentapsRunMrp output) {
        OpentapsRunMrp service = new OpentapsRunMrp();
    ...
    /**
     * Construct a <code>OpentapsRunMrp</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsRunMrp fromInput(Map<String, Object> mapValue) {
        OpentapsRunMrp service = new OpentapsRunMrp();
    ...
    /**
     * Construct a <code>OpentapsRunMrp</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsRunMrp fromOutput(Map<String, Object> mapValue) {
        OpentapsRunMrp service = new OpentapsRunMrp();
