 ...
 */
public class OfbFaRelease extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OfbFaRelease</code> from the input values of the given <code>OfbFaRelease</code>.
     * @param input a <code>OfbFaRelease</code>
     */
    public static OfbFaRelease fromInput(OfbFaRelease input) {
        OfbFaRelease service = new OfbFaRelease();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OfbFaRelease</code> from the output values of the given <code>OfbFaRelease</code>.
     * @param output a <code>OfbFaRelease</code>
     */
    public static OfbFaRelease fromOutput(OfbFaRelease output) {
        OfbFaRelease service = new OfbFaRelease();
    ...
    /**
     * Construct a <code>OfbFaRelease</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OfbFaRelease fromInput(Map<String, Object> mapValue) {
        OfbFaRelease service = new OfbFaRelease();
    ...
    /**
     * Construct a <code>OfbFaRelease</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OfbFaRelease fromOutput(Map<String, Object> mapValue) {
        OfbFaRelease service = new OfbFaRelease();
