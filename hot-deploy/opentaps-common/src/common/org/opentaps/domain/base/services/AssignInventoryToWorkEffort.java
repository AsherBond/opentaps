 ...
 */
public class AssignInventoryToWorkEffort extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AssignInventoryToWorkEffort</code> from the input values of the given <code>AssignInventoryToWorkEffort</code>.
     * @param input a <code>AssignInventoryToWorkEffort</code>
     */
    public static AssignInventoryToWorkEffort fromInput(AssignInventoryToWorkEffort input) {
        AssignInventoryToWorkEffort service = new AssignInventoryToWorkEffort();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AssignInventoryToWorkEffort</code> from the output values of the given <code>AssignInventoryToWorkEffort</code>.
     * @param output a <code>AssignInventoryToWorkEffort</code>
     */
    public static AssignInventoryToWorkEffort fromOutput(AssignInventoryToWorkEffort output) {
        AssignInventoryToWorkEffort service = new AssignInventoryToWorkEffort();
    ...
    /**
     * Construct a <code>AssignInventoryToWorkEffort</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AssignInventoryToWorkEffort fromInput(Map<String, Object> mapValue) {
        AssignInventoryToWorkEffort service = new AssignInventoryToWorkEffort();
    ...
    /**
     * Construct a <code>AssignInventoryToWorkEffort</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AssignInventoryToWorkEffort fromOutput(Map<String, Object> mapValue) {
        AssignInventoryToWorkEffort service = new AssignInventoryToWorkEffort();
