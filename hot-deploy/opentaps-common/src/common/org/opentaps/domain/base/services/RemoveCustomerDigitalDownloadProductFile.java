 ...
 */
public class RemoveCustomerDigitalDownloadProductFile extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>RemoveCustomerDigitalDownloadProductFile</code> from the input values of the given <code>RemoveCustomerDigitalDownloadProductFile</code>.
     * @param input a <code>RemoveCustomerDigitalDownloadProductFile</code>
     */
    public static RemoveCustomerDigitalDownloadProductFile fromInput(RemoveCustomerDigitalDownloadProductFile input) {
        RemoveCustomerDigitalDownloadProductFile service = new RemoveCustomerDigitalDownloadProductFile();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>RemoveCustomerDigitalDownloadProductFile</code> from the output values of the given <code>RemoveCustomerDigitalDownloadProductFile</code>.
     * @param output a <code>RemoveCustomerDigitalDownloadProductFile</code>
     */
    public static RemoveCustomerDigitalDownloadProductFile fromOutput(RemoveCustomerDigitalDownloadProductFile output) {
        RemoveCustomerDigitalDownloadProductFile service = new RemoveCustomerDigitalDownloadProductFile();
    ...
    /**
     * Construct a <code>RemoveCustomerDigitalDownloadProductFile</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static RemoveCustomerDigitalDownloadProductFile fromInput(Map<String, Object> mapValue) {
        RemoveCustomerDigitalDownloadProductFile service = new RemoveCustomerDigitalDownloadProductFile();
    ...
    /**
     * Construct a <code>RemoveCustomerDigitalDownloadProductFile</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static RemoveCustomerDigitalDownloadProductFile fromOutput(Map<String, Object> mapValue) {
        RemoveCustomerDigitalDownloadProductFile service = new RemoveCustomerDigitalDownloadProductFile();
