 ...
 */
public class CreateInventoryTransfersForProduct extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateInventoryTransfersForProduct</code> from the input values of the given <code>CreateInventoryTransfersForProduct</code>.
     * @param input a <code>CreateInventoryTransfersForProduct</code>
     */
    public static CreateInventoryTransfersForProduct fromInput(CreateInventoryTransfersForProduct input) {
        CreateInventoryTransfersForProduct service = new CreateInventoryTransfersForProduct();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateInventoryTransfersForProduct</code> from the output values of the given <code>CreateInventoryTransfersForProduct</code>.
     * @param output a <code>CreateInventoryTransfersForProduct</code>
     */
    public static CreateInventoryTransfersForProduct fromOutput(CreateInventoryTransfersForProduct output) {
        CreateInventoryTransfersForProduct service = new CreateInventoryTransfersForProduct();
    ...
    /**
     * Construct a <code>CreateInventoryTransfersForProduct</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateInventoryTransfersForProduct fromInput(Map<String, Object> mapValue) {
        CreateInventoryTransfersForProduct service = new CreateInventoryTransfersForProduct();
    ...
    /**
     * Construct a <code>CreateInventoryTransfersForProduct</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateInventoryTransfersForProduct fromOutput(Map<String, Object> mapValue) {
        CreateInventoryTransfersForProduct service = new CreateInventoryTransfersForProduct();
