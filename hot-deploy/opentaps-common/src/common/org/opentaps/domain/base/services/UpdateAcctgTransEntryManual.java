 ...
 */
public class UpdateAcctgTransEntryManual extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateAcctgTransEntryManual</code> from the input values of the given <code>UpdateAcctgTransEntryManual</code>.
     * @param input a <code>UpdateAcctgTransEntryManual</code>
     */
    public static UpdateAcctgTransEntryManual fromInput(UpdateAcctgTransEntryManual input) {
        UpdateAcctgTransEntryManual service = new UpdateAcctgTransEntryManual();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateAcctgTransEntryManual</code> from the output values of the given <code>UpdateAcctgTransEntryManual</code>.
     * @param output a <code>UpdateAcctgTransEntryManual</code>
     */
    public static UpdateAcctgTransEntryManual fromOutput(UpdateAcctgTransEntryManual output) {
        UpdateAcctgTransEntryManual service = new UpdateAcctgTransEntryManual();
    ...
    /**
     * Construct a <code>UpdateAcctgTransEntryManual</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateAcctgTransEntryManual fromInput(Map<String, Object> mapValue) {
        UpdateAcctgTransEntryManual service = new UpdateAcctgTransEntryManual();
    ...
    /**
     * Construct a <code>UpdateAcctgTransEntryManual</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateAcctgTransEntryManual fromOutput(Map<String, Object> mapValue) {
        UpdateAcctgTransEntryManual service = new UpdateAcctgTransEntryManual();
