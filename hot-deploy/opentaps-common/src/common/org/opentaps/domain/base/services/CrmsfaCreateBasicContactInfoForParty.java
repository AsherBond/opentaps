 ...
 */
public class CrmsfaCreateBasicContactInfoForParty extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CrmsfaCreateBasicContactInfoForParty</code> from the input values of the given <code>CrmsfaCreateBasicContactInfoForParty</code>.
     * @param input a <code>CrmsfaCreateBasicContactInfoForParty</code>
     */
    public static CrmsfaCreateBasicContactInfoForParty fromInput(CrmsfaCreateBasicContactInfoForParty input) {
        CrmsfaCreateBasicContactInfoForParty service = new CrmsfaCreateBasicContactInfoForParty();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CrmsfaCreateBasicContactInfoForParty</code> from the output values of the given <code>CrmsfaCreateBasicContactInfoForParty</code>.
     * @param output a <code>CrmsfaCreateBasicContactInfoForParty</code>
     */
    public static CrmsfaCreateBasicContactInfoForParty fromOutput(CrmsfaCreateBasicContactInfoForParty output) {
        CrmsfaCreateBasicContactInfoForParty service = new CrmsfaCreateBasicContactInfoForParty();
    ...
    /**
     * Construct a <code>CrmsfaCreateBasicContactInfoForParty</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CrmsfaCreateBasicContactInfoForParty fromInput(Map<String, Object> mapValue) {
        CrmsfaCreateBasicContactInfoForParty service = new CrmsfaCreateBasicContactInfoForParty();
    ...
    /**
     * Construct a <code>CrmsfaCreateBasicContactInfoForParty</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CrmsfaCreateBasicContactInfoForParty fromOutput(Map<String, Object> mapValue) {
        CrmsfaCreateBasicContactInfoForParty service = new CrmsfaCreateBasicContactInfoForParty();
