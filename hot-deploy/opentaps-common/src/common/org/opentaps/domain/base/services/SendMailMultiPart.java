 ...
 */
public class SendMailMultiPart extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>SendMailMultiPart</code> from the input values of the given <code>SendMailMultiPart</code>.
     * @param input a <code>SendMailMultiPart</code>
     */
    public static SendMailMultiPart fromInput(SendMailMultiPart input) {
        SendMailMultiPart service = new SendMailMultiPart();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>SendMailMultiPart</code> from the output values of the given <code>SendMailMultiPart</code>.
     * @param output a <code>SendMailMultiPart</code>
     */
    public static SendMailMultiPart fromOutput(SendMailMultiPart output) {
        SendMailMultiPart service = new SendMailMultiPart();
    ...
    /**
     * Construct a <code>SendMailMultiPart</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static SendMailMultiPart fromInput(Map<String, Object> mapValue) {
        SendMailMultiPart service = new SendMailMultiPart();
    ...
    /**
     * Construct a <code>SendMailMultiPart</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static SendMailMultiPart fromOutput(Map<String, Object> mapValue) {
        SendMailMultiPart service = new SendMailMultiPart();
