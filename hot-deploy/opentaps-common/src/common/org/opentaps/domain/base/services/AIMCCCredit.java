 ...
 */
public class AIMCCCredit extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AIMCCCredit</code> from the input values of the given <code>AIMCCCredit</code>.
     * @param input a <code>AIMCCCredit</code>
     */
    public static AIMCCCredit fromInput(AIMCCCredit input) {
        AIMCCCredit service = new AIMCCCredit();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AIMCCCredit</code> from the output values of the given <code>AIMCCCredit</code>.
     * @param output a <code>AIMCCCredit</code>
     */
    public static AIMCCCredit fromOutput(AIMCCCredit output) {
        AIMCCCredit service = new AIMCCCredit();
    ...
    /**
     * Construct a <code>AIMCCCredit</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AIMCCCredit fromInput(Map<String, Object> mapValue) {
        AIMCCCredit service = new AIMCCCredit();
    ...
    /**
     * Construct a <code>AIMCCCredit</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AIMCCCredit fromOutput(Map<String, Object> mapValue) {
        AIMCCCredit service = new AIMCCCredit();
