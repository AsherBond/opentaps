 ...
 */
public class ValueLinkRefund extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ValueLinkRefund</code> from the input values of the given <code>ValueLinkRefund</code>.
     * @param input a <code>ValueLinkRefund</code>
     */
    public static ValueLinkRefund fromInput(ValueLinkRefund input) {
        ValueLinkRefund service = new ValueLinkRefund();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ValueLinkRefund</code> from the output values of the given <code>ValueLinkRefund</code>.
     * @param output a <code>ValueLinkRefund</code>
     */
    public static ValueLinkRefund fromOutput(ValueLinkRefund output) {
        ValueLinkRefund service = new ValueLinkRefund();
    ...
    /**
     * Construct a <code>ValueLinkRefund</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ValueLinkRefund fromInput(Map<String, Object> mapValue) {
        ValueLinkRefund service = new ValueLinkRefund();
    ...
    /**
     * Construct a <code>ValueLinkRefund</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ValueLinkRefund fromOutput(Map<String, Object> mapValue) {
        ValueLinkRefund service = new ValueLinkRefund();
