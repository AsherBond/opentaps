 ...
 */
public class AccountingTagsEntityInterface extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>AccountingTagsEntityInterface</code> from the input values of the given <code>AccountingTagsEntityInterface</code>.
     * @param input a <code>AccountingTagsEntityInterface</code>
     */
    public static AccountingTagsEntityInterface fromInput(AccountingTagsEntityInterface input) {
        AccountingTagsEntityInterface service = new AccountingTagsEntityInterface();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>AccountingTagsEntityInterface</code> from the output values of the given <code>AccountingTagsEntityInterface</code>.
     * @param output a <code>AccountingTagsEntityInterface</code>
     */
    public static AccountingTagsEntityInterface fromOutput(AccountingTagsEntityInterface output) {
        AccountingTagsEntityInterface service = new AccountingTagsEntityInterface();
    ...
    /**
     * Construct a <code>AccountingTagsEntityInterface</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static AccountingTagsEntityInterface fromInput(Map<String, Object> mapValue) {
        AccountingTagsEntityInterface service = new AccountingTagsEntityInterface();
    ...
    /**
     * Construct a <code>AccountingTagsEntityInterface</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static AccountingTagsEntityInterface fromOutput(Map<String, Object> mapValue) {
        AccountingTagsEntityInterface service = new AccountingTagsEntityInterface();
