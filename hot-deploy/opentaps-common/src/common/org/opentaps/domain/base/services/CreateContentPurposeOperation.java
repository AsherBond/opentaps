 ...
 */
public class CreateContentPurposeOperation extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateContentPurposeOperation</code> from the input values of the given <code>CreateContentPurposeOperation</code>.
     * @param input a <code>CreateContentPurposeOperation</code>
     */
    public static CreateContentPurposeOperation fromInput(CreateContentPurposeOperation input) {
        CreateContentPurposeOperation service = new CreateContentPurposeOperation();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateContentPurposeOperation</code> from the output values of the given <code>CreateContentPurposeOperation</code>.
     * @param output a <code>CreateContentPurposeOperation</code>
     */
    public static CreateContentPurposeOperation fromOutput(CreateContentPurposeOperation output) {
        CreateContentPurposeOperation service = new CreateContentPurposeOperation();
    ...
    /**
     * Construct a <code>CreateContentPurposeOperation</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateContentPurposeOperation fromInput(Map<String, Object> mapValue) {
        CreateContentPurposeOperation service = new CreateContentPurposeOperation();
    ...
    /**
     * Construct a <code>CreateContentPurposeOperation</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateContentPurposeOperation fromOutput(Map<String, Object> mapValue) {
        CreateContentPurposeOperation service = new CreateContentPurposeOperation();
