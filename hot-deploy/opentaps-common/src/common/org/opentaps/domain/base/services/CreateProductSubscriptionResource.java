 ...
 */
public class CreateProductSubscriptionResource extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateProductSubscriptionResource</code> from the input values of the given <code>CreateProductSubscriptionResource</code>.
     * @param input a <code>CreateProductSubscriptionResource</code>
     */
    public static CreateProductSubscriptionResource fromInput(CreateProductSubscriptionResource input) {
        CreateProductSubscriptionResource service = new CreateProductSubscriptionResource();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateProductSubscriptionResource</code> from the output values of the given <code>CreateProductSubscriptionResource</code>.
     * @param output a <code>CreateProductSubscriptionResource</code>
     */
    public static CreateProductSubscriptionResource fromOutput(CreateProductSubscriptionResource output) {
        CreateProductSubscriptionResource service = new CreateProductSubscriptionResource();
    ...
    /**
     * Construct a <code>CreateProductSubscriptionResource</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateProductSubscriptionResource fromInput(Map<String, Object> mapValue) {
        CreateProductSubscriptionResource service = new CreateProductSubscriptionResource();
    ...
    /**
     * Construct a <code>CreateProductSubscriptionResource</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateProductSubscriptionResource fromOutput(Map<String, Object> mapValue) {
        CreateProductSubscriptionResource service = new CreateProductSubscriptionResource();
