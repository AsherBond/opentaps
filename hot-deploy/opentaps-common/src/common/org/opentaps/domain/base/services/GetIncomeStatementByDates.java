 ...
 */
public class GetIncomeStatementByDates extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetIncomeStatementByDates</code> from the input values of the given <code>GetIncomeStatementByDates</code>.
     * @param input a <code>GetIncomeStatementByDates</code>
     */
    public static GetIncomeStatementByDates fromInput(GetIncomeStatementByDates input) {
        GetIncomeStatementByDates service = new GetIncomeStatementByDates();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetIncomeStatementByDates</code> from the output values of the given <code>GetIncomeStatementByDates</code>.
     * @param output a <code>GetIncomeStatementByDates</code>
     */
    public static GetIncomeStatementByDates fromOutput(GetIncomeStatementByDates output) {
        GetIncomeStatementByDates service = new GetIncomeStatementByDates();
    ...
    /**
     * Construct a <code>GetIncomeStatementByDates</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetIncomeStatementByDates fromInput(Map<String, Object> mapValue) {
        GetIncomeStatementByDates service = new GetIncomeStatementByDates();
    ...
    /**
     * Construct a <code>GetIncomeStatementByDates</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetIncomeStatementByDates fromOutput(Map<String, Object> mapValue) {
        GetIncomeStatementByDates service = new GetIncomeStatementByDates();
