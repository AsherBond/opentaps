 ...
 */
public class DeleteEmplPositionTypeRate extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteEmplPositionTypeRate</code> from the input values of the given <code>DeleteEmplPositionTypeRate</code>.
     * @param input a <code>DeleteEmplPositionTypeRate</code>
     */
    public static DeleteEmplPositionTypeRate fromInput(DeleteEmplPositionTypeRate input) {
        DeleteEmplPositionTypeRate service = new DeleteEmplPositionTypeRate();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteEmplPositionTypeRate</code> from the output values of the given <code>DeleteEmplPositionTypeRate</code>.
     * @param output a <code>DeleteEmplPositionTypeRate</code>
     */
    public static DeleteEmplPositionTypeRate fromOutput(DeleteEmplPositionTypeRate output) {
        DeleteEmplPositionTypeRate service = new DeleteEmplPositionTypeRate();
    ...
    /**
     * Construct a <code>DeleteEmplPositionTypeRate</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteEmplPositionTypeRate fromInput(Map<String, Object> mapValue) {
        DeleteEmplPositionTypeRate service = new DeleteEmplPositionTypeRate();
    ...
    /**
     * Construct a <code>DeleteEmplPositionTypeRate</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteEmplPositionTypeRate fromOutput(Map<String, Object> mapValue) {
        DeleteEmplPositionTypeRate service = new DeleteEmplPositionTypeRate();
