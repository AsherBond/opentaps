 ...
 */
public class GetProductInventoryAndFacilitySummary extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetProductInventoryAndFacilitySummary</code> from the input values of the given <code>GetProductInventoryAndFacilitySummary</code>.
     * @param input a <code>GetProductInventoryAndFacilitySummary</code>
     */
    public static GetProductInventoryAndFacilitySummary fromInput(GetProductInventoryAndFacilitySummary input) {
        GetProductInventoryAndFacilitySummary service = new GetProductInventoryAndFacilitySummary();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetProductInventoryAndFacilitySummary</code> from the output values of the given <code>GetProductInventoryAndFacilitySummary</code>.
     * @param output a <code>GetProductInventoryAndFacilitySummary</code>
     */
    public static GetProductInventoryAndFacilitySummary fromOutput(GetProductInventoryAndFacilitySummary output) {
        GetProductInventoryAndFacilitySummary service = new GetProductInventoryAndFacilitySummary();
    ...
    /**
     * Construct a <code>GetProductInventoryAndFacilitySummary</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetProductInventoryAndFacilitySummary fromInput(Map<String, Object> mapValue) {
        GetProductInventoryAndFacilitySummary service = new GetProductInventoryAndFacilitySummary();
    ...
    /**
     * Construct a <code>GetProductInventoryAndFacilitySummary</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetProductInventoryAndFacilitySummary fromOutput(Map<String, Object> mapValue) {
        GetProductInventoryAndFacilitySummary service = new GetProductInventoryAndFacilitySummary();
