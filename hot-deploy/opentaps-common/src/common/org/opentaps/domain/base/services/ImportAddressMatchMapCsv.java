 ...
 */
public class ImportAddressMatchMapCsv extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>ImportAddressMatchMapCsv</code> from the input values of the given <code>ImportAddressMatchMapCsv</code>.
     * @param input a <code>ImportAddressMatchMapCsv</code>
     */
    public static ImportAddressMatchMapCsv fromInput(ImportAddressMatchMapCsv input) {
        ImportAddressMatchMapCsv service = new ImportAddressMatchMapCsv();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>ImportAddressMatchMapCsv</code> from the output values of the given <code>ImportAddressMatchMapCsv</code>.
     * @param output a <code>ImportAddressMatchMapCsv</code>
     */
    public static ImportAddressMatchMapCsv fromOutput(ImportAddressMatchMapCsv output) {
        ImportAddressMatchMapCsv service = new ImportAddressMatchMapCsv();
    ...
    /**
     * Construct a <code>ImportAddressMatchMapCsv</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static ImportAddressMatchMapCsv fromInput(Map<String, Object> mapValue) {
        ImportAddressMatchMapCsv service = new ImportAddressMatchMapCsv();
    ...
    /**
     * Construct a <code>ImportAddressMatchMapCsv</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static ImportAddressMatchMapCsv fromOutput(Map<String, Object> mapValue) {
        ImportAddressMatchMapCsv service = new ImportAddressMatchMapCsv();
