 ...
 */
public class UpdateWorkEffortEventReminder extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateWorkEffortEventReminder</code> from the input values of the given <code>UpdateWorkEffortEventReminder</code>.
     * @param input a <code>UpdateWorkEffortEventReminder</code>
     */
    public static UpdateWorkEffortEventReminder fromInput(UpdateWorkEffortEventReminder input) {
        UpdateWorkEffortEventReminder service = new UpdateWorkEffortEventReminder();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateWorkEffortEventReminder</code> from the output values of the given <code>UpdateWorkEffortEventReminder</code>.
     * @param output a <code>UpdateWorkEffortEventReminder</code>
     */
    public static UpdateWorkEffortEventReminder fromOutput(UpdateWorkEffortEventReminder output) {
        UpdateWorkEffortEventReminder service = new UpdateWorkEffortEventReminder();
    ...
    /**
     * Construct a <code>UpdateWorkEffortEventReminder</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateWorkEffortEventReminder fromInput(Map<String, Object> mapValue) {
        UpdateWorkEffortEventReminder service = new UpdateWorkEffortEventReminder();
    ...
    /**
     * Construct a <code>UpdateWorkEffortEventReminder</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateWorkEffortEventReminder fromOutput(Map<String, Object> mapValue) {
        UpdateWorkEffortEventReminder service = new UpdateWorkEffortEventReminder();
