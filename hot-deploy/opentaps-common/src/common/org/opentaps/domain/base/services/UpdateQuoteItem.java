 ...
 */
public class UpdateQuoteItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateQuoteItem</code> from the input values of the given <code>UpdateQuoteItem</code>.
     * @param input a <code>UpdateQuoteItem</code>
     */
    public static UpdateQuoteItem fromInput(UpdateQuoteItem input) {
        UpdateQuoteItem service = new UpdateQuoteItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateQuoteItem</code> from the output values of the given <code>UpdateQuoteItem</code>.
     * @param output a <code>UpdateQuoteItem</code>
     */
    public static UpdateQuoteItem fromOutput(UpdateQuoteItem output) {
        UpdateQuoteItem service = new UpdateQuoteItem();
    ...
    /**
     * Construct a <code>UpdateQuoteItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateQuoteItem fromInput(Map<String, Object> mapValue) {
        UpdateQuoteItem service = new UpdateQuoteItem();
    ...
    /**
     * Construct a <code>UpdateQuoteItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateQuoteItem fromOutput(Map<String, Object> mapValue) {
        UpdateQuoteItem service = new UpdateQuoteItem();
