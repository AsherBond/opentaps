 ...
 */
public class GetIncomeStatementByTagByDates extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>GetIncomeStatementByTagByDates</code> from the input values of the given <code>GetIncomeStatementByTagByDates</code>.
     * @param input a <code>GetIncomeStatementByTagByDates</code>
     */
    public static GetIncomeStatementByTagByDates fromInput(GetIncomeStatementByTagByDates input) {
        GetIncomeStatementByTagByDates service = new GetIncomeStatementByTagByDates();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>GetIncomeStatementByTagByDates</code> from the output values of the given <code>GetIncomeStatementByTagByDates</code>.
     * @param output a <code>GetIncomeStatementByTagByDates</code>
     */
    public static GetIncomeStatementByTagByDates fromOutput(GetIncomeStatementByTagByDates output) {
        GetIncomeStatementByTagByDates service = new GetIncomeStatementByTagByDates();
    ...
    /**
     * Construct a <code>GetIncomeStatementByTagByDates</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static GetIncomeStatementByTagByDates fromInput(Map<String, Object> mapValue) {
        GetIncomeStatementByTagByDates service = new GetIncomeStatementByTagByDates();
    ...
    /**
     * Construct a <code>GetIncomeStatementByTagByDates</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static GetIncomeStatementByTagByDates fromOutput(Map<String, Object> mapValue) {
        GetIncomeStatementByTagByDates service = new GetIncomeStatementByTagByDates();
