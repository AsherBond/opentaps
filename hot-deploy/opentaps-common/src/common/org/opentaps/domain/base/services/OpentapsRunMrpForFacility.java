 ...
 */
public class OpentapsRunMrpForFacility extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>OpentapsRunMrpForFacility</code> from the input values of the given <code>OpentapsRunMrpForFacility</code>.
     * @param input a <code>OpentapsRunMrpForFacility</code>
     */
    public static OpentapsRunMrpForFacility fromInput(OpentapsRunMrpForFacility input) {
        OpentapsRunMrpForFacility service = new OpentapsRunMrpForFacility();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>OpentapsRunMrpForFacility</code> from the output values of the given <code>OpentapsRunMrpForFacility</code>.
     * @param output a <code>OpentapsRunMrpForFacility</code>
     */
    public static OpentapsRunMrpForFacility fromOutput(OpentapsRunMrpForFacility output) {
        OpentapsRunMrpForFacility service = new OpentapsRunMrpForFacility();
    ...
    /**
     * Construct a <code>OpentapsRunMrpForFacility</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static OpentapsRunMrpForFacility fromInput(Map<String, Object> mapValue) {
        OpentapsRunMrpForFacility service = new OpentapsRunMrpForFacility();
    ...
    /**
     * Construct a <code>OpentapsRunMrpForFacility</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static OpentapsRunMrpForFacility fromOutput(Map<String, Object> mapValue) {
        OpentapsRunMrpForFacility service = new OpentapsRunMrpForFacility();
