 ...
 */
public class CreateCommunicationEventInterface extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateCommunicationEventInterface</code> from the input values of the given <code>CreateCommunicationEventInterface</code>.
     * @param input a <code>CreateCommunicationEventInterface</code>
     */
    public static CreateCommunicationEventInterface fromInput(CreateCommunicationEventInterface input) {
        CreateCommunicationEventInterface service = new CreateCommunicationEventInterface();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateCommunicationEventInterface</code> from the output values of the given <code>CreateCommunicationEventInterface</code>.
     * @param output a <code>CreateCommunicationEventInterface</code>
     */
    public static CreateCommunicationEventInterface fromOutput(CreateCommunicationEventInterface output) {
        CreateCommunicationEventInterface service = new CreateCommunicationEventInterface();
    ...
    /**
     * Construct a <code>CreateCommunicationEventInterface</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateCommunicationEventInterface fromInput(Map<String, Object> mapValue) {
        CreateCommunicationEventInterface service = new CreateCommunicationEventInterface();
    ...
    /**
     * Construct a <code>CreateCommunicationEventInterface</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateCommunicationEventInterface fromOutput(Map<String, Object> mapValue) {
        CreateCommunicationEventInterface service = new CreateCommunicationEventInterface();
