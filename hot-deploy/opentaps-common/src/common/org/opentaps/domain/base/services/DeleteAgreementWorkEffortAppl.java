 ...
 */
public class DeleteAgreementWorkEffortAppl extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeleteAgreementWorkEffortAppl</code> from the input values of the given <code>DeleteAgreementWorkEffortAppl</code>.
     * @param input a <code>DeleteAgreementWorkEffortAppl</code>
     */
    public static DeleteAgreementWorkEffortAppl fromInput(DeleteAgreementWorkEffortAppl input) {
        DeleteAgreementWorkEffortAppl service = new DeleteAgreementWorkEffortAppl();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeleteAgreementWorkEffortAppl</code> from the output values of the given <code>DeleteAgreementWorkEffortAppl</code>.
     * @param output a <code>DeleteAgreementWorkEffortAppl</code>
     */
    public static DeleteAgreementWorkEffortAppl fromOutput(DeleteAgreementWorkEffortAppl output) {
        DeleteAgreementWorkEffortAppl service = new DeleteAgreementWorkEffortAppl();
    ...
    /**
     * Construct a <code>DeleteAgreementWorkEffortAppl</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeleteAgreementWorkEffortAppl fromInput(Map<String, Object> mapValue) {
        DeleteAgreementWorkEffortAppl service = new DeleteAgreementWorkEffortAppl();
    ...
    /**
     * Construct a <code>DeleteAgreementWorkEffortAppl</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeleteAgreementWorkEffortAppl fromOutput(Map<String, Object> mapValue) {
        DeleteAgreementWorkEffortAppl service = new DeleteAgreementWorkEffortAppl();
