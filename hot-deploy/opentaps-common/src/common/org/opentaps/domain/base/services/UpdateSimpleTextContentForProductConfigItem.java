 ...
 */
public class UpdateSimpleTextContentForProductConfigItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateSimpleTextContentForProductConfigItem</code> from the input values of the given <code>UpdateSimpleTextContentForProductConfigItem</code>.
     * @param input a <code>UpdateSimpleTextContentForProductConfigItem</code>
     */
    public static UpdateSimpleTextContentForProductConfigItem fromInput(UpdateSimpleTextContentForProductConfigItem input) {
        UpdateSimpleTextContentForProductConfigItem service = new UpdateSimpleTextContentForProductConfigItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateSimpleTextContentForProductConfigItem</code> from the output values of the given <code>UpdateSimpleTextContentForProductConfigItem</code>.
     * @param output a <code>UpdateSimpleTextContentForProductConfigItem</code>
     */
    public static UpdateSimpleTextContentForProductConfigItem fromOutput(UpdateSimpleTextContentForProductConfigItem output) {
        UpdateSimpleTextContentForProductConfigItem service = new UpdateSimpleTextContentForProductConfigItem();
    ...
    /**
     * Construct a <code>UpdateSimpleTextContentForProductConfigItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateSimpleTextContentForProductConfigItem fromInput(Map<String, Object> mapValue) {
        UpdateSimpleTextContentForProductConfigItem service = new UpdateSimpleTextContentForProductConfigItem();
    ...
    /**
     * Construct a <code>UpdateSimpleTextContentForProductConfigItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateSimpleTextContentForProductConfigItem fromOutput(Map<String, Object> mapValue) {
        UpdateSimpleTextContentForProductConfigItem service = new UpdateSimpleTextContentForProductConfigItem();
