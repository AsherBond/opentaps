 ...
 */
public class UpdateDataResource extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateDataResource</code> from the input values of the given <code>UpdateDataResource</code>.
     * @param input a <code>UpdateDataResource</code>
     */
    public static UpdateDataResource fromInput(UpdateDataResource input) {
        UpdateDataResource service = new UpdateDataResource();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateDataResource</code> from the output values of the given <code>UpdateDataResource</code>.
     * @param output a <code>UpdateDataResource</code>
     */
    public static UpdateDataResource fromOutput(UpdateDataResource output) {
        UpdateDataResource service = new UpdateDataResource();
    ...
    /**
     * Construct a <code>UpdateDataResource</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateDataResource fromInput(Map<String, Object> mapValue) {
        UpdateDataResource service = new UpdateDataResource();
    ...
    /**
     * Construct a <code>UpdateDataResource</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateDataResource fromOutput(Map<String, Object> mapValue) {
        UpdateDataResource service = new UpdateDataResource();
