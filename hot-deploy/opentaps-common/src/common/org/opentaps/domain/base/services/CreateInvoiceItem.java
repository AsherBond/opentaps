 ...
 */
public class CreateInvoiceItem extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateInvoiceItem</code> from the input values of the given <code>CreateInvoiceItem</code>.
     * @param input a <code>CreateInvoiceItem</code>
     */
    public static CreateInvoiceItem fromInput(CreateInvoiceItem input) {
        CreateInvoiceItem service = new CreateInvoiceItem();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateInvoiceItem</code> from the output values of the given <code>CreateInvoiceItem</code>.
     * @param output a <code>CreateInvoiceItem</code>
     */
    public static CreateInvoiceItem fromOutput(CreateInvoiceItem output) {
        CreateInvoiceItem service = new CreateInvoiceItem();
    ...
    /**
     * Construct a <code>CreateInvoiceItem</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateInvoiceItem fromInput(Map<String, Object> mapValue) {
        CreateInvoiceItem service = new CreateInvoiceItem();
    ...
    /**
     * Construct a <code>CreateInvoiceItem</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateInvoiceItem fromOutput(Map<String, Object> mapValue) {
        CreateInvoiceItem service = new CreateInvoiceItem();
