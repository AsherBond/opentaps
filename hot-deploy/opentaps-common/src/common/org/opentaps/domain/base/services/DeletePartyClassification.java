 ...
 */
public class DeletePartyClassification extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>DeletePartyClassification</code> from the input values of the given <code>DeletePartyClassification</code>.
     * @param input a <code>DeletePartyClassification</code>
     */
    public static DeletePartyClassification fromInput(DeletePartyClassification input) {
        DeletePartyClassification service = new DeletePartyClassification();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>DeletePartyClassification</code> from the output values of the given <code>DeletePartyClassification</code>.
     * @param output a <code>DeletePartyClassification</code>
     */
    public static DeletePartyClassification fromOutput(DeletePartyClassification output) {
        DeletePartyClassification service = new DeletePartyClassification();
    ...
    /**
     * Construct a <code>DeletePartyClassification</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static DeletePartyClassification fromInput(Map<String, Object> mapValue) {
        DeletePartyClassification service = new DeletePartyClassification();
    ...
    /**
     * Construct a <code>DeletePartyClassification</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static DeletePartyClassification fromOutput(Map<String, Object> mapValue) {
        DeletePartyClassification service = new DeletePartyClassification();
