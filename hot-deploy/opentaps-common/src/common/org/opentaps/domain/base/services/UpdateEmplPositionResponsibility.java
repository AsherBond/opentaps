 ...
 */
public class UpdateEmplPositionResponsibility extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateEmplPositionResponsibility</code> from the input values of the given <code>UpdateEmplPositionResponsibility</code>.
     * @param input a <code>UpdateEmplPositionResponsibility</code>
     */
    public static UpdateEmplPositionResponsibility fromInput(UpdateEmplPositionResponsibility input) {
        UpdateEmplPositionResponsibility service = new UpdateEmplPositionResponsibility();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateEmplPositionResponsibility</code> from the output values of the given <code>UpdateEmplPositionResponsibility</code>.
     * @param output a <code>UpdateEmplPositionResponsibility</code>
     */
    public static UpdateEmplPositionResponsibility fromOutput(UpdateEmplPositionResponsibility output) {
        UpdateEmplPositionResponsibility service = new UpdateEmplPositionResponsibility();
    ...
    /**
     * Construct a <code>UpdateEmplPositionResponsibility</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateEmplPositionResponsibility fromInput(Map<String, Object> mapValue) {
        UpdateEmplPositionResponsibility service = new UpdateEmplPositionResponsibility();
    ...
    /**
     * Construct a <code>UpdateEmplPositionResponsibility</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateEmplPositionResponsibility fromOutput(Map<String, Object> mapValue) {
        UpdateEmplPositionResponsibility service = new UpdateEmplPositionResponsibility();
