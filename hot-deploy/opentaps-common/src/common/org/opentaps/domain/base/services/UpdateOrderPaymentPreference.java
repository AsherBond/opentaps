 ...
 */
public class UpdateOrderPaymentPreference extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>UpdateOrderPaymentPreference</code> from the input values of the given <code>UpdateOrderPaymentPreference</code>.
     * @param input a <code>UpdateOrderPaymentPreference</code>
     */
    public static UpdateOrderPaymentPreference fromInput(UpdateOrderPaymentPreference input) {
        UpdateOrderPaymentPreference service = new UpdateOrderPaymentPreference();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>UpdateOrderPaymentPreference</code> from the output values of the given <code>UpdateOrderPaymentPreference</code>.
     * @param output a <code>UpdateOrderPaymentPreference</code>
     */
    public static UpdateOrderPaymentPreference fromOutput(UpdateOrderPaymentPreference output) {
        UpdateOrderPaymentPreference service = new UpdateOrderPaymentPreference();
    ...
    /**
     * Construct a <code>UpdateOrderPaymentPreference</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static UpdateOrderPaymentPreference fromInput(Map<String, Object> mapValue) {
        UpdateOrderPaymentPreference service = new UpdateOrderPaymentPreference();
    ...
    /**
     * Construct a <code>UpdateOrderPaymentPreference</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static UpdateOrderPaymentPreference fromOutput(Map<String, Object> mapValue) {
        UpdateOrderPaymentPreference service = new UpdateOrderPaymentPreference();
