 ...
 */
public class CreateSimpleTextContentForCategory extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForCategory</code> from the input values of the given <code>CreateSimpleTextContentForCategory</code>.
     * @param input a <code>CreateSimpleTextContentForCategory</code>
     */
    public static CreateSimpleTextContentForCategory fromInput(CreateSimpleTextContentForCategory input) {
        CreateSimpleTextContentForCategory service = new CreateSimpleTextContentForCategory();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateSimpleTextContentForCategory</code> from the output values of the given <code>CreateSimpleTextContentForCategory</code>.
     * @param output a <code>CreateSimpleTextContentForCategory</code>
     */
    public static CreateSimpleTextContentForCategory fromOutput(CreateSimpleTextContentForCategory output) {
        CreateSimpleTextContentForCategory service = new CreateSimpleTextContentForCategory();
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForCategory</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateSimpleTextContentForCategory fromInput(Map<String, Object> mapValue) {
        CreateSimpleTextContentForCategory service = new CreateSimpleTextContentForCategory();
    ...
    /**
     * Construct a <code>CreateSimpleTextContentForCategory</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateSimpleTextContentForCategory fromOutput(Map<String, Object> mapValue) {
        CreateSimpleTextContentForCategory service = new CreateSimpleTextContentForCategory();
