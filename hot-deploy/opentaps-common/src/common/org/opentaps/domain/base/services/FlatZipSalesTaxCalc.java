 ...
 */
public class FlatZipSalesTaxCalc extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>FlatZipSalesTaxCalc</code> from the input values of the given <code>FlatZipSalesTaxCalc</code>.
     * @param input a <code>FlatZipSalesTaxCalc</code>
     */
    public static FlatZipSalesTaxCalc fromInput(FlatZipSalesTaxCalc input) {
        FlatZipSalesTaxCalc service = new FlatZipSalesTaxCalc();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>FlatZipSalesTaxCalc</code> from the output values of the given <code>FlatZipSalesTaxCalc</code>.
     * @param output a <code>FlatZipSalesTaxCalc</code>
     */
    public static FlatZipSalesTaxCalc fromOutput(FlatZipSalesTaxCalc output) {
        FlatZipSalesTaxCalc service = new FlatZipSalesTaxCalc();
    ...
    /**
     * Construct a <code>FlatZipSalesTaxCalc</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static FlatZipSalesTaxCalc fromInput(Map<String, Object> mapValue) {
        FlatZipSalesTaxCalc service = new FlatZipSalesTaxCalc();
    ...
    /**
     * Construct a <code>FlatZipSalesTaxCalc</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static FlatZipSalesTaxCalc fromOutput(Map<String, Object> mapValue) {
        FlatZipSalesTaxCalc service = new FlatZipSalesTaxCalc();
