 ...
 */
public class CreateDataResourceAndText extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateDataResourceAndText</code> from the input values of the given <code>CreateDataResourceAndText</code>.
     * @param input a <code>CreateDataResourceAndText</code>
     */
    public static CreateDataResourceAndText fromInput(CreateDataResourceAndText input) {
        CreateDataResourceAndText service = new CreateDataResourceAndText();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateDataResourceAndText</code> from the output values of the given <code>CreateDataResourceAndText</code>.
     * @param output a <code>CreateDataResourceAndText</code>
     */
    public static CreateDataResourceAndText fromOutput(CreateDataResourceAndText output) {
        CreateDataResourceAndText service = new CreateDataResourceAndText();
    ...
    /**
     * Construct a <code>CreateDataResourceAndText</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateDataResourceAndText fromInput(Map<String, Object> mapValue) {
        CreateDataResourceAndText service = new CreateDataResourceAndText();
    ...
    /**
     * Construct a <code>CreateDataResourceAndText</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateDataResourceAndText fromOutput(Map<String, Object> mapValue) {
        CreateDataResourceAndText service = new CreateDataResourceAndText();
