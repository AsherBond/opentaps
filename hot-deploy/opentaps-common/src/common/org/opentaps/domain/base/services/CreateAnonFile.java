 ...
 */
public class CreateAnonFile extends ServiceWrapper {
    ...
    */
    ...
    /**
     * Construct a <code>CreateAnonFile</code> from the input values of the given <code>CreateAnonFile</code>.
     * @param input a <code>CreateAnonFile</code>
     */
    public static CreateAnonFile fromInput(CreateAnonFile input) {
        CreateAnonFile service = new CreateAnonFile();
        service.putAllInput(input.inputMap());
        return service;
    }

    /**
     * Construct a <code>CreateAnonFile</code> from the output values of the given <code>CreateAnonFile</code>.
     * @param output a <code>CreateAnonFile</code>
     */
    public static CreateAnonFile fromOutput(CreateAnonFile output) {
        CreateAnonFile service = new CreateAnonFile();
    ...
    /**
     * Construct a <code>CreateAnonFile</code> from the given input <code>Map</code>.
     * @param mapValue the service input <code>Map</code>
     */
    public static CreateAnonFile fromInput(Map<String, Object> mapValue) {
        CreateAnonFile service = new CreateAnonFile();
    ...
    /**
     * Construct a <code>CreateAnonFile</code> from the given output <code>Map</code>.
     * @param mapValue the service output <code>Map</code>
     */
    public static CreateAnonFile fromOutput(Map<String, Object> mapValue) {
        CreateAnonFile service = new CreateAnonFile();
