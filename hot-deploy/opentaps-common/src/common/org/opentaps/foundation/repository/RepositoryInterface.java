...
public interface RepositoryInterface {
    ...
    /**
     * Gets the DomainsDirectory cached object.
     * For cross domain code sometimes need to access another repository.
     * @return the domain directory
     */
    public DomainsDirectory getDomainsDirectory();

    /**
     * Sets the <code>Infrastructure</code> instance used in this repository.
     * @param infrastructure an <code>Infrastructure</code> value
     */
    public void setInfrastructure(Infrastructure infrastructure);

    /**
     * Sets the <code>User</code> associated to this repository.
     * @param user an <code>User</code> value
     */
    public void setUser(User user);

    /**
     * Gets the <code>Infrastructure</code> instance associated to this repository.
     * @return an <code>Infrastructure</code> value
     */
    public Infrastructure getInfrastructure();

    /**
     * Gets the <code>User</code> instance associated to this repository.
