...
fieldMapColumns.put("BudgetItemType", fields);
  ...
  public static enum Fields implements EntityFieldInterface<BudgetItemType> {
   ...
   protected String budgetItemTypeId;
   ...
   protected BudgetItemType parentBudgetItemType = null;
