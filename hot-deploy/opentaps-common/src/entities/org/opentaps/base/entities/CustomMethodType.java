...
fieldMapColumns.put("CustomMethodType", fields);
  ...
  public static enum Fields implements EntityFieldInterface<CustomMethodType> {
   ...
   protected CustomMethodType parentCustomMethodType = null;
   @OneToMany(fetch=FetchType.LAZY)
   @JoinColumn(name="CUSTOM_METHOD_TYPE_ID")
   
   protected List<CustomMethod> customMethods = null;
   @OneToMany(fetch=FetchType.LAZY)
   @JoinColumn(name="PARENT_TYPE_ID")
   
   protected List<CustomMethodType> childCustomMethodTypes = null;
