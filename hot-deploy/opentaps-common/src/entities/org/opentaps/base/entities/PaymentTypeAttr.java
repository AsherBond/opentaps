...
fieldMapColumns.put("PaymentTypeAttr", fields);
  ...
  public static enum Fields implements EntityFieldInterface<PaymentTypeAttr> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.PaymentTypeAttrPkBridge.class)
     protected PaymentTypeAttrPk id = new PaymentTypeAttrPk();
   ...
   protected transient List<PaymentAttribute> paymentAttributes = null;
   protected transient List<Payment> payments = null;
