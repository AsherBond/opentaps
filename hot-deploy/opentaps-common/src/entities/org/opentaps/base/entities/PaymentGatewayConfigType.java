...
fieldMapColumns.put("PaymentGatewayConfigType", fields);
  ...
  public static enum Fields implements EntityFieldInterface<PaymentGatewayConfigType> {
   ...
   protected PaymentGatewayConfigType parentPaymentGatewayConfigType = null;
   @OneToMany(fetch=FetchType.LAZY)
   @JoinColumn(name="PARENT_TYPE_ID")
   
   protected List<PaymentGatewayConfigType> siblingPaymentGatewayConfigTypes = null;
   @OneToMany(fetch=FetchType.LAZY)
   @JoinColumn(name="PAYMENT_GATEWAY_CONFIG_TYPE_ID")
   
   protected List<PaymentGatewayConfig> paymentGatewayConfigs = null;
   @OneToMany(fetch=FetchType.LAZY)
   @JoinColumn(name="PARENT_TYPE_ID")
   
   protected List<PaymentGatewayConfigType> childPaymentGatewayConfigTypes = null;
