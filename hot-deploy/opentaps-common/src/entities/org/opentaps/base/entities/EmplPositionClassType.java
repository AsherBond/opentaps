...
fieldMapColumns.put("EmplPositionClassType", fields);
  ...
  public static enum Fields implements EntityFieldInterface<EmplPositionClassType> {
   ...
   protected String emplPositionClassTypeId;
   ...
   protected EmplPositionClassType parentEmplPositionClassType = null;
   @OneToMany(fetch=FetchType.LAZY)
   @JoinColumn(name="PARENT_TYPE_ID")
   
   protected List<EmplPositionClassType> childEmplPositionClassTypes = null;
