...
fieldMapColumns.put("SubscriptionTypeAttr", fields);
  ...
  public static enum Fields implements EntityFieldInterface<SubscriptionTypeAttr> {
   ...
   @FieldBridge(impl = org.opentaps.base.entities.bridge.SubscriptionTypeAttrPkBridge.class)
     protected SubscriptionTypeAttrPk id = new SubscriptionTypeAttrPk();
   ...
   protected transient List<SubscriptionAttribute> subscriptionAttributes = null;
   protected transient List<Subscription> subscriptions = null;
