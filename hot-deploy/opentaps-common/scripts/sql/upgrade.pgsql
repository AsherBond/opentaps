...
ALTER TABLE FIN_ACCOUNT DROP COLUMN IS_FROZEN RESTRICT;
...
ALTER TABLE FIXED_ASSET_DEP_METHOD DROP COLUMN DEPRECIATION_METHOD_ID RESTRICT;
...
ALTER TABLE PARTY_QUAL DROP COLUMN PARTY_QUAL_ID RESTRICT;
ALTER TABLE PARTY_QUAL DROP COLUMN INSTITUTION_PARTY_ID RESTRICT;
ALTER TABLE PARTY_QUAL DROP COLUMN INSTITUTION_INTERNAL_ID RESTRICT;
ALTER TABLE PARTY_QUAL DROP COLUMN INFO_STRING RESTRICT;

-- those fields are all null in the production DB so this is safe too
ALTER TABLE PRODUCT DROP COLUMN TAX_CATEGORY RESTRICT;
ALTER TABLE PRODUCT DROP COLUMN TAX_VAT_CODE RESTRICT;
ALTER TABLE PRODUCT DROP COLUMN TAX_DUTY_CODE RESTRICT;
...
ALTER TABLE WORK_EFFORT DROP COLUMN WORKFLOW_PACKAGE_ID RESTRICT;
ALTER TABLE WORK_EFFORT DROP COLUMN WORKFLOW_PACKAGE_VERSION RESTRICT;
ALTER TABLE WORK_EFFORT DROP COLUMN WORKFLOW_PROCESS_ID RESTRICT;
ALTER TABLE WORK_EFFORT DROP COLUMN WORKFLOW_PROCESS_VERSION RESTRICT;
ALTER TABLE WORK_EFFORT DROP COLUMN WORKFLOW_ACTIVITY_ID RESTRICT;

-- those are table not longer existing in the system (renamed or deleted)
-- unused
DROP TABLE ASTERISK_USER;
DROP TABLE SIMPLE_SALES_TAX_LOOKUP;
DROP TABLE WORKFLOW_ACTIVITY_LOOP;
DROP TABLE WORKFLOW_ACTIVITY_SUB_FLOW;
DROP TABLE WORKFLOW_ACTIVITY_TOOL;
DROP TABLE WORKFLOW_APPLICATION;
DROP TABLE WORKFLOW_DATA_FIELD;
DROP TABLE WORKFLOW_FORMAL_PARAM;
DROP TABLE WORKFLOW_PACKAGE_EXTERNAL;
DROP TABLE WORKFLOW_PARTICIPANT_LIST;
DROP TABLE WORKFLOW_TRANSITION_REF;
DROP TABLE WORKFLOW_TYPE_DECLARATION;
DROP TABLE WORKFLOW_TRANSITION;
DROP TABLE WORKFLOW_PARTICIPANT;
DROP TABLE WORKFLOW_PARTICIPANT_TYPE;
DROP TABLE WORKFLOW_COMPLEX_TYPE_INFO;
DROP TABLE WORKFLOW_ACTIVITY;
DROP TABLE WORKFLOW_PROCESS;
DROP TABLE WORKFLOW_PACKAGE;
DROP TABLE WORKFLOW_SPECIFICATION;
...
ALTER TABLE QUOTE_ITEM_OPTION ALTER COLUMN QUANTITY TYPE NUMERIC(18,6);
...
ALTER TABLE ORGANIZATION_DIM ALTER COLUMN ORGANIZATION_DIM_ID TYPE INT8;
ALTER TABLE SALES_INVOICE_ITEM_FACT ALTER COLUMN SALES_INV_ITEM_FACT_ID TYPE INT8;
...
ALTER TABLE SALES_INVOICE_ITEM_FACT ALTER COLUMN ORGANIZATION_DIM_ID TYPE INT8;
...
ALTER TABLE TAX_INVOICE_ITEM_FACT ALTER COLUMN TAX_INV_ITEM_FACT_ID TYPE INT8;
...
ALTER TABLE TAX_INVOICE_ITEM_FACT ALTER COLUMN ORGANIZATION_DIM_ID TYPE INT8;

-- recreate primary key for DATA_IMPORT_ORDER_ITEM
ALTER TABLE DATA_IMPORT_ORDER_ITEM DROP CONSTRAINT data_import_order_item_pkey;
