...
<@import location="component://opentaps-common/webapp/common/includes/lib/opentapsFormMacros.ftl"/>
 <script type="text/javascript">
  ...
  <div class="subSectionHeader">
    <div class="subSectionTitle">${uiLabelMap.PurchOrderOptionAndShipToSettings}</div>
  ...
  <br/>
  <div class="subSectionHeader">
    <div class="subSectionTitle">${uiLabelMap.PurchOrderTerms}</div>
  </div>  
  <div class="form"> 
 ...
 <div class="subSectionHeader">
     <div class="subSectionTitle">${uiLabelMap.PurchShipToSettings}</div>
 </div>
 <table width="100%" border="0" cellpadding="1" cellspacing="0">
