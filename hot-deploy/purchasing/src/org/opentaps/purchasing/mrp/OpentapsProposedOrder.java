...
public class OpentapsProposedOrder extends ProposedOrder {
     ...
     */
    public OpentapsProposedOrder(GenericValue product, String facilityId, String manufacturingFacilityId, boolean isBuilt, Timestamp requiredByDate, double quantity, boolean createPendingManufacturingRequirements) {
