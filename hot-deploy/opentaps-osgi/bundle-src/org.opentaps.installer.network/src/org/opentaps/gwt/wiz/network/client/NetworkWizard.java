 ...
 */
package org.opentaps.gwt.wiz.network.client;
 ...
 *
 */
public class NetworkWizard extends BaseEntry {
    ...
    public void onModuleLoad() {
        ...
        form.setWidth(400);
        form.setHeight(300);
        form.setTitle("Network Settings");
        ...
        prev.addListener(new ButtonListenerAdapter() {
            ...
            public void onClick(Button button, EventObject e) {
                NetworkWizard.this.requestUri("prev");
            }
        ...
        next.addListener(new ButtonListenerAdapter() {
            ...
            public void onClick(Button button, EventObject e) {
                NetworkWizard.this.requestUri("next");
            }
    ...
    public void requestUri(String direction) {
        ...
        builder.setRequestData(Format.format("stepId={0}&direction={1}", "network", direction));
