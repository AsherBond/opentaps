...
public class OpportunitiesSubview extends  FindEntityForm<SalesOpportunityListView> {

    public final String partyId;

    private final SalesOpportunityListView salesOpportunityListView;

    public OpportunitiesSubview(String partyId) {
        ...
        salesOpportunityListView.setAutoLoad(false);
