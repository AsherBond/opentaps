...
public class MrpTests extends MrpTestCase {
    ...
    public void testMrpPurchasedProduct() throws GeneralException {
        ...
        // 4. receive 20.0 units of the product as non-serialized inventory
        receiveInventoryProduct(product, 20.0, "NON_SERIAL_INV_ITEM", 99.0, demowarehouse1);
    ...
    public void testMrpManufacturedProductWithBom() throws GeneralException {
        ...
        // 4. create a ProductAssoc entity between finishedGoodTestProduct and rawMaterialTestProduct1 with [productAssocTypeId : 'MANUF_COMPONENT'; quantity : 2.0]
        createBOMProductAssoc(finishedGoodTestProductId, rawMaterialTestProduct1Id, new Long(10), new Double(2.0), admin);

        // 5. create a ProductAssoc entity between finishedGoodTestProduct and rawMaterialTestProduct2 with [productAssocTypeId : 'MANUF_COMPONENT'; quantity : 3.0]
        createBOMProductAssoc(finishedGoodTestProductId, rawMaterialTestProduct2Id, new Long(20), new Double(3.0), admin);
        ...
        // 10. receive 20.0 units of the rawMaterialTestProduct1 as non-serialized inventory (WebStoreWarehouse)
        receiveInventoryProduct(rawMaterialTestProduct1, 20.0, "NON_SERIAL_INV_ITEM", 1.0, facilityId, demowarehouse1);
        ...
        Map<GenericValue, Double> order = new HashMap<GenericValue, Double>();
        order.put(finishedGoodTestProduct, 14.0);
        SalesOrderFactory salesOrder = testCreatesSalesOrder(order, DemoCustomer, productStoreId);
        String orderId = salesOrder.getOrderId();
    ...
    public void testMrpProposedInventoryTransfer() throws GeneralException {
        ...
        // 4. receive 20.0 units of the product as non-serialized inventory (Demo3PL)
        receiveInventoryProduct(product, 20.0, "NON_SERIAL_INV_ITEM", 1.0, thirdPartyFacilityId, demowarehouse1);
    ...
    public void testMrpPendingInventoryTransfersAndPurchaseOrders() throws GeneralException {
        ...
        createMainSupplierForProduct(productId, "DemoSupplier", 5.0, "USD", 1.0, admin);
    ...
    public void testMrpBackupInventoryWarehouse2() throws GeneralException {
        ...
        receiveInventoryProduct(testProduct, 10.0, "NON_SERIAL_INV_ITEM", 1.0, thirdPartyFacilityId, demowarehouse1);
    ...
    public void testMrpForMultiLevelProduct() throws GeneralException {
        ...
        assignDefaultPrice(topLevelProduct, 10.0, admin);
        ...
        createProductFacility(topLevelProductId, facilityId, new Double(0.0), new Double(1.0), admin);
        createProductFacility(midLevelProductId, facilityId, new Double(0.0), new Double(1.0), admin);
        createProductFacility(bottomLevelProductId, facilityId, new Double(0.0), new Double(1.0), admin);

        // bottom level product can be purchased for $0.25
        createMainSupplierForProduct(bottomLevelProductId, "DemoSupplier", 0.25, "USD", 0.0, admin);

        // create BOM from top level to mid level to bottom level product
        createBOMProductAssoc(topLevelProductId, midLevelProductId, new Long(10), new Double(2.0), admin);
        createBOMProductAssoc(midLevelProductId, bottomLevelProductId, new Long(10), new Double(5.0), admin);

        // create sales order
        Map<GenericValue, Double> order = new HashMap<GenericValue, Double>();
        order.put(topLevelProduct, 10.0);
        User = DemoSalesManager;
    ...
    public void testMrpWithBasicSalesForecast() throws GeneralException {
        ...
        String productId = product.getString("productId");
        assignDefaultPrice(product, 10.0, admin);

        // set a facility minimum stock for it
        createProductFacility(productId, facilityId, new Double(0.0), new Double(1.0), admin);

        // associate it with a supplier
        createMainSupplierForProduct(productId, "DemoSupplier", 5.0, "USD", 0.0, admin);
    ...
    public void testMrpWithTransferPlanAndTransferRequirements() throws GeneralException {
        ...
        createProductFacility(productId, facilityId, new Double(0.0), new Double(1.0), admin);
        createProductFacility(productId, thirdPartyFacilityId, new Double(0.0), new Double(1.0), admin);

        // receive 300 into the backup warehouse
        receiveInventoryProduct(product, new Double(300), "NON_SERIAL_INV_ITEM", 5.0, thirdPartyFacilityId, demowarehouse1);
        ...
        receiveInventoryProduct(product, new Double(50), "NON_SERIAL_INV_ITEM", 5.0, facilityId, demowarehouse1);
    ...
    public void testMrpWithTransferRequirementFromSpecifiedWarehouse() throws GeneralException {
        ...
        createProductFacility(productId, facilityId, new Double(0.0), new Double(1.0), retailStoreFacilityId, "PF_RM_SPECIF", admin);
        createProductFacility(productId, thirdPartyFacilityId, new Double(0.0), new Double(1.0), admin);

        // receive 10 into WebStoreWarehouse and 100 into retail store
        receiveInventoryProduct(product, new Double(10), "NON_SERIAL_INV_ITEM", 5.0, facilityId, demowarehouse1);
        receiveInventoryProduct(product, new Double(100), "NON_SERIAL_INV_ITEM", 5.0, retailStoreFacilityId, demowarehouse1);

        // create a sales order for 20
        Map<GenericValue, Double> order = new HashMap<GenericValue, Double>();
        order.put(product, 20.0);
        User = DemoSalesManager;
        testCreatesSalesOrder(order, DemoCustomer, productStoreId);
    ...
    public void testMrpWithNoTransfer() throws GeneralException {
        ...
        createProductFacility(productId, facilityId, new Double(0.0), new Double(1.0), "PF_RM_NEVER", admin);
        createProductFacility(productId, thirdPartyFacilityId, new Double(0.0), new Double(1.0), admin);
    ...
    public void testMrpWithTransferRequirementFromBackupWarehouseWithNoInventory() throws GeneralException {
        ...
        createProductFacility(productId, facilityId, new Double(0.0), new Double(1.0), "PF_RM_BACKUP_ALW", admin);
        createProductFacility(productId, thirdPartyFacilityId, new Double(0.0), new Double(1.0), admin);
    ...
    public void testMrpWithTransferRequirementFromSpecifiedWarehouseWithNoInventory() throws GeneralException {
        ...
        createProductFacility(productId, facilityId, new Double(0.0), new Double(1.0), retailStoreFacilityId, "PF_RM_SPECIF_ALW", admin);
        createProductFacility(productId, thirdPartyFacilityId, new Double(0.0), new Double(1.0), admin);
    ...
    public void testMrpWithPendingInternalRequirements() throws GeneralException {
        ...
        createBOMProductAssoc(productId, productComp1Id, new Long("10"), new Double("7.0"), admin);
        createBOMProductAssoc(productId, productComp2Id, new Long("10"), new Double("3.0"), admin);
    ...
    public void testMrpWithApprovedPendingInternalRequirementsForComponents() throws GeneralException {
        ...
        assignDefaultPrice(productComp1, 7.5, admin);
        createMainSupplierForProduct(productComp1Id, "DemoSupplier", 7.0, "USD", 1.0, admin);
        assignDefaultPrice(productComp2, 3.5, admin);
        createMainSupplierForProduct(productComp2Id, "DemoSupplier", 3.0, "USD", 1.0, admin);
        ...
        createProductFacility(productId, facilityId, new Double(0.0), new Double(1.0), admin);
        createProductFacility(productComp1Id, facilityId, new Double(0.0), new Double(1.0), admin);
        createProductFacility(productComp2Id, facilityId, new Double(0.0), new Double(1.0), admin);
    ...
    public void testMrpForProductWithMultipleBOM() throws GeneralException {
        ...
        createBOMProductAssoc(productId, mat1Id, null, new Long(10), new Double(2.0), admin);
        ...
        createBOMProductAssoc(productId, mat2Id, null, new Long(20), new Double(3.0), admin);
        ...
        createBOMProductAssoc(productId, mat3Id, "ROUT01", new Long(10), new Double(5.0), admin);
        ...
        createBOMProductAssoc(productId, mat4Id, "ROUT01", new Long(20), new Double(2.0), admin);
    ...
    public void testMrpQuantityAboveMaximumQuantity() throws GeneralException {
        ...
        createBOMProductAssoc(testProductId, testPartId1, 1L, 10.0, admin);
        ...
        runMrpContext.put("createPendingManufacturingRequirements", true);
        runAndAssertServiceSuccess("opentaps.runMrp", runMrpContext);
    ...
    public void testMrpApplyMinimalQuantityIrrespectiveOfMinimumStock() throws GeneralException {
        ...
        Map<GenericValue, Double> order = FastMap.newInstance();
        order.put(mftProduct, 5.0);
        User = DemoSalesManager;
        testCreatesSalesOrder(order, DemoCustomer, productStoreId);
