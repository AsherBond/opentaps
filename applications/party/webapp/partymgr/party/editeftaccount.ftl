              ...
              <#list postalAddressInfos as postalAddressInfo>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <#if postalAddress.city?exists><p>${postalAddress.city}</#if>
                    <#if postalAddress.stateProvinceGeoId?has_content>,&nbsp;${postalAddress.stateProvinceGeoId}</#if>&nbsp;${postalAddress.postalCode}</p>
